...
Bool_t CbmStsUnpackPar::getParams(FairParamList* l) {
  ...
  LOG(info)<< " Before CbmStsUnpackPar GetParams at NrOfnDpbs ";
  if ( ! l->fill("NrOfnDpbsModA", &fNrOfnDpbsModA) ) return kFALSE;
  LOG(info)<< " After CbmStsUnpackPar GetParams at NrOfnDpbs ";
  ...
  LOG(info)<< " Before CbmStsUnpackPar GetParams at NrOfnDpbs for GEM2 ";
