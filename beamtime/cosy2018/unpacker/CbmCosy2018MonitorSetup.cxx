...
//         fvmChanHitsInTs[ uXyterIdx ][ uChan ].clear();
   ...
   LOG(info) << "CbmCosy2018MonitorSetup::ReInitContainers =>  Dual STS mode:  " << fbDualStsEna;
   return kTRUE;
}
...
void CbmCosy2018MonitorSetup::Finish()
{
   ...
   LOG(info) << "-------------------------------------";
   LOG(info) << "CbmCosy2018MonitorSetup statistics are ";
...
void CbmCosy2018MonitorSetup::FillOutput(boost::any)
{
}
