...
class CbmTofStarMonitor2018: public CbmTSUnpack {
  public:

    CbmTofStarMonitor2018();
    virtual ~CbmTofStarMonitor2018();
...
*/
    ...
    CbmTofStarMonitor2018(const CbmTofStarMonitor2018&);
    CbmTofStarMonitor2018 operator=(const CbmTofStarMonitor2018&);

  ClassDef(CbmTofStarMonitor2018, 1)
};
