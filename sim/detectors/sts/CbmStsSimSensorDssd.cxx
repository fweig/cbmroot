...
// -----   Lorentz shift   -------------------------------------------------
Double_t CbmStsSimSensorDssd::LorentzShift(Double_t z, Int_t chargeType,
                                           Double_t bY) const {
  ...
  if (chargeType == 0) // electrons
    muHall = GetConditions()->GetHallMobility((eField + eFieldMax)/2.,
                                              chargeType);
  else // holes
    muHall = GetConditions()->GetHallMobility((eField + eFieldMin)/2.,
                                              chargeType);
...
void CbmStsSimSensorDssd::RegisterCharge(Int_t side, Int_t strip,
                                         Double_t charge,
                                         Double_t time) const {
