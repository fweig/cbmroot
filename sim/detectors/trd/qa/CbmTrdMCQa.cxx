...
CbmTrdMCQa::CbmTrdMCQa() : FairTask(), fHM(new CbmHistManager()), fTrdPoints(NULL), fMCTracks(NULL), fNofStation(10) {}
...
void CbmTrdMCQa::CreatePointHistograms()
{
  for (Int_t stationId = 0; stationId < fNofStation; stationId++) {
    ...
    fHM->Create1<TH1F>(Form("h_trd_MultPoints_Station%i", stationId),
                       Form("Mult, Station %i;Objects per event;Entries", stationId), nofBins, minX, maxX);

    fHM->Create2<TH2F>(Form("h_trd_PointsMap_Station%i", stationId),
                       Form("TrdPoint, Station %i;x, cm;y, cm", stationId), 120, -60., 60., 120, -60., 60.);
    fHM->Create2<TH2F>(Form("h_trd_PointsMapEvent_Station%i", stationId),
                       Form("TrdPoint/cm^{2}, Station %i;x, cm;y, cm", stationId), 120, -60., 60., 120, -60., 60.);
    fHM->Create2<TH2F>(Form("h_trd_PointsMapRate_Station%i", stationId),
                       Form("TrdPoint/cm^{2}/s, Station %i;x, cm;y, cm", stationId), 120, -60., 60., 120, -60., 60.);
