...
class CbmEventGenerator : public FairPrimaryGenerator
{
	...
	public:
	  ...
	  virtual Bool_t GenerateEvent(FairGenericStack* stack);
		 ...
		 */
		void SetBeamAngle(Double_t meanThetaX, Double_t meanThetaY,
											Double_t sigmaThetaX = -1., Double_t sigmaThetaY = -1.);
		 ...
		 */
		void SetBeamPosition(Double_t meanX, Double_t meanY,
												 Double_t sigmaX = -1., Double_t sigmaY = -1.,
												 Double_t zF = 0.);
