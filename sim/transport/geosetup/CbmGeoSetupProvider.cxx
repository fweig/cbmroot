...
namespace { // anonymous namespace
  ...
  std::vector<ECbmModuleId> GetModuleLoadingOrder() {
    return { ECbmModuleId::kCave, ECbmModuleId::kMagnet, ECbmModuleId::kPipe, ECbmModuleId::kTarget,
//      ECbmModuleId::kMvd, ECbmModuleId::kSts, ECbmModuleId::kRich, ECbmModuleId::kMuch, ECbmModuleId::kTrd, ECbmModuleId::kTof, ECbmModuleId::kEcal, ECbmModuleId::kPsd,
      ECbmModuleId::kMvd, ECbmModuleId::kSts, ECbmModuleId::kRich, ECbmModuleId::kMuch, ECbmModuleId::kTrd, ECbmModuleId::kTof, ECbmModuleId::kPsd,
...
void CbmGeoSetupProvider::RegisterSetup() {
  ...
  for (ECbmModuleId moduleId : GetModuleLoadingOrder()) {
    ...
    for (auto& string: _geom) {
      ...
      LOG(info) << "-I- RegisterSetup: Registering "
                << modulName
                << " " << _tag[counter]
      ...
      switch (moduleId) {
        ...
        case ECbmModuleId::kTof:      fairModule = new CbmTof("TOF", isActive); break;
...
//        case ECbmModuleId::kShield:   fairModule = new CbmShield("SHIELD"); break;
        ...
        default:
          LOG(error) << "-E- RegisterSetup: Unknown fairModule ID " 
                     << moduleId;
          break;
      }
          counter++;
