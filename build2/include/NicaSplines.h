 ...
 */
#ifndef NICASPLINES_H_
#define NICASPLINES_H_
 ...
 * method
 */
class NicaSpline1D : public TObject {
  TAxis* fXaxis;
  Int_t fNbins;
  Double_t* fA;   //[fNbins]
  Double_t* fB;   //[fNbins]
  ...
  Double_t* fBe;  //[fNbins]
  void
  CalcParams(Double_t x1, Double_t y1, Double_t x2, Double_t y2, Double_t x3, Double_t y3, Double_t& A, Double_t& B, Double_t& C);
...
public:
  NicaSpline1D(TH1* h = NULL, Double_t begval = 0, Double_t endval = 0);
  /**
  ...
  virtual ~NicaSpline1D();
  ClassDef(NicaSpline1D, 1)
};
 ...
 * method
 */
class NicaSpline2D : public TObject {
  TAxis* fXaxis;
  TAxis* fYaxis;
  Int_t fNbinsX;
  Int_t fNbinsY;
  NicaArray_3<Double_t> fA;
  NicaArray_2<Double_t>* fAe;
...
public:
   ...
   * same as last bin
   */
  NicaSpline2D(TH2* h = NULL, Option_t* interpolation = "");
  /**
  ...
  virtual ~NicaSpline2D();
  ClassDef(NicaSpline2D, 1)
};
/**
 ...
 * value of histogram.
 */
class NicaSpline3D : public TObject {
  TAxis* fXaxis;
  TAxis* fYaxis;
  TAxis* fZaxis;
  Int_t fNbinsX;
  Int_t fNbinsY;
  Int_t fNbinsZ;
  NicaArray_4<Double_t> fA;
  NicaArray_3<Double_t> fAe;
...
public:
   ...
   *
   */
  NicaSpline3D(TH3* h = NULL, Option_t* interpolation = "");
  /**
  ...
  /**
   * works like NicaSpline3D: Eval(Double_t x,Double_t y, Double_t z)
  ...
  virtual ~NicaSpline3D();
  ClassDef(NicaSpline3D, 1)
};

#endif /* NICASPLINES_H_ */
