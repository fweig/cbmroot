 ...
 */
#ifndef NICAMULTIGRAPH_H_
#define NICAMULTIGRAPH_H_
 ...
 */
class NicaMultiGraph : public TObject {
  Int_t fN;
...
public:
  ...
  virtual ~NicaMultiGraph();
  ClassDef(NicaMultiGraph, 1)
};

#endif /* NICAMULTIGRAPH_H_ */
