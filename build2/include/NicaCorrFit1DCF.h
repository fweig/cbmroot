...
#ifndef NICACORRFIT1DCF_H_
#define NICACORRFIT1DCF_H_
...
class NicaCorrFitMath1DCF;
/**
 * abstract class for fitting 1-dim correlation functions
 */
class NicaCorrFit1DCF : public NicaCorrFitFunc {
  friend class NicaFemto1DCF;
  friend class NicaCorrFitMath1DCF;
...
public:
   ...
   */
  NicaCorrFit1DCF(Int_t parameters = 3);
  /**
   *
  ...
  virtual ~NicaCorrFit1DCF();
  ClassDef(NicaCorrFit1DCF, 1)
};

#endif /* NICACORRFIT1DCF_H_ */
