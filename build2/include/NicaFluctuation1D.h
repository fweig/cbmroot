 ...
 */
#ifndef NICAFLUCTUATION1D_H_
#define NICAFLUCTUATION1D_H_
 ...
 *
 **/
class NicaFluctuation1D : public NicaPack {
  Double_t fN;
  Double_t fNError;
  Double_t fM[7];
  Double_t fMErr[7];
 ...
 public:
   ...
   * negative particles
   */
  NicaFluctuation1D(TH2D *h, TString opt);
  ...
  virtual ~NicaFluctuation1D();
  ClassDef(NicaFluctuation1D, 1)
};

#endif /* NICAFLUCTUATION1D_H_ */
