 ...
 */
#ifndef NICAFEMTO_FEATURES_IO_HTML_OBJECT_H_
#define NICAFEMTO_FEATURES_IO_HTML_OBJECT_H_
#include <TObject.h>
#include <TString.h>

class NicaHtmlObject : public TObject {
  TString fClass;
  TString fID;
  TString fStyle;
  TString fContent;
 ...
 public:
  NicaHtmlObject();
  NicaHtmlObject(TString id, TString className, TString style);
  /**
  ...
  virtual ~NicaHtmlObject();
  NicaHtmlObject(const NicaHtmlObject& other);
  NicaHtmlObject& operator=(const NicaHtmlObject& other);
  ClassDef(NicaHtmlObject, 1)
};

#endif /* NICAFEMTO_FEATURES_IO_HTML_OBJECT_H_ */
