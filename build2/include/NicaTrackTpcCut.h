 ...
 */
#ifndef NICATRACKTPCCUT_H_
#define NICATRACKTPCCUT_H_
 ...
 * sigma". This class should not be used directly because NicaToFTrack doesn't
 * inherit directly from NicaTrack. Therefore user should create own version of
 * Pass method.
 * This Pass(NicaTrack*) method should explicite specify class of track that is
 * passed to cut. Then by using SetValue set values and use VerifyTpc to return
 * value (instead of Validate()).
 */
class NicaTrackTpcCut : public NicaTrackExpCut {
  Int_t fParticleType;
  enum NicaTrackTpcMode { kNotBad, kGood };
  NicaTrackTpcMode fMode;
 ...
 public:
  NicaTrackTpcCut();
  NicaTrackTpcCut(const NicaTrackTpcCut& other);
  ...
  virtual ~NicaTrackTpcCut();
  ClassDef(NicaTrackTpcCut, 1)
};

#endif /* NICATRACKTPCCUT_H_ */
