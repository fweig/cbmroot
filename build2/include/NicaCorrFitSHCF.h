 ...
 */
#ifndef NICACORRFITSHCF_H_
#define NICACORRFITSHCF_H_
...
class NicaCorrFitSHCF : public NicaCorrFitFunc {
  friend class NicaFemto1DCF;
  friend class NicaFemto3DCF;
  friend class NicaFemtoSHCF;
  ...
  NicaArray_2<Double_t>* fIntegralsRe;
  NicaArray_2<Double_t>* fIntegralsIm;
  NicaArray_1<Double_t>* fX;
  NicaArray_1<Double_t>* fY;
  NicaArray_1<Double_t>* fZ;
  NicaArray_1<Int_t>* fBinMin;
  NicaArray_1<Int_t>* fBinMax;
...
public:
  NicaCorrFitSHCF(NicaCorrFit3DCF* f = NULL);
  /**
  ...
  virtual ~NicaCorrFitSHCF();
  ClassDef(NicaCorrFitSHCF, 1)
};

#endif /* NICACORRFITSHCF_H_ */
