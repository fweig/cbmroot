 ...
 */
#ifndef NICAFEMTOMINIPAIR_H_
#define NICAFEMTOMINIPAIR_H_

#include <TMath.h>

#include "NicaFemtoPair.h"

class NicaFemtoPicoPair : public TObject {
 protected:
  /**
 ...
 public:
   ...
   * @return
   */
  NicaFemtoPicoPair& operator=(const NicaFemtoPicoPair& other);
  /**
   *
   ...
   */
  inline Float_t GetPhi() const {
    return TMath::ATan2(fPy1 + fPy2, fPx1 + fPx2);
  };
  virtual ~NicaFemtoPicoPair();
  ClassDef(NicaFemtoPicoPair, 1)
};

class NicaFemtoMicroPair : public NicaFemtoPicoPair {
 protected:
  /**
 ...
 public:
  ...
  NicaFemtoMicroPair& operator=(const NicaFemtoPair& other);
  virtual ~NicaFemtoMicroPair();
  ClassDef(NicaFemtoMicroPair, 1)
};

/**
 * small class for storing pairs in TTree
 */
class NicaFemtoMiniPair : public NicaFemtoMicroPair {
  /**
 ...
 public:
   ...
   * @return
   */
  NicaFemtoMiniPair& operator=(const NicaFemtoPair& other);
  /**
   * print info about this pair
   */
  void PrintInfo() const;
  virtual ~NicaFemtoMiniPair();
  /**
   *
  ...
  ClassDef(NicaFemtoMiniPair, 1);
};

#endif /* NICAFEMTOMINIPAIR_H_ */
