...
#ifndef NICACORRFITFUNC_H_
#define NICACORRFITFUNC_H_
...
class NicaChiSqMap2D;
class TF1;
class TH1;
class NicaCorrFitHDFunc;

/**
 * abstract class for fitting correlation function
 */
//#define CF_FIT_TRACKING
class NicaCorrFitFunc : public NicaCorrFit {
...
protected:
   ...
   */
  mutable NicaCorrFitHDFunc* fHDMaps;
  /**
...
public:
   ...
   */
  NicaCorrFitFunc(Int_t nparams = 1, Int_t dim = 1);
  /**
   ...
   */
  NicaChiSqMap2D* GetChiSquareMap(Int_t par1,
                                  Int_t par1_steps,
                                  Double_t par1_min,
                                  Double_t par1_max,
                                  Int_t par2,
  ...
  NicaCorrFitHDFunc* GetHD() const { return fHDMaps; };
  virtual ~NicaCorrFitFunc();
  ClassDef(NicaCorrFitFunc, 1)
};

#endif /* NICACORRFITFUNC_H_ */
