 ...
 */
#ifndef NICAFEMTOWEIGHTGENERATORLEDNICKY2_H_
#define NICAFEMTOWEIGHTGENERATORLEDNICKY2_H_


#include "NicaFemtoConst.h"
#include "NicaFemtoWeightGenerator.h"

class NicaFemtoFsiParsed;

class NicaFemtoWeightGeneratorLednicky2 : public NicaFemtoWeightGenerator {
 protected:
  NicaFemtoFsiParsed *fParser;
  /**
   * normal weight
   */
  double fWei;
 ...
 public:
   ...
   * default c-tor
   */
  NicaFemtoWeightGeneratorLednicky2();  // call SetDefaultCalcPar
  /**
   * copy c-tor
   * @param aWeight
   */
  NicaFemtoWeightGeneratorLednicky2(const NicaFemtoWeightGeneratorLednicky2
                                        &aWeight);  // call SetDefaultCalcPar
   ...
   * @return
   */
  NicaFemtoWeightGeneratorLednicky2 &operator=(
      const NicaFemtoWeightGeneratorLednicky2 &aWeight);
  virtual NicaFemtoWeightGeneratorLednicky2 *MakeClone() const {
    return new NicaFemtoWeightGeneratorLednicky2(*this);
  };
  /**
   * default d-tor
   */
  virtual ~NicaFemtoWeightGeneratorLednicky2();
  ...
  ClassDef(NicaFemtoWeightGeneratorLednicky2, 1)
};

#endif /* NICAFEMTOWEIGHTGENERATORLEDNICKY2_H_ */
