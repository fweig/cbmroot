 ...
 */
#ifndef NICATRACKINTERFACE_H_
#define NICATRACKINTERFACE_H_

#include <TObject.h>
/**
 * basic class for representig tracks from tree as common tracks
 */
class NicaTrackInterface : public TObject {
protected:
  const Int_t fRawObjNo;
  TObject** fRawObject;  //[fRawObjNo]

public:
  NicaTrackInterface(Int_t rawObj = 1);
  /**
   *
  ...
  virtual ~NicaTrackInterface();
  ClassDef(NicaTrackInterface, 1)
};
#endif /* NICAROOT_DATAFORMAT_NICATRACKINTERFACE_H_ */
