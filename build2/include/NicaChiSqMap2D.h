 ...
 */
#ifndef NICACHISQMAP2D_H_
#define NICACHISQMAP2D_H_
...
class NicaChiSqMap2D : public NicaPack {
  TH2D* fHist;
  TLine* fLineX;
  TLine* fLineY;
  TLine* fLineXlow;
...
public:
   ...
   */
  NicaChiSqMap2D(TString name, Int_t xbins, Double_t xlow, Double_t xhigh, Int_t ybins, Double_t ylow, Double_t yhigh);
  /**
   ...
   * @param thres threshold of uncertainty
  ...
  virtual ~NicaChiSqMap2D();
  ClassDef(NicaChiSqMap2D, 1)
};

#endif /* NICACHISQMAP2D_H_ */
