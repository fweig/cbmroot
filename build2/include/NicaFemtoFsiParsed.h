 ...
 */
#ifndef NICAFEMTOFSIPARSED_H_
#define NICAFEMTOFSIPARSED_H_
#include <complex>
#include "TComplex.h"
#include "TObject.h"
class NicaFemtoWeightGeneratorLednicky2;
class NicaFemtoFsiParsed : public TObject {
  friend class NicaFemtoWeightGeneratorLednicky2;
...
#define fsi_aapap__1 (*(struct fsi_aapap__1_ *)&fsi_aapap__)
  ...
  struct fsi_fdh__1_ {
    Double_t fdh[300] /* was [30][10] */, rdh[300] /* was [30][10] */,
        ebh[300] /* was [30][10] */, rbh[300] /* was [30][10] */;
  };
...
#define fsi_amch__1 (*(struct fsi_amch__1_ *)&fsi_amch__)
 ...
 public:
  NicaFemtoFsiParsed();
  virtual ~NicaFemtoFsiParsed();
  ClassDef(NicaFemtoFsiParsed, 1)
};

#endif /* NICAFEMTOFSIPARSED_H_ */
