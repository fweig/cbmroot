 ...
 */
#ifndef NICAV0TRACK_H_
#define NICAV0TRACK_H_
 ...
 */
class NicaV0Track : public TObject {
  Int_t fPosId;
  Int_t fNegId;
  Int_t fAssumedPdg;
...
public:
  NicaV0Track();
  NicaV0Track(const NicaV0Track& other) = default;
  /**
   * copy content
   * @param v
   */
  virtual void CopyData(NicaV0Track* v);
  /**
   *
  ...
  virtual ~NicaV0Track();
  ClassDef(NicaV0Track, 1)
};

#endif /* NICAV0TRACK_H_ */
