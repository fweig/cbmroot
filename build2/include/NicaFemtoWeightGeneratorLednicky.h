...
#ifndef NICAFEMTOWEIGHTGENERATORLEDNICKY_H_
#define NICAFEMTOWEIGHTGENERATORLEDNICKY_H_
 ...
 */
class NicaFemtoWeightGeneratorLednicky : public NicaFemtoWeightGenerator {
protected:
  /**
   * normal weight
   */
   ...
   * @param pair
   */
  virtual void SetPairTypeFromPairAndConfigureFSI(NicaFemtoPair* pair);
  /**
   * convert pair ID to lednicky pair ID
   * @param pair_pid
   * @return
   */
  void PairIDToLL(ENicaFemtoPairType pair_pid, Int_t& LL, Int_t& tCharge) const;
  /**
   * convert lednicky's weight ID to pair ID
   * @param ll
   * @return
   */
  ENicaFemtoPairType LLToPairID(Int_t ll) const;
  /**
...
public:
   ...
   * default c-tor
   */
  NicaFemtoWeightGeneratorLednicky();  // call SetDefaultCalcPar
  /**
   * copy c-tor
   * @param aWeight
   */
  NicaFemtoWeightGeneratorLednicky(const NicaFemtoWeightGeneratorLednicky& aWeight);  // call SetDefaultCalcPar
   ...
   * @return
   */
  NicaFemtoWeightGeneratorLednicky& operator=(const NicaFemtoWeightGeneratorLednicky& aWeight);
  /**
   * default d-tor
   */
  virtual ~NicaFemtoWeightGeneratorLednicky();
  ...
  virtual NicaFemtoWeightGeneratorLednicky* MakeCopy() const { return new NicaFemtoWeightGeneratorLednicky(*this); };

  virtual NicaFemtoWeightGenerator* Clone(const char* newname = "") const;

  // --- Setting
  void Init(Int_t taks_id);
  // >>> Calculation mode
  /**
  ...
  ClassDef(NicaFemtoWeightGeneratorLednicky, 1)
};
#endif /* NICAFEMTOWEIGHTGENERATORLEDNICKY_H_ */
