 ...
 */
#ifndef NICAMINIMIZER_H_
#define NICAMINIMIZER_H_
 ...
 */
/*
class NicaMinimizerParameter : public TObject {
private:
  Double_t fMapMin;
  Double_t fMapMax;
  Double_t fMin;
...
public:
  NicaMinimizerParameter() : fMapMin(0), fMapMax(0), fMin(0), fMax(0), fStartParam(0), fMapSteps(0) {};
  ...
  virtual ~NicaMinimizerParameter() {};
};
*/
class NicaMinimizer : public ROOT::Math::Minimizer {

protected:
  enum eMinimizeType { kScan, kAnt };

private:
  static NicaMinimizer* fgInstance;
...
public:
  ...
  virtual ~NicaMinimizer();
  ClassDef(NicaMinimizer, 1)
};

#endif /* NICAMINIMIZER_H_ */
