 ...
 */
#ifndef NICACORRFITPAIRGENERATORYPT_H_
#define NICACORRFITPAIRGENERATORYPT_H_
...
class NicaCorrFitPairGeneratorYPt : public TObject {
  Int_t fBins;
  Int_t fNEvents;
  Int_t fPid1, fPid2;
  Int_t fMultiplicity;
...
public:
  ...
  NicaCorrFitPairGeneratorYPt& operator=(const NicaCorrFitPairGeneratorYPt&) = delete;
  /**
   ...
   */
  void Exec();
  virtual ~NicaCorrFitPairGeneratorYPt();
  ClassDef(NicaCorrFitPairGeneratorYPt, 1)
};

#endif /* NICACORRFITPAIRGENERATORYPT_H_ */
