...
//show entrie table
	function showTable($result){
		...
		echo "<tr><td>No</td>"
	.getJavaSort("Comment")."Comment</td>"
	.getJavaSort("InputFile")."InputFile</td>"
	.getJavaSort("AnaName")."AnaName</td>"
	.getJavaSort("PathFile")."Full Path</td>"
	.getJavaSort("ID")."Link</td>"
	.getJavaSort("Tags")."Tags</td><tr>".PHP_EOL;
