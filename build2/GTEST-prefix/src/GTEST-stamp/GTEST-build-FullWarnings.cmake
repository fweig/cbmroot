...
set(stdout_log "/home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-build-out.log")
set(stderr_log "/home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "GTEST build command succeeded.  See also /home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
