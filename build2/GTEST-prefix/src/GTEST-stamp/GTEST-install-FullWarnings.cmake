...
set(stdout_log "/home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-install-out.log")
set(stderr_log "/home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "GTEST install command succeeded.  See also /home/heinemann/gpuunpacker/cbmroot/build2/GTEST-prefix/src/GTEST-stamp/GTEST-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
