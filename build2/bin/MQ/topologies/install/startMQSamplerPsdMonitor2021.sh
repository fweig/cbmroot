...
_paramfile=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mPsdPar.par
...
xterm -l -geometry 80x23+0+0 -hold -e /usr/local/bin/MQ/source/$SAMPLER &
...
while (( _iMoni < _nbmoni )); do
  ...
  xterm -l -geometry 80x23+500+$_yOffset -hold -e /usr/local/bin/MQ/monitor/$MONITOR &
done
...
xterm -geometry 80x23+1000+0 -hold -e /usr/local/bin/MQ/parmq/$PARAMETERSERVER &
...
xterm -geometry 800x230+1500+0 -hold -e /usr/local/bin/MQ/histogramServer/$HISTSERVER &
