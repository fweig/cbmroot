...
_paramfile=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mTofPar.par
...
# Replaces log filename Xterm.log.hostname.yyyy.mm.dd.hh.mm.ss.XXXXXX
  ...
  xterm -l -lf $MONITOR_LOG -geometry 80x23+500+$_yOffset -hold -e /usr/local/bin/MQ/monitor/$MONITOR &
done
...
xterm -l -lf $PARAMSRV_LOG -geometry 80x23+1000+0 -hold -e /usr/local/bin/MQ/parmq/$PARAMETERSERVER &
...
xterm -l -lf $HISTSRV_LOG -geometry 80x23+1500+0 -hold -e /usr/local/bin/MQ/histogramServer/$HISTSERVER &
