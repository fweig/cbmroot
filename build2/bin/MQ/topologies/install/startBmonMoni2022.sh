...
_parfileSts=/usr/local/share/cbmroot/macro/beamtime/mcbm2022/mStsPar.par
_parfileMuch=/usr/local/share/cbmroot/macro/beamtime/mcbm2022/mMuchPar.par  # Valid from 2163
_parfileTrdAsic=/usr/local/share/cbmroot/parameters/trd/trd_v22d_mcbm.asic.par
_parfileTrdDigi=/usr/local/share/cbmroot/parameters/trd/trd_v22d_mcbm.digi.par
_parfileTrdGas=/usr/local/share/cbmroot/parameters/trd/trd_v22d_mcbm.gas.par
_parfileTrdGain=/usr/local/share/cbmroot/parameters/trd/trd_v22d_mcbm.gain.par
_parfileTof=/usr/local/share/cbmroot/macro/beamtime/mcbm2022/mTofCriPar.par
_parfileBmon=/usr/local/share/cbmroot/macro/beamtime/mcbm2022/mBmonCriPar.par
_parfileRich=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mRichPar_70.par
_parfilePsd=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mPsdPar.par
...
if [ $_run_id -ge 2060 ]; then
  if [ $_run_id -le 2065 ]; then
    ...
    _parfileMuch=/usr/local/share/cbmroot/macro/beamtime/mcbm2022/mMuchParUpto26032022.par # Valid for runs 2060-2162
...
nohup /usr/local/bin/MQ/source/$SAMPLER  &> $SAMPLER_LOG &
...
nohup /usr/local/bin/MQ/parmq/$PARAMETERSERVER &> $PARAMSRV_LOG &
...
nohup /usr/local/bin/MQ/histogramServer/$HISTSERVER &> $HISTSRV_LOG &
...
#  UNPACKER+=" --channel-config name=commands,type=sub,method=connect,transport=zeromq,address=tcp://127.0.0.1:11007"
  ...
  # xterm -l -lf $UNPACKER_LOG -geometry 132x23+400+$_yOffset -hold -e /usr/local/bin/MQ/mcbm/$UNPACKER &
  nohup /usr/local/bin/MQ/mcbm/$UNPACKER &> $UNPACKER_LOG &
