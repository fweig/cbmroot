...
_parfileSts=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mStsPar.par
_parfileMuch=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mMuchPar.par
_parfileTrdAsic=/usr/local/share/cbmroot/parameters/trd/trd_v21b_mcbm.asic.par
_parfileTrdDigi=/usr/local/share/cbmroot/parameters/trd/trd_v21b_mcbm.digi.par
_parfileTrdGas=/usr/local/share/cbmroot/parameters/trd/trd_v21b_mcbm.gas.par
_parfileTrdGain=/usr/local/share/cbmroot/parameters/trd/trd_v21b_mcbm.gain.par
_parfileTof=/usr/local/share/cbmroot/macro/beamtime/mcbm2021/mTofCriPar.par
...
while (( _iMoni < _nbmoni )); do
  ...
  xterm -l -lf $UNPACKER_LOG -geometry 132x23+400+$_yOffset -hold -e /usr/local/bin/mq/$UNPACKER &
...
###  TRIGGER+=" --TriggerDet Tof"
  ...
  xterm -l -lf $TRIGGER_LOG -geometry 80x23+800+$_yOffset -hold -e /usr/local/bin/mq/$TRIGGER &
...
##  EVTBUILDER+=" --SetEvbuildWin kPsd,-100,100"
  ...
  xterm -l -lf $EVTBUILDER_LOG -geometry 80x23+800+$_yOffset -hold -e /usr/local/bin/mq/$EVTBUILDER &
...
xterm -l -lf $EVTSINK_LOG -geometry 80x23+1200+0 -hold -e /usr/local/bin/mq/$EVTSINK &
