...
_paramfile=/home/heinemann/gpuunpacker/cbmroot/macro/beamtime/mcbm2021/mPsdPar.par
...
while (( _iMoni < _nbmoni )); do
  ...
  xterm -l -geometry 80x23+500+$_yOffset -hold -e /home/heinemann/gpuunpacker/cbmroot/build2/bin/MQ/monitor/$MONITOR &
done
...
xterm -geometry 80x23+1000+0 -hold -e /home/heinemann/gpuunpacker/cbmroot/build2/bin/MQ/parmq/$PARAMETERSERVER &
...
xterm -geometry 800x230+1500+0 -hold -e /home/heinemann/gpuunpacker/cbmroot/build2/bin/MQ/histogramServer/$HISTSERVER &
