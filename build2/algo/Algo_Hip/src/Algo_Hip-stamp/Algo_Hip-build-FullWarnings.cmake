...
set(stdout_log "/home/heinemann/gpuunpacker/cbmroot/build2/algo/Algo_Hip/src/Algo_Hip-stamp/Algo_Hip-build.log")
set(stderr_log "/home/heinemann/gpuunpacker/cbmroot/build2/algo/Algo_Hip/src/Algo_Hip-stamp/Algo_Hip-build.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/heinemann/gpuunpacker/cbmroot/build2/algo/Algo_Hip/src/Algo_Hip-stamp/Algo_Hip-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "Algo_Hip build command succeeded.  See also /home/heinemann/gpuunpacker/cbmroot/build2/algo/Algo_Hip/src/Algo_Hip-stamp/Algo_Hip-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
