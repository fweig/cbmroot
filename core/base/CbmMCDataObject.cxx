...
CbmMCDataObject::CbmMCDataObject(const char* branchname,
  ...
  : fLegacy(0), fLegacyObject(nullptr), fBranchName(branchname), fSize(-1111), fChains(), fTArr(), fN(), fArrays()
{
...
// --- Legacy constructor
CbmMCDataObject::CbmMCDataObject(const char* branchname)
  : fLegacy(1), fLegacyObject(nullptr), fBranchName(branchname), fSize(-1111), fChains(), fTArr(), fN(), fArrays()
{
