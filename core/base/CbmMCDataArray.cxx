...
CbmMCDataArray::CbmMCDataArray(const char* branchname,
  ...
  : fLegacy(0), fLegacyArray(nullptr), fBranchName(branchname), fSize(-1111), fChains(), fTArr(), fN(), fArrays()
{
...
// --- Legacy constructor
CbmMCDataArray::CbmMCDataArray(const char* branchname)
  : fLegacy(1), fLegacyArray(nullptr), fBranchName(branchname), fSize(-1111), fChains(), fTArr(), fN(), fArrays()
{
