...
TEST(_GTestCbmStripHit, CheckDefaultConstructor) {
  CbmStripHit test;
  {
    ...
    compareStripHitDataMembers(
      test, kSTRIPHIT, 0., 0., -1, -1, nullptr, -1., -1., 0., 0., 0., 0.);
  }
}
...
TEST(_GTestCbmStripHit, CheckStandardConstructorWithTime) {
  CbmStripHit test {-1, 0., 0., 0., 0., 0., 0., -1, -2., -2.};
  {
    ...
    compareStripHitDataMembers(
      test, kSTRIPHIT, 0., 0., -1, -1, nullptr, -2., -2., 0., 0., 0., 0.);
  }
}
...
TEST(_GTestCbmStripHit, CheckSetters) {
  ...
  test.SetU(-11.);
  {
    ...
    compareStripHitDataMembers(
      test, kSTRIPHIT, 0., 0., -1, -1, nullptr, -1., -1., -11., 0., 0., 0.);
  }
  ...
  test.SetDu(-12.);
  {
    ...
    compareStripHitDataMembers(
      test, kSTRIPHIT, 0., 0., -1, -1, nullptr, -1., -1., -11., -12., 0., 0.);
  }
  ...
  test.SetPhi(-13.);
  {
    ...
    compareStripHitDataMembers(
      test, kSTRIPHIT, 0., 0., -1, -1, nullptr, -1., -1., -11., -12., -13., 0.);
  }

  test.SetDphi(-14.);
  {
    SCOPED_TRACE("CheckSetters: SetDphi");
    compareStripHitDataMembers(test,
                               kSTRIPHIT,
                               0.,
                               0.,
                               -1,
