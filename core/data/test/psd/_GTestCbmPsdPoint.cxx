...
TEST(_GTestCbmPsdPoint , CheckDefaultConstructor)
{
  ...
  comparePsdPointDataMembers(test, -1, -1, TVector3(0., 0., 0.), TVector3(0., 0., 0.), 
                            0., 0., 0., 0, 0);

  CbmPsdPoint* test1 = new CbmPsdPoint();

  comparePsdPointDataMembers(*test1, -1, -1, TVector3(0., 0., 0.), TVector3(0., 0., 0.), 
                            0., 0., 0., 0, 0);
...
TEST(_GTestCbmPsdPoint , CheckStandardConstructor)
{
  ...
  comparePsdPointDataMembers(test, trackid, detid, pos, mom, 
                             tof, length, eloss, moduleid, eventid);

  CbmPsdPoint* test1 = new CbmPsdPoint(trackid, detid, pos, mom, tof, length, eloss);

  comparePsdPointDataMembers(*test1, trackid, detid, pos, mom, 
                             tof, length, eloss, moduleid, eventid);
...
TEST(_GTestCbmPsdPoint , CheckCopyConstructor)
{
  ...
  comparePsdPointDataMembers(test2, trackid, detid, pos, mom, 
                             tof, length, eloss, moduleid, eventid);
