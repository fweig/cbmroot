...
TEST(_GTestCbmMuchBeamTimeDigi, CheckDefaultConstructor)
{
  ...
  compareMuchBeamTimeDigiDataMembers(test, 0, ECbmModuleId::kMuch, 0, 0, 
                                     -1, -1, -1, -1, -1, -1);

  CbmMuchBeamTimeDigi* test1 = new CbmMuchBeamTimeDigi();

  compareMuchBeamTimeDigiDataMembers(*test1, 0, ECbmModuleId::kMuch, 0, 0,
                                     -1, -1, -1, -1, -1, -1);
}
...
TEST(_GTestCbmMuchBeamTimeDigi , CheckStandardConstructor)
{
  ...
  compareMuchBeamTimeDigiDataMembers(test, 111, ECbmModuleId::kMuch, 987654321, 23,
                                     -1, -1, -1, -1, -1, -1);

  CbmMuchBeamTimeDigi* test1 = new CbmMuchBeamTimeDigi(111, 23, 987654321);

  compareMuchBeamTimeDigiDataMembers(*test1, 111, ECbmModuleId::kMuch, 987654321, 23,
                                     -1, -1, -1, -1, -1, -1);
}
...
TEST(_GTestCbmMuchBeamTimeDigi , CheckCopyConstructor)
{
  ...
  compareMuchBeamTimeDigiDataMembers(test2, 111, ECbmModuleId::kMuch, 987654321, 23,
                                     -1, -1, -1, -1, -1, -1);
