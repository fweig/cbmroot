...
TEST(_GTestCbmTrdDigi, CheckStandardConstructor) {
  ...
  Int_t uniqueModuleId =
    (Int_t) ECbmModuleId::kTrd;  // Unique ModuleId of first module
  Double_t charge    = 42.42;
  ULong64_t digiTime = 42001;
  Int_t errClass     = 0;
  CbmTrdDigi test(padChNr,
                  uniqueModuleId,
                  charge,
                  digiTime,
                  ((Int_t) CbmTrdDigi::kSelf),
                  errClass);
  compareTrdDigiDataMembers(
    test, padChNr, ECbmModuleId::kTrd, digiTime, charge);

  CbmTrdDigi* test1 = new CbmTrdDigi(padChNr,
                                     uniqueModuleId,
                                     charge,
                                     digiTime,
                                     ((Int_t) CbmTrdDigi::kSelf),
  ...
  compareTrdDigiDataMembers(
    *test1, padChNr, ECbmModuleId::kTrd, digiTime, charge);
  ;
}
