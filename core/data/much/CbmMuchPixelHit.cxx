...
CbmMuchPixelHit::CbmMuchPixelHit() : CbmPixelHit(), fPlaneId(-1), fFlag(0) {
  SetType(kMUCHPIXELHIT);
}

CbmMuchPixelHit::~CbmMuchPixelHit() {}

CbmMuchPixelHit::CbmMuchPixelHit(Int_t address,
                                 Double_t x,
                                 Double_t y,
                                 Double_t z,
                                 Double_t dx,
...
CbmMuchPixelHit::CbmMuchPixelHit(Int_t address,
                                 ...
                                 Int_t refId,
                                 Int_t planeId)
  : CbmPixelHit(address, pos, err, dxy, refId), fPlaneId(planeId), fFlag(0) {
  SetType(kMUCHPIXELHIT);
  SetTime(-1);
  SetTimeError(-1.);
}
