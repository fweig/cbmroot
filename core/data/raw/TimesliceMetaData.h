...
public:
  TimesliceMetaData(ULong64_t ulStart   = 0,
  ...
  ULong64_t GetOverlapStartTime() const {
    return fulStartTimeNs + fulDurationNs;
  }
...
private:
  ...
  ULong64_t fulDurationNs =
    12800000;  //  10 MS * 1280000 ns (with TRD), default to update in source
  ULong64_t fulOverlapNs =
    1280000;  //   1 MS * 1280000 ns (with TRD), default to update in source
