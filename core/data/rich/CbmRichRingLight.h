/* Copyright (C) 2010-2019 UGiessen/JINR-LIT, Giessen/Dubna
...
public:
  /**
    ...
    */
  CbmRichHitLight() : fX(0.), fY(0.), fId(0) {}
...
public:
  ...
  /**
    * \brief Destructor.
    */
  virtual ~CbmRichRingLight() { fHits.clear(); }

  /**
    * \brief Add new hit to the ring.
    * \param[in] hit New hit to be added.
    */
  void AddHit(CbmRichHitLight hit) { fHits.push_back(hit); }
