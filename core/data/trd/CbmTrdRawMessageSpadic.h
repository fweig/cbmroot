...
namespace Spadic
{
	...
	**/
	enum class MsMessageType : uint8_t {
		...
		kSOM = 0x20,    ///< Start of Message.          MSB: 001. ....   timestamp (bits 50-35) in clockcycles. Currently (Feb 2020) only 11 LSB in use.
		kRDA = 0x80,    ///< Raw Data. Preceded by SOM. MSB: 1... ....   always 64bits, bits after last transmitted sample are filled with 0.
		kINF = 0x10,    ///< Info  Message.             MSB: 0001 ....   The 20 LSBs of the 64bit word contain the 20 LSBs of a raw spadic InfoType frame e.g. BOM.
