...
{
  if(GetType()!=kFASP){
    LOG(warn)<<"CbmTrdDigi::AddCharge(CbmTrdDigi*, Double_t) : Only available for FASP. Use AddCharge(Double_t, Double_t) instead.";
    return;
  } 
...
{
  if(GetType()!=kSPADIC){
    LOG(warn)<<"CbmTrdDigi::AddCharge(Double_t, Double_t) : Only available for SPADIC. Use AddCharge(CbmTrdDigi*, Double_t) instead.";
    return;
  } 
...
{
  if(GetType()!=kSPADIC){
    LOG(warn)<<"CbmTrdDigi::GetCharge() : Use Double_t GetCharge(Double_t &tilt) instead.";
    return 0;
  } 
 ...
 */
  if(GetType()!=kFASP){
    LOG(warn)<<"CbmTrdDigi::GetCharge(Double_t &) : Use Double_t GetCharge() instead.";
    return 0;
  } 
