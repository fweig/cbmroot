...
public:
  CbmTrdParSpadic(Int_t address        = 0,
                  Int_t FebGrouping    = -1,
                  Double_t x           = 0,
                  Double_t y           = 0,
                  Double_t z           = 0,
  ...
  static Int_t GetNasicsPerCrob(
    Int_t
      moduleType);  ///< Returns the number of asics per Crob on a given moduleType defined in eCbmTrdModuleTypes
  ...
  static std::uint8_t
  GetCrobId(std::uint64_t
              componentId);  ///< Extracts the CrobId from a given componentId
  static std::uint8_t GetCrobNumber(
    std::uint64_t
      componentId);  ///< Extracts the CrobNumber (nTh Crob on the module) from a given componentId
