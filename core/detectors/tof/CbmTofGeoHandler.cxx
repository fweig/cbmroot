...
Int_t CbmTofGeoHandler::GetUniqueDetectorId()
{
  ...
  CbmTofDetectorInfo detInfo(ECbmModuleId::kTof, smtype, smodule, counter, gap, cell);
...
Int_t CbmTofGeoHandler::GetUniqueCounterId()
{
  ...
  fDetectorInfoArray = CbmTofDetectorInfo(ECbmModuleId::kTof, smtype, smodule, counter, gap, cell);
