...
void CbmAnaConversionPhotons2::InitHistos() {
  ...
  fh2Electrons_angle_all =
    new TH1D("fh2Electrons_angle_all",
             "fh2Electrons_angle_all; opening angle [deg]; #",
             2001,
             -0.05,
             200.05);
  fh2Electrons_angle_combBack =
    new TH1D("fh2Electrons_angle_combBack",
             "fh2Electrons_angle_combBack; opening angle [deg]; #",
             2001,
             -0.05,
             200.05);
  fh2Electrons_angle_allSameG =
    new TH1D("fh2Electrons_angle_allSameG",
             "fh2Electrons_angle_allSameG; opening angle [deg]; #",
             1001,
             -0.05,
             100.05);
  ...
  fh2Electrons_angle_CUTcomparison =
    new TH1I("fh2Electrons_angle_CUTcomparison",
             "fh2Electrons_angle_CUTcomparison; ; #",
             14,
             0.,
             14.);
  ...
  fh2Electrons_angle_CUTcomparison_chi =
    new TH1I("fh2Electrons_angle_CUTcomparison_chi",
             "fh2Electrons_angle_CUTcomparison_chi; ; #",
             10,
             0.,
             10.);
  fHistoList_photons.push_back(fh2Electrons_angle_CUTcomparison_chi);
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(1,
                                                                "true, no cut");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(
    2, "false, no cut");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(3,
                                                                "true, cut1");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(4,
                                                                "false, cut1");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(5,
                                                                "true, cut2");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(6,
                                                                "false, cut2");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(7,
                                                                "true, cut3");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(8,
                                                                "false, cut3");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(9,
                                                                "true, cut4");
  fh2Electrons_angle_CUTcomparison_chi->GetXaxis()->SetBinLabel(10,
                                                                "false, cut4");


  fh2Electrons_angle_CUTcomparison_withRICH =
    new TH1I("fh2Electrons_angle_CUTcomparison_withRICH",
             "fh2Electrons_angle_CUTcomparison_withRICH; ; #",
             14,
             0.,
             14.);
  fHistoList_photons.push_back(fh2Electrons_angle_CUTcomparison_withRICH);
  fh2Electrons_angle_CUTcomparison_withRICH->GetXaxis()->SetBinLabel(
    1, "true, no cut");
  fh2Electrons_angle_CUTcomparison_withRICH->GetXaxis()->SetBinLabel(
    2, "false, no cut");
  fh2Electrons_angle_CUTcomparison_withRICH->GetXaxis()->SetBinLabel(
  ...
  fh2Electrons_angle_CUTcomparison_withRICH_chi =
    new TH1I("fh2Electrons_angle_CUTcomparison_withRICH_chi",
             "fh2Electrons_angle_CUTcomparison_withRICH_chi; ; #",
             10,
             0.,
             10.);
  fHistoList_photons.push_back(fh2Electrons_angle_CUTcomparison_withRICH_chi);
  fh2Electrons_angle_CUTcomparison_withRICH_chi->GetXaxis()->SetBinLabel(
    1, "true, no cut");
  fh2Electrons_angle_CUTcomparison_withRICH_chi->GetXaxis()->SetBinLabel(
    2, "false, no cut");
  fh2Electrons_angle_CUTcomparison_withRICH_chi->GetXaxis()->SetBinLabel(
  ...
  fh2Electrons_angle_CUTcomparison_withRICH_withChi =
    new TH1I("fh2Electrons_angle_CUTcomparison_withRICH_withChi",
             ...
             0.,
             14.);
  fHistoList_photons.push_back(
    fh2Electrons_angle_CUTcomparison_withRICH_withChi);
  fh2Electrons_angle_CUTcomparison_withRICH_withChi->GetXaxis()->SetBinLabel(
    1, "true, no cut");
  fh2Electrons_angle_CUTcomparison_withRICH_withChi->GetXaxis()->SetBinLabel(
    2, "false, no cut");
  fh2Electrons_angle_CUTcomparison_withRICH_withChi->GetXaxis()->SetBinLabel(
  ...
  fh2Electrons_angle_all_cuts =
    new TH1D("fh2Electrons_angle_all_cuts",
             "fh2Electrons_angle_all_cuts; opening angle [deg]; #",
             101,
             -0.05,
             10.05);
  fh2Electrons_angle_combBack_cuts =
    new TH1D("fh2Electrons_angle_combBack_cuts",
             "fh2Electrons_angle_combBack_cuts; opening angle [deg]; #",
             101,
             -0.05,
             10.05);
  fh2Electrons_angle_allSameG_cuts =
    new TH1D("fh2Electrons_angle_allSameG_cuts",
             "fh2Electrons_angle_allSameG_cuts; opening angle [deg]; #",
             101,
             -0.05,
             10.05);
  ...
  fh2Electrons_invmass_all =
    new TH1D("fh2Electrons_invmass_all",
             "fh2Electrons_invmass_all; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_combBack =
    new TH1D("fh2Electrons_invmass_combBack",
             "fh2Electrons_invmass_combBack; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_allSameG =
    new TH1D("fh2Electrons_invmass_allSameG",
             "fh2Electrons_invmass_allSameG; invmass [GeV/c^2]; #",
             5000,
             0.,
             5);
  ...
  fh2Electrons_invmass_all_cut =
    new TH1D("fh2Electrons_invmass_all_cut",
             "fh2Electrons_invmass_all_cut; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_combBack_cut =
    new TH1D("fh2Electrons_invmass_combBack_cut",
             "fh2Electrons_invmass_combBack_cut; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_allSameG_cut =
    new TH1D("fh2Electrons_invmass_allSameG_cut",
             "fh2Electrons_invmass_allSameG_cut; invmass [GeV/c^2]; #",
             5000,
             0.,
             5);
  ...
  fh2Electrons_angleVSpt_all =
    new TH2D("fh2Electrons_angleVSpt_all",
             "fh2Electrons_angleVSpt_all;pt [GeV/c];opening angle [deg]",
             500,
             0.,
             5.,
             400,
  ...
  fh2Electrons_angleVSpt_combBack =
    new TH2D("fh2Electrons_angleVSpt_combBack",
             "fh2Electrons_angleVSpt_combBack;pt [GeV/c];opening angle [deg]",
             500,
             0.,
             5.,
             400,
  ...
  fh2Electrons_angleVSpt_allSameG =
    new TH2D("fh2Electrons_angleVSpt_allSameG",
             "fh2Electrons_angleVSpt_allSameG;pt [GeV/c];opening angle [deg]",
             500,
             0.,
             5.,
             400,
  ...
  fh2Electrons_invmassVSpt_all =
    new TH2D("fh2Electrons_invmassVSpt_all",
             "fh2Electrons_invmassVSpt_all;pt [GeV/c];invmass [GeV]",
             500,
             0.,
             5.,
             5000,
  ...
  fh2Electrons_invmassVSpt_combBack =
    new TH2D("fh2Electrons_invmassVSpt_combBack",
             "fh2Electrons_invmassVSpt_combBack;pt [GeV/c];invmass [GeV]",
             500,
             0.,
             5.,
             5000,
  ...
  fh2Electrons_invmassVSpt_allSameG =
    new TH2D("fh2Electrons_invmassVSpt_allSameG",
             "fh2Electrons_invmassVSpt_allSameG;pt [GeV/c];invmass [GeV]",
             500,
             0.,
             5.,
             5000,
  ...
  fh2Electrons_angle_withRICH_all =
    new TH1D("fh2Electrons_angle_withRICH_all",
             "fh2Electrons_angle_withRICH_all; opening angle [deg]; #",
             2001,
             -0.05,
             200.05);
  fh2Electrons_angle_withRICH_combBack =
    new TH1D("fh2Electrons_angle_withRICH_combBack",
             "fh2Electrons_angle_withRICH_combBack; opening angle [deg]; #",
             2001,
             -0.05,
             200.05);
  fh2Electrons_angle_withRICH_allSameG =
    new TH1D("fh2Electrons_angle_withRICH_allSameG",
  ...
  fh2Electrons_angleVSpt_withRICH_all = new TH2D(
    "fh2Electrons_angleVSpt_withRICH_all",
    "fh2Electrons_angleVSpt_withRICH_all;pt [GeV/c];opening angle [deg]",
    500,
    0.,
    5.,
    400,
    0.,
    20.);
  fh2Electrons_angleVSpt_withRICH_combBack = new TH2D(
    "fh2Electrons_angleVSpt_withRICH_combBack",
    "fh2Electrons_angleVSpt_withRICH_combBack;pt [GeV/c];opening angle [deg]",
    500,
    0.,
    5.,
    400,
    0.,
    20.);
  fh2Electrons_angleVSpt_withRICH_allSameG = new TH2D(
    "fh2Electrons_angleVSpt_withRICH_allSameG",
    "fh2Electrons_angleVSpt_withRICH_allSameG;pt [GeV/c];opening angle [deg]",
    500,
    0.,
    5.,
    400,
  ...
  fHistoList_photons_withRICH.push_back(
    fh2Electrons_angleVSpt_withRICH_combBack);
  fHistoList_photons_withRICH.push_back(
    fh2Electrons_angleVSpt_withRICH_allSameG);
  ...
  fh2Electrons_invmass_withRICH_all =
    new TH1D("fh2Electrons_invmass_withRICH_all",
             "fh2Electrons_invmass_withRICH_all; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_withRICH_combBack =
    new TH1D("fh2Electrons_invmass_withRICH_combBack",
             "fh2Electrons_invmass_withRICH_combBack; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_withRICH_allSameG =
    new TH1D("fh2Electrons_invmass_withRICH_allSameG",
  ...
  fh2Electrons_invmassVSpt_withRICH_all =
    new TH2D("fh2Electrons_invmassVSpt_withRICH_all",
             ...
             0.,
             5.);
  fh2Electrons_invmassVSpt_withRICH_combBack = new TH2D(
    "fh2Electrons_invmassVSpt_withRICH_combBack",
    "fh2Electrons_invmassVSpt_withRICH_combBack;pt [GeV/c];invmass [GeV]",
    500,
    0.,
    5.,
    5000,
    0.,
    5.);
  fh2Electrons_invmassVSpt_withRICH_allSameG = new TH2D(
    "fh2Electrons_invmassVSpt_withRICH_allSameG",
    "fh2Electrons_invmassVSpt_withRICH_allSameG;pt [GeV/c];invmass [GeV]",
    500,
    0.,
    5.,
    5000,
  ...
  fh2Electrons_fullrecoCheck = new TH1I(
    "fh2Electrons_fullrecoCheck", "fh2Electrons_fullrecoCheck;; #", 5, 0., 5.);
  ...
  fh2Electrons_angle_withRICH_withChi_all =
    new TH1D("fh2Electrons_angle_withRICH_withChi_all",
             "fh2Electrons_angle_withRICH_withChi_all; opening angle [deg]; #",
             2001,
             -0.05,
             200.05);
  fh2Electrons_angle_withRICH_withChi_combBack = new TH1D(
    "fh2Electrons_angle_withRICH_withChi_combBack",
    "fh2Electrons_angle_withRICH_withChi_combBack; opening angle [deg]; #",
    2001,
    -0.05,
    200.05);
  fh2Electrons_angle_withRICH_withChi_allSameG = new TH1D(
    "fh2Electrons_angle_withRICH_withChi_allSameG",
    "fh2Electrons_angle_withRICH_withChi_allSameG; opening angle [deg]; #",
    1001,
    -0.05,
    100.05);
  fHistoList_photons_withRICH_withChi.push_back(
    fh2Electrons_angle_withRICH_withChi_all);
  fHistoList_photons_withRICH_withChi.push_back(
    fh2Electrons_angle_withRICH_withChi_combBack);
  fHistoList_photons_withRICH_withChi.push_back(
  ...
  fh2Electrons_angleVSpt_withRICH_withChi_combBack =
    new TH2D("fh2Electrons_angleVSpt_withRICH_withChi_combBack",
  ...
  fh2Electrons_angleVSpt_withRICH_withChi_allSameG =
    new TH2D("fh2Electrons_angleVSpt_withRICH_withChi_allSameG",
  ...
  fh2Electrons_invmass_withRICH_withChi_all =
    new TH1D("fh2Electrons_invmass_withRICH_withChi_all",
             "fh2Electrons_invmass_withRICH_withChi_all; invmass [GeV/c^2]; #",
             5000,
             0.,
             5.);
  fh2Electrons_invmass_withRICH_withChi_combBack = new TH1D(
    "fh2Electrons_invmass_withRICH_withChi_combBack",
    "fh2Electrons_invmass_withRICH_withChi_combBack; invmass [GeV/c^2]; #",
    5000,
    0.,
    5.);
  fh2Electrons_invmass_withRICH_withChi_allSameG = new TH1D(
    "fh2Electrons_invmass_withRICH_withChi_allSameG",
    "fh2Electrons_invmass_withRICH_withChi_allSameG; invmass [GeV/c^2]; #",
    5000,
    0.,
    5.);
  fHistoList_photons_withRICH_withChi.push_back(
  ...
  // invmass vs pt (reco), with RICH
  fh2Electrons_invmassVSpt_withRICH_withChi_all = new TH2D(
    "fh2Electrons_invmassVSpt_withRICH_withChi_all",
    "fh2Electrons_invmassVSpt_withRICH_withChi_all;pt [GeV/c];invmass [GeV]",
    500,
    0.,
    5.,
    5000,
  ...
  fh2Electrons_invmassVSpt_withRICH_withChi_combBack =
    new TH2D("fh2Electrons_invmassVSpt_withRICH_withChi_combBack",
  ...
  fh2Electrons_invmassVSpt_withRICH_withChi_allSameG =
    new TH2D("fh2Electrons_invmassVSpt_withRICH_withChi_allSameG",
  ...
  fh2Electrons_angle_withRICH_fromTarget_all = new TH1D(
    "fh2Electrons_angle_withRICH_fromTarget_all",
    "fh2Electrons_angle_withRICH_fromTarget_all; opening angle [deg]; #",
    2001,
    -0.05,
    200.05);
  fh2Electrons_angle_withRICH_fromTarget_combBack = new TH1D(
    "fh2Electrons_angle_withRICH_fromTarget_combBack",
    "fh2Electrons_angle_withRICH_fromTarget_combBack; opening angle [deg]; #",
    2001,
    -0.05,
    200.05);
  fh2Electrons_angle_withRICH_fromTarget_allSameG = new TH1D(
    "fh2Electrons_angle_withRICH_fromTarget_allSameG",
    "fh2Electrons_angle_withRICH_fromTarget_allSameG; opening angle [deg]; #",
    1001,
    -0.05,
    100.05);
  fHistoList_photons_withRICH_fromTarget.push_back(
    fh2Electrons_angle_withRICH_fromTarget_all);
  fHistoList_photons_withRICH_fromTarget.push_back(
    fh2Electrons_angle_withRICH_fromTarget_combBack);
  fHistoList_photons_withRICH_fromTarget.push_back(
  ...
  fh2Electrons_angleVSpt_withRICH_fromTarget_all =
    new TH2D("fh2Electrons_angleVSpt_withRICH_fromTarget_all",
  ...
  // invmass for all photon-energies (RECO) with RICH
  fh2Electrons_invmass_withRICH_fromTarget_all = new TH1D(
    "fh2Electrons_invmass_withRICH_fromTarget_all",
    "fh2Electrons_invmass_withRICH_fromTarget_all; invmass [GeV/c^2]; #",
    5000,
    0.,
    5.);
  fh2Electrons_invmass_withRICH_fromTarget_combBack = new TH1D(
    "fh2Electrons_invmass_withRICH_fromTarget_combBack",
    "fh2Electrons_invmass_withRICH_fromTarget_combBack; invmass [GeV/c^2]; #",
    5000,
    0.,
    5.);
  fh2Electrons_invmass_withRICH_fromTarget_allSameG = new TH1D(
    "fh2Electrons_invmass_withRICH_fromTarget_allSameG",
    "fh2Electrons_invmass_withRICH_fromTarget_allSameG; invmass [GeV/c^2]; #",
    5000,
    0.,
    5.);
  fHistoList_photons_withRICH_fromTarget.push_back(
  ...
  // invmass vs pt (reco), with RICH
  fh2Electrons_invmassVSpt_withRICH_fromTarget_all = new TH2D(
    "fh2Electrons_invmassVSpt_withRICH_fromTarget_all",
    "fh2Electrons_invmassVSpt_withRICH_fromTarget_all;pt [GeV/c];invmass [GeV]",
    500,
    0.,
    5.,
    5000,
...
void CbmAnaConversionPhotons2::AnalyseElectronsReco() {
  ...
  cout << "CbmAnaConversionPhotons: array size in AnalyseElectronsReco(): "
       << electronnumber << endl;
  for (int i = 0; i < electronnumber - 1; i++) {
    for (int j = i + 1; j < electronnumber; j++) {
      if (fRecoTracklist_mctrack[i]->GetPdgCode()
            + fRecoTracklist_mctrack[j]->GetPdgCode()
          != 0)
        continue;  // only 1 electron and 1 positron allowed


      CbmAnaConversionKinematicParams paramSet =
      ...
      if (motherID_i != motherID_j) {
        ...
        if (fRecoTracklist_chi[i]
              < CbmAnaConversionCutSettings::CalcChiCut(pt_e1)
            && fRecoTracklist_chi[j]
                 < CbmAnaConversionCutSettings::CalcChiCut(pt_e2)) {
          fh2Electrons_angle_CUTcomparison_chi->Fill(3);
        }
        if (fRecoTracklist_chi[i]
              < CbmAnaConversionCutSettings::CalcChiCutAlt1(pt_e1)
            && fRecoTracklist_chi[j]
                 < CbmAnaConversionCutSettings::CalcChiCutAlt1(pt_e2)) {
          fh2Electrons_angle_CUTcomparison_chi->Fill(5);
        }
        if (fRecoTracklist_chi[i]
              < CbmAnaConversionCutSettings::CalcChiCutAlt2(pt_e1)
            && fRecoTracklist_chi[j]
                 < CbmAnaConversionCutSettings::CalcChiCutAlt2(pt_e2)) {
          fh2Electrons_angle_CUTcomparison_chi->Fill(7);
        }
        if (fRecoTracklist_chi[i]
              < CbmAnaConversionCutSettings::CalcChiCutAlt3(pt_e1)
            && fRecoTracklist_chi[j]
                 < CbmAnaConversionCutSettings::CalcChiCutAlt3(pt_e2)) {
      ...
      if (paramSet.fAngle
          < CbmAnaConversionCutSettings::CalcOpeningAngleCutAlt5(paramSet.fPt))
...
void CbmAnaConversionPhotons2::AnalyseElectronsRecoWithRICH() {
  ...
  for (int i = 0; i < electronnumber - 1; i++) {
    for (int j = i + 1; j < electronnumber; j++) {
      if (fRecoTracklist_withRICH_mctrack[i]->GetPdgCode()
            + fRecoTracklist_withRICH_mctrack[j]->GetPdgCode()
          != 0)
        continue;  // only 1 electron and 1 positron allowed
      ...
      CbmAnaConversionKinematicParams paramSet =
        CbmAnaConversionKinematicParams::KinematicParams_2particles_Reco(
          fRecoTracklist_withRICH_momentum[i],
          fRecoTracklist_withRICH_momentum[j]);
      ...
      if (fRecoTracklist_withRICH_chi[i]
            < CbmAnaConversionCutSettings::CalcChiCut(pt_e1)
          && fRecoTracklist_withRICH_chi[j]
               < CbmAnaConversionCutSettings::CalcChiCut(pt_e2)) {
        ...
        fh2Electrons_angleVSpt_withRICH_withChi_all->Fill(paramSet.fPt,
                                                          paramSet.fAngle);
        fh2Electrons_invmassVSpt_withRICH_withChi_all->Fill(paramSet.fPt,
                                                            paramSet.fMinv);
      }
      ...
      if (startvertex1.Z() < 1 && startvertex2.Z() < 1) {
        ...
        fh2Electrons_angleVSpt_withRICH_fromTarget_all->Fill(paramSet.fPt,
                                                             paramSet.fAngle);
        fh2Electrons_invmassVSpt_withRICH_fromTarget_all->Fill(paramSet.fPt,
                                                               paramSet.fMinv);
      }
      ...
      Bool_t electron_rich1 =
        CbmLitGlobalElectronId::GetInstance().IsRichElectron(
          fRecoTracklist_withRICH_gtIndex[i],
          fRecoTracklist_withRICH_momentum[i].Mag());
      Bool_t electron_rich2 =
        CbmLitGlobalElectronId::GetInstance().IsRichElectron(
          fRecoTracklist_withRICH_gtIndex[j],
          fRecoTracklist_withRICH_momentum[j].Mag());
      ...
      if (motherID_i != motherID_j) {
        ...
        fh2Electrons_angleVSpt_withRICH_combBack->Fill(paramSet.fPt,
                                                       paramSet.fAngle);
        fh2Electrons_invmassVSpt_withRICH_combBack->Fill(paramSet.fPt,
                                                         paramSet.fMinv);
        ...
        fh2Electrons_angle_CUTcomparison_withRICH_chi->Fill(
          1);  // no cuts applied
        //Double_t pt_e1 = fRecoTracklist_withRICH_momentum[i].Perp();
        //Double_t pt_e2 = fRecoTracklist_withRICH_momentum[j].Perp();
        if (fRecoTracklist_withRICH_chi[i]
          ...
          fh2Electrons_angleVSpt_withRICH_withChi_combBack->Fill(
            paramSet.fPt, paramSet.fAngle);
          fh2Electrons_invmassVSpt_withRICH_withChi_combBack->Fill(
            paramSet.fPt, paramSet.fMinv);

          // study of different opening angle cuts
          fh2Electrons_angle_CUTcomparison_withRICH_withChi->Fill(
            1);  // no cuts applied
          if (paramSet.fAngle
              < CbmAnaConversionCutSettings::CalcOpeningAngleCut(paramSet.fPt))
        ...
        if (startvertex1.Z() < 1 && startvertex2.Z() < 1) {
          fh2Electrons_angle_withRICH_fromTarget_combBack->Fill(
            paramSet.fAngle);
          fh2Electrons_invmass_withRICH_fromTarget_combBack->Fill(
            paramSet.fMinv);
          fh2Electrons_angleVSpt_withRICH_fromTarget_combBack->Fill(
            paramSet.fPt, paramSet.fAngle);
          fh2Electrons_invmassVSpt_withRICH_fromTarget_combBack->Fill(
            paramSet.fPt, paramSet.fMinv);
        }


        Bool_t WithinChiCut =
          (fRecoTracklist_withRICH_chi[i]
             < CbmAnaConversionCutSettings::CalcChiCut(pt_e1)
           && fRecoTracklist_withRICH_chi[j]
                < CbmAnaConversionCutSettings::CalcChiCut(pt_e2));
        Bool_t WithinAngleCut =
          (paramSet.fAngle
           < CbmAnaConversionCutSettings::CalcOpeningAngleCutAlt1(
             paramSet.fPt));
      ...
      fh2Electrons_angleVSpt_withRICH_allSameG->Fill(paramSet.fPt,
                                                     paramSet.fAngle);
      fh2Electrons_invmassVSpt_withRICH_allSameG->Fill(paramSet.fPt,
                                                       paramSet.fMinv);
      ...
      if (fRecoTracklist_withRICH_chi[i]
        ...
        fh2Electrons_angleVSpt_withRICH_withChi_allSameG->Fill(paramSet.fPt,
                                                               paramSet.fAngle);
        fh2Electrons_invmassVSpt_withRICH_withChi_allSameG->Fill(
          paramSet.fPt, paramSet.fMinv);
      ...
      if (startvertex1.Z() < 1 && startvertex2.Z() < 1) {
        ...
        fh2Electrons_angleVSpt_withRICH_fromTarget_allSameG->Fill(
          paramSet.fPt, paramSet.fAngle);
        fh2Electrons_invmassVSpt_withRICH_fromTarget_allSameG->Fill(
          paramSet.fPt, paramSet.fMinv);
      }
...
void CbmAnaConversionPhotons2::EstimateFullRecoResults()  // with RICH
{
  ...
  for (int i = 0; i < nof - 1; i++) {
    for (int j = i + 1; j < nof; j++) {
      ...
      Int_t motherID_11 =
        fRecoTracklist_withRICH_mctrack[electron11]->GetMotherId();
      Int_t motherID_12 =
        fRecoTracklist_withRICH_mctrack[electron12]->GetMotherId();
      Int_t motherID_21 =
        fRecoTracklist_withRICH_mctrack[electron21]->GetMotherId();
      Int_t motherID_22 =
        fRecoTracklist_withRICH_mctrack[electron22]->GetMotherId();
      ...
      if (grandmotherID_11 == grandmotherID_12
          && grandmotherID_11 == grandmotherID_21
