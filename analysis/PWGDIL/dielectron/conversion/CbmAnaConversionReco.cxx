...
void CbmAnaConversionReco::Init() {
  ...
  if (NULL == fRichHits) {
    Fatal("CbmAnaConversion::Init", "No RichHit array!");
  }
...
void CbmAnaConversionReco::InitHistos() {
  ...
  fhInvariantMass_MC_all =
    new TH1D("fhInvariantMass_MC_all",
             "fhInvariantMass_MC_all;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  fhInvariantMass_MC_pi0 =
    new TH1D("fhInvariantMass_MC_pi0",
             "fhInvariantMass_MC_pi0;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  fhInvariantMass_MC_pi0_epem =
    new TH1D("fhInvariantMass_MC_pi0_epem",
             "fhInvariantMass_MC_pi0_epem;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  fhInvariantMass_MC_pi0_gepem =
    new TH1D("fhInvariantMass_MC_pi0_gepem",
             "fhInvariantMass_MC_pi0_gepem;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  fhInvariantMass_MC_pi0_gg =
    new TH1D("fhInvariantMass_MC_pi0_gg",
             "fhInvariantMass_MC_pi0_gg;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  fhInvariantMass_MC_eta =
    new TH1D("fhInvariantMass_MC_eta",
             "fhInvariantMass_MC_eta;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  fhInvariantMass_MC_etaPrime =
    new TH1D("fhInvariantMass_MC_etaPrime",
             "fhInvariantMass_MC_etaPrime;invariant mass in GeV/c^{2};#",
             2001,
             -0.0005,
             2.0005);
  ...
  fhMC_electrons_theta = new TH1D(
    "fhMC_electrons_theta", "fhMC_electrons_theta;theta in deg;#", 90, 0., 90.);
  fhMC_electrons_p = new TH1D(
    "fhMC_electrons_p", "fhMC_electrons_p;momentum p in GeV/c;#", 100, 0., 10.);
  fhMC_electrons_theta_vs_p =
    new TH2D("fhMC_electrons_theta_vs_p",
             "fhMC_electrons_theta_vs_p;theta in deg;momentum p in GeV/c",
             90,
             0.,
             90.,
             100,
  ...
  fhEta_openingAngleGG = new TH1D("fhEta_openingAngleGG",
                                  "fhEta_openingAngleGG;theta in deg;#",
                                  900,
                                  0.,
                                  90.);
  fHistoList_MC.push_back(fhEta_openingAngleGG);

  fhMC_grandmotherPDGs = new TH1D("fhMC_grandmotherPDGs",
                                  "fhMC_grandmotherPDGs;particle pdg;#",
                                  1000,
                                  0.,
                                  1000.);
  ...
  fhEPEM_openingAngle_gg_mc =
    new TH1D("fhEPEM_openingAngle_gg_mc",
             "fhEPEM_openingAngle_gg_mc (between e+e- from g);angle [deg];#",
             1010,
             -0.1,
             100.9);
  fhEPEM_openingAngle_gg_refitted = new TH1D(
  ...
  fhEPEM_openingAngle_gee_mc =
    new TH1D("fhEPEM_openingAngle_gee_mc",
             "fhEPEM_openingAngle_gee_mc (between e+e- from g);angle [deg];#",
             1010,
             -0.1,
             100.9);
  fhEPEM_openingAngle_gee_refitted = new TH1D(
  ...
  fhEPEM_openingAngle_gee_mc_dalitz = new TH1D(
    "fhEPEM_openingAngle_gee_mc_dalitz",
    "fhEPEM_openingAngle_gee_mc_dalitz (between e+e- from pi0);angle [deg];#",
    1010,
    -0.1,
    100.9);
  fhEPEM_openingAngle_gee_refitted_dalitz =
    new TH1D("fhEPEM_openingAngle_gee_refitted_dalitz",
  ...
  fhEPEM_openingAngle_vs_pt_gg_mc =
    new TH2D("fhEPEM_openingAngle_vs_pt_gg_mc",
             "fhEPEM_openingAngle_vs_pt_gg_mc;pt [GeV]; opening angle [deg]",
             220,
             -1.,
             10.,
             100,
  ...
  fhEPEM_openingAngle_vs_pt_gg_reco =
    new TH2D("fhEPEM_openingAngle_vs_pt_gg_reco",
  ...
  fhEPEM_openingAngle_betweenGammas_mc =
    new TH1D("fhEPEM_openingAngle_betweenGammas_mc",
             "fhEPEM_openingAngle_betweenGammas_mc;angle [deg];#",
             1010,
             -0.1,
             100.9);
  fhEPEM_openingAngle_betweenGammas_reco =
    new TH1D("fhEPEM_openingAngle_betweenGammas_reco",
             "fhEPEM_openingAngle_betweenGammas_reco;angle [deg];#",
             1010,
             -0.1,
             100.9);
  ...
  fhPi0_pt_vs_rap_gg  = new TH2D("fhPi0_pt_vs_rap_gg",
                                "fhPi0_pt_vs_rap_gg;pt [GeV]; rap [GeV]",
                                240,
                                -2.,
                                10.,
                                270,
                                -2.,
                                7.);
  fhPi0_pt_vs_rap_gee = new TH2D("fhPi0_pt_vs_rap_gee",
                                 "fhPi0_pt_vs_rap_gee;pt [GeV]; rap [GeV]",
                                 240,
                                 -2.,
                                 10.,
                                 270,
                                 -2.,
                                 7.);
  fhPi0_pt_vs_rap_all = new TH2D("fhPi0_pt_vs_rap_all",
                                 "fhPi0_pt_vs_rap_all;pt [GeV]; rap [GeV]",
                                 240,
                                 -2.,
                                 10.,
                                 270,
  ...
  fhPi0_pt_gee =
    new TH1D("fhPi0_pt_gee", "fhPi0_pt_gee;pt [GeV];#", 200, 0., 10.);
  fhPi0_pt_all =
    new TH1D("fhPi0_pt_all", "fhPi0_pt_all;pt [GeV];#", 200, 0., 10.);
  ...
  fhEPEM_efficiencyCuts =
    new TH1D("fhEPEM_efficiencyCuts", "fhEPEM_efficiencyCuts;;#", 13, 0., 13.);
  ...
  fhEPEM_efficiencyCuts->GetXaxis()->SetBinLabel(
    4, "ANN: #theta of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts->GetXaxis()->SetBinLabel(
    5, "ANN: m_{inv} of e^{+}e^{-} pairs");
  ...
  fhEPEM_efficiencyCuts->GetXaxis()->SetBinLabel(
    8, "Normal: #theta of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts->GetXaxis()->SetBinLabel(
    9, "Normal: m_{inv} of e^{+}e^{-} pairs");
  ...
  fhEPEM_efficiencyCuts->GetXaxis()->SetBinLabel(
    12, "MC: #theta of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts->GetXaxis()->SetBinLabel(
    13, "MC: m_{inv} of e^{+}e^{-} pairs");

  fhEPEM_efficiencyCuts2 = new TH1D(
    "fhEPEM_efficiencyCuts2", "fhEPEM_efficiencyCuts2;;#", 10, 0., 10.);
  fHistoList_all.push_back(fhEPEM_efficiencyCuts2);

  fhEPEM_pi0_nofLeptons_ann = new TH1D(
    "fhEPEM_pi0_nofLeptons_ann", "fhEPEM_pi0_nofLeptons_ann;;#", 5, -0.5, 4.5);
  fhEPEM_pi0_ANNvalues_noCuts   = new TH1D("fhEPEM_pi0_ANNvalues_noCuts",
                                         "fhEPEM_pi0_ANNvalues_noCuts;;#",
                                         400,
                                         -2,
                                         2);
  fhEPEM_pi0_ANNvalues_angleCut = new TH1D("fhEPEM_pi0_ANNvalues_angleCut",
                                           "fhEPEM_pi0_ANNvalues_angleCut;;#",
                                           400,
                                           -2,
                                           2);
  fhEPEM_pi0_ANNefficiencies    = new TH1D(
    "fhEPEM_pi0_ANNefficiencies", "fhEPEM_pi0_ANNefficiencies;;#", 15, 0, 15);
  ...
  fhEPEM_rap_vs_chi = new TH2D("fhEPEM_rap_vs_chi",
                               "fhEPEM_rap_vs_chi; rap [GeV]; chi of electrons",
                               300,
                               0.,
                               10.,
                               100,
  ...
  fhEPEM_rap_vs_invmass = new TH2D("fhEPEM_rap_vs_invmass",
                                   "fhEPEM_rap_vs_invmass; rap [GeV]; invmass",
                                   300,
                                   0.,
                                   10.,
                                   100,
  ...
  fhInvMass_EPEM_error_refitted =
    new TH1D("fhInvMass_EPEM_error_refitted",
             "fhInvariantMass_recoMomentum5 (error, refitted);(mc-reco)/mc;#",
             500,
             -0.005,
             4.995);
  fhInvMass_EPEM_openingAngleRef =
    new TH1D("fhInvMass_EPEM_openingAngleRef",
             "fhInvariantMass_openingAngleRef;angle [deg];#",
             1010,
             -0.1,
             100.9);
  fhUsedMomenta_stsMomVec = new TH1D(
    "fhUsedMomenta_stsMomVec", "fhMomentumtest1;momentum;#", 100, 0., 2.);
  fhUsedMomenta_mc =
    new TH1D("fhUsedMomenta_mc", "fhMomentumtest2;momentum;#", 100, 0., 2.);
  fhUsedMomenta_error_stsMomVec =
    new TH1D("fhUsedMomenta_error_stsMomVec",
             "fhMomentumtest3 (error);(mc-reco)/mc;#",
             400,
             -2.005,
             1.995);
  fhUsedMomenta_error_refitted =
    new TH1D("fhUsedMomenta_error_refitted",
             "fhMomentumtest4 (error);(mc-reco_refitted)/mc;#",
             400,
             -2.005,
             1.995);

  fhUsedMomenta_errorX_stsMomVec =
    new TH1D("fhUsedMomenta_errorX_stsMomVec",
             "fhMomentumtest5 (error of x-momentum);(mc-reco_reco)/mc;#",
             401,
             -4.01,
             4.01);
  fhUsedMomenta_vsX_stsMomVec =
    new TH2D("fhUsedMomenta_vsX_stsMomVec",
             "fhMomentumtest5vs (error of x-momentum);mc;reco",
             101,
             -1.01,
             1.01,
             101,
  ...
  fhUsedMomenta_errorY_stsMomVec =
    new TH1D("fhUsedMomenta_errorY_stsMomVec",
             "fhMomentumtest6 (error of y-momentum);(mc-reco_reco)/mc;#",
             401,
             -4.01,
             4.01);
  fhUsedMomenta_vsY_stsMomVec =
    new TH2D("fhUsedMomenta_vsY_stsMomVec",
             "fhMomentumtest6vs (error of y-momentum);mc;reco",
             101,
             -1.01,
             1.01,
             101,
  ...
  fhUsedMomenta_errorZ_stsMomVec =
    new TH1D("fhUsedMomenta_errorZ_stsMomVec",
             "fhMomentumtest7 (error of z-momentum);(mc-reco_reco)/mc;#",
             401,
             -4.01,
             4.01);
  fhUsedMomenta_vsZ_stsMomVec =
    new TH2D("fhUsedMomenta_vsZ_stsMomVec",
             "fhMomentumtest7vs (error of z-momentum);mc;reco",
             201,
             -0.01,
             4.01,
             201,
  ...
  fhUsedMomenta_errorX_refitted =
    new TH1D("fhUsedMomenta_errorX_refitted",
             "fhMomentumtest5 (error of x-momentum);(mc-reco_reco)/mc;#",
             401,
             -4.01,
             4.01);
  fhUsedMomenta_vsX_refitted =
    new TH2D("fhUsedMomenta_vsX_refitted",
             "fhMomentumtest5vs (error of x-momentum);mc;reco",
             101,
             -1.01,
             1.01,
  ...
  fhUsedMomenta_errorY_refitted =
    new TH1D("fhUsedMomenta_errorY_refitted",
             "fhMomentumtest6 (error of y-momentum);(mc-reco_reco)/mc;#",
             401,
             -4.01,
             4.01);
  fhUsedMomenta_vsY_refitted =
    new TH2D("fhUsedMomenta_vsY_refitted",
             "fhMomentumtest6vs (error of y-momentum);mc;reco",
             101,
             -1.01,
             1.01,
  ...
  fhUsedMomenta_errorZ_refitted =
    new TH1D("fhUsedMomenta_errorZ_refitted",
             "fhMomentumtest7 (error of z-momentum);(mc-reco_reco)/mc;#",
             401,
             -4.01,
             4.01);
  fhUsedMomenta_vsZ_refitted =
    new TH2D("fhUsedMomenta_vsZ_refitted",
             "fhMomentumtest7vs (error of z-momentum);mc;reco",
             201,
             -0.01,
             4.01,
  ...
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_errorX_stsMomVec);  // error of x-component of reconstructed momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_errorY_stsMomVec);  // error of y-component of reconstructed momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_errorZ_stsMomVec);  // error of z-component of reconstructed momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_vsX_stsMomVec);  // x-component of reconstructed momentum vs mc-momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_vsY_stsMomVec);  // y-component of reconstructed momentum vs mc-momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_vsZ_stsMomVec);  // z-component of reconstructed momentum vs mc-momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_errorX_refitted);  // error of x-component of reconstructed momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_errorY_refitted);  // error of y-component of reconstructed momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_errorZ_refitted);  // error of z-component of reconstructed momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_vsX_refitted);  // x-component of reconstructed momentum vs mc-momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_vsY_refitted);  // y-component of reconstructed momentum vs mc-momentum
  fHistoList_reco_mom.push_back(
    fhUsedMomenta_vsZ_refitted);  // z-component of reconstructed momentum vs mc-momentum

  fhInvariantMass_pi0epem = new TH1D("fhInvariantMass_pi0epem",
                                     "fhInvariantMass_pi0epem;mass [GeV/c^2];#",
                                     400,
                                     0.,
                                     2.);
  fHistoList_reco.push_back(fhInvariantMass_pi0epem);

  fhPi0_startvertex = new TH1D(
    "fhPi0_startvertex", "fhPi0_startvertex;z in cm;#", 210, -5., 100.);
  fHistoList_reco.push_back(fhPi0_startvertex);

  fhPi0_startvertexElectrons_all =
    new TH1D("fhPi0_startvertexElectrons_all",
             "fhPi0_startvertexElectrons_all;z in cm;#",
             411,
             -5.25,
             200.25);
  ...
  fhPi0_startvertexElectrons_gg =
    new TH1D("fhPi0_startvertexElectrons_gg",
             "fhPi0_startvertexElectrons_gg;z in cm;#",
             411,
             -5.25,
             200.25);
  ...
  fhPi0_startvertexElectrons_gee =
    new TH1D("fhPi0_startvertexElectrons_gee",
             "fhPi0_startvertexElectrons_gee;z in cm;#",
             411,
             -5.25,
             200.25);
  fHistoList_reco.push_back(fhPi0_startvertexElectrons_gee);

  fhPi0_startvertex_vs_chi = new TH2D("fhPi0_startvertex_vs_chi",
                                      "fhPi0_startvertex_vs_chi;z[cm];chi",
                                      210,
                                      -5.,
                                      100.,
                                      1000,
  ...
  fhPi0_startvertex_vs_momentum =
    new TH2D("fhPi0_startvertex_vs_momentum",
             "fhPi0_startvertex_vs_momentum;z in cm;momentum (MC-true)",
             210,
             -5.,
             100.,
             1000,
  ...
  fhInvMassWithFullRecoCuts =
    new TH1D("fhInvMassWithFullRecoCuts",
             "fhInvMassWithFullRecoCuts;mass [GeV/c^2];#",
             800,
             0.,
             2.);
  ...
  fhEPEM_pt_vs_p_all_mc =
    new TH2D("fhEPEM_pt_vs_p_all_mc",
             "fhEPEM_pt_vs_p_all_mc;p_{t} in GeV/c; p in GeV/c",
             240,
             -2.,
             10.,
             360,
  ...
  fhEPEM_pt_vs_p_all_refitted =
    new TH2D("fhEPEM_pt_vs_p_all_refitted",
  ...
  fhEPEM_missingLepton_nofRingHits =
    new TH1D("fhEPEM_missingLepton_nofRingHits",
             "fhEPEM_missingLepton_nofRingHits;nofringhits;#",
             41,
             -0.5,
             40.5);
  fhEPEM_missingLepton_ringMid = new TH2D("fhEPEM_missingLepton_ringMid",
                                          "fhEPEM_missingLepton_ringMid;X;Y",
                                          100,
                                          -150,
                                          150,
                                          150,
  ...
  fhEPEM_missingLepton_ringRadius =
    new TH1D("fhEPEM_missingLepton_ringRadius",
             "fhEPEM_missingLepton_ringRadius;ringRadius;#",
             100,
             0,
             10);
  fhEPEM_missingLepton_distance =
    new TH1D("fhEPEM_missingLepton_distance",
             "fhEPEM_missingLepton_distance;distance;#",
             100,
             0,
             20);
  fhEPEM_missingLepton_selectionNN =
    new TH1D("fhEPEM_missingLepton_selectionNN",
             "fhEPEM_missingLepton_selectionNN;selectionNN;#",
             40,
             -2,
             2);
  fhEPEM_missingLepton_rings =
    new TH2D("fhEPEM_missingLepton_rings",
             "fhEPEM_missingLepton_rings;selectionNN;#",
             400,
             -200,
             200,
             600,
             -300,
             300);
  fhEPEM_missingLepton_radius_vs_p = new TH2D(
    "fhEPEM_missingLepton_radius_vs_p",
    "fhEPEM_missingLepton_radius_vs_p;momentum p in GeV/c;ring radius in cm",
    120,
    0,
    12,
    100,
  ...
  fhEPEM_missingLepton_ANNvalue =
    new TH1D("fhEPEM_missingLepton_ANNvalue",
             "fhEPEM_missingLepton_ANNvalue;ANNvalue;#",
             40,
             -2,
             2);
  ...
  fhEPEM_identifiedLepton_nofRingHits =
    new TH1D("fhEPEM_identifiedLepton_nofRingHits",
             "fhEPEM_identifiedLepton_nofRingHits;nofringhits;#",
             41,
             -0.5,
             40.5);
  fhEPEM_identifiedLepton_ringMid =
    new TH2D("fhEPEM_identifiedLepton_ringMid",
             "fhEPEM_identifiedLepton_ringMid;X;Y",
             100,
             -150,
             150,
             150,
  ...
  fhEPEM_identifiedLepton_ringRadius =
    new TH1D("fhEPEM_identifiedLepton_ringRadius",
             "fhEPEM_identifiedLepton_ringRadius;ringRadius;#",
             100,
             0,
             10);
  fhEPEM_identifiedLepton_distance =
    new TH1D("fhEPEM_identifiedLepton_distance",
             "fhEPEM_identifiedLepton_distance;distance;#",
             100,
             0,
             20);
  fhEPEM_identifiedLepton_selectionNN =
    new TH1D("fhEPEM_identifiedLepton_selectionNN",
             "fhEPEM_identifiedLepton_selectionNN;selectionNN;#",
             40,
             -2,
             2);
  fhEPEM_identifiedLepton_rings =
    new TH2D("fhEPEM_identifiedLepton_rings",
             "fhEPEM_identifiedLepton_rings;selectionNN;#",
             400,
             -200,
             200,
             600,
             -300,
             300);
  fhEPEM_identifiedLepton_radius_vs_p = new TH2D(
    "fhEPEM_identifiedLepton_radius_vs_p",
    "fhEPEM_identifiedLepton_radius_vs_p;momentum p in GeV/c;ring radius in cm",
    120,
    0,
    12,
    100,
  ...
  fhEPEM_identifiedLepton_ANNvalue =
    new TH1D("fhEPEM_identifiedLepton_ANNvalue",
             "fhEPEM_identifiedLepton_ANNvalue;ANNvalue;#",
             40,
             -2,
             2);
  ...
  fhEPEM_invmass_eta_mc = new TH1D("fhEPEM_invmass_eta_mc",
                                   "fhEPEM_Iinvmass_eta_mc;mass [GeV/c^2];#",
                                   invmassSpectra_nof,
                                   invmassSpectra_start,
                                   invmassSpectra_end);
  fhEPEM_invmass_eta_refitted =
    new TH1D("fhEPEM_invmass_eta_refitted",
             "fhEPEM_Iinvmass_eta_refitted;mass [GeV/c^2];#",
             invmassSpectra_nof,
             invmassSpectra_start,
             invmassSpectra_end);
  ...
  fhEPEM_efficiencyCuts_eta = new TH1D(
    "fhEPEM_efficiencyCuts_eta", "fhEPEM_efficiencyCuts_eta;;#", 13, 0., 13.);
  fHistoList_eta.push_back(fhEPEM_efficiencyCuts_eta);
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(1, "no cuts");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(2,
                                                     "ANN: 4 rich electrons");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(3, "ANN: #chi^{2}-cut");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(
    4, "ANN: #theta of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(
    5, "ANN: m_{inv} of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(
    6, "Normal: 4 rich electrons");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(7, "Normal: #chi^{2}-cut");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(
    8, "Normal: #theta of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(
    9, "Normal: m_{inv} of e^{+}e^{-} pairs");
  fhEPEM_efficiencyCuts_eta->GetXaxis()->SetBinLabel(10,
                                                     "MC: 4 rich electrons");
...
void CbmAnaConversionReco::SetTracklistReco(vector<CbmMCTrack*> MCTracklist,
                                            vector<TVector3> RecoTracklist1,
                                            vector<TVector3> RecoTracklist2,
                                            vector<int> ids,
                                            vector<Double_t> chi,
...
// calculation of invariant mass via X -> gamma gamma -> e+ e- e+ e-, only MC data with several cuts (see FillMCTrackslists())
{
  ...
  if (fMCTracklist_all.size() >= 4) {
    for (unsigned int i = 0; i < fMCTracklist_all.size() - 3; i++) {
      if (i % 10 == 0)
        cout << "CbmAnaConversionReco: InvariantMassTestMC - iteration i = "
             << i << endl;
      for (unsigned int j = i + 1; j < fMCTracklist_all.size() - 2; j++) {
        for (unsigned int k = j + 1; k < fMCTracklist_all.size() - 1; k++) {
          for (unsigned int l = k + 1; l < fMCTracklist_all.size(); l++) {
            ...
            if (fMCTracklist_all[i]->GetPdgCode()
                  + fMCTracklist_all[j]->GetPdgCode()
                  + fMCTracklist_all[k]->GetPdgCode()
                  + fMCTracklist_all[l]->GetPdgCode()
                != 0)
              continue;
            ...
            if (motherId1 == motherId2 && motherId1 == motherId3
                && motherId1 == motherId4) {
              cout << "testxyz" << endl;
              Double_t invmass = Invmass_4particles(fMCTracklist_all[i],
                                                    fMCTracklist_all[j],
                                                    fMCTracklist_all[k],
                                                    fMCTracklist_all[l]);
              ...
              if (motherId1 != -1) {
                ...
                if (mcMotherPdg1 == 111) {
                  Double_t invmass2 = 0;
                  invmass2          = Invmass_4particles(fMCTracklist_all[i],
                                                fMCTracklist_all[j],
                                                fMCTracklist_all[k],
                                                fMCTracklist_all[l]);
            ...
            if (motherId1 != -1) {
              ...
              if (grandmotherId1 != -1) {
                CbmMCTrack* grandmother1 =
                  (CbmMCTrack*) fMcTracks->At(grandmotherId1);
            ...
            if (((motherId1 == motherId2 && motherId3 == motherId4)
              ...
              if (mcGrandmotherPdg1 == 111) {
                ...
                fhMC_electrons_theta->Fill(momentum1.Theta() * 180.
                                           / TMath::Pi());
                fhMC_electrons_theta->Fill(momentum2.Theta() * 180.
                                           / TMath::Pi());
                fhMC_electrons_theta->Fill(momentum3.Theta() * 180.
                                           / TMath::Pi());
                fhMC_electrons_theta->Fill(momentum4.Theta() * 180.
                                           / TMath::Pi());
                ...
                fhMC_electrons_theta_vs_p->Fill(
                  momentum1.Theta() * 180. / TMath::Pi(), momentum1.Mag());
                fhMC_electrons_theta_vs_p->Fill(
                  momentum2.Theta() * 180. / TMath::Pi(), momentum2.Mag());
                fhMC_electrons_theta_vs_p->Fill(
                  momentum3.Theta() * 180. / TMath::Pi(), momentum3.Mag());
                fhMC_electrons_theta_vs_p->Fill(
                  momentum4.Theta() * 180. / TMath::Pi(), momentum4.Mag());
              }
              if (mcGrandmotherPdg1 == 221) {
                ...
                if (motherId1 == motherId3) {
                  opening_angle_gg =
                    CbmAnaConversionGlobalFunctions::OpeningAngleBetweenGamma(
                      momentum1, momentum3, momentum2, momentum4);
                }
                if (motherId1 == motherId4) {
                  opening_angle_gg =
                    CbmAnaConversionGlobalFunctions::OpeningAngleBetweenGamma(
                      momentum1, momentum4, momentum2, momentum3);
                }
            ...
            if (((motherId1 == motherId2 && motherId3 == motherId4)
                 && (mcMotherPdg1 == 22) && (mcMotherPdg3 == 111)
                 && grandmotherId1 == motherId3)
                || ((motherId1 == motherId2 && motherId3 == motherId4)
                    && (mcMotherPdg1 == 111) && (mcMotherPdg3 == 22)
                    && grandmotherId3 == motherId1)
                || ((motherId1 == motherId3 && motherId2 == motherId4)
                    && (mcMotherPdg1 == 22) && (mcMotherPdg2 == 111)
                    && grandmotherId1 == motherId2)
                || ((motherId1 == motherId3 && motherId2 == motherId4)
                    && (mcMotherPdg1 == 111) && (mcMotherPdg2 == 22)
            ...
            if (((motherId1 == motherId2 && motherId3 == motherId4)
                 && (mcMotherPdg1 == 22) && (mcMotherPdg3 == 221)
                 && grandmotherId1 == motherId3)
                || ((motherId1 == motherId2 && motherId3 == motherId4)
                    && (mcMotherPdg1 == 221) && (mcMotherPdg3 == 22)
                    && grandmotherId3 == motherId1)
                || ((motherId1 == motherId3 && motherId2 == motherId4)
                    && (mcMotherPdg1 == 22) && (mcMotherPdg2 == 221)
                    && grandmotherId1 == motherId2)
                || ((motherId1 == motherId3 && motherId2 == motherId4)
                    && (mcMotherPdg1 == 221) && (mcMotherPdg2 == 22)
                    && grandmotherId2 == motherId1)
                || ((motherId1 == motherId4 && motherId2 == motherId3)
                    && (mcMotherPdg1 == 22) && (mcMotherPdg2 == 221)
                    && grandmotherId1 == motherId2)
...
// Calculating invariant mass of 4 ep/em, using MC data AND reconstructed momentum
{
  ...
  cout << "CbmAnaConversionReco: InvariantMassTest_4epem - "
       << fRecoTracklistEPEM.size() << "\t" << fRecoMomentum.size() << endl;
  int fill = 0;
  if (fRecoTracklistEPEM.size() < 4) return;
  for (unsigned int i = 0; i < fRecoTracklistEPEM.size(); i++) {
    if (i % 10 == 0)
      cout << "CbmAnaConversionReco: InvariantMassTest_4epem - iteration i = "
           << i << endl;
    for (unsigned int j = i + 1; j < fRecoTracklistEPEM.size(); j++) {
      for (unsigned int k = j + 1; k < fRecoTracklistEPEM.size(); k++) {
        for (unsigned int l = k + 1; l < fRecoTracklistEPEM.size(); l++) {
          if (fRecoTracklistEPEM[i]->GetPdgCode()
                + fRecoTracklistEPEM[j]->GetPdgCode()
                + fRecoTracklistEPEM[k]->GetPdgCode()
                + fRecoTracklistEPEM[l]->GetPdgCode()
              != 0)
            continue;
          ...
          if (motherId1 == motherId2 && motherId1 == motherId3
            ...
            if (motherId1 != -1) {
              ...
              if ((mcMotherPdg1 == 111
                ...
                invmass1 =
                  Invmass_4particles(fRecoTracklistEPEM[i],
                                     fRecoTracklistEPEM[j],
                                     fRecoTracklistEPEM[k],
                                     fRecoTracklistEPEM[l]);  // true MC values
                invmass3 = Invmass_4particlesRECO(fRecoRefittedMomentum[i],
                                                  fRecoRefittedMomentum[j],
                                                  fRecoRefittedMomentum[k],
                                                  fRecoRefittedMomentum[l]);
                //	fhInvariantMass_pi0epem->Fill(invmass2);
                cout << "Decay pi0 -> e+e-e+e- detected!\t\t mc mass: "
                     << invmass1 << "\t, reco mass: " << invmass3 << endl;
                cout << "motherids: " << motherId1 << "/" << motherId2 << "/"
                     << motherId3 << "/" << motherId4
                     << "\t motherpdg: " << mcMotherPdg1
                     << "\t mctrack mass: " << mother1->GetMass()
                     << "\t nofdaughters: " << NofDaughters(motherId1) << endl;
                cout << "pdgs " << fRecoTracklistEPEM[i]->GetPdgCode() << "/"
                     << fRecoTracklistEPEM[j]->GetPdgCode() << "/"
                     << fRecoTracklistEPEM[k]->GetPdgCode() << "/"
                     << fRecoTracklistEPEM[l]->GetPdgCode() << endl;
                TVector3 start1;
                ...
                cout << "start: " << start1.Z() << "/" << start2.Z() << "/"
                     << start3.Z() << "/" << start4.Z() << endl;
          ...
          if ((motherId1 == motherId2 && motherId3 == motherId4)
            ...
            if (motherId1 == motherId2 && motherId3 == motherId4) {
              ...
              if ((grandmotherId1 == motherId3 && mcMotherPdg3 == 111)
                ...
                CutEfficiencyStudies(
                  i, j, k, l, motherId1, motherId2, motherId3, motherId4);
                ...
                fhEPEM_pt_vs_p_all_mc->Fill(fRecoTracklistEPEM[i]->GetPt(),
                                            fRecoTracklistEPEM[i]->GetP());
                fhEPEM_pt_vs_p_all_mc->Fill(fRecoTracklistEPEM[j]->GetPt(),
                                            fRecoTracklistEPEM[j]->GetP());
                fhEPEM_pt_vs_p_all_mc->Fill(fRecoTracklistEPEM[k]->GetPt(),
                                            fRecoTracklistEPEM[k]->GetP());
                fhEPEM_pt_vs_p_all_mc->Fill(fRecoTracklistEPEM[l]->GetPt(),
                                            fRecoTracklistEPEM[l]->GetP());
                fhEPEM_pt_vs_p_all_refitted->Fill(
                  fRecoRefittedMomentum[i].Perp(),
                  fRecoRefittedMomentum[i].Mag());
                fhEPEM_pt_vs_p_all_refitted->Fill(
                  fRecoRefittedMomentum[j].Perp(),
                  fRecoRefittedMomentum[j].Mag());
                fhEPEM_pt_vs_p_all_refitted->Fill(
                  fRecoRefittedMomentum[k].Perp(),
                  fRecoRefittedMomentum[k].Mag());
                fhEPEM_pt_vs_p_all_refitted->Fill(
                  fRecoRefittedMomentum[l].Perp(),
                  fRecoRefittedMomentum[l].Mag());

                CbmLmvmKinematicParams params1 =
                  CalculateKinematicParams_4particles(fRecoRefittedMomentum[i],
                                                      fRecoRefittedMomentum[j],
                                                      fRecoRefittedMomentum[k],
                                                      fRecoRefittedMomentum[l]);
                ...
                if (
                  mcGrandmotherPdg1
                  == 111) {  // case: i,j = electrons from gamma, k,l = electrons from pi0
                  Double_t opening_angle1_mc       = 0;
                  Double_t opening_angle1_refitted = 0;
                  opening_angle1_mc                = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[i], fRecoTracklistEPEM[j]);
                  opening_angle1_refitted = CalculateOpeningAngleReco(
                    fRecoRefittedMomentum[i], fRecoRefittedMomentum[j]);
                  fhEPEM_openingAngle_gee_mc->Fill(opening_angle1_mc);
                  fhEPEM_openingAngle_gee_refitted->Fill(
                    opening_angle1_refitted);

                  Double_t opening_angle1_mc_dalitz       = 0;
                  Double_t opening_angle1_refitted_dalitz = 0;
                  opening_angle1_mc_dalitz = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[k], fRecoTracklistEPEM[l]);
                  opening_angle1_refitted_dalitz = CalculateOpeningAngleReco(
                    fRecoRefittedMomentum[k], fRecoRefittedMomentum[l]);
                  fhEPEM_openingAngle_gee_mc_dalitz->Fill(
                    opening_angle1_mc_dalitz);
                  fhEPEM_openingAngle_gee_refitted_dalitz->Fill(
                    opening_angle1_refitted_dalitz);
                }

                if (
                  mcMotherPdg1
                  == 111) {  // case: i,j = electrons from pi0, k,l = electrons from gamma
                  Double_t opening_angle1_mc       = 0;
                  Double_t opening_angle1_refitted = 0;
                  opening_angle1_mc                = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[k], fRecoTracklistEPEM[l]);
            ...
            if (motherId1 == motherId3 && motherId2 == motherId4) {
              ...
              if ((grandmotherId1 == motherId2 && mcMotherPdg2 == 111)
                ...
                if (mcGrandmotherPdg1 == 111) {
                  ...
                  Double_t opening_angle1_refitted = 0;
                  opening_angle1_mc                = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[i], fRecoTracklistEPEM[k]);
                  opening_angle1_refitted = CalculateOpeningAngleReco(
                    fRecoRefittedMomentum[i], fRecoRefittedMomentum[k]);
                  fhEPEM_openingAngle_gee_mc->Fill(opening_angle1_mc);
                  fhEPEM_openingAngle_gee_refitted->Fill(
                    opening_angle1_refitted);
                  ...
                  Double_t opening_angle1_refitted_dalitz = 0;
                  opening_angle1_mc_dalitz = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[j], fRecoTracklistEPEM[l]);
                  opening_angle1_refitted_dalitz = CalculateOpeningAngleReco(
                    fRecoRefittedMomentum[j], fRecoRefittedMomentum[l]);
                  fhEPEM_openingAngle_gee_mc_dalitz->Fill(
                    opening_angle1_mc_dalitz);
                  fhEPEM_openingAngle_gee_refitted_dalitz->Fill(
                    opening_angle1_refitted_dalitz);
            ...
            if (motherId1 == motherId4 && motherId2 == motherId3) {
              ...
              if ((grandmotherId1 == motherId2 && mcMotherPdg2 == 111)
                ...
                if (mcGrandmotherPdg1 == 111) {
                  ...
                  Double_t opening_angle1_refitted = 0;
                  opening_angle1_mc                = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[i], fRecoTracklistEPEM[l]);
                  opening_angle1_refitted = CalculateOpeningAngleReco(
                    fRecoRefittedMomentum[i], fRecoRefittedMomentum[l]);
                  fhEPEM_openingAngle_gee_mc->Fill(opening_angle1_mc);
                  fhEPEM_openingAngle_gee_refitted->Fill(
                    opening_angle1_refitted);
                  ...
                  Double_t opening_angle1_refitted_dalitz = 0;
                  opening_angle1_mc_dalitz = CalculateOpeningAngleMC(
                    fRecoTracklistEPEM[j], fRecoTracklistEPEM[k]);
                  opening_angle1_refitted_dalitz = CalculateOpeningAngleReco(
                    fRecoRefittedMomentum[j], fRecoRefittedMomentum[k]);
                  fhEPEM_openingAngle_gee_mc_dalitz->Fill(
                    opening_angle1_mc_dalitz);
                  fhEPEM_openingAngle_gee_refitted_dalitz->Fill(
                    opening_angle1_refitted_dalitz);
            ...
            if (grandmotherId1 == grandmotherId2
              ...
              if (pi0start_i.Z() <= 1 && pi0start_j.Z() <= 1
                ...
                Double_t invmass_eta_mc =
                  Invmass_4particles(fRecoTracklistEPEM[i],
                                     fRecoTracklistEPEM[j],
                                     fRecoTracklistEPEM[k],
                                     fRecoTracklistEPEM[l]);
                Double_t invmass_eta_reco =
                  Invmass_4particlesRECO(fRecoRefittedMomentum[i],
                                         fRecoRefittedMomentum[j],
                                         fRecoRefittedMomentum[k],
                                         fRecoRefittedMomentum[l]);
                ...
                CutEfficiencyStudies(
                  i, j, k, l, motherId1, motherId2, motherId3, motherId4, 1);
              }
              ...
              fhPi0_startvertex_vs_chi->Fill(pi0start_i.Z(),
                                             fRecoTracklistEPEM_chi[i]);
              fhPi0_startvertex_vs_chi->Fill(pi0start_j.Z(),
                                             fRecoTracklistEPEM_chi[j]);
              fhPi0_startvertex_vs_chi->Fill(pi0start_k.Z(),
                                             fRecoTracklistEPEM_chi[l]);
              fhPi0_startvertex_vs_chi->Fill(pi0start_l.Z(),
                                             fRecoTracklistEPEM_chi[l]);

              fhPi0_startvertex_vs_momentum->Fill(
                pi0start_i.Z(), fRecoTracklistEPEM[i]->GetP());
              fhPi0_startvertex_vs_momentum->Fill(
                pi0start_j.Z(), fRecoTracklistEPEM[j]->GetP());
              fhPi0_startvertex_vs_momentum->Fill(
                pi0start_k.Z(), fRecoTracklistEPEM[k]->GetP());
              fhPi0_startvertex_vs_momentum->Fill(
                pi0start_l.Z(), fRecoTracklistEPEM[l]->GetP());

              Double_t invmass1 = 0;  // true MC values
              invmass1          = Invmass_4particles(fRecoTracklistEPEM[i],
                                            fRecoTracklistEPEM[j],
                                            fRecoTracklistEPEM[k],
                                            fRecoTracklistEPEM[l]);
              Double_t invmass2 = 0;  // momenta from stsMomentumVec
              invmass2          = Invmass_4particlesRECO(fRecoMomentum[i],
                                                fRecoMomentum[j],
                                                fRecoMomentum[k],
                                                fRecoMomentum[l]);
              ...
              fhEPEM_pt_vs_p_all_mc->Fill(fRecoTracklistEPEM[l]->GetPt(),
                                          fRecoTracklistEPEM[l]->GetP());
              fhEPEM_pt_vs_p_all_refitted->Fill(fRecoRefittedMomentum[i].Perp(),
                                                fRecoRefittedMomentum[i].Mag());
              fhEPEM_pt_vs_p_all_refitted->Fill(fRecoRefittedMomentum[j].Perp(),
                                                fRecoRefittedMomentum[j].Mag());
              fhEPEM_pt_vs_p_all_refitted->Fill(fRecoRefittedMomentum[k].Perp(),
                                                fRecoRefittedMomentum[k].Mag());
              fhEPEM_pt_vs_p_all_refitted->Fill(fRecoRefittedMomentum[l].Perp(),
                                                fRecoRefittedMomentum[l].Mag());

              cout << "########################################################"
                      "##############"
                   << endl;
              cout << fRecoMomentum[i].X() << "\t"
                   << fRecoRefittedMomentum[i].X() << endl;
              cout << fRecoMomentum[i].Y() << "\t"
                   << fRecoRefittedMomentum[i].Y() << endl;
              cout << fRecoMomentum[i].Z() << "\t"
                   << fRecoRefittedMomentum[i].Z() << endl;

              if (fRecoTracklistEPEM_ids.size() != fRecoTracklistEPEM.size()) {
                cout << "size mismatch! " << fRecoTracklistEPEM_ids.size()
                     << "/" << fRecoTracklistEPEM.size() << endl;
              }
              ...
              cout << "index: " << i << "\t" << j << "\t" << k << "\t" << l
                   << endl;
              cout << "mc id: " << fRecoTracklistEPEM_ids[i] << "\t"
                   << fRecoTracklistEPEM_ids[j] << "\t"
                   << fRecoTracklistEPEM_ids[k] << "\t"
                   << fRecoTracklistEPEM_ids[l] << endl;
              cout << "motherid: " << motherId1 << "\t" << motherId2 << "\t"
                   << motherId3 << "\t" << motherId4 << endl;
              cout << "motherpdg: " << mcMotherPdg1 << "\t" << mcMotherPdg2
                   << "\t" << mcMotherPdg3 << "\t" << mcMotherPdg4 << endl;
              cout << "grandmotherid: " << grandmotherId1 << "\t"
                   << grandmotherId2 << "\t" << grandmotherId3 << "\t"
                   << grandmotherId4 << endl;
              cout << "pdg: " << fRecoTracklistEPEM[i]->GetPdgCode() << "\t"
                   << fRecoTracklistEPEM[j]->GetPdgCode() << "\t"
                   << fRecoTracklistEPEM[k]->GetPdgCode() << "\t"
                   << fRecoTracklistEPEM[l]->GetPdgCode() << endl;
              cout << "invmass reco: " << invmass2
              ...
              fhInvMass_EPEM_error_stsMomVec->Fill(
                1.0 * TMath::Abs(invmass1 - invmass2) / invmass1);
              fhInvMass_EPEM_error_refitted->Fill(
                1.0 * TMath::Abs(invmass1 - invmass3) / invmass1);
              ...
              fhUsedMomenta_error_stsMomVec->Fill(
                TMath::Abs(fRecoTracklistEPEM[i]->GetP()
                           - fRecoMomentum[i].Mag())
                / fRecoTracklistEPEM[i]->GetP());
              fhUsedMomenta_error_stsMomVec->Fill(
                TMath::Abs(fRecoTracklistEPEM[j]->GetP()
                           - fRecoMomentum[j].Mag())
                / fRecoTracklistEPEM[j]->GetP());
              fhUsedMomenta_error_stsMomVec->Fill(
                TMath::Abs(fRecoTracklistEPEM[k]->GetP()
                           - fRecoMomentum[k].Mag())
                / fRecoTracklistEPEM[k]->GetP());
              fhUsedMomenta_error_stsMomVec->Fill(
                TMath::Abs(fRecoTracklistEPEM[l]->GetP()
                           - fRecoMomentum[l].Mag())
                / fRecoTracklistEPEM[l]->GetP());
              ...
              fhUsedMomenta_errorX_stsMomVec->Fill(
                TMath::Abs(momentumtest5a.X() - fRecoMomentum[i].X())
                / momentumtest5a.X());
              fhUsedMomenta_errorY_stsMomVec->Fill(
                TMath::Abs(momentumtest5a.Y() - fRecoMomentum[i].Y())
                / momentumtest5a.Y());
              fhUsedMomenta_errorZ_stsMomVec->Fill(
                TMath::Abs(momentumtest5a.Z() - fRecoMomentum[i].Z())
                / momentumtest5a.Z());
              fhUsedMomenta_vsX_stsMomVec->Fill(momentumtest5a.X(),
                                                fRecoMomentum[i].X());
              fhUsedMomenta_vsY_stsMomVec->Fill(momentumtest5a.Y(),
                                                fRecoMomentum[i].Y());
              fhUsedMomenta_vsZ_stsMomVec->Fill(momentumtest5a.Z(),
                                                fRecoMomentum[i].Z());
              fhUsedMomenta_errorX_refitted->Fill(
                TMath::Abs(momentumtest5a.X() - fRecoRefittedMomentum[i].X())
                / momentumtest5a.X());
              fhUsedMomenta_errorY_refitted->Fill(
                TMath::Abs(momentumtest5a.Y() - fRecoRefittedMomentum[i].Y())
                / momentumtest5a.Y());
              fhUsedMomenta_errorZ_refitted->Fill(
                TMath::Abs(momentumtest5a.Z() - fRecoRefittedMomentum[i].Z())
                / momentumtest5a.Z());
              fhUsedMomenta_vsX_refitted->Fill(momentumtest5a.X(),
                                               fRecoRefittedMomentum[i].X());
              fhUsedMomenta_vsY_refitted->Fill(momentumtest5a.Y(),
                                               fRecoRefittedMomentum[i].Y());
              fhUsedMomenta_vsZ_refitted->Fill(momentumtest5a.Z(),
                                               fRecoRefittedMomentum[i].Z());

              TVector3 momentumtest5b;
              fRecoTracklistEPEM[j]->GetMomentum(momentumtest5b);
              fhUsedMomenta_errorX_stsMomVec->Fill(
                TMath::Abs(momentumtest5b.X() - fRecoMomentum[j].X())
                / momentumtest5b.X());
              fhUsedMomenta_errorY_stsMomVec->Fill(
                TMath::Abs(momentumtest5b.Y() - fRecoMomentum[j].Y())
                / momentumtest5b.Y());
              fhUsedMomenta_errorZ_stsMomVec->Fill(
                TMath::Abs(momentumtest5b.Z() - fRecoMomentum[j].Z())
                / momentumtest5b.Z());
              fhUsedMomenta_vsX_stsMomVec->Fill(momentumtest5b.X(),
                                                fRecoMomentum[j].X());
              fhUsedMomenta_vsY_stsMomVec->Fill(momentumtest5b.Y(),
                                                fRecoMomentum[j].Y());
              fhUsedMomenta_vsZ_stsMomVec->Fill(momentumtest5b.Z(),
                                                fRecoMomentum[j].Z());
              fhUsedMomenta_errorX_refitted->Fill(
                TMath::Abs(momentumtest5b.X() - fRecoRefittedMomentum[j].X())
                / momentumtest5b.X());
              fhUsedMomenta_errorY_refitted->Fill(
                TMath::Abs(momentumtest5b.Y() - fRecoRefittedMomentum[j].Y())
                / momentumtest5b.Y());
              fhUsedMomenta_errorZ_refitted->Fill(
                TMath::Abs(momentumtest5b.Z() - fRecoRefittedMomentum[j].Z())
                / momentumtest5b.Z());
              fhUsedMomenta_vsX_refitted->Fill(momentumtest5b.X(),
                                               fRecoRefittedMomentum[j].X());
              fhUsedMomenta_vsY_refitted->Fill(momentumtest5b.Y(),
                                               fRecoRefittedMomentum[j].Y());
              fhUsedMomenta_vsZ_refitted->Fill(momentumtest5b.Z(),
                                               fRecoRefittedMomentum[j].Z());

              TVector3 momentumtest5c;
              fRecoTracklistEPEM[k]->GetMomentum(momentumtest5c);
              fhUsedMomenta_errorX_stsMomVec->Fill(
                TMath::Abs(momentumtest5c.X() - fRecoMomentum[k].X())
                / momentumtest5c.X());
              fhUsedMomenta_errorY_stsMomVec->Fill(
                TMath::Abs(momentumtest5c.Y() - fRecoMomentum[k].Y())
                / momentumtest5c.Y());
              fhUsedMomenta_errorZ_stsMomVec->Fill(
                TMath::Abs(momentumtest5c.Z() - fRecoMomentum[k].Z())
                / momentumtest5c.Z());
              fhUsedMomenta_vsX_stsMomVec->Fill(momentumtest5c.X(),
                                                fRecoMomentum[k].X());
              fhUsedMomenta_vsY_stsMomVec->Fill(momentumtest5c.Y(),
                                                fRecoMomentum[k].Y());
              fhUsedMomenta_vsZ_stsMomVec->Fill(momentumtest5c.Z(),
                                                fRecoMomentum[k].Z());
              fhUsedMomenta_errorX_refitted->Fill(
                TMath::Abs(momentumtest5c.X() - fRecoRefittedMomentum[k].X())
                / momentumtest5c.X());
              fhUsedMomenta_errorY_refitted->Fill(
                TMath::Abs(momentumtest5c.Y() - fRecoRefittedMomentum[k].Y())
                / momentumtest5c.Y());
              fhUsedMomenta_errorZ_refitted->Fill(
                TMath::Abs(momentumtest5c.Z() - fRecoRefittedMomentum[k].Z())
                / momentumtest5c.Z());
              fhUsedMomenta_vsX_refitted->Fill(momentumtest5c.X(),
                                               fRecoRefittedMomentum[k].X());
              fhUsedMomenta_vsY_refitted->Fill(momentumtest5c.Y(),
                                               fRecoRefittedMomentum[k].Y());
              fhUsedMomenta_vsZ_refitted->Fill(momentumtest5c.Z(),
                                               fRecoRefittedMomentum[k].Z());

              TVector3 momentumtest5d;
              fRecoTracklistEPEM[l]->GetMomentum(momentumtest5d);
              fhUsedMomenta_errorX_stsMomVec->Fill(
                TMath::Abs(momentumtest5d.X() - fRecoMomentum[l].X())
                / momentumtest5d.X());
              fhUsedMomenta_errorY_stsMomVec->Fill(
                TMath::Abs(momentumtest5d.Y() - fRecoMomentum[l].Y())
                / momentumtest5d.Y());
              fhUsedMomenta_errorZ_stsMomVec->Fill(
                TMath::Abs(momentumtest5d.Z() - fRecoMomentum[l].Z())
                / momentumtest5d.Z());
              fhUsedMomenta_vsX_stsMomVec->Fill(momentumtest5d.X(),
                                                fRecoMomentum[l].X());
              fhUsedMomenta_vsY_stsMomVec->Fill(momentumtest5d.Y(),
                                                fRecoMomentum[l].Y());
              fhUsedMomenta_vsZ_stsMomVec->Fill(momentumtest5d.Z(),
                                                fRecoMomentum[l].Z());
              fhUsedMomenta_errorX_refitted->Fill(
                TMath::Abs(momentumtest5d.X() - fRecoRefittedMomentum[l].X())
                / momentumtest5d.X());
              fhUsedMomenta_errorY_refitted->Fill(
                TMath::Abs(momentumtest5d.Y() - fRecoRefittedMomentum[l].Y())
                / momentumtest5d.Y());
              fhUsedMomenta_errorZ_refitted->Fill(
                TMath::Abs(momentumtest5d.Z() - fRecoRefittedMomentum[l].Z())
                / momentumtest5d.Z());
              fhUsedMomenta_vsX_refitted->Fill(momentumtest5d.X(),
                                               fRecoRefittedMomentum[l].X());
              fhUsedMomenta_vsY_refitted->Fill(momentumtest5d.Y(),
                                               fRecoRefittedMomentum[l].Y());
              fhUsedMomenta_vsZ_refitted->Fill(momentumtest5d.Z(),
                                               fRecoRefittedMomentum[l].Z());
              ...
              if (motherId1 == motherId2) {
                opening_angle1_mc = CalculateOpeningAngleMC(
                  fRecoTracklistEPEM[i], fRecoTracklistEPEM[j]);
                opening_angle2_mc = CalculateOpeningAngleMC(
                  fRecoTracklistEPEM[k], fRecoTracklistEPEM[l]);
                opening_angle1_refitted = CalculateOpeningAngleReco(
                  fRecoRefittedMomentum[i], fRecoRefittedMomentum[j]);
                opening_angle2_refitted = CalculateOpeningAngleReco(
                  fRecoRefittedMomentum[k], fRecoRefittedMomentum[l]);
              }
              if (motherId1 == motherId3) {
                opening_angle1_mc = CalculateOpeningAngleMC(
              ...
              Double_t openingAngleBetweenGammas =
                CalculateOpeningAngleBetweenGammasMC(fRecoTracklistEPEM[i],
                                                     fRecoTracklistEPEM[j],
                                                     fRecoTracklistEPEM[k],
                                                     fRecoTracklistEPEM[l]);
              fhEPEM_openingAngle_betweenGammas_mc->Fill(
                openingAngleBetweenGammas);
              Double_t openingAngleBetweenGammasReco =
                CalculateOpeningAngleBetweenGammasReco(
                  fRecoRefittedMomentum[i],
                  fRecoRefittedMomentum[j],
                  fRecoRefittedMomentum[k],
                  fRecoRefittedMomentum[l]);
              fhEPEM_openingAngle_betweenGammas_reco->Fill(
              ...
              fhEPEM_openingAngle_vs_pt_gg_reco->Fill(params1.fPt,
                                                      opening_angle1_refitted);
              fhEPEM_openingAngle_vs_pt_gg_reco->Fill(params1.fPt,
                                                      opening_angle2_refitted);

              fhEPEM_rap_vs_chi->Fill(params1.fRapidity,
                                      fRecoTracklistEPEM_chi[i]);
              fhEPEM_rap_vs_chi->Fill(params1.fRapidity,
                                      fRecoTracklistEPEM_chi[j]);
              fhEPEM_rap_vs_chi->Fill(params1.fRapidity,
                                      fRecoTracklistEPEM_chi[k]);
              fhEPEM_rap_vs_chi->Fill(params1.fRapidity,
                                      fRecoTracklistEPEM_chi[l]);
              ...
              Bool_t IsRichElectron1ann = IsRichElectronANN(
                fRecoTracklistEPEM_gtid[i], fRecoRefittedMomentum[i].Mag());
              Bool_t IsRichElectron2ann = IsRichElectronANN(
                fRecoTracklistEPEM_gtid[j], fRecoRefittedMomentum[j].Mag());
              Bool_t IsRichElectron3ann = IsRichElectronANN(
                fRecoTracklistEPEM_gtid[k], fRecoRefittedMomentum[k].Mag());
              Bool_t IsRichElectron4ann = IsRichElectronANN(
                fRecoTracklistEPEM_gtid[l], fRecoRefittedMomentum[l].Mag());

              Bool_t IsRichElectron1normal = IsRichElectronNormal(
                fRecoTracklistEPEM_gtid[i], fRecoRefittedMomentum[i].Mag());
              Bool_t IsRichElectron2normal = IsRichElectronNormal(
                fRecoTracklistEPEM_gtid[j], fRecoRefittedMomentum[j].Mag());
              Bool_t IsRichElectron3normal = IsRichElectronNormal(
                fRecoTracklistEPEM_gtid[k], fRecoRefittedMomentum[k].Mag());
              Bool_t IsRichElectron4normal = IsRichElectronNormal(
                fRecoTracklistEPEM_gtid[l], fRecoRefittedMomentum[l].Mag());

              Bool_t IsRichElectron1MC =
                (TMath::Abs(fRecoTracklistEPEM[i]->GetPdgCode()) == 11);
              Bool_t IsRichElectron2MC =
                (TMath::Abs(fRecoTracklistEPEM[j]->GetPdgCode()) == 11);
              Bool_t IsRichElectron3MC =
                (TMath::Abs(fRecoTracklistEPEM[k]->GetPdgCode()) == 11);
              Bool_t IsRichElectron4MC =
                (TMath::Abs(fRecoTracklistEPEM[l]->GetPdgCode()) == 11);

              CbmLmvmKinematicParams paramsCut1;
              CbmLmvmKinematicParams paramsCut2;

              if (motherId1 == motherId2) {
                paramsCut1 = CalculateKinematicParamsReco(
                  fRecoRefittedMomentum[i], fRecoRefittedMomentum[j]);
                paramsCut2 = CalculateKinematicParamsReco(
                  fRecoRefittedMomentum[k], fRecoRefittedMomentum[l]);
              }
              if (motherId1 == motherId3) {
                paramsCut1 = CalculateKinematicParamsReco(
              ...
              Bool_t OpeningAngleCut1 =
                (opening_angle1_refitted < Value_openingAngleCut1);
              Bool_t OpeningAngleCut2 =
                (opening_angle2_refitted < Value_openingAngleCut2);
              Bool_t InvariantMassCut1 =
                (paramsCut1.fMinv < Value_invariantMassCut);
              Bool_t InvariantMassCut2 =
                (paramsCut2.fMinv < Value_invariantMassCut);


              fhEPEM_efficiencyCuts2->Fill(0);  // no further cuts applied
              // first ANN usage for electron identification
              if (
                IsRichElectron1ann && IsRichElectron2ann && IsRichElectron3ann
                && IsRichElectron4ann) {  // all 4 electrons correctly identified with the RICH via ANN
                fhEPEM_efficiencyCuts2->Fill(1);
                if (
                  OpeningAngleCut1
                  && OpeningAngleCut2) {  // opening angle of e+e- pairs below x
              ...
              if (
                IsRichElectron1normal && IsRichElectron2normal
                && IsRichElectron3normal
              ...
              if (
                IsRichElectron1MC && IsRichElectron2MC && IsRichElectron3MC
              ...
              cout << "reco/mc: " << fRecoMomentum[i].Mag() << " / "
                   << fRecoTracklistEPEM[i]->GetP() << " ### "
                   << fRecoMomentum[j].Mag() << " / "
                   << fRecoTracklistEPEM[j]->GetP() << " ### "
                   << fRecoMomentum[k].Mag() << " / "
                   << fRecoTracklistEPEM[k]->GetP() << " ### "
                   << fRecoMomentum[l].Mag() << " / "
                   << fRecoTracklistEPEM[l]->GetP() << endl;
  ...
  cout << "CbmAnaConversionReco: InvariantMassTest_4epem - Filled events: "
       << fill << endl;
...
void CbmAnaConversionReco::CutEfficiencyStudies(int e1,
  ...
  if (motherE1 == motherE2) {
    opening_angle1_refitted = CalculateOpeningAngleReco(
      fRecoRefittedMomentum[e1], fRecoRefittedMomentum[e2]);
    opening_angle2_refitted = CalculateOpeningAngleReco(
      fRecoRefittedMomentum[e3], fRecoRefittedMomentum[e4]);
  }
  if (motherE1 == motherE3) {
    opening_angle1_refitted = CalculateOpeningAngleReco(
      fRecoRefittedMomentum[e1], fRecoRefittedMomentum[e3]);
    opening_angle2_refitted = CalculateOpeningAngleReco(
      fRecoRefittedMomentum[e2], fRecoRefittedMomentum[e4]);
  }
  if (motherE1 == motherE4) {
    opening_angle1_refitted = CalculateOpeningAngleReco(
      fRecoRefittedMomentum[e1], fRecoRefittedMomentum[e4]);
    opening_angle2_refitted = CalculateOpeningAngleReco(
      fRecoRefittedMomentum[e2], fRecoRefittedMomentum[e3]);
  }


  Bool_t IsWithinChiCut1 =
    (fRecoTracklistEPEM_chi[e1] < CbmAnaConversionCutSettings::CalcChiCut(
       fRecoRefittedMomentum[e1].Perp()));
  Bool_t IsWithinChiCut2 =
    (fRecoTracklistEPEM_chi[e2] < CbmAnaConversionCutSettings::CalcChiCut(
       fRecoRefittedMomentum[e2].Perp()));
  Bool_t IsWithinChiCut3 =
    (fRecoTracklistEPEM_chi[e3] < CbmAnaConversionCutSettings::CalcChiCut(
       fRecoRefittedMomentum[e3].Perp()));
  Bool_t IsWithinChiCut4 =
    (fRecoTracklistEPEM_chi[e4] < CbmAnaConversionCutSettings::CalcChiCut(
       fRecoRefittedMomentum[e4].Perp()));

  Bool_t AllWithinChiCut =
    (IsWithinChiCut1 && IsWithinChiCut2 && IsWithinChiCut3 && IsWithinChiCut4);
  ...
  Bool_t IsRichElectron1ann = IsRichElectronANN(
    fRecoTracklistEPEM_gtid[e1], fRecoRefittedMomentum[e1].Mag());
  Bool_t IsRichElectron2ann = IsRichElectronANN(
    fRecoTracklistEPEM_gtid[e2], fRecoRefittedMomentum[e2].Mag());
  Bool_t IsRichElectron3ann = IsRichElectronANN(
    fRecoTracklistEPEM_gtid[e3], fRecoRefittedMomentum[e3].Mag());
  Bool_t IsRichElectron4ann = IsRichElectronANN(
    fRecoTracklistEPEM_gtid[e4], fRecoRefittedMomentum[e4].Mag());
  ...
  Bool_t IsRichElectron1MC =
    (TMath::Abs(fRecoTracklistEPEM[e1]->GetPdgCode()) == 11);
  Bool_t IsRichElectron2MC =
    (TMath::Abs(fRecoTracklistEPEM[e2]->GetPdgCode()) == 11);
  Bool_t IsRichElectron3MC =
    (TMath::Abs(fRecoTracklistEPEM[e3]->GetPdgCode()) == 11);
  Bool_t IsRichElectron4MC =
    (TMath::Abs(fRecoTracklistEPEM[e4]->GetPdgCode()) == 11);

  Double_t ANNvalueE1 = ElectronANNvalue(fRecoTracklistEPEM_gtid[e1],
                                         fRecoRefittedMomentum[e1].Mag());
  Double_t ANNvalueE2 = ElectronANNvalue(fRecoTracklistEPEM_gtid[e2],
                                         fRecoRefittedMomentum[e2].Mag());
  Double_t ANNvalueE3 = ElectronANNvalue(fRecoTracklistEPEM_gtid[e3],
                                         fRecoRefittedMomentum[e3].Mag());
  Double_t ANNvalueE4 = ElectronANNvalue(fRecoTracklistEPEM_gtid[e4],
                                         fRecoRefittedMomentum[e4].Mag());

  CbmLmvmKinematicParams paramsCut1;
  CbmLmvmKinematicParams paramsCut2;

  if (motherE1 == motherE2) {
    paramsCut1 = CalculateKinematicParamsReco(fRecoRefittedMomentum[e1],
                                              fRecoRefittedMomentum[e2]);
    paramsCut2 = CalculateKinematicParamsReco(fRecoRefittedMomentum[e3],
                                              fRecoRefittedMomentum[e4]);
  }
  if (motherE1 == motherE3) {
    paramsCut1 = CalculateKinematicParamsReco(fRecoRefittedMomentum[e1],
                                              fRecoRefittedMomentum[e3]);
    paramsCut2 = CalculateKinematicParamsReco(fRecoRefittedMomentum[e2],
                                              fRecoRefittedMomentum[e4]);
  }
  if (motherE1 == motherE4) {
    paramsCut1 = CalculateKinematicParamsReco(fRecoRefittedMomentum[e1],
  ...
  if (IsEta == 0) {
    fhEPEM_pi0_nofLeptons_ann->Fill(IsRichElectron1ann + IsRichElectron2ann
                                    + IsRichElectron3ann + IsRichElectron4ann);
    ...
    if (IsRichElectron1ann + IsRichElectron2ann + IsRichElectron3ann
      ...
      if (IsRichElectron1ann == 0)
        gTrack =
          (CbmGlobalTrack*) fGlobalTracks->At(fRecoTracklistEPEM_gtid[e1]);
      if (IsRichElectron2ann == 0)
        gTrack =
          (CbmGlobalTrack*) fGlobalTracks->At(fRecoTracklistEPEM_gtid[e2]);
      if (IsRichElectron3ann == 0)
        gTrack =
          (CbmGlobalTrack*) fGlobalTracks->At(fRecoTracklistEPEM_gtid[e3]);
      if (IsRichElectron4ann == 0)
        gTrack =
          (CbmGlobalTrack*) fGlobalTracks->At(fRecoTracklistEPEM_gtid[e4]);
      ...
      fhEPEM_missingLepton_ringMid->Fill(richRing->GetCenterX(),
                                         richRing->GetCenterY());
      ...
      if (IsRichElectron1ann == 0) {
        fhEPEM_missingLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e1].Mag(),
                                               richRing->GetRadius());
        fhEPEM_missingLepton_ANNvalue->Fill(ANNvalueE1);
      }
      if (IsRichElectron2ann == 0) {
        fhEPEM_missingLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e2].Mag(),
                                               richRing->GetRadius());
        fhEPEM_missingLepton_ANNvalue->Fill(ANNvalueE2);
      }
      if (IsRichElectron3ann == 0) {
        fhEPEM_missingLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e3].Mag(),
                                               richRing->GetRadius());
        fhEPEM_missingLepton_ANNvalue->Fill(ANNvalueE3);
      }
      if (IsRichElectron4ann == 0) {
        fhEPEM_missingLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e4].Mag(),
                                               richRing->GetRadius());
    ...
    if (IsRichElectron1ann > 0) {
      ...
      fhEPEM_identifiedLepton_ringMid->Fill(richRing->GetCenterX(),
                                            richRing->GetCenterY());
      ...
      fhEPEM_identifiedLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e1].Mag(),
                                                richRing->GetRadius());
    ...
    if (IsRichElectron2ann > 0) {
      ...
      fhEPEM_identifiedLepton_distance->Fill(1. /*richRing->GetDistance()*/);
      fhEPEM_identifiedLepton_selectionNN->Fill(richRing->GetSelectionNN());
      fhEPEM_identifiedLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e2].Mag(),
                                                richRing->GetRadius());
    ...
    if (IsRichElectron3ann > 0) {
      ...
      fhEPEM_identifiedLepton_distance->Fill(1. /*richRing->GetDistance() */);
      fhEPEM_identifiedLepton_selectionNN->Fill(richRing->GetSelectionNN());
      fhEPEM_identifiedLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e3].Mag(),
                                                richRing->GetRadius());
    ...
    if (IsRichElectron4ann > 0) {
      ...
      fhEPEM_identifiedLepton_distance->Fill(1. /*richRing->GetDistance()*/);
      fhEPEM_identifiedLepton_selectionNN->Fill(richRing->GetSelectionNN());
      fhEPEM_identifiedLepton_radius_vs_p->Fill(fRecoRefittedMomentum[e4].Mag(),
                                                richRing->GetRadius());
    ...
    if (ANNvalueE1 > -1 && ANNvalueE2 > -1 && ANNvalueE3 > -1
        && ANNvalueE4 > -1) {
      fhEPEM_pi0_ANNefficiencies->Fill(1);
    }
    if (ANNvalueE1 > -0.9 && ANNvalueE2 > -0.9 && ANNvalueE3 > -0.9
        && ANNvalueE4 > -0.9) {
      fhEPEM_pi0_ANNefficiencies->Fill(2);
    }
    if (ANNvalueE1 > -0.8 && ANNvalueE2 > -0.8 && ANNvalueE3 > -0.8
        && ANNvalueE4 > -0.8) {
      fhEPEM_pi0_ANNefficiencies->Fill(3);
    }
    if (ANNvalueE1 > -0.7 && ANNvalueE2 > -0.7 && ANNvalueE3 > -0.7
        && ANNvalueE4 > -0.7) {
      fhEPEM_pi0_ANNefficiencies->Fill(4);
    }
    if (ANNvalueE1 > -0.6 && ANNvalueE2 > -0.6 && ANNvalueE3 > -0.6
        && ANNvalueE4 > -0.6) {
      fhEPEM_pi0_ANNefficiencies->Fill(5);
    }
    if (ANNvalueE1 > -0.5 && ANNvalueE2 > -0.5 && ANNvalueE3 > -0.5
        && ANNvalueE4 > -0.5) {
      fhEPEM_pi0_ANNefficiencies->Fill(6);
    }
    if (ANNvalueE1 > -0.4 && ANNvalueE2 > -0.4 && ANNvalueE3 > -0.4
        && ANNvalueE4 > -0.4) {
      fhEPEM_pi0_ANNefficiencies->Fill(7);
    }
    if (ANNvalueE1 > -0.3 && ANNvalueE2 > -0.3 && ANNvalueE3 > -0.3
        && ANNvalueE4 > -0.3) {
      fhEPEM_pi0_ANNefficiencies->Fill(8);
    }
    if (ANNvalueE1 > -0.2 && ANNvalueE2 > -0.2 && ANNvalueE3 > -0.2
        && ANNvalueE4 > -0.2) {
      fhEPEM_pi0_ANNefficiencies->Fill(9);
    }
    if (ANNvalueE1 > -0.1 && ANNvalueE2 > -0.1 && ANNvalueE3 > -0.1
        && ANNvalueE4 > -0.1) {
      fhEPEM_pi0_ANNefficiencies->Fill(10);
    }
    if (ANNvalueE1 > -0.0 && ANNvalueE2 > -0.0 && ANNvalueE3 > -0.0
        && ANNvalueE4 > -0.0) {
    ...
    // then standard method for electron identification
    if (
      IsRichElectron1normal && IsRichElectron2normal && IsRichElectron3normal
      && IsRichElectron4normal) {  // all 4 electrons correctly identified with the RICH via "normal way"
...
Double_t CbmAnaConversionReco::CalculateOpeningAngleBetweenGammasMC(
  CbmMCTrack* mctrack1,
  CbmMCTrack* mctrack2,
  CbmMCTrack* mctrack3,
  CbmMCTrack* mctrack4) {
  ...
  if (mctrack1->GetMotherId() == mctrack3->GetMotherId()
  ...
  if (mctrack1->GetMotherId() == mctrack4->GetMotherId()
...
Double_t CbmAnaConversionReco::CalculateOpeningAngleBetweenGammasReco(
  TVector3 electron1,
  TVector3 electron2,
  TVector3 electron3,
  TVector3 electron4) {
      ...
      for (int b = a + 1; b < nof - 2; b++) {
        for (int c = b + 1; c < nof - 1; c++) {
          for (int d = c + 1; d < nof; d++) {
            ...
            Double_t invmass = Invmass_4particlesRECO(fRecoRefittedMomentum[a],
                                                      fRecoRefittedMomentum[b],
                                                      fRecoRefittedMomentum[c],
                                                      fRecoRefittedMomentum[d]);
            //fhElectrons_invmass->Fill(invmass);


            CbmLmvmKinematicParams params1 = CalculateKinematicParamsReco(
              fRecoRefittedMomentum[a], fRecoRefittedMomentum[b]);
            CbmLmvmKinematicParams params2 = CalculateKinematicParamsReco(
              fRecoRefittedMomentum[a], fRecoRefittedMomentum[c]);
            CbmLmvmKinematicParams params3 = CalculateKinematicParamsReco(
              fRecoRefittedMomentum[a], fRecoRefittedMomentum[d]);
            CbmLmvmKinematicParams params4 = CalculateKinematicParamsReco(
              fRecoRefittedMomentum[b], fRecoRefittedMomentum[c]);
            CbmLmvmKinematicParams params5 = CalculateKinematicParamsReco(
              fRecoRefittedMomentum[b], fRecoRefittedMomentum[d]);
            CbmLmvmKinematicParams params6 = CalculateKinematicParamsReco(
            ...
            if (IsPhoton_openingAngle1 && IsPhoton_openingAngle6
                && IsPhoton_invMass1 && IsPhoton_invMass6
                && (check1 + check2 == 1) && (check3 + check4 == 1)) {
              fhInvMassWithFullRecoCuts->Fill(invmass);
            }
            if (IsPhoton_openingAngle2 && IsPhoton_openingAngle5
                && IsPhoton_invMass2 && IsPhoton_invMass5
                && (check1 + check3 == 1) && (check2 + check4 == 1)) {
              fhInvMassWithFullRecoCuts->Fill(invmass);
            }
            if (IsPhoton_openingAngle3 && IsPhoton_openingAngle4
                && IsPhoton_invMass3 && IsPhoton_invMass4
...
CbmAnaConversionReco::CalculateKinematicParamsReco(const TVector3 electron1,
