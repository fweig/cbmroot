...
void CbmAnaConversionTest::InitHistos()
{
  ...
  fElectrons_nofPerPi0_withRichInd =
    new TH1I("fElectrons_nofPerPi0_withRichInd", "fElectrons_nofPerPi0_withRichInd; nof; #", 7, -0.5, 6.5);
  fHistoList_test.push_back(fElectrons_nofPerPi0_withRichInd);

  fhElectronsTest_invmass =
    new TH1D("fhElectronsTest_invmass", "fhElectronsTest_invmass; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
  ...
  fhTest_PhotonsPerEvent_RICHonly =
    new TH1I("fhTest_PhotonsPerEvent_RICHonly", "fhTest_PhotonsPerEvent_RICHonly; nof; #", 501, -0.5, 500.5);
  fHistoList_test.push_back(fhTest_PhotonsPerEvent_RICHonly);
  fhTest_PhotonsPerEvent_STSandRICH =
    new TH1I("fhTest_PhotonsPerEvent_STSandRICH", "fhTest_PhotonsPerEvent_STSandRICH; nof; #", 501, -0.5, 500.5);
  fHistoList_test.push_back(fhTest_PhotonsPerEvent_STSandRICH);
  fhTest_ParticlesPerEvent =
    new TH1I("fhTest_ParticlesPerEvent", "fhTest_ParticlesPerEvent; nof; #", 1001, -0.5, 1000.5);
  fHistoList_test.push_back(fhTest_ParticlesPerEvent);
  fhTest_ReconstructedPi0PerEvent =
    new TH1I("fhTest_ReconstructedPi0PerEvent", "fhTest_ReconstructedPi0PerEvent; nof; #", 101, -0.5, 100.5);
  fHistoList_test.push_back(fhTest_ReconstructedPi0PerEvent);
  fhTest_RICHelectronsPerEvent =
    new TH1I("fhTest_RICHelectronsPerEvent", "fhTest_RICHelectronsPerEvent; nof; #", 501, -0.5, 500.5);
  fHistoList_test.push_back(fhTest_RICHelectronsPerEvent);

  fhTest_invmass =
    new TH1D("fhTest_invmass", "fhTest_invmass; invariant mass of 3 e^{#pm} + 1 particle in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  ...
  fhTest_invmass_RICHindex0 =
    new TH1D("fhTest_invmass_RICHindex0", "fhTest_invmass_RICHindex0; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_invmass_RICHindex0);
  fhTest_invmass_RICHindex1 =
    new TH1D("fhTest_invmass_RICHindex1", "fhTest_invmass_RICHindex1; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_invmass_RICHindex1);
  fhTest_invmass_RICHindex2 =
    new TH1D("fhTest_invmass_RICHindex2", "fhTest_invmass_RICHindex2; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_invmass_RICHindex2);
  fhTest_invmass_RICHindex3 =
    new TH1D("fhTest_invmass_RICHindex3", "fhTest_invmass_RICHindex3; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_invmass_RICHindex3);
  fhTest_invmass_RICHindex4 =
    new TH1D("fhTest_invmass_RICHindex4", "fhTest_invmass_RICHindex4; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_invmass_RICHindex4);

  fhTest_invmass_MCcutAll = new TH2D("fhTest_invmass_MCcutAll", "fhTest_invmass_MCcutAll; case; invariant mass", 25, 0,
  ...
  fhTest_phaseSpace_pi0 =
    new TH2D("fhTest_phaseSpace_pi0", "fhTest_phaseSpace_pi0;p_{t} in GeV/c;rapidity y", 240, -2., 10., 270, -2., 7.);
  fhTest_phaseSpace_eta =
    new TH2D("fhTest_phaseSpace_eta", "fhTest_phaseSpace_eta;p_{t} in GeV/c;rapidity y", 240, -2., 10., 270, -2., 7.);
  fHistoList_test.push_back(fhTest_phaseSpace_pi0);
  fHistoList_test.push_back(fhTest_phaseSpace_eta);

  fhTest_eventMixing_STSonly_2p2 = new TH1D("fhTest_eventMixing_STSonly_2p2",
                                            "fhTest_eventMixing_STSonly_2p2; invariant mass of 4 e^{#pm} in "
                                            "GeV/c^{2}; #",
                                            invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_eventMixing_STSonly_2p2);
  fhTest_eventMixing_STSonly_3p1 = new TH1D("fhTest_eventMixing_STSonly_3p1",
                                            "fhTest_eventMixing_STSonly_3p1; invariant mass of 4 e^{#pm} in "
                                            "GeV/c^{2}; #",
                                            invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_eventMixing_STSonly_3p1);
  fhTest_eventMixing_STSonly_4p0 = new TH1D("fhTest_eventMixing_STSonly_4p0",
  ...
  fhTest_eventMixing_3p1 =
    new TH1D("fhTest_eventMixing_3p1", "fhTest_eventMixing_3p1; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_eventMixing_3p1);
  fhTest_eventMixing_3p1_pCut =
    new TH1D("fhTest_eventMixing_3p1_pCut", "fhTest_eventMixing_3p1_pCut; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
             invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_eventMixing_3p1_pCut);
  fhTest_eventMixing_3p1_GGcut = new TH1D("fhTest_eventMixing_3p1_GGcut",
                                          "fhTest_eventMixing_3p1_GGcut; invariant mass of 4 e^{#pm} in GeV/c^{2}; #",
                                          invmassSpectra_nof, invmassSpectra_start, invmassSpectra_end);
  fHistoList_test.push_back(fhTest_eventMixing_3p1_GGcut);

  fhTest_eventMixing_3p1_ANNcuts = new TH2D("fhTest_eventMixing_3p1_ANNcuts",
...
void CbmAnaConversionTest::Exec()
{
  ...
  for (Int_t i = 0; i < nGTracks; i++) {
    ...
    cout << "CbmAnaConversionTest: pdg particle/mother/grandmother: " << pdg << " / " << pdg_mother << " / "
...
Double_t CbmAnaConversionTest::CalcInvMass(Int_t e1, Int_t e2, Int_t e3, Int_t e4)
{
  ...
  if (mcTrack_e1->GetPdgCode() + mcTrack_e2->GetPdgCode() + mcTrack_e3->GetPdgCode() + mcTrack_e4->GetPdgCode())
    return -1;
        ...
        if (richMcTrackId >= 0) {
          ...
          if (mcTrack2 != NULL) {
            ...
            Bool_t electron_rich =
              CbmLitGlobalElectronId::GetInstance().IsRichElectron(i, refittedMomentum_electron.Mag());
            if (electron_rich) {
              fVector_electronRICH_momenta.push_back(refittedMomentum_electron);
              fVector_electronRICH_gt.push_back(gTrack);
              fVector_electronRICH_gtIndex.push_back(i);
...
void CbmAnaConversionTest::CombineElectrons_FromSTSandRICH()
{
  ...
  cout << "CbmAnaConversionTest: CombineElectrons_FromSTSandRICH, nof sts/rich - " << nof_sts << " / " << nof_rich
       << endl;
  Int_t nofPhotons = 0;
  if (nof_sts + nof_rich >= 2) {
    for (int a = 0; a < nof_sts; a++) {
      for (int b = 0; b < nof_rich; b++) {
        Int_t check1 = (fVector_gt[a]->GetParamLast()->GetQp()
  ...
  if (nof >= 2) {
    for (int a = 0; a < nof - 1; a++) {
      for (int b = a + 1; b < nof; b++) {
        Int_t check1 = (fVector_electronRICH_gt[a]->GetParamLast()->GetQp()
                        > 0);  // positive or negative charge (qp = charge over momentum ratio)
        Int_t check2 = (fVector_electronRICH_gt[b]->GetParamLast()->GetQp() > 0);
        Int_t test   = check1 + check2;
        if (test != 1) continue;  // need one electron and one positron
  ...
  if (nof_STSandRICH + nof_RICH >= 2) {
    for (int a = 0; a < nof_STSandRICH; a++) {
      for (int b = 0; b < nof_RICH; b++) {
        ...
        if (gtIndex11 == gtIndex12 || gtIndex11 == gtIndex21 || gtIndex11 == gtIndex22 || gtIndex12 == gtIndex21
        ...
        CbmAnaConversionKinematicParams paramsTest = CbmAnaConversionKinematicParams::KinematicParams_4particles_Reco(
          fVector_momenta[electron11], fVector_electronRICH_momenta[electron12],
          fVector_electronRICH_momenta[electron21], fVector_electronRICH_momenta[electron22]);

        Double_t invmass = paramsTest.fMinv;

        fhTest_invmass->Fill(invmass);

        if (fVector_momenta[electron11].Mag() < 0.6) { fhTest_invmass_pCut->Fill(invmass); }

        Double_t OpeningAngleGG = CbmAnaConversionGlobalFunctions::OpeningAngleBetweenGamma(
          fVector_momenta[electron11], fVector_electronRICH_momenta[electron12],
          fVector_electronRICH_momenta[electron21], fVector_electronRICH_momenta[electron22]);
        ...
        cout << "CbmAnaConversionTest: CombinePhotons, anns: " << ANNe11 << "/" << ANNe12 << "/" << ANNe21 << "/"
             << ANNe22 << endl;
        ...
        cout << "CbmAnaConversionTest: CombinePhotons, photon combined! " << invmass << "/" << gtIndex11 << "/"
             << gtIndex12 << "/" << gtIndex21 << "/" << gtIndex22 << endl;
        nofPi0++;
        ...
        if (
          ...
          if (grandmotherId11 == grandmotherId21) { fhTest_invmass_MCcutAll->Fill(9, invmass); }
        }
        ...
        if (motherId11 != motherId12 && motherId21 != motherId22) {
          ...
          if (sameGrandmothersSum == 4) {
            ...
            if (grandmotherId11 == grandmotherId12) { fhTest_invmass_MCcutAll->Fill(17, invmass); }
            if (grandmotherId11 != grandmotherId12) { fhTest_invmass_MCcutAll->Fill(18, invmass); }
          }
...
Double_t CbmAnaConversionTest::Invmass_4particlesRECO(const TVector3 part1, const TVector3 part2, const TVector3 part3,
...
void CbmAnaConversionTest::CombinePhotons_STSonly()
{
  ...
  if (nof >= 2) {
    for (int a = 0; a < nof - 1; a++) {
      for (int b = a + 1; b < nof; b++) {
        ...
        CbmAnaConversionKinematicParams paramsTest = CbmAnaConversionKinematicParams::KinematicParams_4particles_Reco(
          fVector_momenta[electron11], fVector_momenta[electron12], fVector_momenta[electron21],
        ...
        Int_t nofRICHindices = fVector_withRichSignal[electron11] + fVector_withRichSignal[electron12]
                               + fVector_withRichSignal[electron21] + fVector_withRichSignal[electron22];
  ...
  cout << "CbmAnaConversionTest: CombinePhotons_STSonly, nofPi0 - " << nofPi0 << "/" << nofPi0_0 << "/" << nofPi0_1
       << "/" << nofPi0_2 << "/" << nofPi0_3 << "/" << nofPi0_4 << endl;
}
...
*/
  ...
  Bool_t electron_rich =
    CbmLitGlobalElectronId::GetInstance().IsRichElectron(gtIndex, fVector_momenta[arrayIndex].Mag());
...
void CbmAnaConversionTest::MixedEventTest_STSonly()
{
  ...
  for (Int_t a = 0; a < nof - 1; a++) {
    for (Int_t b = a + 1; b < nof; b++) {
      ...
      if (IsRichSum == 2) { fhTest_eventMixing_STSonly_2p2->Fill(params.fMinv); }
      if (IsRichSum == 3) { fhTest_eventMixing_STSonly_3p1->Fill(params.fMinv); }
      if (IsRichSum == 4) { fhTest_eventMixing_STSonly_4p0->Fill(params.fMinv); }
    }
  }
}
