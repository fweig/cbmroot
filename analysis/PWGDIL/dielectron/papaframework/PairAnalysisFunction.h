...
public:
  ...
  Double_t PeakFunExpGaussExp(const Double_t* x,
                              const Double_t* par);  // exp gaussian exp
...
protected:
  ...
  ClassDef(PairAnalysisFunction,
           1)  // Combine functions for e.g. signal extractions
};
