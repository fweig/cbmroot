  ...
  fFastTrack(track.fFastTrack)
{
  ...
  this->SetBit(BIT(14+ToIntegralType(ECbmModuleId::kTof)),  track.TestBit(BIT(14+ToIntegralType(ECbmModuleId::kTof)) ));
  this->SetBit(BIT(14+ToIntegralType(ECbmModuleId::kRich)), track.TestBit(BIT(14+ToIntegralType(ECbmModuleId::kRich))));
  this->SetBit(BIT(14+ToIntegralType(ECbmModuleId::kTrd)),  track.TestBit(BIT(14+ToIntegralType(ECbmModuleId::kTrd)) ));
  this->SetBit(BIT(14+ToIntegralType(ECbmModuleId::kSts)),  track.TestBit(BIT(14+ToIntegralType(ECbmModuleId::kSts)) ));
  this->SetBit(BIT(14+ToIntegralType(ECbmModuleId::kMuch)), track.TestBit(BIT(14+ToIntegralType(ECbmModuleId::kMuch))));
