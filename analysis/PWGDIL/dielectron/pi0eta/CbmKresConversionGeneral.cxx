...
void CbmKresConversionGeneral::Init() {
  ...
  if (nullptr == ioman) {
    Fatal("CbmKresConversionGeneral::Init", "RootManager not instantised!");
  }

  fMcTracks = (TClonesArray*) ioman->GetObject("MCTrack");
  if (nullptr == fMcTracks) {
    Fatal("CbmKresConversionGeneral::Init", "No MCTrack array!");
  }

  fGlobalTracks = (TClonesArray*) ioman->GetObject("GlobalTrack");
  if (nullptr == fGlobalTracks) {
    Fatal("CbmKresConversionGeneral::Init", "No GlobalTrack array!");
  }

  fStsTracks = (TClonesArray*) ioman->GetObject("StsTrack");
  if (nullptr == fStsTracks) {
    Fatal("CbmKresConversionGeneral::Init", "No StsTrack array!");
  }

  fStsTrackMatches = (TClonesArray*) ioman->GetObject("StsTrackMatch");
  if (nullptr == fStsTrackMatches) {
    Fatal("CbmKresConversionGeneral::Init", "No StsTrackMatch array!");
  }

  fRichPoints = (TClonesArray*) ioman->GetObject("RichPoint");
  if (nullptr == fRichPoints) {
    Fatal("CbmKresConversionGeneral::Init", "No RichPoint array!");
  }

  fRichHits = (TClonesArray*) ioman->GetObject("RichHit");
  if (nullptr == fRichHits) {
    Fatal("CbmKresConversionGeneral::Init", "No RichHit array!");
  }

  fRichRings = (TClonesArray*) ioman->GetObject("RichRing");
  if (nullptr == fRichRings) {
    Fatal("CbmKresConversionGeneral::Init", "No RichRing array!");
  }

  fRichRingMatches = (TClonesArray*) ioman->GetObject("RichRingMatch");
  if (nullptr == fRichRingMatches) {
    Fatal("CbmKresConversionGeneral::Init", "No RichRingMatch array!");
  }

  fRichProjections = (TClonesArray*) ioman->GetObject("RichProjection");
  if (nullptr == fRichProjections) {
    Fatal("CbmKresConversionGeneral::Init", "No RichProjection array!");
  }
  ...
  fTauFit =
    new CbmRichRingFitterEllipseTau();  ///// fit of ellipse instead of ring within RICH detector
}
...
void CbmKresConversionGeneral::Exec(int /*fEventNumGen*/) {
  ...
  for (int ix = 1; ix <= temporarygraph->GetNbinsX(); ix++) {
    for (int iy = 1; iy <= temporarygraph->GetNbinsY(); iy++) {
      ...
      if (iy <= 6)
        HitsPerPmtFullMiddle->Fill(temporarygraph->GetBinContent(ix, iy));
    }
  }
  ...
  for (int i = 0; i < nofMcTracks; i++) {
    ...
    if (TMath::Abs(mctrack->GetPdgCode()) == 111) {
      ...
      if (mctrack->GetRapidity() > 1.2 && mctrack->GetRapidity() < 4.0)
        MC_pi0_Pt_est->Fill(mctrack->GetPt());
      MC_pi0_Pt_vs_rap->Fill(mctrack->GetRapidity(), mctrack->GetPt());
      Pi0_pt_vs_rap_est->Fill(mctrack->GetRapidity(), mctrack->GetPt());
      if (mctrack->GetMotherId() == -1) {
        MC_pi0_Pt_vs_rap_primary->Fill(mctrack->GetRapidity(),
                                       mctrack->GetPt());
        Pi0_pt_vs_rap_est_primary->Fill(mctrack->GetRapidity(),
                                        mctrack->GetPt());
      }
      MC_pi0_theta->Fill(momentum.Theta() * 180. / TMath::Pi());
      MC_pi0_phi->Fill(momentum.Phi() * 180. / TMath::Pi());
      MC_pi0_theta_vs_rap->Fill(momentum.Theta() * 180. / TMath::Pi(),
                                mctrack->GetRapidity());
    }
    ...
    if (TMath::Abs(mctrack->GetPdgCode()) == 221) {
      ...
      if (mctrack->GetMotherId() == -1)
        MC_eta_Pt_vs_rap_primary->Fill(mctrack->GetRapidity(),
                                       mctrack->GetPt());
      MC_eta_theta->Fill(momentum.Theta() * 180. / TMath::Pi());
      MC_eta_theta_vs_rap->Fill(momentum.Theta() * 180. / TMath::Pi(),
                                mctrack->GetRapidity());
    }
    ...
    if (mctrack->GetPdgCode() == 22) {
      ...
      if (mctrack->GetMotherId() != -1) {
        ...
        MC_Not_Direct_photons_theta->Fill(momentum.Theta() * 180.
                                          / TMath::Pi());
        MC_Not_Direct_photons_theta_vs_rap->Fill(
          momentum.Theta() * 180. / TMath::Pi(), mctrack->GetRapidity());
      }
      if (mctrack->GetMotherId() == -1) {
        ...
        MC_Direct_photons_Pt_vs_rap->Fill(mctrack->GetRapidity(),
                                          mctrack->GetPt());
        MC_Direct_photons_Pt_vs_rap_est->Fill(mctrack->GetRapidity(),
                                              mctrack->GetPt());
        MC_Direct_photons_theta->Fill(momentum.Theta() * 180. / TMath::Pi());
        MC_Direct_photons_theta_vs_rap->Fill(
          momentum.Theta() * 180. / TMath::Pi(), mctrack->GetRapidity());
      }
    }
    ...
    if (TMath::Abs(mctrack->GetPdgCode()) == 11) {
      ...
      MC_electrons_Pt_vs_rap_est->Fill(mctrack->GetRapidity(),
                                       mctrack->GetPt());
      ...
      if (mcGrandmotherPdg == 111) {
        MC_leptons_from_pi0_start_vertex->Fill(mctrack->GetStartZ(),
                                               mctrack->GetStartY());
        MC_leptons_from_pi0_P->Fill(mctrack->GetP());
      }
      MC_leptons_conversion_ZY->Fill(mctrack->GetStartZ(),
                                     mctrack->GetStartY());
      MC_leptons_conversion_XY->Fill(mctrack->GetStartX(),
                                     mctrack->GetStartY());
      MC_leptons_conversion_XZ->Fill(mctrack->GetStartX(),
                                     mctrack->GetStartZ());
    }
  ...
  for (Int_t iTr = 0; iTr < ngTracks; iTr++) {
    ...
    CbmTrackMatchNew* stsMatch = (CbmTrackMatchNew*) fStsTrackMatches->At(
      stsInd);  /// match of reconstructed track to Monte Carlo
    ...
    if (TMath::Abs(mcTrackSTS->GetPdgCode()) == 11
        || TMath::Abs(mcTrackSTS->GetPdgCode()) == 211) {
      if (richInd >= 0) {
    ...
    CbmRichRing* richRing = (CbmRichRing*) fRichRings->At(richInd);
    if (richRing == nullptr) continue;
    CbmTrackMatchNew* richMatch = (CbmTrackMatchNew*) fRichRingMatches->At(
      richInd);  /// match of reconstructed ring to Monte Carlo
    if (richMatch == nullptr) continue;
    if (richMatch->GetNofLinks() <= 0) continue;
    int richMcTrackId = richMatch->GetMatchedLink().GetIndex();
    if (richMcTrackId < 0) continue;
    ...
    if (ringHit.GetAaxis() > fMinAaxis && ringHit.GetAaxis() < fMaxAaxis
        && ringHit.GetBaxis() > fMinBaxis
        && ringHit.GetAaxis() < fMaxBaxis) {  //// only good rings
      if (mcTrackRICH->GetPdgCode() == -11)
        Distance_positron->Fill(richRing->GetCenterX(),
                                richRing->GetCenterY(),
                                CbmRichUtil::GetRingTrackDistance(iTr));
      if (mcTrackRICH->GetPdgCode() == 11)
        Distance_electron->Fill(richRing->GetCenterX(),
                                richRing->GetCenterY(),
                                CbmRichUtil::GetRingTrackDistance(iTr));
      ...
      MC_Reconstructed_electrons_Pt_vs_rap_est->Fill(mcTrackRICH->GetRapidity(),
                                                     mcTrackRICH->GetPt());
...
void CbmKresConversionGeneral::InitHistograms() {
  //***** photons analysis
  MC_All_photons_Pt =
    new TH1D("MC_All_photons_Pt",
             "Monte Carlo,   all #gamma,   p_{t} distribution; p_{t} in GeV/c",
             200,
             0,
             2);
  ...
  MC_Not_Direct_photons_Pt = new TH1D(
    ...
    "Monte Carlo,   #gamma from decays,   p_{t} distribution; p_{t} in GeV/c",
    200,
    0,
    2);
  fHistoList_MC.push_back(MC_Not_Direct_photons_Pt);

  MC_Direct_photons_Pt = new TH1D(
    "MC_Direct_photons_Pt",
    "Monte Carlo,   direct #gamma,   p_{t} distribution; p_{t} in GeV/c",
    200,
    0,
    2);
  ...
  MC_All_photons_P =
    new TH1D("MC_All_photons_P",
             "Monte Carlo,   all #gamma,   p distribution; p in GeV/c",
             1000,
             0,
             10);
  ...
  MC_Not_Direct_photons_P =
    new TH1D("MC_Not_Direct_photons_P",
             "Monte Carlo,   #gamma from decays,   p distribution; p in GeV/c",
             1000,
             0,
             10);
  ...
  MC_Direct_photons_P =
    new TH1D("MC_Direct_photons_P",
             "Monte Carlo,   direct #gamma,   p distribution; p in GeV/c",
             1000,
             0,
             10);
  ...
  MC_Direct_photons_Pt_vs_rap =
    new TH2D("MC_Direct_photons_Pt_vs_rap",
  ...
  MC_Direct_photons_Pt_vs_rap_est =
    new TH2D("MC_Direct_photons_Pt_vs_rap_est",
             "Monte Carlo,   direct #gamma,   p_{t} vs rapidity distribution; "
             "rapidity y; p_{t} in GeV/c ",
             10,
             0.,
  ...
  MC_photons_mother_Pdg = new TH1D(
    "MC_photons_mother_Pdg", "MC_photons_mother_Pdg; Id;#", 2500, -10, 2511);
  fHistoList_MC.push_back(MC_photons_mother_Pdg);

  MC_Not_Direct_photons_theta =
    new TH1D("MC_Not_Direct_photons_theta",
  ...
  MC_Not_Direct_photons_theta_vs_rap =
    new TH2D("MC_Not_Direct_photons_theta_vs_rap",
  ...
  MC_Direct_photons_theta =
    new TH1D("MC_Direct_photons_theta",
  ...
  MC_Direct_photons_theta_vs_rap =
    new TH2D("MC_Direct_photons_theta_vs_rap",
  ...
  MC_electrons_Pt_vs_rap_est =
    new TH2D("MC_electrons_Pt_vs_rap_est",
  ...
  MC_Reconstructed_electrons_Pt_vs_rap_est =
    new TH2D("MC_Reconstructed_electrons_Pt_vs_rap_est",
  ...
  MC_omega_Pt_vs_rap_est =
    new TH2D("MC_omega_Pt_vs_rap_est",
  ...
  MC_pi0_Pt = new TH1D(
    "MC_pi0_Pt",
    "Monte Carlo,   #pi^{0},   p_{t} distribution;p_{t} in GeV/c; Entries",
    200.,
    0.,
    10.);
  fHistoList_MC.push_back(MC_pi0_Pt);

  MC_pi0_Pt_est = new TH1D(
    "MC_pi0_Pt_est",
    "Monte Carlo,   #pi^{0},   p_{t} distribution;p_{t} in GeV/c; Entries",
    20.,
    0.,
  ...
  MC_pi0_Pt_vs_rap_primary =
    new TH2D("MC_pi0_Pt_vs_rap_primary",
  ...
  Pi0_pt_vs_rap_est = new TH2D("Pi0_pt_vs_rap_est",
                               "Pi0_pt_vs_rap_est; rapidity y; p_{t} in GeV/c ",
                               10,
                               0.,
                               4.,
                               40,
  ...
  Pi0_pt_vs_rap_est_primary =
    new TH2D("Pi0_pt_vs_rap_est_primary",
             "Pi0_pt_vs_rap_est_primary; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             40,
  ...
  MC_leptons_conversion_ZY =
    new TH2D("MC_leptons_conversion_ZY",
             "Start vertices of leptons coming from #gamma; z[cm]; y[cm]",
             800,
             -1,
             400,
             880,
  ...
  MC_leptons_conversion_XY =
    new TH2D("MC_leptons_conversion_XY",
             "Start vertices of leptons coming from #gamma; x[cm]; y[cm]",
             1200,
             -300,
             300,
             880,
  ...
  MC_leptons_conversion_XZ =
    new TH2D("MC_leptons_conversion_XZ",
             "Start vertices of leptons coming from #gamma; x[cm]; z[cm]",
             1200,
             -300,
             300,
             800,
  ...
  MC_leptons_from_pi0_start_vertex =
    new TH2D("MC_leptons_from_pi0_start_vertex",
             "Start vertices of leptons coming from #pi^{0}; z[cm]; y[cm]",
             200,
             -1,
             100,
             200,
  ...
  MC_leptons_from_pi0_P = new TH1D("MC_leptons_from_pi0_P",
                                   "MC_leptons_from_pi0_P; P_{e} in GeV/c",
                                   200,
                                   0,
                                   5);
  ...
  MC_eta_Pt = new TH1D(
    "MC_eta_Pt",
    "Monte Carlo,   #eta,   p_{t} distribution; p_{t} in GeV/c;Entries",
    200.,
    0.,
    10.);
  ...
  MC_eta_Pt_vs_rap_primary =
    new TH2D("MC_eta_Pt_vs_rap_primary",
  ...
  ForChristian_P_vs_R = new TH2D("ForChristian_P_vs_R",
                                 "ForChristian_P_vs_R; P [GeV]; R [cm]; Nof",
                                 100,
                                 0,
                                 10,
                                 100,
  ...
  AllPoints2D = new TH2D("AllPoints2D",
                         "AllPoints2D; X [cm]; Y [cm]; Nof",
                         300,
                         -150,
                         150,
                         120,
  ...
  AllPoints3D = new TH3D("AllPoints3D",
                         "AllPoints3D; X [cm]; Y [cm]; Z [cm]",
                         300,
                         -150,
                         150,
                         120,
  ...
  MC_PdgCodes = new TH1D(
    "MC_PdgCodes", "All PdgCodes from Monte Carlo; PDG code", 3500, 0, 3500);
  fHistoList.push_back(MC_PdgCodes);

  BoA_electrons = new TProfile2D("BoA_electrons",
                                 "B/A for electrons; X [cm]; Y [cm]",
                                 60,
                                 -150,
                                 150,
                                 20,
  ...
  A_1d_electrons =
    new TH1D("A_1d_electrons", "A for electrons; A [cm]", 200, 3., 7.);
  fHistoList.push_back(A_1d_electrons);

  B_1d_electrons =
    new TH1D("B_1d_electrons", "B for electrons; B [cm]", 200, 3., 7.);
  fHistoList.push_back(B_1d_electrons);

  BoA_1d_electrons =
    new TH1D("BoA_1d_electrons", "BoA for electrons; B/A", 250, 0.5, 1.);
  fHistoList.push_back(BoA_1d_electrons);

  Tracks_electrons =
    new TH1D("Tracks_electrons", "Electron tracks in STS", 3, -0.5, 2.5);
  fHistoList.push_back(Tracks_electrons);

  Rings_electrons =
    new TH1D("Rings_electrons", "Electron tracks in STS+RICH", 3, -0.5, 2.5);
  fHistoList.push_back(Rings_electrons);

  A_electrons = new TProfile2D("A_electrons",
                               "A for electrons; X [cm]; Y [cm]",
                               60,
                               -150,
                               150,
                               20,
  ...
  B_electrons = new TProfile2D("B_electrons",
                               "B for electrons; X [cm]; Y [cm]",
                               60,
                               -150,
                               150,
                               20,
  ...
  NumberOfRings_electrons =
    new TH2D("NumberOfRings_electrons",
  ...
  AllHits_electrons =
    new TH2D("AllHits_electrons",
             "Hits from electrons after unfolding; X [cm]; Y [cm]; Nof",
             300,
             -150,
             150,
             120,
  ...
  dR_electrons =
    new TH1D("dR_electrons", "dR for electrons; dR [cm]", 100, -2., 2.);
  fHistoList.push_back(dR_electrons);

  dR2d_electrons = new TProfile2D("dR2d_electrons",
                                  "dR for electrons; X [cm]; Y [cm]",
                                  60,
                                  -150,
                                  150,
                                  20,
  ...
  Distance_electron =
    new TProfile2D("Distance_electron",
  ...
  Distance_positron =
    new TProfile2D("Distance_positron",
                   "Distance between projected track and center of the ring "
  ...
  fhBoverAXYZ = new TH3D("fhBoverAXYZ",
  ...
  fhBaxisXYZ = new TH3D("fhBaxisXYZ",
                        "fhBaxisXYZ; X [cm]; Y [cm]; B [cm]",
                        60,
                        -150,
                        150,
                        20,
  ...
  fhAaxisXYZ = new TH3D("fhAaxisXYZ",
                        "fhAaxisXYZ; X [cm]; Y [cm]; A [cm]",
                        60,
                        -150,
                        150,
                        20,
  ...
  Test_rings =
    new TH2D("Test_rings", "Test_rings", 60, -150, 150, 20, 120, 220);
  fHistoList.push_back(Test_rings);

  AllPointsPerPMT = new TH2D("AllPointsPerPMT",
                             "AllPointsPerPMT; X [cm]; Y [cm]; Nof",
                             41,
                             -105,
                             105,
                             17,
  ...
  AllPointsPerPixel = new TH2D("AllPointsPerPixel",
                               "AllPointsPerPixel; X [cm]; Y [cm]; Nof",
                               350,
                               -105,
                               105,
                               142,
  ...
  AllHitsPerPMT = new TH2D("AllHitsPerPMT",
                           "AllHitsPerPMT; X [cm]; Y [cm]; Nof",
                           41,
                           -105,
                           105,
                           17,
  ...
  AllHitsPerPixel = new TH2D("AllHitsPerPixel",
                             "AllHitsPerPixel; X [cm]; Y [cm]; Nof",
                             350,
                             -105,
                             105,
                             142,
  ...
  AllHits2D = new TH2D("AllHits2D",
                       "AllHits2D; X [cm]; Y [cm]; Nof",
                       300,
                       -150,
                       150,
                       120,
  ...
  AllHits3D = new TH3D("AllHits3D",
                       "AllHits3D; X [cm]; Y [cm]; Z [cm]",
                       300,
                       -150.,
                       150,
                       120,
  ...
  temporarygraph = new TH2D("temporarygraph",
                            "temporarygraph; X [cm]; Y [cm]; Nof",
                            41,
                            -105,
                            105,
                            17,
  ...
  HitsPerPmtFullPlane =
    new TH1D("HitsPerPmtFullPlane",
             "Number of hits per PMT. Distribution for all PMTs; Nof photons",
             50,
             -0.5,
             49.5);
  fHistoList.push_back(HitsPerPmtFullPlane);
  HitsPerPmtFullMiddle =
    new TH1D("HitsPerPmtFullMiddle",
