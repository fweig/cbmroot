...
class CbmKresConversionManualmbias2
{
...
public:
  ...
  void FindPi0(TString mod, TString position, vector< vector<TVector3> > Gammas, vector< vector<int> > StsIndex, vector< vector<CbmMCTrack*> > GammasMC, 
...
private:
  ...
  // charged tracks from the Target_mbias2  
  ...
  // EMT Target_mbias2 Target_mbias2
  ...
  // EMT Target_mbias2 Outside_mbias2
  ...
  // combined gammas from the Target_mbias2
  ...
  // combined gammas from Outside_mbias2
  ...
  // combined gammas from the Target_mbias2 and Outside_mbias2 together
  ...
  // histograms
  ///////   histograms to check Cuts => Both_mbias2
  ...
  ///////   histograms to check Cuts => Target_mbias2
  ...
  ///////   histograms to check Cuts => Outside_mbias2
  ...
  // Both_mbias2 additional histograms
  ...
  CbmKresConversionManualmbias2(const CbmKresConversionManualmbias2&);

  //***** brief Assignment operator.
  CbmKresConversionManualmbias2 operator=(const CbmKresConversionManualmbias2&);


  ClassDef(CbmKresConversionManualmbias2,2)
};
