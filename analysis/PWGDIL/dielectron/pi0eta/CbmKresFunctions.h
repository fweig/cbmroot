...
public:
  ...
  static TVector3
  FitToVertex(CbmStsTrack* stsTrack, double x, double y, double z) {
  ...
  static double
  ChiToVertex(CbmStsTrack* stsTrack, double x, double y, double z) {
    CbmVertex* vtx      = new CbmVertex();
    TMatrixFSym* covMat = new TMatrixFSym(3);
    vtx->SetVertex(x, y, z, 0, 0, 0, *covMat);
    CbmStsKFTrackFitter fitter;
  ...
  static TVector3 FitToVertexAndGetChi(CbmStsTrack* stsTrack,
                                       double x,
                                       double y,
                                       double z,
                                       double& chi) {
  ...
  static double Invmass_2particles_MC(const CbmMCTrack* mctrack1,
  ...
  static double Invmass_2particles_RECO(const TVector3 part1,
  ...
  static double Invmass_4particles_MC(const CbmMCTrack* mctrack1,
                                      const CbmMCTrack* mctrack2,
  ...
  static double Invmass_4particles_RECO(const TVector3 part1,
                                        const TVector3 part2,
  ...
  CalculateKinematicParamsReco(const TVector3 electron1,
  ...
  static Double_t CalculateOpeningAngle_Reco(TVector3 electron1,
                                             TVector3 electron2) {
    Double_t energyP = TMath::Sqrt(electron1.Mag2() + M2E);
    TLorentzVector lorVecP(electron1, energyP);
  ...
  static Double_t CalculateOpeningAngle_MC(CbmMCTrack* mctrack1,
                                           CbmMCTrack* mctrack2) {
    TVector3 electron1;
  ...
  static Double_t CalculateOpeningAngleBetweenGammas_Reco(TVector3 electron1,
                                                          TVector3 electron2,
                                                          TVector3 electron3,
                                                          TVector3 electron4) {
  ...
  static double Invmass_2el_2pions_RECO(const TVector3 part1El,
  ...
  static double Invmass_6particles_MC(const CbmMCTrack* mctrack1,
                                      const CbmMCTrack* mctrack2,
                                      const CbmMCTrack* mctrack3,
                                      const CbmMCTrack* mctrack4,
  ...
  static double Invmass_4el_2pions_RECO(const TVector3 part1El,
                                        const TVector3 part2El,
  ...
  static Double_t CalculateOpeningAngleBetweenPions_Reco(TVector3 electron1,
                                                         TVector3 electron2) {
  ...
  static Double_t CalculateOpeningAngleBetweenPions_MC(CbmMCTrack* mctrack1,
                                                       CbmMCTrack* mctrack2) {
    TVector3 electron1;
    mctrack1->GetMomentum(electron1);
    Double_t energyP = TMath::Sqrt(electron1.Mag2() + M2Pion);
  ...
  static CbmLmvmKinematicParams
  CalculateKinematicParams_2el_2pions(const TVector3 part1,
                                      const TVector3 part2,
                                      const TVector3 part3,
                                      const TVector3 part4) {
    CbmLmvmKinematicParams params;
