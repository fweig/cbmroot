...
void CbmKresConversionPhotons::Init() {
  ...
  if (nullptr == ioman) {
    Fatal("CbmKresConversionPhotons::Init", "RootManager not instantised!");
  }

  fMcTracks = (TClonesArray*) ioman->GetObject("MCTrack");
  if (nullptr == fMcTracks) {
    Fatal("CbmKresConversionPhotons::Init", "No MCTrack array!");
  }
  ...
  if (nullptr == fPrimVertex) {
    LOG(fatal) << "CbmKresConversionPhotons::Init  No PrimaryVertex array!";
  }

  fGlobalTracks = (TClonesArray*) ioman->GetObject("GlobalTrack");
  if (nullptr == fGlobalTracks) {
    Fatal("CbmKresConversionPhotons::Init", "No GlobalTrack array!");
  }

  fStsTracks = (TClonesArray*) ioman->GetObject("StsTrack");
  if (nullptr == fStsTracks) {
    Fatal("CbmKresConversionPhotons::Init", "No StsTrack array!");
  }

  fStsTrackMatches = (TClonesArray*) ioman->GetObject("StsTrackMatch");
  if (nullptr == fStsTrackMatches) {
    Fatal("CbmKresConversionPhotons::Init", "No StsTrackMatch array!");
  }

  fRichProjections = (TClonesArray*) ioman->GetObject("RichProjection");
  if (nullptr == fRichProjections) {
    Fatal("CbmKresConversionPhotons::Init", "No RichProjection array!");
  }

  fRichRings = (TClonesArray*) ioman->GetObject("RichRing");
  if (nullptr == fRichRings) {
    Fatal("CbmKresConversionPhotons::Init", "No RichRing array!");
  }

  fRichRingMatches = (TClonesArray*) ioman->GetObject("RichRingMatch");
  if (nullptr == fRichRingMatches) {
    Fatal("CbmKresConversionPhotons::Init", "No RichRingMatch array!");
  }

  fRichHits = (TClonesArray*) ioman->GetObject("RichHit");
  if (nullptr == fRichHits) {
    Fatal("CbmKresConversionPhotons::Init", "No RichHit array!");
  }

  fArrayMvdHit = (TClonesArray*) ioman->GetObject("MvdHit");
  if (nullptr == fArrayMvdHit) {
    Fatal("CbmKresConversionPhotons::Init", "No MvdHit array!");
  }

  fArrayStsHit = (TClonesArray*) ioman->GetObject("StsHit");
  if (nullptr == fArrayStsHit) {
    Fatal("CbmKresConversionPhotons::Init", "No StsHit array!");
  }
...
void CbmKresConversionPhotons::Exec(int fEventNumDP,
  ...
  for (Int_t i = 0; i < ngTracks; i++) {
    ...
    if (richInd > -1) {
      ...
      Pdg_vs_Distance_for_dp->Fill(TMath::Abs(mcTrack->GetPdgCode()),
                                   CbmRichUtil::GetRingTrackDistance(i));
      if (TMath::Abs(mcTrack->GetPdgCode()) == 11)
        P_vs_Distance_for_dp->Fill(mcTrack->GetP(),
                                   CbmRichUtil::GetRingTrackDistance(i));
    }
...
void CbmKresConversionPhotons::SaveOutsideTracks(CbmMCTrack* mcTrack1,
...
void CbmKresConversionPhotons::SaveTargetTracks(CbmMCTrack* mcTrack1,
                                                CbmStsTrack* stsTrack,
                                                TVector3 refmom,
                                                double charge,
                                                int stsInd,
...
void CbmKresConversionPhotons::FindGammasTarget(
  int EventNumMan,
  double AngleCut,
  double InvMassCut,
  int RealPID,
      ...
      if (richcheck == 2) {
        ...
        if (fromCombinatorial == 1) {
          ...
          if (part1MC->GetMotherId() != -1) {
            CbmMCTrack* mama1 =
              (CbmMCTrack*) fMcTracks->At(part1MC->GetMotherId());
            CombinatorialMotherPdg_two_Target->Fill(
              TMath::Abs(mama1->GetPdgCode()));
            if (mama1->GetMotherId() != -1) {
              CbmMCTrack* grmama1 =
                (CbmMCTrack*) fMcTracks->At(mama1->GetMotherId());
              CombinatorialGrMotherPdg_two_Target->Fill(
                TMath::Abs(grmama1->GetPdgCode()));
            } else {
          ...
          if (part2MC->GetMotherId() != -1) {
            CbmMCTrack* mama2 =
              (CbmMCTrack*) fMcTracks->At(part2MC->GetMotherId());
            CombinatorialMotherPdg_two_Target->Fill(
              TMath::Abs(mama2->GetPdgCode()));
            if (mama2->GetMotherId() != -1) {
              CbmMCTrack* grmama2 =
                (CbmMCTrack*) fMcTracks->At(mama2->GetMotherId());
              CombinatorialGrMotherPdg_two_Target->Fill(
                TMath::Abs(grmama2->GetPdgCode()));
            } else {
              CombinatorialGrMotherPdg_two_Target->Fill(-1);
            }
          } else {
          ...
          if (TMath::Abs(part1MC->GetPdgCode()) == 11
              && TMath::Abs(part2MC->GetPdgCode()) == 11) {
            Electrons_two_Target->Fill(params.fPt);
          } else if (TMath::Abs(part1MC->GetPdgCode()) == 211
                     && TMath::Abs(part2MC->GetPdgCode()) == 211) {
            Pions_two_Target->Fill(params.fPt);
          } else if ((TMath::Abs(part1MC->GetPdgCode()) == 211
                      && TMath::Abs(part2MC->GetPdgCode()) == 11)
                     || (TMath::Abs(part1MC->GetPdgCode()) == 11
                         && TMath::Abs(part2MC->GetPdgCode()) == 211)) {
          ...
          if (TMath::Abs(part1MC->GetPdgCode()) == 11
            ...
            if (
              (mama1PDG == 22 && mama2PDG == 111
               && mama1->GetMotherId() == part2MC->GetMotherId())
            ...
            if (
              mama1PDG == 22 && mama2PDG == 22
              && mama1->GetMotherId() == mama2->GetMotherId()
              && part1MC->GetMotherId()
                   != part2MC
          ...
          fromCombinatorial_PDG_two_Target->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          fromCombinatorial_PDG_two_Target->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          if (TMath::Abs(part1MC->GetPdgCode() == 11)) {
      ...
      if (richcheck == 1 || richcheck == 2) {
        ...
        if (fromCombinatorial == 1) {
          ...
          if (part1MC->GetMotherId() != -1) {
            CbmMCTrack* mama1 =
              (CbmMCTrack*) fMcTracks->At(part1MC->GetMotherId());
            CombinatorialMotherPdg_onetwo_Target->Fill(
              TMath::Abs(mama1->GetPdgCode()));
            if (mama1->GetMotherId() != -1) {
              CbmMCTrack* grmama1 =
                (CbmMCTrack*) fMcTracks->At(mama1->GetMotherId());
              CombinatorialGrMotherPdg_onetwo_Target->Fill(
                TMath::Abs(grmama1->GetPdgCode()));
            } else {
          ...
          fromCombinatorial_PDG_onetwo_Target->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          fromCombinatorial_PDG_onetwo_Target->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          if (TMath::Abs(part1MC->GetPdgCode() == 11)) {
        ...
        if (twoFromTarget == 1) {
          ...
          twoFromTarget_PDG_onetwo_Target->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          twoFromTarget_PDG_onetwo_Target->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
      ...
      if (richcheck == 2) {
        ...
        if (fromCombinatorial == 1) {
          ...
          if (part1MC->GetMotherId() != -1) {
            CbmMCTrack* mama1 =
              (CbmMCTrack*) fMcTracks->At(part1MC->GetMotherId());
            CombinatorialMotherPdg_two_Outside->Fill(
              TMath::Abs(mama1->GetPdgCode()));
            if (mama1->GetMotherId() != -1) {
              CbmMCTrack* grmama1 =
                (CbmMCTrack*) fMcTracks->At(mama1->GetMotherId());
              CombinatorialGrMotherPdg_two_Outside->Fill(
                TMath::Abs(grmama1->GetPdgCode()));
            } else {
          ...
          Ph_fromCombinatorial_Pt_reco_two_Both->Fill(params.fPt);
          fromCombinatorial_PDG_two_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          fromCombinatorial_PDG_two_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          if (TMath::Abs(part1MC->GetPdgCode() == 11)) {
        ...
        if (twoFromTarget == 1) {
          ...
          Ph_twoFromTarget_Pt_reco_two_Both->Fill(params.fPt);
          twoFromTarget_PDG_two_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          twoFromTarget_PDG_two_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
      ...
      if (richcheck == 1 || richcheck == 2) {
        ...
        if (fromCombinatorial == 1) {
          ...
          if (part1MC->GetMotherId() != -1) {
            CbmMCTrack* mama1 =
              (CbmMCTrack*) fMcTracks->At(part1MC->GetMotherId());
            CombinatorialMotherPdg_onetwo_Outside->Fill(
              TMath::Abs(mama1->GetPdgCode()));
            if (mama1->GetMotherId() != -1) {
              CbmMCTrack* grmama1 =
                (CbmMCTrack*) fMcTracks->At(mama1->GetMotherId());
              CombinatorialGrMotherPdg_onetwo_Outside->Fill(
                TMath::Abs(grmama1->GetPdgCode()));
            } else {
          ...
          Ph_fromCombinatorial_Pt_reco_onetwo_Both->Fill(params.fPt);
          fromCombinatorial_PDG_onetwo_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          fromCombinatorial_PDG_onetwo_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          if (TMath::Abs(part1MC->GetPdgCode() == 11)) {
        ...
        if (twoFromTarget == 1) {
          ...
          Ph_twoFromTarget_Pt_reco_onetwo_Both->Fill(params.fPt);
          twoFromTarget_PDG_onetwo_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
          twoFromTarget_PDG_onetwo_Outside->Fill(
            TMath::Abs(part1MC->GetPdgCode()));
...
int CbmKresConversionPhotons::CheckIfElectron(CbmRichRing* ring,
                                              double momentum) {
  int identified = 0;
...
std::vector<TVector3>
CbmKresConversionPhotons::SaveAllHits(CbmStsTrack* track) {
...
double CbmKresConversionPhotons::CalculatePlaneAngle_last_fromHits(
...
double CbmKresConversionPhotons::CalculatePlaneAngle_last(CbmStsTrack* Sts_1,
                                                          CbmStsTrack* Sts_2) {
  double FinalAngle = 400;
...
double CbmKresConversionPhotons::CalculatePlaneAngle_first(CbmStsTrack* Sts_1,
                                                           CbmStsTrack* Sts_2) {
  double FinalAngle = 400;
  Int_t hits1sts    = Sts_1->GetNofStsHits();
  Int_t hits2sts    = Sts_2->GetNofStsHits();
...
void CbmKresConversionPhotons::DP_likesign_Mixing_Target(double AngleCut,
                                                         double InvMassCut)
// mix particles with the same charge TARGET
{
  ...
  for (int a = 0; a < nof_minus - 1; a++) {
    for (int b = a + 1; b < nof_minus; b++) {
      if (DP_LK_EMT_STS_minus_index_Target[a]
          == DP_LK_EMT_STS_minus_index_Target[b])
        continue;
      ...
      int rings_amount =
        DP_LK_EMT_NofRings_minus_Target[a] + DP_LK_EMT_NofRings_minus_Target[b];
      ...
      if ((rings_amount == 1 || rings_amount == 2))
        DP_LK_EMT_Pt_onetwo_Target->Fill(params.fPt);
    }
  }
  ...
  for (int a = 0; a < nof_plus - 1; a++) {
    for (int b = a + 1; b < nof_plus; b++) {
      if (DP_LK_EMT_STS_plus_index_Target[a]
          == DP_LK_EMT_STS_plus_index_Target[b])
        continue;
      ...
      int rings_amount =
        DP_LK_EMT_NofRings_plus_Target[a] + DP_LK_EMT_NofRings_plus_Target[b];
...
void CbmKresConversionPhotons::DP_likesign_Mixing_Outside(double AngleCut,
                                                          double InvMassCut)
// mix particles with the same charge OUTSIDE
{
  ...
  for (int a = 0; a < nof_minus - 1; a++) {
    for (int b = a + 1; b < nof_minus; b++) {
      if (DP_LK_EMT_STS_minus_index_Outside[a]
          == DP_LK_EMT_STS_minus_index_Outside[b])
        continue;
      ...
      int rings_amount = DP_LK_EMT_NofRings_minus_Outside[a]
                         + DP_LK_EMT_NofRings_minus_Outside[b];
      ...
      if ((rings_amount == 1 || rings_amount == 2))
        DP_LK_EMT_neg_Pt_onetwo_Outside->Fill(params.fPt);
      ...
      if ((rings_amount == 1 || rings_amount == 2))
        DP_LK_EMT_Pt_onetwo_Outside->Fill(params.fPt);
    }
  }
  ...
  for (int a = 0; a < nof_plus - 1; a++) {
    for (int b = a + 1; b < nof_plus; b++) {
      if (DP_LK_EMT_STS_plus_index_Outside[a]
          == DP_LK_EMT_STS_plus_index_Outside[b])
        continue;
      ...
      int rings_amount =
        DP_LK_EMT_NofRings_plus_Outside[a] + DP_LK_EMT_NofRings_plus_Outside[b];
      ...
      if ((rings_amount == 1 || rings_amount == 2))
        DP_LK_EMT_pos_Pt_onetwo_Outside->Fill(params.fPt);
      DP_LK_EMT_Pt_all_Outside->Fill(params.fPt);
      if (rings_amount == 0) DP_LK_EMT_Pt_zero_Outside->Fill(params.fPt);
      if (rings_amount == 1) DP_LK_EMT_Pt_one_Outside->Fill(params.fPt);
      if (rings_amount == 2) DP_LK_EMT_Pt_two_Outside->Fill(params.fPt);
...
void CbmKresConversionPhotons::DP_Mixing_Target(double AngleCut,
                                                double InvMassCut)
// TARGET
{
  int nof_Target = DP_EMT_Event_minus_Target.size();
  cout << "Mixing for direct photons in Target - nof entries " << nof_Target
       << endl;
  ...
  for (size_t a = 0; a < DP_EMT_Event_minus_Target.size(); a++) {
    for (size_t b = 0; b < DP_EMT_Event_plus_Target.size(); b++) {
      ...
      CbmLmvmKinematicParams params =
        CbmKresFunctions::CalculateKinematicParamsReco(e1, e2);
      int rings_amount =
        DP_EMT_NofRings_minus_Target[a] + DP_EMT_NofRings_plus_Target[b];
...
void CbmKresConversionPhotons::DP_Mixing_Outside(double AngleCut,
                                                 double InvMassCut)
// OUTSIDE
{
  int nof_Outside = DP_EMT_Event_minus_Outside.size();
  cout << "Mixing for direct photons in Outside - nof entries " << nof_Outside
       << endl;
  ...
  for (size_t a = 0; a < DP_EMT_Event_minus_Outside.size(); a++) {
    for (size_t b = 0; b < DP_EMT_Event_plus_Outside.size(); b++) {
      ...
      CbmLmvmKinematicParams params =
        CbmKresFunctions::CalculateKinematicParamsReco(e1, e2);
      int rings_amount =
        DP_EMT_NofRings_minus_Outside[a] + DP_EMT_NofRings_plus_Outside[b];
...
void CbmKresConversionPhotons::InitHistograms() {
  // Target
  Mother_PDG_Target =
    new TH1D("Mother_PDG_Target", "Mother_PDG_Target; Id;#", 1000, -10, 490);
  fHistoList_dp_Target.push_back(Mother_PDG_Target);
  GrandMother_PDG_Target = new TH1D(
    "GrandMother_PDG_Target", "GrandMother_PDG_Target; Id;#", 1000, -10, 490);
  fHistoList_dp_Target.push_back(GrandMother_PDG_Target);

  // Outside
  Mother_PDG_Outside =
    new TH1D("Mother_PDG_Outside", "Mother_PDG_Outside; Id;#", 1000, -10, 490);
  fHistoList_dp_Outside.push_back(Mother_PDG_Outside);
  GrandMother_PDG_Outside = new TH1D(
    "GrandMother_PDG_Outside", "GrandMother_PDG_Outside; Id;#", 1000, -10, 490);
  fHistoList_dp_Outside.push_back(GrandMother_PDG_Outside);

  // Both
  Pdg_vs_Distance_for_dp =
    new TH2D("Pdg_vs_Distance_for_dp",
             "Pdg_vs_Distance_for_dp; pdg; distance in cm",
             2500,
             0,
             2499,
             500,
  ...
  DP_AnnTruePairs = new TH1D(
    "DP_AnnTruePairs", "DP_AnnTruePairs; Ann value ;#", 100, -1.2, 1.2);
  fHistoList_dp_Both.push_back(DP_AnnTruePairs);
  DP_AnnFalsePairs = new TH1D(
    "DP_AnnFalsePairs", "DP_AnnFalsePairs; Ann value ;#", 100, -1.2, 1.2);
  fHistoList_dp_Both.push_back(DP_AnnFalsePairs);
  DP_AnnTruePairs_AfterCuts =
    new TH1D("DP_AnnTruePairs_AfterCuts",
             "DP_AnnTruePairs_AfterCuts; Ann value ;#",
             100,
             -1.2,
             1.2);
  fHistoList_dp_Both.push_back(DP_AnnTruePairs_AfterCuts);
  DP_AnnFalsePairs_AfterCuts =
    new TH1D("DP_AnnFalsePairs_AfterCuts",
             "DP_AnnFalsePairs_AfterCuts; Ann value ;#",
             100,
             -1.2,
             1.2);
  ...
  DP_candidates_InvMass_vs_OA_Both =
    new TH2D("DP_candidates_InvMass_vs_OA_Both",
  ...
  DP_candidates_InvMass_Both =
    new TH1D("DP_candidates_InvMass_Both",
             "DP_candidates_InvMass_Both; invariant mass in GeV/c^{2};#",
             510,
             -0.01,
             0.5);
  fHistoList_dp_cuts_Both.push_back(DP_candidates_InvMass_Both);
  DP_InvMass_Both = new TH1D("DP_InvMass_Both",
                             "DP_InvMass_Both; invariant mass in GeV/c^{2};#",
                             510,
                             -0.01,
                             0.5);
  fHistoList_dp_cuts_Both.push_back(DP_InvMass_Both);
  DP_candidates_OA_Both =
    new TH1D("DP_candidates_OA_Both",
             "DP_candidates_OA_Both; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_dp_cuts_Both.push_back(DP_candidates_OA_Both);
  DP_OA_Both = new TH1D(
    "DP_OA_Both", "DP_OA_Both; opening angle in degree;#", 300, -0.1, 29.9);
  fHistoList_dp_cuts_Both.push_back(DP_OA_Both);
  DP_candidates_PlaneAngles_last_Both =
    new TH1D("DP_candidates_PlaneAngles_last_Both",
  ...
  DP_PlaneAngles_last_Both =
    new TH1D("DP_PlaneAngles_last_Both",
             "DP_PlaneAngles_last_Both; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_dp_cuts_Both.push_back(DP_PlaneAngles_last_Both);
  DP_candidates_PlaneAngles_first_Both =
    new TH1D("DP_candidates_PlaneAngles_first_Both",
  ...
  DP_PlaneAngles_first_Both =
    new TH1D("DP_PlaneAngles_first_Both",
             "DP_PlaneAngles_first_Both; #theta angle in degree;#",
             720,
             -1.,
             179.);
  ...
  DP_candidates_InvMass_vs_OA_Target =
    new TH2D("DP_candidates_InvMass_vs_OA_Target",
  ...
  DP_candidates_InvMass_Target =
    new TH1D("DP_candidates_InvMass_Target",
             "DP_candidates_InvMass_Target; invariant mass in GeV/c^{2};#",
             510,
             -0.01,
             0.5);
  fHistoList_dp_cuts_Target.push_back(DP_candidates_InvMass_Target);
  DP_InvMass_Target =
    new TH1D("DP_InvMass_Target",
             "DP_InvMass_Target; invariant mass in GeV/c^{2};#",
             510,
             -0.01,
             0.5);
  fHistoList_dp_cuts_Target.push_back(DP_InvMass_Target);
  DP_candidates_OA_Target =
    new TH1D("DP_candidates_OA_Target",
             "DP_candidates_OA_Target; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_dp_cuts_Target.push_back(DP_candidates_OA_Target);
  DP_OA_Target = new TH1D(
    "DP_OA_Target", "DP_OA_Target; opening angle in degree;#", 300, -0.1, 29.9);
  fHistoList_dp_cuts_Target.push_back(DP_OA_Target);
  DP_candidates_PlaneAngles_last_Target =
    new TH1D("DP_candidates_PlaneAngles_last_Target",
  ...
  DP_PlaneAngles_last_Target =
    new TH1D("DP_PlaneAngles_last_Target",
             "DP_PlaneAngles_last_Target; #theta angle in degree;#",
             720,
             -1.,
             179.);
  ...
  DP_candidates_PlaneAngles_first_Target =
    new TH1D("DP_candidates_PlaneAngles_first_Target",
             "DP_candidates_PlaneAngles_first_Target; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_dp_cuts_Target.push_back(DP_candidates_PlaneAngles_first_Target);
  DP_PlaneAngles_first_Target =
    new TH1D("DP_PlaneAngles_first_Target",
             "DP_PlaneAngles_first_Target; #theta angle in degree;#",
             720,
             -1.,
             179.);
  ...
  DP_candidates_InvMass_vs_OA_Outside =
    new TH2D("DP_candidates_InvMass_vs_OA_Outside",
  ...
  DP_InvMass_vs_OA_Outside =
    new TH2D("DP_InvMass_vs_OA_Outside",
  ...
  DP_candidates_InvMass_Outside =
    new TH1D("DP_candidates_InvMass_Outside",
             "DP_candidates_InvMass_Outside; invariant mass in GeV/c^{2};#",
             510,
             -0.01,
             0.5);
  fHistoList_dp_cuts_Outside.push_back(DP_candidates_InvMass_Outside);
  DP_InvMass_Outside =
    new TH1D("DP_InvMass_Outside",
             "DP_InvMass_Outside; invariant mass in GeV/c^{2};#",
             510,
             -0.01,
             0.5);
  fHistoList_dp_cuts_Outside.push_back(DP_InvMass_Outside);
  DP_candidates_OA_Outside =
    new TH1D("DP_candidates_OA_Outside",
             "DP_candidates_OA_Outside; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_dp_cuts_Outside.push_back(DP_candidates_OA_Outside);
  DP_OA_Outside = new TH1D("DP_OA_Outside",
                           "DP_OA_Outside; opening angle in degree;#",
                           300,
                           -0.1,
                           29.9);
  ...
  DP_candidates_PlaneAngles_last_Outside =
    new TH1D("DP_candidates_PlaneAngles_last_Outside",
             "DP_candidates_PlaneAngles_last_Outside; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_dp_cuts_Outside.push_back(DP_candidates_PlaneAngles_last_Outside);
  DP_PlaneAngles_last_Outside =
    new TH1D("DP_PlaneAngles_last_Outside",
             "DP_PlaneAngles_last_Outside; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_dp_cuts_Outside.push_back(DP_PlaneAngles_last_Outside);
  DP_candidates_PlaneAngles_first_Outside = new TH1D(
    "DP_candidates_PlaneAngles_first_Outside",
    "DP_candidates_PlaneAngles_first_Outside; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_dp_cuts_Outside.push_back(DP_candidates_PlaneAngles_first_Outside);
  DP_PlaneAngles_first_Outside =
    new TH1D("DP_PlaneAngles_first_Outside",
             "DP_PlaneAngles_first_Outside; #theta angle in degree;#",
             720,
             -1.,
             179.);
  ...
  DP_InvMassReco_all_Target =
    new TH1D("DP_InvMassReco_all_Target",
             "DP_InvMassReco_all_Target; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_all_Target.push_back(DP_InvMassReco_all_Target);
  DP_OpeningAngleReco_all_Target =
    new TH1D("DP_OpeningAngleReco_all_Target",
             "DP_OpeningAngleReco_all_Target; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_all_Target.push_back(DP_OpeningAngleReco_all_Target);
  DP_Pdg_all_Target =
    new TH1D("DP_Pdg_all_Target", "DP_Pdg_all_Target; Id;#", 1000, -10, 490);
  fHistoList_dp_all_Target.push_back(DP_Pdg_all_Target);
  DP_P_reco_all_Target = new TH1D("DP_P_reco_all_Target",
                                  "DP_P_reco_all_Target; P in GeV/c^{2};#",
                                  200,
                                  0,
                                  10);
  fHistoList_dp_all_Target.push_back(DP_P_reco_all_Target);
  DP_Pt_reco_all_Target =
    new TH1D("DP_Pt_reco_all_Target",
             "DP_Pt_reco_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(DP_Pt_reco_all_Target);
  Ph_fromTarget_Pt_reco_all_Target =
    new TH1D("Ph_fromTarget_Pt_reco_all_Target",
             "Ph_fromTarget_Pt_reco_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(Ph_fromTarget_Pt_reco_all_Target);
  Ph_fromPions_Pt_reco_all_Target =
    new TH1D("Ph_fromPions_Pt_reco_all_Target",
             "Ph_fromPions_Pt_reco_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(Ph_fromPions_Pt_reco_all_Target);
  Ph_fromEtas_Pt_reco_all_Target =
    new TH1D("Ph_fromEtas_Pt_reco_all_Target",
             "Ph_fromEtas_Pt_reco_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(Ph_fromEtas_Pt_reco_all_Target);
  Ph_fromDalitz_Pt_reco_all_Target =
    new TH1D("Ph_fromDalitz_Pt_reco_all_Target",
             "Ph_fromDalitz_Pt_reco_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_InvMassReco_zero_Target =
    new TH1D("DP_InvMassReco_zero_Target",
             "DP_InvMassReco_zero_Target; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_zero_Target.push_back(DP_InvMassReco_zero_Target);
  DP_OpeningAngleReco_zero_Target =
    new TH1D("DP_OpeningAngleReco_zero_Target",
             "DP_OpeningAngleReco_zero_Target; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_zero_Target.push_back(DP_OpeningAngleReco_zero_Target);
  DP_Pdg_zero_Target =
    new TH1D("DP_Pdg_zero_Target", "DP_Pdg_zero_Target; Id;#", 1000, -10, 490);
  fHistoList_dp_zero_Target.push_back(DP_Pdg_zero_Target);
  DP_P_reco_zero_Target = new TH1D("DP_P_reco_zero_Target",
                                   "DP_P_reco_zero_Target; P in GeV/c^{2};#",
                                   200,
                                   0,
                                   10);
  fHistoList_dp_zero_Target.push_back(DP_P_reco_zero_Target);
  DP_Pt_reco_zero_Target =
    new TH1D("DP_Pt_reco_zero_Target",
             "DP_Pt_reco_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(DP_Pt_reco_zero_Target);
  Ph_fromTarget_Pt_reco_zero_Target =
    new TH1D("Ph_fromTarget_Pt_reco_zero_Target",
             "Ph_fromTarget_Pt_reco_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(Ph_fromTarget_Pt_reco_zero_Target);
  Ph_fromPions_Pt_reco_zero_Target =
    new TH1D("Ph_fromPions_Pt_reco_zero_Target",
             "Ph_fromPions_Pt_reco_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(Ph_fromPions_Pt_reco_zero_Target);
  Ph_fromEtas_Pt_reco_zero_Target =
    new TH1D("Ph_fromEtas_Pt_reco_zero_Target",
             "Ph_fromEtas_Pt_reco_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(Ph_fromEtas_Pt_reco_zero_Target);
  Ph_fromDalitz_Pt_reco_zero_Target =
    new TH1D("Ph_fromDalitz_Pt_reco_zero_Target",
             "Ph_fromDalitz_Pt_reco_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_InvMassReco_one_Target =
    new TH1D("DP_InvMassReco_one_Target",
             "DP_InvMassReco_one_Target; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_one_Target.push_back(DP_InvMassReco_one_Target);
  DP_OpeningAngleReco_one_Target =
    new TH1D("DP_OpeningAngleReco_one_Target",
             "DP_OpeningAngleReco_one_Target; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_one_Target.push_back(DP_OpeningAngleReco_one_Target);
  DP_Pdg_one_Target =
    new TH1D("DP_Pdg_one_Target", "DP_Pdg_one_Target; Id;#", 1000, -10, 490);
  fHistoList_dp_one_Target.push_back(DP_Pdg_one_Target);
  DP_P_reco_one_Target = new TH1D("DP_P_reco_one_Target",
                                  "DP_P_reco_one_Target; P in GeV/c^{2};#",
                                  200,
                                  0,
                                  10);
  fHistoList_dp_one_Target.push_back(DP_P_reco_one_Target);
  DP_Pt_reco_one_Target =
    new TH1D("DP_Pt_reco_one_Target",
             "DP_Pt_reco_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(DP_Pt_reco_one_Target);
  Ph_fromTarget_Pt_reco_one_Target =
    new TH1D("Ph_fromTarget_Pt_reco_one_Target",
             "Ph_fromTarget_Pt_reco_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(Ph_fromTarget_Pt_reco_one_Target);
  Ph_fromPions_Pt_reco_one_Target =
    new TH1D("Ph_fromPions_Pt_reco_one_Target",
             "Ph_fromPions_Pt_reco_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(Ph_fromPions_Pt_reco_one_Target);
  Ph_fromEtas_Pt_reco_one_Target =
    new TH1D("Ph_fromEtas_Pt_reco_one_Target",
             "Ph_fromEtas_Pt_reco_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(Ph_fromEtas_Pt_reco_one_Target);
  Ph_fromDalitz_Pt_reco_one_Target =
    new TH1D("Ph_fromDalitz_Pt_reco_one_Target",
             "Ph_fromDalitz_Pt_reco_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  Ph_fromConversion_Pt_reco_two_Target =
    new TH1D("Ph_fromConversion_Pt_reco_two_Target",
             "Ph_fromConversion_Pt_reco_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(Ph_fromConversion_Pt_reco_two_Target);

  twoFromTarget_PDG_two_Target = new TH1D("twoFromTarget_PDG_two_Target",
                                          "twoFromTarget_PDG_two_Target; Id;#",
                                          1000,
                                          -10,
                                          490);
  fHistoList_dp_two_Target.push_back(twoFromTarget_PDG_two_Target);
  fromCombinatorial_PDG_two_Target =
    new TH1D("fromCombinatorial_PDG_two_Target",
             "fromCombinatorial_PDG_two_Target; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_two_Target.push_back(fromCombinatorial_PDG_two_Target);
  CombinatorialMotherPdg_two_Target =
    new TH1D("CombinatorialMotherPdg_two_Target",
             "CombinatorialMotherPdg_two_Target; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_two_Target.push_back(CombinatorialMotherPdg_two_Target);
  CombinatorialGrMotherPdg_two_Target =
    new TH1D("CombinatorialGrMotherPdg_two_Target",
             "CombinatorialGrMotherPdg_two_Target; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_two_Target.push_back(CombinatorialGrMotherPdg_two_Target);
  Electrons_two_Target = new TH1D("Electrons_two_Target",
                                  "Electrons_two_Target; P_{t} in GeV/c^{2};#",
                                  30,
                                  0,
                                  3);
  fHistoList_dp_two_Target.push_back(Electrons_two_Target);
  Pions_two_Target = new TH1D(
    "Pions_two_Target", "Pions_two_Target; P_{t} in GeV/c^{2};#", 30, 0, 3);
  fHistoList_dp_two_Target.push_back(Pions_two_Target);
  PionElectron_two_Target =
    new TH1D("PionElectron_two_Target",
             "PionElectron_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(PionElectron_two_Target);
  elsePionOrElectron_two_Target =
    new TH1D("elsePionOrElectron_two_Target",
             "elsePionOrElectron_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(elsePionOrElectron_two_Target);
  DalitzAndConversion_Pt_two_Target =
    new TH1D("DalitzAndConversion_Pt_two_Target",
             "DalitzAndConversion_Pt_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(DalitzAndConversion_Pt_two_Target);
  DoubleConversion_Pt_two_Target =
    new TH1D("DoubleConversion_Pt_two_Target",
             "DoubleConversion_Pt_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(DoubleConversion_Pt_two_Target);
  fromFireball_P_two_Target =
    new TH1D("fromFireball_P_two_Target",
             "fromFireball_P_two_Target; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_two_Target.push_back(fromFireball_P_two_Target);
  twoFromTarget_P_two_Target =
    new TH1D("twoFromTarget_P_two_Target",
             "twoFromTarget_P_two_Target; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_two_Target.push_back(twoFromTarget_P_two_Target);
  fromCombinatorial_electron_P_two_Target =
    new TH1D("fromCombinatorial_electron_P_two_Target",
  ...
  fromCombinatorial_NOTelectron_P_two_Target =
    new TH1D("fromCombinatorial_NOTelectron_P_two_Target",
             "fromCombinatorial_NOTelectron_P_two_Target; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_two_Target.push_back(
    fromCombinatorial_NOTelectron_P_two_Target);

  // Target => onetwo
  DP_InvMassReco_onetwo_Target =
    new TH1D("DP_InvMassReco_onetwo_Target",
             "DP_InvMassReco_onetwo_Target; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_onetwo_Target.push_back(DP_InvMassReco_onetwo_Target);
  DP_OpeningAngleReco_onetwo_Target =
    new TH1D("DP_OpeningAngleReco_onetwo_Target",
             "DP_OpeningAngleReco_onetwo_Target; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_onetwo_Target.push_back(DP_OpeningAngleReco_onetwo_Target);
  DP_Pdg_onetwo_Target = new TH1D(
    "DP_Pdg_onetwo_Target", "DP_Pdg_onetwo_Target; Id;#", 1000, -10, 490);
  fHistoList_dp_onetwo_Target.push_back(DP_Pdg_onetwo_Target);
  DP_P_reco_onetwo_Target =
    new TH1D("DP_P_reco_onetwo_Target",
             "DP_P_reco_onetwo_Target; P in GeV/c^{2};#",
             200,
             0,
             10);
  fHistoList_dp_onetwo_Target.push_back(DP_P_reco_onetwo_Target);
  DP_Pt_reco_onetwo_Target =
    new TH1D("DP_Pt_reco_onetwo_Target",
             "DP_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(DP_Pt_reco_onetwo_Target);
  Ph_fromTarget_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromTarget_Pt_reco_onetwo_Target",
             "Ph_fromTarget_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(Ph_fromTarget_Pt_reco_onetwo_Target);
  Ph_fromPions_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromPions_Pt_reco_onetwo_Target",
             "Ph_fromPions_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(Ph_fromPions_Pt_reco_onetwo_Target);
  Ph_fromEtas_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromEtas_Pt_reco_onetwo_Target",
             "Ph_fromEtas_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(Ph_fromEtas_Pt_reco_onetwo_Target);
  Ph_fromXi_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromXi_Pt_reco_onetwo_Target",
             "Ph_fromXi_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(Ph_fromXi_Pt_reco_onetwo_Target);
  Ph_fromDalitz_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromDalitz_Pt_reco_onetwo_Target",
             "Ph_fromDalitz_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(Ph_fromDalitz_Pt_reco_onetwo_Target);
  Ph_fromOther_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromOther_Pt_reco_onetwo_Target",
             "Ph_fromOther_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Target.push_back(Ph_fromOther_Pt_reco_onetwo_Target);
  Ph_twoFromTarget_Pt_reco_onetwo_Target =
    new TH1D("Ph_twoFromTarget_Pt_reco_onetwo_Target",
             "Ph_twoFromTarget_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  Ph_fromCombinatorial_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromCombinatorial_Pt_reco_onetwo_Target",
             "Ph_fromCombinatorial_Pt_reco_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  Ph_fromConversion_Pt_reco_onetwo_Target =
    new TH1D("Ph_fromConversion_Pt_reco_onetwo_Target",
  ...
  fromCombinatorial_electron_P_onetwo_Target =
    new TH1D("fromCombinatorial_electron_P_onetwo_Target",
             "fromCombinatorial_electron_P_onetwo_Target; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_onetwo_Target.push_back(
    fromCombinatorial_electron_P_onetwo_Target);
  fromCombinatorial_NOTelectron_P_onetwo_Target = new TH1D(
    "fromCombinatorial_NOTelectron_P_onetwo_Target",
    "fromCombinatorial_NOTelectron_P_onetwo_Target; P_{t} in GeV/c^{2};#",
    120,
    0,
    6);
  fHistoList_dp_onetwo_Target.push_back(
  ...
  DP_InvMassReco_all_Outside =
    new TH1D("DP_InvMassReco_all_Outside",
             "DP_InvMassReco_all_Outside; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_all_Outside.push_back(DP_InvMassReco_all_Outside);
  DP_OpeningAngleReco_all_Outside =
    new TH1D("DP_OpeningAngleReco_all_Outside",
             "DP_OpeningAngleReco_all_Outside; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_all_Outside.push_back(DP_OpeningAngleReco_all_Outside);
  DP_Pdg_all_Outside =
    new TH1D("DP_Pdg_all_Outside", "DP_Pdg_all_Outside; Id;#", 1000, -10, 490);
  fHistoList_dp_all_Outside.push_back(DP_Pdg_all_Outside);
  DP_P_reco_all_Outside = new TH1D("DP_P_reco_all_Outside",
                                   "DP_P_reco_all_Outside; P in GeV/c^{2};#",
                                   200,
                                   0,
                                   10);
  fHistoList_dp_all_Outside.push_back(DP_P_reco_all_Outside);
  DP_Pt_reco_all_Outside =
    new TH1D("DP_Pt_reco_all_Outside",
             "DP_Pt_reco_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(DP_Pt_reco_all_Outside);
  Ph_fromTarget_Pt_reco_all_Outside =
    new TH1D("Ph_fromTarget_Pt_reco_all_Outside",
             "Ph_fromTarget_Pt_reco_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(Ph_fromTarget_Pt_reco_all_Outside);
  Ph_fromPions_Pt_reco_all_Outside =
    new TH1D("Ph_fromPions_Pt_reco_all_Outside",
             "Ph_fromPions_Pt_reco_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(Ph_fromPions_Pt_reco_all_Outside);
  Ph_fromEtas_Pt_reco_all_Outside =
    new TH1D("Ph_fromEtas_Pt_reco_all_Outside",
             "Ph_fromEtas_Pt_reco_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(Ph_fromEtas_Pt_reco_all_Outside);
  Ph_fromDalitz_Pt_reco_all_Outside =
    new TH1D("Ph_fromDalitz_Pt_reco_all_Outside",
             "Ph_fromDalitz_Pt_reco_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_InvMassReco_zero_Outside =
    new TH1D("DP_InvMassReco_zero_Outside",
             "DP_InvMassReco_zero_Outside; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_zero_Outside.push_back(DP_InvMassReco_zero_Outside);
  DP_OpeningAngleReco_zero_Outside =
    new TH1D("DP_OpeningAngleReco_zero_Outside",
             "DP_OpeningAngleReco_zero_Outside; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_zero_Outside.push_back(DP_OpeningAngleReco_zero_Outside);
  DP_Pdg_zero_Outside = new TH1D(
    "DP_Pdg_zero_Outside", "DP_Pdg_zero_Outside; Id;#", 1000, -10, 490);
  fHistoList_dp_zero_Outside.push_back(DP_Pdg_zero_Outside);
  DP_P_reco_zero_Outside = new TH1D("DP_P_reco_zero_Outside",
                                    "DP_P_reco_zero_Outside; P in GeV/c^{2};#",
                                    200,
                                    0,
                                    10);
  fHistoList_dp_zero_Outside.push_back(DP_P_reco_zero_Outside);
  DP_Pt_reco_zero_Outside =
    new TH1D("DP_Pt_reco_zero_Outside",
             "DP_Pt_reco_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(DP_Pt_reco_zero_Outside);
  Ph_fromTarget_Pt_reco_zero_Outside =
    new TH1D("Ph_fromTarget_Pt_reco_zero_Outside",
             "Ph_fromTarget_Pt_reco_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(Ph_fromTarget_Pt_reco_zero_Outside);
  Ph_fromPions_Pt_reco_zero_Outside =
    new TH1D("Ph_fromPions_Pt_reco_zero_Outside",
             "Ph_fromPions_Pt_reco_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(Ph_fromPions_Pt_reco_zero_Outside);
  Ph_fromEtas_Pt_reco_zero_Outside =
    new TH1D("Ph_fromEtas_Pt_reco_zero_Outside",
             "Ph_fromEtas_Pt_reco_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(Ph_fromEtas_Pt_reco_zero_Outside);
  Ph_fromDalitz_Pt_reco_zero_Outside =
    new TH1D("Ph_fromDalitz_Pt_reco_zero_Outside",
             "Ph_fromDalitz_Pt_reco_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_InvMassReco_one_Outside =
    new TH1D("DP_InvMassReco_one_Outside",
             "DP_InvMassReco_one_Outside; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_one_Outside.push_back(DP_InvMassReco_one_Outside);
  DP_OpeningAngleReco_one_Outside =
    new TH1D("DP_OpeningAngleReco_one_Outside",
             "DP_OpeningAngleReco_one_Outside; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_one_Outside.push_back(DP_OpeningAngleReco_one_Outside);
  DP_Pdg_one_Outside =
    new TH1D("DP_Pdg_one_Outside", "DP_Pdg_one_Outside; Id;#", 1000, -10, 490);
  fHistoList_dp_one_Outside.push_back(DP_Pdg_one_Outside);
  DP_P_reco_one_Outside = new TH1D("DP_P_reco_one_Outside",
                                   "DP_P_reco_one_Outside; P in GeV/c^{2};#",
                                   200,
                                   0,
                                   10);
  fHistoList_dp_one_Outside.push_back(DP_P_reco_one_Outside);
  DP_Pt_reco_one_Outside =
    new TH1D("DP_Pt_reco_one_Outside",
             "DP_Pt_reco_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(DP_Pt_reco_one_Outside);
  Ph_fromTarget_Pt_reco_one_Outside =
    new TH1D("Ph_fromTarget_Pt_reco_one_Outside",
             "Ph_fromTarget_Pt_reco_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(Ph_fromTarget_Pt_reco_one_Outside);
  Ph_fromPions_Pt_reco_one_Outside =
    new TH1D("Ph_fromPions_Pt_reco_one_Outside",
             "Ph_fromPions_Pt_reco_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(Ph_fromPions_Pt_reco_one_Outside);
  Ph_fromEtas_Pt_reco_one_Outside =
    new TH1D("Ph_fromEtas_Pt_reco_one_Outside",
             "Ph_fromEtas_Pt_reco_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(Ph_fromEtas_Pt_reco_one_Outside);
  Ph_fromDalitz_Pt_reco_one_Outside =
    new TH1D("Ph_fromDalitz_Pt_reco_one_Outside",
             "Ph_fromDalitz_Pt_reco_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_InvMassReco_two_Outside =
    new TH1D("DP_InvMassReco_two_Outside",
             "DP_InvMassReco_two_Outside; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_two_Outside.push_back(DP_InvMassReco_two_Outside);
  DP_OpeningAngleReco_two_Outside =
    new TH1D("DP_OpeningAngleReco_two_Outside",
             "DP_OpeningAngleReco_two_Outside; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_two_Outside.push_back(DP_OpeningAngleReco_two_Outside);
  DP_Pdg_two_Outside =
    new TH1D("DP_Pdg_two_Outside", "DP_Pdg_two_Outside; Id;#", 1000, -10, 490);
  fHistoList_dp_two_Outside.push_back(DP_Pdg_two_Outside);
  DP_P_reco_two_Outside = new TH1D("DP_P_reco_two_Outside",
                                   "DP_P_reco_two_Outside; P in GeV/c^{2};#",
                                   200,
                                   0,
                                   10);
  fHistoList_dp_two_Outside.push_back(DP_P_reco_two_Outside);
  DP_Pt_reco_two_Outside =
    new TH1D("DP_Pt_reco_two_Outside",
             "DP_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(DP_Pt_reco_two_Outside);
  Ph_fromTarget_Pt_reco_two_Outside =
    new TH1D("Ph_fromTarget_Pt_reco_two_Outside",
             "Ph_fromTarget_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(Ph_fromTarget_Pt_reco_two_Outside);
  Ph_fromPions_Pt_reco_two_Outside =
    new TH1D("Ph_fromPions_Pt_reco_two_Outside",
             "Ph_fromPions_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(Ph_fromPions_Pt_reco_two_Outside);
  Ph_fromEtas_Pt_reco_two_Outside =
    new TH1D("Ph_fromEtas_Pt_reco_two_Outside",
             "Ph_fromEtas_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(Ph_fromEtas_Pt_reco_two_Outside);
  Ph_fromXi_Pt_reco_two_Outside =
    new TH1D("Ph_fromXi_Pt_reco_two_Outside",
             "Ph_fromXi_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(Ph_fromXi_Pt_reco_two_Outside);
  Ph_fromDalitz_Pt_reco_two_Outside =
    new TH1D("Ph_fromDalitz_Pt_reco_two_Outside",
             "Ph_fromDalitz_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(Ph_fromDalitz_Pt_reco_two_Outside);
  Ph_fromOther_Pt_reco_two_Outside =
    new TH1D("Ph_fromOther_Pt_reco_two_Outside",
             "Ph_fromOther_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(Ph_fromOther_Pt_reco_two_Outside);
  Ph_twoFromTarget_Pt_reco_two_Outside =
    new TH1D("Ph_twoFromTarget_Pt_reco_two_Outside",
             "Ph_twoFromTarget_Pt_reco_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  fromCombinatorial_electron_P_two_Outside =
    new TH1D("fromCombinatorial_electron_P_two_Outside",
             "fromCombinatorial_electron_P_two_Outside; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_two_Outside.push_back(fromCombinatorial_electron_P_two_Outside);
  fromCombinatorial_NOTelectron_P_two_Outside = new TH1D(
    "fromCombinatorial_NOTelectron_P_two_Outside",
    "fromCombinatorial_NOTelectron_P_two_Outside; P_{t} in GeV/c^{2};#",
    120,
    0,
    6);
  ...
  fHistoList_dp_onetwo_Outside.push_back(
    Ph_twoFromTarget_Pt_reco_onetwo_Outside);
  Ph_fromCombinatorial_Pt_reco_onetwo_Outside = new TH1D(
    "Ph_fromCombinatorial_Pt_reco_onetwo_Outside",
    "Ph_fromCombinatorial_Pt_reco_onetwo_Outside; P_{t} in GeV/c^{2};#",
    30,
    0,
    3);
  fHistoList_dp_onetwo_Outside.push_back(
  ...
  Ph_fromConversion_Pt_reco_onetwo_Outside =
    new TH1D("Ph_fromConversion_Pt_reco_onetwo_Outside",
             "Ph_fromConversion_Pt_reco_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Outside.push_back(
  ...
  twoFromTarget_PDG_onetwo_Outside =
    new TH1D("twoFromTarget_PDG_onetwo_Outside",
             "twoFromTarget_PDG_onetwo_Outside; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_onetwo_Outside.push_back(twoFromTarget_PDG_onetwo_Outside);
  fromCombinatorial_PDG_onetwo_Outside =
    new TH1D("fromCombinatorial_PDG_onetwo_Outside",
             "fromCombinatorial_PDG_onetwo_Outside; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_onetwo_Outside.push_back(fromCombinatorial_PDG_onetwo_Outside);
  CombinatorialMotherPdg_onetwo_Outside =
    new TH1D("CombinatorialMotherPdg_onetwo_Outside",
             "CombinatorialMotherPdg_onetwo_Outside; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_onetwo_Outside.push_back(CombinatorialMotherPdg_onetwo_Outside);
  CombinatorialGrMotherPdg_onetwo_Outside =
    new TH1D("CombinatorialGrMotherPdg_onetwo_Outside",
             "CombinatorialGrMotherPdg_onetwo_Outside; Id;#",
             1000,
             -10,
             490);
  fHistoList_dp_onetwo_Outside.push_back(
  ...
  Electrons_onetwo_Outside =
    new TH1D("Electrons_onetwo_Outside",
             "Electrons_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Outside.push_back(Electrons_onetwo_Outside);
  Pions_onetwo_Outside = new TH1D("Pions_onetwo_Outside",
                                  "Pions_onetwo_Outside; P_{t} in GeV/c^{2};#",
                                  30,
                                  0,
                                  3);
  fHistoList_dp_onetwo_Outside.push_back(Pions_onetwo_Outside);
  PionElectron_onetwo_Outside =
    new TH1D("PionElectron_onetwo_Outside",
             "PionElectron_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Outside.push_back(PionElectron_onetwo_Outside);
  elsePionOrElectron_onetwo_Outside =
    new TH1D("elsePionOrElectron_onetwo_Outside",
             "elsePionOrElectron_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Outside.push_back(elsePionOrElectron_onetwo_Outside);
  DalitzAndConversion_Pt_onetwo_Outside =
    new TH1D("DalitzAndConversion_Pt_onetwo_Outside",
             "DalitzAndConversion_Pt_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Outside.push_back(DalitzAndConversion_Pt_onetwo_Outside);
  DoubleConversion_Pt_onetwo_Outside =
    new TH1D("DoubleConversion_Pt_onetwo_Outside",
             "DoubleConversion_Pt_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Outside.push_back(DoubleConversion_Pt_onetwo_Outside);
  fromFireball_P_onetwo_Outside =
    new TH1D("fromFireball_P_onetwo_Outside",
             "fromFireball_P_onetwo_Outside; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_onetwo_Outside.push_back(fromFireball_P_onetwo_Outside);
  twoFromTarget_P_onetwo_Outside =
    new TH1D("twoFromTarget_P_onetwo_Outside",
             "twoFromTarget_P_onetwo_Outside; P_{t} in GeV/c^{2};#",
             120,
             0,
             6);
  fHistoList_dp_onetwo_Outside.push_back(twoFromTarget_P_onetwo_Outside);
  fromCombinatorial_electron_P_onetwo_Outside = new TH1D(
    "fromCombinatorial_electron_P_onetwo_Outside",
    "fromCombinatorial_electron_P_onetwo_Outside; P_{t} in GeV/c^{2};#",
    120,
    0,
    6);
  fHistoList_dp_onetwo_Outside.push_back(
    fromCombinatorial_electron_P_onetwo_Outside);
  fromCombinatorial_NOTelectron_P_onetwo_Outside = new TH1D(
    "fromCombinatorial_NOTelectron_P_onetwo_Outside",
    "fromCombinatorial_NOTelectron_P_onetwo_Outside; P_{t} in GeV/c^{2};#",
    120,
    0,
    6);
  fHistoList_dp_onetwo_Outside.push_back(
  ...
  DP_InvMassReco_all_Both =
    new TH1D("DP_InvMassReco_all_Both",
             "DP_InvMassReco_all_Both; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_all_Both.push_back(DP_InvMassReco_all_Both);
  DP_OpeningAngleReco_all_Both =
    new TH1D("DP_OpeningAngleReco_all_Both",
             "DP_OpeningAngleReco_all_Both; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_all_Both.push_back(DP_OpeningAngleReco_all_Both);
  DP_Pdg_all_Both =
    new TH1D("DP_Pdg_all_Both", "DP_Pdg_all_Both; Id;#", 1000, -10, 490);
  fHistoList_dp_all_Both.push_back(DP_Pdg_all_Both);
  DP_P_reco_all_Both = new TH1D(
    "DP_P_reco_all_Both", "DP_P_reco_all_Both; P in GeV/c^{2};#", 200, 0, 10);
  fHistoList_dp_all_Both.push_back(DP_P_reco_all_Both);
  DP_Pt_reco_all_Both = new TH1D("DP_Pt_reco_all_Both",
                                 "DP_Pt_reco_all_Both; P_{t} in GeV/c^{2};#",
                                 30,
                                 0,
                                 3);
  fHistoList_dp_all_Both.push_back(DP_Pt_reco_all_Both);
  Ph_fromTarget_Pt_reco_all_Both =
    new TH1D("Ph_fromTarget_Pt_reco_all_Both",
             "Ph_fromTarget_Pt_reco_all_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Both.push_back(Ph_fromTarget_Pt_reco_all_Both);
  Ph_fromPions_Pt_reco_all_Both =
    new TH1D("Ph_fromPions_Pt_reco_all_Both",
             "Ph_fromPions_Pt_reco_all_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Both.push_back(Ph_fromPions_Pt_reco_all_Both);
  Ph_fromEtas_Pt_reco_all_Both =
    new TH1D("Ph_fromEtas_Pt_reco_all_Both",
             "Ph_fromEtas_Pt_reco_all_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Both.push_back(Ph_fromEtas_Pt_reco_all_Both);
  Ph_fromDalitz_Pt_reco_all_Both =
    new TH1D("Ph_fromDalitz_Pt_reco_all_Both",
             "Ph_fromDalitz_Pt_reco_all_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Both.push_back(Ph_fromDalitz_Pt_reco_all_Both);
  Ph_pt_vs_rap_est_all_Both =
    new TH2D("Ph_pt_vs_rap_est_all_Both",
             "Ph_pt_vs_rap_est_all_Both; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             40,
  ...
  DP_InvMassReco_zero_Both =
    new TH1D("DP_InvMassReco_zero_Both",
             "DP_InvMassReco_zero_Both; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_zero_Both.push_back(DP_InvMassReco_zero_Both);
  DP_OpeningAngleReco_zero_Both =
    new TH1D("DP_OpeningAngleReco_zero_Both",
             "DP_OpeningAngleReco_zero_Both; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_zero_Both.push_back(DP_OpeningAngleReco_zero_Both);
  DP_Pdg_zero_Both =
    new TH1D("DP_Pdg_zero_Both", "DP_Pdg_zero_Both; Id;#", 1000, -10, 490);
  fHistoList_dp_zero_Both.push_back(DP_Pdg_zero_Both);
  DP_P_reco_zero_Both = new TH1D(
    "DP_P_reco_zero_Both", "DP_P_reco_zero_Both; P in GeV/c^{2};#", 200, 0, 10);
  fHistoList_dp_zero_Both.push_back(DP_P_reco_zero_Both);
  DP_Pt_reco_zero_Both = new TH1D("DP_Pt_reco_zero_Both",
                                  "DP_Pt_reco_zero_Both; P_{t} in GeV/c^{2};#",
                                  30,
                                  0,
                                  3);
  fHistoList_dp_zero_Both.push_back(DP_Pt_reco_zero_Both);
  Ph_fromTarget_Pt_reco_zero_Both =
    new TH1D("Ph_fromTarget_Pt_reco_zero_Both",
             "Ph_fromTarget_Pt_reco_zero_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Both.push_back(Ph_fromTarget_Pt_reco_zero_Both);
  Ph_fromPions_Pt_reco_zero_Both =
    new TH1D("Ph_fromPions_Pt_reco_zero_Both",
             "Ph_fromPions_Pt_reco_zero_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Both.push_back(Ph_fromPions_Pt_reco_zero_Both);
  Ph_fromEtas_Pt_reco_zero_Both =
    new TH1D("Ph_fromEtas_Pt_reco_zero_Both",
             "Ph_fromEtas_Pt_reco_zero_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Both.push_back(Ph_fromEtas_Pt_reco_zero_Both);
  Ph_fromDalitz_Pt_reco_zero_Both =
    new TH1D("Ph_fromDalitz_Pt_reco_zero_Both",
             "Ph_fromDalitz_Pt_reco_zero_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Both.push_back(Ph_fromDalitz_Pt_reco_zero_Both);
  Ph_pt_vs_rap_est_zero_Both =
    new TH2D("Ph_pt_vs_rap_est_zero_Both",
             "Ph_pt_vs_rap_est_zero_Both; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             40,
  ...
  DP_InvMassReco_one_Both =
    new TH1D("DP_InvMassReco_one_Both",
             "DP_InvMassReco_one_Both; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_one_Both.push_back(DP_InvMassReco_one_Both);
  DP_OpeningAngleReco_one_Both =
    new TH1D("DP_OpeningAngleReco_one_Both",
             "DP_OpeningAngleReco_one_Both; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_one_Both.push_back(DP_OpeningAngleReco_one_Both);
  DP_Pdg_one_Both =
    new TH1D("DP_Pdg_one_Both", "DP_Pdg_one_Both; Id;#", 1000, -10, 490);
  fHistoList_dp_one_Both.push_back(DP_Pdg_one_Both);
  DP_P_reco_one_Both = new TH1D(
    "DP_P_reco_one_Both", "DP_P_reco_one_Both; P in GeV/c^{2};#", 200, 0, 10);
  fHistoList_dp_one_Both.push_back(DP_P_reco_one_Both);
  DP_Pt_reco_one_Both = new TH1D("DP_Pt_reco_one_Both",
                                 "DP_Pt_reco_one_Both; P_{t} in GeV/c^{2};#",
                                 30,
                                 0,
                                 3);
  fHistoList_dp_one_Both.push_back(DP_Pt_reco_one_Both);
  Ph_fromTarget_Pt_reco_one_Both =
    new TH1D("Ph_fromTarget_Pt_reco_one_Both",
             "Ph_fromTarget_Pt_reco_one_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Both.push_back(Ph_fromTarget_Pt_reco_one_Both);
  Ph_fromPions_Pt_reco_one_Both =
    new TH1D("Ph_fromPions_Pt_reco_one_Both",
             "Ph_fromPions_Pt_reco_one_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Both.push_back(Ph_fromPions_Pt_reco_one_Both);
  Ph_fromEtas_Pt_reco_one_Both =
    new TH1D("Ph_fromEtas_Pt_reco_one_Both",
             "Ph_fromEtas_Pt_reco_one_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Both.push_back(Ph_fromEtas_Pt_reco_one_Both);
  Ph_fromDalitz_Pt_reco_one_Both =
    new TH1D("Ph_fromDalitz_Pt_reco_one_Both",
             "Ph_fromDalitz_Pt_reco_one_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Both.push_back(Ph_fromDalitz_Pt_reco_one_Both);
  Ph_pt_vs_rap_est_one_Both =
    new TH2D("Ph_pt_vs_rap_est_one_Both",
             "Ph_pt_vs_rap_est_one_Both; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             40,
  ...
  DP_InvMassReco_two_Both =
    new TH1D("DP_InvMassReco_two_Both",
             "DP_InvMassReco_two_Both; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_two_Both.push_back(DP_InvMassReco_two_Both);
  DP_OpeningAngleReco_two_Both =
    new TH1D("DP_OpeningAngleReco_two_Both",
             "DP_OpeningAngleReco_two_Both; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_two_Both.push_back(DP_OpeningAngleReco_two_Both);
  DP_Pdg_two_Both =
    new TH1D("DP_Pdg_two_Both", "DP_Pdg_two_Both; Id;#", 1000, -10, 490);
  fHistoList_dp_two_Both.push_back(DP_Pdg_two_Both);
  DP_P_reco_two_Both = new TH1D(
    "DP_P_reco_two_Both", "DP_P_reco_two_Both; P in GeV/c^{2};#", 200, 0, 10);
  fHistoList_dp_two_Both.push_back(DP_P_reco_two_Both);
  DP_Pt_reco_two_Both = new TH1D("DP_Pt_reco_two_Both",
                                 "DP_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
                                 30,
                                 0,
                                 3);
  fHistoList_dp_two_Both.push_back(DP_Pt_reco_two_Both);
  Ph_fromTarget_Pt_reco_two_Both =
    new TH1D("Ph_fromTarget_Pt_reco_two_Both",
             "Ph_fromTarget_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_fromTarget_Pt_reco_two_Both);
  Ph_fromPions_Pt_reco_two_Both =
    new TH1D("Ph_fromPions_Pt_reco_two_Both",
             "Ph_fromPions_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_fromPions_Pt_reco_two_Both);
  Ph_fromEtas_Pt_reco_two_Both =
    new TH1D("Ph_fromEtas_Pt_reco_two_Both",
             "Ph_fromEtas_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_fromEtas_Pt_reco_two_Both);
  Ph_fromDalitz_Pt_reco_two_Both =
    new TH1D("Ph_fromDalitz_Pt_reco_two_Both",
             "Ph_fromDalitz_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_fromDalitz_Pt_reco_two_Both);
  Ph_twoFromTarget_Pt_reco_two_Both =
    new TH1D("Ph_twoFromTarget_Pt_reco_two_Both",
             "Ph_twoFromTarget_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_twoFromTarget_Pt_reco_two_Both);
  Ph_fromCombinatorial_Pt_reco_two_Both =
    new TH1D("Ph_fromCombinatorial_Pt_reco_two_Both",
             "Ph_fromCombinatorial_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_fromCombinatorial_Pt_reco_two_Both);
  Ph_fromConversion_Pt_reco_two_Both =
    new TH1D("Ph_fromConversion_Pt_reco_two_Both",
             "Ph_fromConversion_Pt_reco_two_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Both.push_back(Ph_fromConversion_Pt_reco_two_Both);
  Ph_pt_vs_rap_est_two_Both =
    new TH2D("Ph_pt_vs_rap_est_two_Both",
             "Ph_pt_vs_rap_est_two_Both; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             40,
  ...
  DP_InvMassReco_onetwo_Both =
    new TH1D("DP_InvMassReco_onetwo_Both",
             "DP_InvMassReco_onetwo_Both; invariant mass in GeV/c^{2};#",
             50,
             -0.005,
             0.045);
  fHistoList_dp_onetwo_Both.push_back(DP_InvMassReco_onetwo_Both);
  DP_OpeningAngleReco_onetwo_Both =
    new TH1D("DP_OpeningAngleReco_onetwo_Both",
             "DP_OpeningAngleReco_onetwo_Both; angle [deg];#",
             45,
             -0.5,
             4.);
  fHistoList_dp_onetwo_Both.push_back(DP_OpeningAngleReco_onetwo_Both);
  DP_Pdg_onetwo_Both =
    new TH1D("DP_Pdg_onetwo_Both", "DP_Pdg_onetwo_Both; Id;#", 1000, -10, 490);
  fHistoList_dp_onetwo_Both.push_back(DP_Pdg_onetwo_Both);
  DP_P_reco_onetwo_Both = new TH1D("DP_P_reco_onetwo_Both",
                                   "DP_P_reco_onetwo_Both; P in GeV/c^{2};#",
                                   200,
                                   0,
                                   10);
  fHistoList_dp_onetwo_Both.push_back(DP_P_reco_onetwo_Both);
  DP_Pt_reco_onetwo_Both =
    new TH1D("DP_Pt_reco_onetwo_Both",
             "DP_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(DP_Pt_reco_onetwo_Both);
  Ph_fromTarget_Pt_reco_onetwo_Both =
    new TH1D("Ph_fromTarget_Pt_reco_onetwo_Both",
             "Ph_fromTarget_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(Ph_fromTarget_Pt_reco_onetwo_Both);
  Ph_fromPions_Pt_reco_onetwo_Both =
    new TH1D("Ph_fromPions_Pt_reco_onetwo_Both",
             "Ph_fromPions_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(Ph_fromPions_Pt_reco_onetwo_Both);
  Ph_fromEtas_Pt_reco_onetwo_Both =
    new TH1D("Ph_fromEtas_Pt_reco_onetwo_Both",
             "Ph_fromEtas_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(Ph_fromEtas_Pt_reco_onetwo_Both);
  Ph_fromDalitz_Pt_reco_onetwo_Both =
    new TH1D("Ph_fromDalitz_Pt_reco_onetwo_Both",
             "Ph_fromDalitz_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(Ph_fromDalitz_Pt_reco_onetwo_Both);
  Ph_twoFromTarget_Pt_reco_onetwo_Both =
    new TH1D("Ph_twoFromTarget_Pt_reco_onetwo_Both",
             "Ph_twoFromTarget_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  Ph_fromCombinatorial_Pt_reco_onetwo_Both =
    new TH1D("Ph_fromCombinatorial_Pt_reco_onetwo_Both",
             "Ph_fromCombinatorial_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(Ph_fromCombinatorial_Pt_reco_onetwo_Both);
  Ph_fromConversion_Pt_reco_onetwo_Both =
    new TH1D("Ph_fromConversion_Pt_reco_onetwo_Both",
             "Ph_fromConversion_Pt_reco_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_onetwo_Both.push_back(Ph_fromConversion_Pt_reco_onetwo_Both);
  Ph_pt_vs_rap_est_onetwo_Both =
    new TH2D("Ph_pt_vs_rap_est_onetwo_Both",
             "Ph_pt_vs_rap_est_onetwo_Both; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             40,
  ...
  DP_EMT_Pt_all_Target = new TH1D("DP_EMT_Pt_all_Target",
                                  "DP_EMT_Pt_all_Target; P_{t} in GeV/c^{2};#",
                                  30,
                                  0,
                                  3);
  fHistoList_dp_all_Target.push_back(DP_EMT_Pt_all_Target);
  DP_EMT_Pt_zero_Target =
    new TH1D("DP_EMT_Pt_zero_Target",
             "DP_EMT_Pt_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(DP_EMT_Pt_zero_Target);
  DP_EMT_Pt_one_Target = new TH1D("DP_EMT_Pt_one_Target",
                                  "DP_EMT_Pt_one_Target; P_{t} in GeV/c^{2};#",
                                  30,
                                  0,
                                  3);
  fHistoList_dp_one_Target.push_back(DP_EMT_Pt_one_Target);
  DP_EMT_Pt_two_Target = new TH1D("DP_EMT_Pt_two_Target",
                                  "DP_EMT_Pt_two_Target; P_{t} in GeV/c^{2};#",
                                  30,
                                  0,
                                  3);
  fHistoList_dp_two_Target.push_back(DP_EMT_Pt_two_Target);
  DP_EMT_Pt_onetwo_Target =
    new TH1D("DP_EMT_Pt_onetwo_Target",
             "DP_EMT_Pt_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_EMT_Pt_all_Outside =
    new TH1D("DP_EMT_Pt_all_Outside",
             "DP_EMT_Pt_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(DP_EMT_Pt_all_Outside);
  DP_EMT_Pt_zero_Outside =
    new TH1D("DP_EMT_Pt_zero_Outside",
             "DP_EMT_Pt_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(DP_EMT_Pt_zero_Outside);
  DP_EMT_Pt_one_Outside =
    new TH1D("DP_EMT_Pt_one_Outside",
             "DP_EMT_Pt_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(DP_EMT_Pt_one_Outside);
  DP_EMT_Pt_two_Outside =
    new TH1D("DP_EMT_Pt_two_Outside",
             "DP_EMT_Pt_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(DP_EMT_Pt_two_Outside);
  DP_EMT_Pt_onetwo_Outside =
    new TH1D("DP_EMT_Pt_onetwo_Outside",
             "DP_EMT_Pt_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_EMT_Pt_all_Both = new TH1D(
    "DP_EMT_Pt_all_Both", "DP_EMT_Pt_all_Both; P_{t} in GeV/c^{2};#", 30, 0, 3);
  fHistoList_dp_all_Both.push_back(DP_EMT_Pt_all_Both);
  DP_EMT_Pt_zero_Both = new TH1D("DP_EMT_Pt_zero_Both",
                                 "DP_EMT_Pt_zero_Both; P_{t} in GeV/c^{2};#",
                                 30,
                                 0,
                                 3);
  fHistoList_dp_zero_Both.push_back(DP_EMT_Pt_zero_Both);
  DP_EMT_Pt_one_Both = new TH1D(
    "DP_EMT_Pt_one_Both", "DP_EMT_Pt_one_Both; P_{t} in GeV/c^{2};#", 30, 0, 3);
  fHistoList_dp_one_Both.push_back(DP_EMT_Pt_one_Both);
  DP_EMT_Pt_two_Both = new TH1D(
    "DP_EMT_Pt_two_Both", "DP_EMT_Pt_two_Both; P_{t} in GeV/c^{2};#", 30, 0, 3);
  fHistoList_dp_two_Both.push_back(DP_EMT_Pt_two_Both);
  DP_EMT_Pt_onetwo_Both =
    new TH1D("DP_EMT_Pt_onetwo_Both",
             "DP_EMT_Pt_onetwo_Both; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_LK_EMT_neg_Pt_all_Target =
    new TH1D("DP_LK_EMT_neg_Pt_all_Target",
             "DP_LK_EMT_neg_Pt_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(DP_LK_EMT_neg_Pt_all_Target);
  DP_LK_EMT_neg_Pt_zero_Target =
    new TH1D("DP_LK_EMT_neg_Pt_zero_Target",
             "DP_LK_EMT_neg_Pt_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(DP_LK_EMT_neg_Pt_zero_Target);
  DP_LK_EMT_neg_Pt_one_Target =
    new TH1D("DP_LK_EMT_neg_Pt_one_Target",
             "DP_LK_EMT_neg_Pt_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(DP_LK_EMT_neg_Pt_one_Target);
  DP_LK_EMT_neg_Pt_two_Target =
    new TH1D("DP_LK_EMT_neg_Pt_two_Target",
             "DP_LK_EMT_neg_Pt_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(DP_LK_EMT_neg_Pt_two_Target);
  DP_LK_EMT_neg_Pt_onetwo_Target =
    new TH1D("DP_LK_EMT_neg_Pt_onetwo_Target",
             "DP_LK_EMT_neg_Pt_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_LK_EMT_pos_Pt_all_Target =
    new TH1D("DP_LK_EMT_pos_Pt_all_Target",
             "DP_LK_EMT_pos_Pt_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(DP_LK_EMT_pos_Pt_all_Target);
  DP_LK_EMT_pos_Pt_zero_Target =
    new TH1D("DP_LK_EMT_pos_Pt_zero_Target",
             "DP_LK_EMT_pos_Pt_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(DP_LK_EMT_pos_Pt_zero_Target);
  DP_LK_EMT_pos_Pt_one_Target =
    new TH1D("DP_LK_EMT_pos_Pt_one_Target",
             "DP_LK_EMT_pos_Pt_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(DP_LK_EMT_pos_Pt_one_Target);
  DP_LK_EMT_pos_Pt_two_Target =
    new TH1D("DP_LK_EMT_pos_Pt_two_Target",
             "DP_LK_EMT_pos_Pt_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(DP_LK_EMT_pos_Pt_two_Target);
  DP_LK_EMT_pos_Pt_onetwo_Target =
    new TH1D("DP_LK_EMT_pos_Pt_onetwo_Target",
             "DP_LK_EMT_pos_Pt_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_LK_EMT_Pt_all_Target =
    new TH1D("DP_LK_EMT_Pt_all_Target",
             "DP_LK_EMT_Pt_all_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Target.push_back(DP_LK_EMT_Pt_all_Target);
  DP_LK_EMT_Pt_zero_Target =
    new TH1D("DP_LK_EMT_Pt_zero_Target",
             "DP_LK_EMT_Pt_zero_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Target.push_back(DP_LK_EMT_Pt_zero_Target);
  DP_LK_EMT_Pt_one_Target =
    new TH1D("DP_LK_EMT_Pt_one_Target",
             "DP_LK_EMT_Pt_one_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Target.push_back(DP_LK_EMT_Pt_one_Target);
  DP_LK_EMT_Pt_two_Target =
    new TH1D("DP_LK_EMT_Pt_two_Target",
             "DP_LK_EMT_Pt_two_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Target.push_back(DP_LK_EMT_Pt_two_Target);
  DP_LK_EMT_Pt_onetwo_Target =
    new TH1D("DP_LK_EMT_Pt_onetwo_Target",
             "DP_LK_EMT_Pt_onetwo_Target; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_LK_EMT_neg_Pt_all_Outside =
    new TH1D("DP_LK_EMT_neg_Pt_all_Outside",
             "DP_LK_EMT_neg_Pt_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(DP_LK_EMT_neg_Pt_all_Outside);
  DP_LK_EMT_neg_Pt_zero_Outside =
    new TH1D("DP_LK_EMT_neg_Pt_zero_Outside",
             "DP_LK_EMT_neg_Pt_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(DP_LK_EMT_neg_Pt_zero_Outside);
  DP_LK_EMT_neg_Pt_one_Outside =
    new TH1D("DP_LK_EMT_neg_Pt_one_Outside",
             "DP_LK_EMT_neg_Pt_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(DP_LK_EMT_neg_Pt_one_Outside);
  DP_LK_EMT_neg_Pt_two_Outside =
    new TH1D("DP_LK_EMT_neg_Pt_two_Outside",
             "DP_LK_EMT_neg_Pt_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(DP_LK_EMT_neg_Pt_two_Outside);
  DP_LK_EMT_neg_Pt_onetwo_Outside =
    new TH1D("DP_LK_EMT_neg_Pt_onetwo_Outside",
             "DP_LK_EMT_neg_Pt_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_LK_EMT_pos_Pt_all_Outside =
    new TH1D("DP_LK_EMT_pos_Pt_all_Outside",
             "DP_LK_EMT_pos_Pt_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(DP_LK_EMT_pos_Pt_all_Outside);
  DP_LK_EMT_pos_Pt_zero_Outside =
    new TH1D("DP_LK_EMT_pos_Pt_zero_Outside",
             "DP_LK_EMT_pos_Pt_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(DP_LK_EMT_pos_Pt_zero_Outside);
  DP_LK_EMT_pos_Pt_one_Outside =
    new TH1D("DP_LK_EMT_pos_Pt_one_Outside",
             "DP_LK_EMT_pos_Pt_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(DP_LK_EMT_pos_Pt_one_Outside);
  DP_LK_EMT_pos_Pt_two_Outside =
    new TH1D("DP_LK_EMT_pos_Pt_two_Outside",
             "DP_LK_EMT_pos_Pt_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(DP_LK_EMT_pos_Pt_two_Outside);
  DP_LK_EMT_pos_Pt_onetwo_Outside =
    new TH1D("DP_LK_EMT_pos_Pt_onetwo_Outside",
             "DP_LK_EMT_pos_Pt_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  ...
  DP_LK_EMT_Pt_all_Outside =
    new TH1D("DP_LK_EMT_Pt_all_Outside",
             "DP_LK_EMT_Pt_all_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_all_Outside.push_back(DP_LK_EMT_Pt_all_Outside);
  DP_LK_EMT_Pt_zero_Outside =
    new TH1D("DP_LK_EMT_Pt_zero_Outside",
             "DP_LK_EMT_Pt_zero_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_zero_Outside.push_back(DP_LK_EMT_Pt_zero_Outside);
  DP_LK_EMT_Pt_one_Outside =
    new TH1D("DP_LK_EMT_Pt_one_Outside",
             "DP_LK_EMT_Pt_one_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_one_Outside.push_back(DP_LK_EMT_Pt_one_Outside);
  DP_LK_EMT_Pt_two_Outside =
    new TH1D("DP_LK_EMT_Pt_two_Outside",
             "DP_LK_EMT_Pt_two_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
  fHistoList_dp_two_Outside.push_back(DP_LK_EMT_Pt_two_Outside);
  DP_LK_EMT_Pt_onetwo_Outside =
    new TH1D("DP_LK_EMT_Pt_onetwo_Outside",
             "DP_LK_EMT_Pt_onetwo_Outside; P_{t} in GeV/c^{2};#",
             30,
             0,
             3);
