...
void CbmKresConversionManualmbias2::Init() {
  ...
  if (nullptr == ioman) {
    Fatal("CbmKresConversionManualmbias2::Init",
          "RootManager not instantised!");
  }

  fMcTracks = (TClonesArray*) ioman->GetObject("MCTrack");
  if (nullptr == fMcTracks) {
    Fatal("CbmKresConversionManualmbias2::Init", "No MCTrack array!");
  }
  ...
  if (nullptr == fPrimVertex) {
    LOG(fatal)
      << "CbmKresConversionManualmbias2::Init  No PrimaryVertex array!";
  }

  fGlobalTracks = (TClonesArray*) ioman->GetObject("GlobalTrack");
  if (nullptr == fGlobalTracks) {
    Fatal("CbmKresConversionManualmbias2::Init", "No GlobalTrack array!");
  }

  fStsTracks = (TClonesArray*) ioman->GetObject("StsTrack");
  if (nullptr == fStsTracks) {
    Fatal("CbmKresConversionManualmbias2::Init", "No StsTrack array!");
  }

  fStsTrackMatches = (TClonesArray*) ioman->GetObject("StsTrackMatch");
  if (nullptr == fStsTrackMatches) {
    Fatal("CbmKresConversionManualmbias2::Init", "No StsTrackMatch array!");
  }

  fRichProjections = (TClonesArray*) ioman->GetObject("RichProjection");
  if (nullptr == fRichProjections) {
    Fatal("CbmKresConversionManualmbias2::Init", "No RichProjection array!");
  }

  fRichRings = (TClonesArray*) ioman->GetObject("RichRing");
  if (nullptr == fRichRings) {
    Fatal("CbmKresConversionManualmbias2::Init", "No RichRing array!");
  }

  fRichRingMatches = (TClonesArray*) ioman->GetObject("RichRingMatch");
  if (nullptr == fRichRingMatches) {
    Fatal("CbmKresConversionManualmbias2::Init", "No RichRingMatch array!");
  }

  fRichHits = (TClonesArray*) ioman->GetObject("RichHit");
  if (nullptr == fRichHits) {
    Fatal("CbmKresConversionManualmbias2::Init", "No RichHit array!");
  }

  fArrayMvdHit = (TClonesArray*) ioman->GetObject("MvdHit");
  if (nullptr == fArrayMvdHit) {
    Fatal("CbmKresConversionManualmbias2::Init", "No MvdHit array!");
  }

  fArrayStsHit = (TClonesArray*) ioman->GetObject("StsHit");
  if (nullptr == fArrayStsHit) {
    Fatal("CbmKresConversionManualmbias2::Init", "No StsHit array!");
  }
...
void CbmKresConversionManualmbias2::Exec(int fEventNumMan,
  ...
  if (fEventNumMan == 1000) {
    EMT_man_Event_Both_mbias2.insert(EMT_man_Event_Both_mbias2.end(),
                                     EMT_man_Event_Outside_mbias2.begin(),
                                     EMT_man_Event_Outside_mbias2.end());
    EMT_man_Event_Both_mbias2.insert(EMT_man_Event_Both_mbias2.end(),
                                     EMT_man_Event_Target_mbias2.begin(),
                                     EMT_man_Event_Target_mbias2.end());
    EMT_man_pair_momenta_Both_mbias2.insert(
      EMT_man_pair_momenta_Both_mbias2.end(),
    ...
    EMT_man_NofRings_Both_mbias2.insert(EMT_man_NofRings_Both_mbias2.end(),
                                        EMT_man_NofRings_Outside_mbias2.begin(),
                                        EMT_man_NofRings_Outside_mbias2.end());
    EMT_man_NofRings_Both_mbias2.insert(EMT_man_NofRings_Both_mbias2.end(),
                                        EMT_man_NofRings_Target_mbias2.begin(),
  ...
  FindPi0("All",
          ...
          MultiplicityGamma_all_Target_mbias2,
  ...
  FindPi0("Zero",
          ...
          MultiplicityGamma_zero_Target_mbias2,
  ...
  FindPi0("One",
          ...
          MultiplicityGamma_one_Target_mbias2,
  ...
  FindPi0("Two",
          ...
          MultiplicityGamma_two_Target_mbias2,
  ...
  FindPi0("OneTwo",
          ...
          MultiplicityGamma_onetwo_Target_mbias2,
  ...
  FindPi0("All",
          ...
          MultiplicityGamma_all_Outside_mbias2,
  ...
  FindPi0("Zero",
          ...
          MultiplicityGamma_zero_Outside_mbias2,
  ...
  FindPi0("One",
          ...
          MultiplicityGamma_one_Outside_mbias2,
  ...
  FindPi0("Two",
          ...
          MultiplicityGamma_two_Outside_mbias2,
  ...
  FindPi0("OneTwo",
          ...
          MultiplicityGamma_onetwo_Outside_mbias2,
  ...
  FindPi0("All",
          ...
          Gammas_stsIndex_all_Both_mbias2,
          Gammas_MC_all_Both_mbias2,
          Pi0InvMassReco_all_Both_mbias2,
          Pi0_pt_vs_rap_all_Both_mbias2,
          Pi0_pt_vs_rap_est_all_Both_mbias2,
          MultiplicityGamma_all_Both_mbias2,
          MultiplicityChargedParticles_all_Both_mbias2,
          fHistoList_bg_InM_all_Both_mbias2);
  FindPi0("Zero",
          "Both",
          Gammas_zero_Both_mbias2,
  ...
  FindPi0("One",
          ...
          Gammas_stsIndex_one_Both_mbias2,
          Gammas_MC_one_Both_mbias2,
          Pi0InvMassReco_one_Both_mbias2,
          Pi0_pt_vs_rap_one_Both_mbias2,
          Pi0_pt_vs_rap_est_one_Both_mbias2,
          MultiplicityGamma_one_Both_mbias2,
          MultiplicityChargedParticles_one_Both_mbias2,
  ...
  FindPi0("Two",
          ...
          Gammas_stsIndex_two_Both_mbias2,
          Gammas_MC_two_Both_mbias2,
          Pi0InvMassReco_two_Both_mbias2,
          Pi0_pt_vs_rap_two_Both_mbias2,
          Pi0_pt_vs_rap_est_two_Both_mbias2,
          MultiplicityGamma_two_Both_mbias2,
          MultiplicityChargedParticles_two_Both_mbias2,
          fHistoList_bg_InM_two_Both_mbias2);
  FindPi0("OneTwo",
          "Both",
          Gammas_onetwo_Both_mbias2,
          ...
          MultiplicityGamma_onetwo_Both_mbias2,
          MultiplicityChargedParticles_onetwo_Both_mbias2,
          fHistoList_bg_InM_onetwo_Both_mbias2);
}


void CbmKresConversionManualmbias2::SaveOutsideTracks(CbmMCTrack* mcTrack1,
...
void CbmKresConversionManualmbias2::SaveTargetTracks(CbmMCTrack* mcTrack1,
                                                     CbmStsTrack* stsTrack,
                                                     TVector3 refmom,
                                                     double charge,
                                                     int stsInd,
      ...
      if (part1MC->GetMotherId() == part2MC->GetMotherId()
        ...
        if (mcTrackmama->GetMotherId() != -1
          ...
          if (mcTrackgrmama->GetPdgCode() == 111) {
            ...
            InvMass_vs_OA_fromPi0_Target_mbias2->Fill(InvmassReco,
                                                      OpeningAngle);
...
void CbmKresConversionManualmbias2::FindGammasOutside(
  ...
  double InvMassCut,
  int RealPID,
  vector<CbmMCTrack*> MCtracks_minus_Outside_mbias2,
  vector<CbmMCTrack*> MCtracks_plus_Outside_mbias2,
  vector<CbmStsTrack*> StsTrack_minus_Outside_mbias2,
  vector<CbmStsTrack*> StsTrack_plus_Outside_mbias2,
  std::vector<int> Rings_minus_Outside_mbias2,
  std::vector<int> Rings_plus_Outside_mbias2,
  std::vector<int> stsIndex_minus_Outside_mbias2,
  std::vector<int> stsIndex_plus_Outside_mbias2,
  vector<CbmRichRing*> richRing_minus_Outside_mbias2,
  ...
  for (size_t i = 0; i < StsTrack_minus_Outside_mbias2.size(); i++) {
    for (size_t j = 0; j < StsTrack_plus_Outside_mbias2.size(); j++) {
      ...
      if (RealPID == 1) {
        // Real PID
        richcheck_0 =
          CheckIfElectron(richRing_minus_Outside_mbias2[i], part1.Mag());
        richcheck_1 =
          CheckIfElectron(richRing_plus_Outside_mbias2[j], part2.Mag());
        richcheck = richcheck_0 + richcheck_1;
      } else {
        // MC   PID
        richcheck =
          Rings_minus_Outside_mbias2[i] + Rings_plus_Outside_mbias2[j];
      }
      ...
      if (part1MC->GetMotherId() == part2MC->GetMotherId()
        ...
        if (mcTrackmama->GetMotherId() != -1
          ...
          if (mcTrackgrmama->GetPdgCode() == 111) {
            ...
            GammasOA_fromPi0_Both_mbias2->Fill(OpeningAngle);
            InvMass_vs_OA_fromPi0_Outside_mbias2->Fill(InvmassReco,
                                                       OpeningAngle);
            InvMass_vs_OA_fromPi0_Both_mbias2->Fill(InvmassReco, OpeningAngle);
...
void CbmKresConversionManualmbias2::FindGammasBoth() {
  Gammas_all_Both_mbias2.insert(Gammas_all_Both_mbias2.end(),
                                Gammas_all_Outside_mbias2.begin(),
                                Gammas_all_Outside_mbias2.end());
  Gammas_all_Both_mbias2.insert(Gammas_all_Both_mbias2.end(),
                                Gammas_all_Target_mbias2.begin(),
                                Gammas_all_Target_mbias2.end());
  Gammas_zero_Both_mbias2.insert(Gammas_zero_Both_mbias2.end(),
                                 Gammas_zero_Outside_mbias2.begin(),
                                 Gammas_zero_Outside_mbias2.end());
  Gammas_zero_Both_mbias2.insert(Gammas_zero_Both_mbias2.end(),
                                 Gammas_zero_Target_mbias2.begin(),
                                 Gammas_zero_Target_mbias2.end());
  Gammas_one_Both_mbias2.insert(Gammas_one_Both_mbias2.end(),
                                Gammas_one_Outside_mbias2.begin(),
                                Gammas_one_Outside_mbias2.end());
  Gammas_one_Both_mbias2.insert(Gammas_one_Both_mbias2.end(),
                                Gammas_one_Target_mbias2.begin(),
                                Gammas_one_Target_mbias2.end());
  Gammas_two_Both_mbias2.insert(Gammas_two_Both_mbias2.end(),
                                Gammas_two_Outside_mbias2.begin(),
                                Gammas_two_Outside_mbias2.end());
  Gammas_two_Both_mbias2.insert(Gammas_two_Both_mbias2.end(),
                                Gammas_two_Target_mbias2.begin(),
                                Gammas_two_Target_mbias2.end());
  Gammas_onetwo_Both_mbias2.insert(Gammas_onetwo_Both_mbias2.end(),
                                   Gammas_onetwo_Outside_mbias2.begin(),
                                   Gammas_onetwo_Outside_mbias2.end());
  Gammas_onetwo_Both_mbias2.insert(Gammas_onetwo_Both_mbias2.end(),
                                   Gammas_onetwo_Target_mbias2.begin(),
                                   Gammas_onetwo_Target_mbias2.end());

  Gammas_stsIndex_all_Both_mbias2.insert(
    Gammas_stsIndex_all_Both_mbias2.end(),
  ...
  Gammas_stsIndex_zero_Both_mbias2.insert(
    Gammas_stsIndex_zero_Both_mbias2.end(),
  ...
  Gammas_stsIndex_one_Both_mbias2.insert(
    Gammas_stsIndex_one_Both_mbias2.end(),
  ...
  Gammas_stsIndex_two_Both_mbias2.insert(
    Gammas_stsIndex_two_Both_mbias2.end(),
  ...
  Gammas_stsIndex_onetwo_Both_mbias2.insert(
    Gammas_stsIndex_onetwo_Both_mbias2.end(),
  ...
  Gammas_MC_all_Both_mbias2.insert(Gammas_MC_all_Both_mbias2.end(),
                                   Gammas_MC_all_Outside_mbias2.begin(),
                                   Gammas_MC_all_Outside_mbias2.end());
  Gammas_MC_all_Both_mbias2.insert(Gammas_MC_all_Both_mbias2.end(),
                                   Gammas_MC_all_Target_mbias2.begin(),
                                   Gammas_MC_all_Target_mbias2.end());
  Gammas_MC_zero_Both_mbias2.insert(Gammas_MC_zero_Both_mbias2.end(),
                                    Gammas_MC_zero_Outside_mbias2.begin(),
                                    Gammas_MC_zero_Outside_mbias2.end());
  Gammas_MC_zero_Both_mbias2.insert(Gammas_MC_zero_Both_mbias2.end(),
                                    Gammas_MC_zero_Target_mbias2.begin(),
                                    Gammas_MC_zero_Target_mbias2.end());
  Gammas_MC_one_Both_mbias2.insert(Gammas_MC_one_Both_mbias2.end(),
                                   Gammas_MC_one_Outside_mbias2.begin(),
                                   Gammas_MC_one_Outside_mbias2.end());
  Gammas_MC_one_Both_mbias2.insert(Gammas_MC_one_Both_mbias2.end(),
                                   Gammas_MC_one_Target_mbias2.begin(),
                                   Gammas_MC_one_Target_mbias2.end());
  Gammas_MC_two_Both_mbias2.insert(Gammas_MC_two_Both_mbias2.end(),
                                   Gammas_MC_two_Outside_mbias2.begin(),
                                   Gammas_MC_two_Outside_mbias2.end());
  Gammas_MC_two_Both_mbias2.insert(Gammas_MC_two_Both_mbias2.end(),
                                   Gammas_MC_two_Target_mbias2.begin(),
                                   Gammas_MC_two_Target_mbias2.end());
  Gammas_MC_onetwo_Both_mbias2.insert(Gammas_MC_onetwo_Both_mbias2.end(),
                                      Gammas_MC_onetwo_Outside_mbias2.begin(),
                                      Gammas_MC_onetwo_Outside_mbias2.end());
  Gammas_MC_onetwo_Both_mbias2.insert(Gammas_MC_onetwo_Both_mbias2.end(),
                                      Gammas_MC_onetwo_Target_mbias2.begin(),
...
void CbmKresConversionManualmbias2::FindPi0(
  TString mod,
  TString position,
      ...
      if (mod == "OneTwo" && position == "Both") {
        if (params.fRapidity > 1.2 && params.fRapidity <= 1.6) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_1_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_2_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_3_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_4_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_5_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 1.6 && params.fRapidity <= 2.0) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_6_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_7_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_8_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_9_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_10_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 2.0 && params.fRapidity <= 2.4) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_11_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_12_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_13_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_14_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_15_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 2.4 && params.fRapidity <= 2.8) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_16_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_17_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_18_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_19_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_20_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 2.8 && params.fRapidity <= 3.2) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_21_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_22_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_23_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_24_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_25_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 3.2 && params.fRapidity <= 3.6) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_26_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_27_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_28_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_29_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_30_mbias2->Fill(params.fMinv);
        }
      }
...
// TARGET
{
  ...
  cout << "Mixing in Manual(Target_mbias2) - nof entries " << nof_Target
       << endl;
  for (Int_t a = 0; a < nof_Target - 1; a++) {
    for (Int_t b = a + 1; b < nof_Target; b++) {
      ...
      if (EMT_man_NofRings_Target_mbias2[a] == 0
          && EMT_man_NofRings_Target_mbias2[b] == 0)
        EMT_InvMass_zero_Target_mbias2->Fill(params.fMinv);
      if (EMT_man_NofRings_Target_mbias2[a] == 1
          && EMT_man_NofRings_Target_mbias2[b] == 1)
        EMT_InvMass_one_Target_mbias2->Fill(params.fMinv);
      if (EMT_man_NofRings_Target_mbias2[a] == 2
          && EMT_man_NofRings_Target_mbias2[b] == 2)
        EMT_InvMass_two_Target_mbias2->Fill(params.fMinv);
      if ((EMT_man_NofRings_Target_mbias2[a] == 1
           || EMT_man_NofRings_Target_mbias2[a] == 2)
          && (EMT_man_NofRings_Target_mbias2[b] == 1
              || EMT_man_NofRings_Target_mbias2[b] == 2))
...
// OUTSIDE
{
  ...
  cout << "Mixing in Manual(Outside_mbias2) - nof entries " << nof_Outside
       << endl;
  for (Int_t a = 0; a < nof_Outside - 1; a++) {
    for (Int_t b = a + 1; b < nof_Outside; b++) {
      ...
      if (EMT_man_NofRings_Outside_mbias2[a] == 0
          && EMT_man_NofRings_Outside_mbias2[b] == 0)
        EMT_InvMass_zero_Outside_mbias2->Fill(params.fMinv);
      if (EMT_man_NofRings_Outside_mbias2[a] == 1
          && EMT_man_NofRings_Outside_mbias2[b] == 1)
        EMT_InvMass_one_Outside_mbias2->Fill(params.fMinv);
      if (EMT_man_NofRings_Outside_mbias2[a] == 2
          && EMT_man_NofRings_Outside_mbias2[b] == 2)
        EMT_InvMass_two_Outside_mbias2->Fill(params.fMinv);
      if ((EMT_man_NofRings_Outside_mbias2[a] == 1
           || EMT_man_NofRings_Outside_mbias2[a] == 2)
          && (EMT_man_NofRings_Outside_mbias2[b] == 1
              || EMT_man_NofRings_Outside_mbias2[b] == 2))
...
// BOTH
{
  ...
  for (Int_t a = 0; a < nof_Both - 1; a++) {
    for (Int_t b = a + 1; b < nof_Both; b++) {
      ...
      if (EMT_man_NofRings_Both_mbias2[a] == 0
          && EMT_man_NofRings_Both_mbias2[b] == 0)
        EMT_InvMass_zero_Both_mbias2->Fill(params.fMinv);
      if (EMT_man_NofRings_Both_mbias2[a] == 1
          && EMT_man_NofRings_Both_mbias2[b] == 1)
        EMT_InvMass_one_Both_mbias2->Fill(params.fMinv);
      if (EMT_man_NofRings_Both_mbias2[a] == 2
          && EMT_man_NofRings_Both_mbias2[b] == 2)
        EMT_InvMass_two_Both_mbias2->Fill(params.fMinv);
      if ((EMT_man_NofRings_Both_mbias2[a] == 1
           || EMT_man_NofRings_Both_mbias2[a] == 2)
          && (EMT_man_NofRings_Both_mbias2[b] == 1
              || EMT_man_NofRings_Both_mbias2[b] == 2))
      ...
      if ((EMT_man_NofRings_Both_mbias2[a] == 1
        ...
        if (params.fRapidity > 1.2 && params.fRapidity <= 1.6) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_mixing_1_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_mixing_2_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_mixing_3_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_mixing_4_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_mixing_5_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 1.6 && params.fRapidity <= 2.0) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_mixing_6_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_mixing_7_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_mixing_8_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_mixing_9_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_mixing_10_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 2.0 && params.fRapidity <= 2.4) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_mixing_11_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_mixing_12_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_mixing_13_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_mixing_14_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_mixing_15_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 2.4 && params.fRapidity <= 2.8) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_mixing_16_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_mixing_17_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_mixing_18_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_mixing_19_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_mixing_20_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 2.8 && params.fRapidity <= 3.2) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_mixing_21_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_mixing_22_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_mixing_23_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_mixing_24_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_mixing_25_mbias2->Fill(params.fMinv);
        }
        if (params.fRapidity > 3.2 && params.fRapidity <= 3.6) {
          if (params.fPt > 0.0 && params.fPt <= 0.4)
            rap_vs_Pt_InM_mixing_26_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.4 && params.fPt <= 0.8)
            rap_vs_Pt_InM_mixing_27_mbias2->Fill(params.fMinv);
          if (params.fPt > 0.8 && params.fPt <= 1.2)
            rap_vs_Pt_InM_mixing_28_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.2 && params.fPt <= 1.6)
            rap_vs_Pt_InM_mixing_29_mbias2->Fill(params.fMinv);
          if (params.fPt > 1.6 && params.fPt <= 2.0)
            rap_vs_Pt_InM_mixing_30_mbias2->Fill(params.fMinv);
        }
      }
    }
  }
...
int CbmKresConversionManualmbias2::CheckIfElectron(CbmRichRing* ring,
                                                   double momentum) {
  int identified = 0;
...
double
CbmKresConversionManualmbias2::CalculatePlaneAngle_last(CbmStsTrack* Sts_1,
                                                        CbmStsTrack* Sts_2) {
...
double
CbmKresConversionManualmbias2::CalculatePlaneAngle_first(CbmStsTrack* Sts_1,
                                                         CbmStsTrack* Sts_2) {
  double FinalAngle = 400;
  Int_t hits1sts    = Sts_1->GetNofStsHits();
  Int_t hits2sts    = Sts_2->GetNofStsHits();
...
void CbmKresConversionManualmbias2::Finish() {
  ...
  for (UInt_t i = 0; i < fHistoList_multiplicity_man_Target_mbias2.size();
       i++) {
  ...
  gDirectory->mkdir("multiplicity");
  gDirectory->cd("multiplicity");
  for (UInt_t i = 0; i < fHistoList_multiplicity_man_Outside_mbias2.size();
       i++) {
...
void CbmKresConversionManualmbias2::InitHistograms() {
  ...
  InvMass_vs_OA_candidates_Both_mbias2 =
    new TH2D("InvMass_vs_OA_candidates_Both_mbias2",
             ...
             0,
             50);
  fHistoList_man_cuts_Both_mbias2.push_back(
    InvMass_vs_OA_candidates_Both_mbias2);
  InvMass_vs_OA_fromPi0_Both_mbias2 =
    new TH2D("InvMass_vs_OA_fromPi0_Both_mbias2",
  ...
  GammasInvMass_candidates_Both_mbias2 = new TH1D(
    "GammasInvMass_candidates_Both_mbias2",
    "GammasInvMass_candidates_Both_mbias2; invariant mass in GeV/c^{2};#",
    510,
    -0.01,
    0.5);
  fHistoList_man_cuts_Both_mbias2.push_back(
    GammasInvMass_candidates_Both_mbias2);
  GammasOA_candidates_Both_mbias2 =
    new TH1D("GammasOA_candidates_Both_mbias2",
             "GammasOA_candidates_Both_mbias2; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_man_cuts_Both_mbias2.push_back(GammasOA_candidates_Both_mbias2);
  GammasInvMass_fromPi0_Both_mbias2 =
    new TH1D("GammasInvMass_fromPi0_Both_mbias2",
             "GammasInvMass_fromPi0_Both_mbias2; invariant mass in GeV/c^{2};#",
             510,
             -0.01,
             0.5);
  fHistoList_man_cuts_Both_mbias2.push_back(GammasInvMass_fromPi0_Both_mbias2);
  GammasOA_fromPi0_Both_mbias2 =
    new TH1D("GammasOA_fromPi0_Both_mbias2",
             "GammasOA_fromPi0_Both_mbias2; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_man_cuts_Both_mbias2.push_back(GammasOA_fromPi0_Both_mbias2);
  PlaneAngles_last_candidates_Both_mbias2 = new TH1D(
    "PlaneAngles_last_candidates_Both_mbias2",
    "PlaneAngles_last_candidates_Both_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Both_mbias2.push_back(
  ...
  PlaneAngles_last_fromPi0_Both_mbias2 =
    new TH1D("PlaneAngles_last_fromPi0_Both_mbias2",
             "PlaneAngles_last_fromPi0_Both_mbias2; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_man_cuts_Both_mbias2.push_back(
    PlaneAngles_last_fromPi0_Both_mbias2);
  PlaneAngles_first_candidates_Both_mbias2 = new TH1D(
    "PlaneAngles_first_candidates_Both_mbias2",
    "PlaneAngles_first_candidates_Both_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Both_mbias2.push_back(
  ...
  PlaneAngles_first_fromPi0_Both_mbias2 =
    new TH1D("PlaneAngles_first_fromPi0_Both_mbias2",
             "PlaneAngles_first_fromPi0_Both_mbias2; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_man_cuts_Both_mbias2.push_back(
  ...
  InvMass_vs_OA_candidates_Target_mbias2 =
    new TH2D("InvMass_vs_OA_candidates_Target_mbias2",
             ...
             0,
             50);
  fHistoList_man_cuts_Target_mbias2.push_back(
    InvMass_vs_OA_candidates_Target_mbias2);
  InvMass_vs_OA_fromPi0_Target_mbias2 =
    new TH2D("InvMass_vs_OA_fromPi0_Target_mbias2",
  ...
  fHistoList_man_cuts_Target_mbias2.push_back(
    InvMass_vs_OA_fromPi0_Target_mbias2);
  GammasInvMass_candidates_Target_mbias2 = new TH1D(
    "GammasInvMass_candidates_Target_mbias2",
    "GammasInvMass_candidates_Target_mbias2; invariant mass in GeV/c^{2};#",
    510,
    -0.01,
    0.5);
  fHistoList_man_cuts_Target_mbias2.push_back(
  ...
  GammasOA_candidates_Target_mbias2 =
    new TH1D("GammasOA_candidates_Target_mbias2",
             "GammasOA_candidates_Target_mbias2; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_man_cuts_Target_mbias2.push_back(
    GammasOA_candidates_Target_mbias2);
  GammasInvMass_fromPi0_Target_mbias2 = new TH1D(
    "GammasInvMass_fromPi0_Target_mbias2",
    "GammasInvMass_fromPi0_Target_mbias2; invariant mass in GeV/c^{2};#",
    510,
    -0.01,
    0.5);
  fHistoList_man_cuts_Target_mbias2.push_back(
    GammasInvMass_fromPi0_Target_mbias2);
  GammasOA_fromPi0_Target_mbias2 =
    new TH1D("GammasOA_fromPi0_Target_mbias2",
             "GammasOA_fromPi0_Target_mbias2; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_man_cuts_Target_mbias2.push_back(GammasOA_fromPi0_Target_mbias2);
  PlaneAngles_last_candidates_Target_mbias2 = new TH1D(
    "PlaneAngles_last_candidates_Target_mbias2",
    "PlaneAngles_last_candidates_Target_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Target_mbias2.push_back(
  ...
  PlaneAngles_last_fromPi0_Target_mbias2 =
    new TH1D("PlaneAngles_last_fromPi0_Target_mbias2",
             "PlaneAngles_last_fromPi0_Target_mbias2; #theta angle in degree;#",
             720,
             -1.,
             179.);
  fHistoList_man_cuts_Target_mbias2.push_back(
    PlaneAngles_last_fromPi0_Target_mbias2);
  PlaneAngles_first_candidates_Target_mbias2 = new TH1D(
    "PlaneAngles_first_candidates_Target_mbias2",
    "PlaneAngles_first_candidates_Target_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Target_mbias2.push_back(
    PlaneAngles_first_candidates_Target_mbias2);
  PlaneAngles_first_fromPi0_Target_mbias2 = new TH1D(
    "PlaneAngles_first_fromPi0_Target_mbias2",
    "PlaneAngles_first_fromPi0_Target_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Target_mbias2.push_back(
  ...
  InvMass_vs_OA_candidates_Outside_mbias2 =
    new TH2D("InvMass_vs_OA_candidates_Outside_mbias2",
             ...
             0,
             50);
  fHistoList_man_cuts_Outside_mbias2.push_back(
    InvMass_vs_OA_candidates_Outside_mbias2);
  InvMass_vs_OA_fromPi0_Outside_mbias2 =
    new TH2D("InvMass_vs_OA_fromPi0_Outside_mbias2",
  ...
  fHistoList_man_cuts_Outside_mbias2.push_back(
    InvMass_vs_OA_fromPi0_Outside_mbias2);
  GammasInvMass_candidates_Outside_mbias2 = new TH1D(
    "GammasInvMass_candidates_Outside_mbias2",
    "GammasInvMass_candidates_Outside_mbias2; invariant mass in GeV/c^{2};#",
    510,
    -0.01,
    0.5);
  fHistoList_man_cuts_Outside_mbias2.push_back(
  ...
  GammasOA_candidates_Outside_mbias2 =
    new TH1D("GammasOA_candidates_Outside_mbias2",
             "GammasOA_candidates_Outside_mbias2; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_man_cuts_Outside_mbias2.push_back(
    GammasOA_candidates_Outside_mbias2);
  GammasInvMass_fromPi0_Outside_mbias2 = new TH1D(
    "GammasInvMass_fromPi0_Outside_mbias2",
    "GammasInvMass_fromPi0_Outside_mbias2; invariant mass in GeV/c^{2};#",
    510,
    -0.01,
    0.5);
  fHistoList_man_cuts_Outside_mbias2.push_back(
    GammasInvMass_fromPi0_Outside_mbias2);
  GammasOA_fromPi0_Outside_mbias2 =
    new TH1D("GammasOA_fromPi0_Outside_mbias2",
             "GammasOA_fromPi0_Outside_mbias2; opening angle in degree;#",
             300,
             -0.1,
             29.9);
  fHistoList_man_cuts_Outside_mbias2.push_back(GammasOA_fromPi0_Outside_mbias2);
  PlaneAngles_last_candidates_Outside_mbias2 = new TH1D(
    "PlaneAngles_last_candidates_Outside_mbias2",
    "PlaneAngles_last_candidates_Outside_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Outside_mbias2.push_back(
    PlaneAngles_last_candidates_Outside_mbias2);
  PlaneAngles_last_fromPi0_Outside_mbias2 = new TH1D(
    "PlaneAngles_last_fromPi0_Outside_mbias2",
    "PlaneAngles_last_fromPi0_Outside_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Outside_mbias2.push_back(
    PlaneAngles_last_fromPi0_Outside_mbias2);
  PlaneAngles_first_candidates_Outside_mbias2 = new TH1D(
    "PlaneAngles_first_candidates_Outside_mbias2",
    "PlaneAngles_first_candidates_Outside_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Outside_mbias2.push_back(
    PlaneAngles_first_candidates_Outside_mbias2);
  PlaneAngles_first_fromPi0_Outside_mbias2 = new TH1D(
    "PlaneAngles_first_fromPi0_Outside_mbias2",
    "PlaneAngles_first_fromPi0_Outside_mbias2; #theta angle in degree;#",
    720,
    -1.,
    179.);
  fHistoList_man_cuts_Outside_mbias2.push_back(
  ...
  // Target_mbias2 => all
  GammaInvMassReco_all_Target_mbias2 = new TH1D(
    "GammaInvMassReco_all_Target_mbias2",
    "GammaInvMassReco_all_Target_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_all_Target_mbias2.push_back(
    GammaInvMassReco_all_Target_mbias2);
  GammaOpeningAngleReco_all_Target_mbias2 =
    new TH1D("GammaOpeningAngleReco_all_Target_mbias2",
             "GammaOpeningAngleReco_all_Target_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_all_Target_mbias2.push_back(
    GammaOpeningAngleReco_all_Target_mbias2);
  Pdg_all_Target_mbias2 = new TH1D(
    "Pdg_all_Target_mbias2", "Pdg_all_Target_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_all_Target_mbias2.push_back(Pdg_all_Target_mbias2);
  P_reco_all_Target_mbias2 =
    new TH1D("P_reco_all_Target_mbias2",
             "P_reco_all_Target_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_all_Target_mbias2.push_back(P_reco_all_Target_mbias2);
  Pt_reco_all_Target_mbias2 =
    new TH1D("Pt_reco_all_Target_mbias2",
             "Pt_reco_all_Target_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_all_Target_mbias2.push_back(Pt_reco_all_Target_mbias2);
  Pi0InvMassReco_all_Target_mbias2 =
    new TH1D("Pi0InvMassReco_all_Target_mbias2",
             "Pi0InvMassReco_all_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_all_Target_mbias2.push_back(Pi0InvMassReco_all_Target_mbias2);
  EMT_InvMass_all_Target_mbias2 =
    new TH1D("EMT_InvMass_all_Target_mbias2",
             "EMT_InvMass_all_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_all_Target_mbias2.push_back(EMT_InvMass_all_Target_mbias2);
  Pi0_pt_vs_rap_all_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_all_Target_mbias2",
             "Pi0_pt_vs_rap_all_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_all_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_all_Target_mbias2",
             "Pi0_pt_vs_rap_est_all_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  // Target_mbias2 => zero
  GammaInvMassReco_zero_Target_mbias2 = new TH1D(
    "GammaInvMassReco_zero_Target_mbias2",
    "GammaInvMassReco_zero_Target_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_zero_Target_mbias2.push_back(
    GammaInvMassReco_zero_Target_mbias2);
  GammaOpeningAngleReco_zero_Target_mbias2 =
    new TH1D("GammaOpeningAngleReco_zero_Target_mbias2",
             "GammaOpeningAngleReco_zero_Target_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_zero_Target_mbias2.push_back(
    GammaOpeningAngleReco_zero_Target_mbias2);
  Pdg_zero_Target_mbias2 = new TH1D(
    "Pdg_zero_Target_mbias2", "Pdg_zero_Target_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_zero_Target_mbias2.push_back(Pdg_zero_Target_mbias2);
  P_reco_zero_Target_mbias2 =
    new TH1D("P_reco_zero_Target_mbias2",
             "P_reco_zero_Target_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_zero_Target_mbias2.push_back(P_reco_zero_Target_mbias2);
  Pt_reco_zero_Target_mbias2 =
    new TH1D("Pt_reco_zero_Target_mbias2",
             "Pt_reco_zero_Target_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_zero_Target_mbias2.push_back(Pt_reco_zero_Target_mbias2);
  Pi0InvMassReco_zero_Target_mbias2 =
    new TH1D("Pi0InvMassReco_zero_Target_mbias2",
             "Pi0InvMassReco_zero_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_zero_Target_mbias2.push_back(
    Pi0InvMassReco_zero_Target_mbias2);
  EMT_InvMass_zero_Target_mbias2 =
    new TH1D("EMT_InvMass_zero_Target_mbias2",
             "EMT_InvMass_zero_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_zero_Target_mbias2.push_back(EMT_InvMass_zero_Target_mbias2);
  Pi0_pt_vs_rap_zero_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_zero_Target_mbias2",
             "Pi0_pt_vs_rap_zero_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_zero_Target_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_zero_Target_mbias2",
    "Pi0_pt_vs_rap_est_zero_Target_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  // Target_mbias2 => one
  GammaInvMassReco_one_Target_mbias2 = new TH1D(
    "GammaInvMassReco_one_Target_mbias2",
    "GammaInvMassReco_one_Target_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_one_Target_mbias2.push_back(
    GammaInvMassReco_one_Target_mbias2);
  GammaOpeningAngleReco_one_Target_mbias2 =
    new TH1D("GammaOpeningAngleReco_one_Target_mbias2",
             "GammaOpeningAngleReco_one_Target_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_one_Target_mbias2.push_back(
    GammaOpeningAngleReco_one_Target_mbias2);
  Pdg_one_Target_mbias2 = new TH1D(
    "Pdg_one_Target_mbias2", "Pdg_one_Target_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_one_Target_mbias2.push_back(Pdg_one_Target_mbias2);
  P_reco_one_Target_mbias2 =
    new TH1D("P_reco_one_Target_mbias2",
             "P_reco_one_Target_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_one_Target_mbias2.push_back(P_reco_one_Target_mbias2);
  Pt_reco_one_Target_mbias2 =
    new TH1D("Pt_reco_one_Target_mbias2",
             "Pt_reco_one_Target_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_one_Target_mbias2.push_back(Pt_reco_one_Target_mbias2);
  Pi0InvMassReco_one_Target_mbias2 =
    new TH1D("Pi0InvMassReco_one_Target_mbias2",
             "Pi0InvMassReco_one_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_one_Target_mbias2.push_back(Pi0InvMassReco_one_Target_mbias2);
  EMT_InvMass_one_Target_mbias2 =
    new TH1D("EMT_InvMass_one_Target_mbias2",
             "EMT_InvMass_one_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_one_Target_mbias2.push_back(EMT_InvMass_one_Target_mbias2);
  Pi0_pt_vs_rap_one_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_one_Target_mbias2",
             "Pi0_pt_vs_rap_one_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_one_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_one_Target_mbias2",
             "Pi0_pt_vs_rap_est_one_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  // Target_mbias2 => two
  GammaInvMassReco_two_Target_mbias2 = new TH1D(
    "GammaInvMassReco_two_Target_mbias2",
    "GammaInvMassReco_two_Target_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_two_Target_mbias2.push_back(
    GammaInvMassReco_two_Target_mbias2);
  GammaOpeningAngleReco_two_Target_mbias2 =
    new TH1D("GammaOpeningAngleReco_two_Target_mbias2",
             "GammaOpeningAngleReco_two_Target_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_two_Target_mbias2.push_back(
    GammaOpeningAngleReco_two_Target_mbias2);
  Pdg_two_Target_mbias2 = new TH1D(
    "Pdg_two_Target_mbias2", "Pdg_two_Target_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_two_Target_mbias2.push_back(Pdg_two_Target_mbias2);
  P_reco_two_Target_mbias2 =
    new TH1D("P_reco_two_Target_mbias2",
             "P_reco_two_Target_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_two_Target_mbias2.push_back(P_reco_two_Target_mbias2);
  Pt_reco_two_Target_mbias2 =
    new TH1D("Pt_reco_two_Target_mbias2",
             "Pt_reco_two_Target_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_two_Target_mbias2.push_back(Pt_reco_two_Target_mbias2);
  Pi0InvMassReco_two_Target_mbias2 =
    new TH1D("Pi0InvMassReco_two_Target_mbias2",
             "Pi0InvMassReco_two_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_two_Target_mbias2.push_back(Pi0InvMassReco_two_Target_mbias2);
  EMT_InvMass_two_Target_mbias2 =
    new TH1D("EMT_InvMass_two_Target_mbias2",
             "EMT_InvMass_two_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_two_Target_mbias2.push_back(EMT_InvMass_two_Target_mbias2);
  Pi0_pt_vs_rap_two_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_two_Target_mbias2",
             "Pi0_pt_vs_rap_two_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_two_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_two_Target_mbias2",
             "Pi0_pt_vs_rap_est_two_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  GammaInvMassReco_onetwo_Target_mbias2 = new TH1D(
    "GammaInvMassReco_onetwo_Target_mbias2",
    "GammaInvMassReco_onetwo_Target_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_onetwo_Target_mbias2.push_back(
    GammaInvMassReco_onetwo_Target_mbias2);
  GammaOpeningAngleReco_onetwo_Target_mbias2 =
    new TH1D("GammaOpeningAngleReco_onetwo_Target_mbias2",
             "GammaOpeningAngleReco_onetwo_Target_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_onetwo_Target_mbias2.push_back(
    GammaOpeningAngleReco_onetwo_Target_mbias2);
  Pdg_onetwo_Target_mbias2 = new TH1D(
    "Pdg_onetwo_Target_mbias2", "Pdg_onetwo_Target_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_onetwo_Target_mbias2.push_back(Pdg_onetwo_Target_mbias2);
  P_reco_onetwo_Target_mbias2 =
    new TH1D("P_reco_onetwo_Target_mbias2",
             "P_reco_onetwo_Target_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_onetwo_Target_mbias2.push_back(P_reco_onetwo_Target_mbias2);
  Pt_reco_onetwo_Target_mbias2 =
    new TH1D("Pt_reco_onetwo_Target_mbias2",
             "Pt_reco_onetwo_Target_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_onetwo_Target_mbias2.push_back(Pt_reco_onetwo_Target_mbias2);
  Pi0InvMassReco_onetwo_Target_mbias2 = new TH1D(
    "Pi0InvMassReco_onetwo_Target_mbias2",
    "Pi0InvMassReco_onetwo_Target_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_man_onetwo_Target_mbias2.push_back(
  ...
  EMT_InvMass_onetwo_Target_mbias2 =
    new TH1D("EMT_InvMass_onetwo_Target_mbias2",
             "EMT_InvMass_onetwo_Target_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_onetwo_Target_mbias2.push_back(
    EMT_InvMass_onetwo_Target_mbias2);
  Pi0_pt_vs_rap_onetwo_Target_mbias2 =
    new TH2D("Pi0_pt_vs_rap_onetwo_Target_mbias2",
             "Pi0_pt_vs_rap_onetwo_Target_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  fHistoList_man_onetwo_Target_mbias2.push_back(
    Pi0_pt_vs_rap_onetwo_Target_mbias2);
  Pi0_pt_vs_rap_est_onetwo_Target_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_onetwo_Target_mbias2",
    "Pi0_pt_vs_rap_est_onetwo_Target_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  // Outside_mbias2 => all
  GammaInvMassReco_all_Outside_mbias2 = new TH1D(
    "GammaInvMassReco_all_Outside_mbias2",
    "GammaInvMassReco_all_Outside_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_all_Outside_mbias2.push_back(
    GammaInvMassReco_all_Outside_mbias2);
  GammaOpeningAngleReco_all_Outside_mbias2 =
    new TH1D("GammaOpeningAngleReco_all_Outside_mbias2",
             "GammaOpeningAngleReco_all_Outside_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_all_Outside_mbias2.push_back(
    GammaOpeningAngleReco_all_Outside_mbias2);
  Pdg_all_Outside_mbias2 = new TH1D(
    "Pdg_all_Outside_mbias2", "Pdg_all_Outside_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_all_Outside_mbias2.push_back(Pdg_all_Outside_mbias2);
  P_reco_all_Outside_mbias2 =
    new TH1D("P_reco_all_Outside_mbias2",
             "P_reco_all_Outside_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_all_Outside_mbias2.push_back(P_reco_all_Outside_mbias2);
  Pt_reco_all_Outside_mbias2 =
    new TH1D("Pt_reco_all_Outside_mbias2",
             "Pt_reco_all_Outside_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_all_Outside_mbias2.push_back(Pt_reco_all_Outside_mbias2);
  Pi0InvMassReco_all_Outside_mbias2 =
    new TH1D("Pi0InvMassReco_all_Outside_mbias2",
             "Pi0InvMassReco_all_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_all_Outside_mbias2.push_back(
    Pi0InvMassReco_all_Outside_mbias2);
  EMT_InvMass_all_Outside_mbias2 =
    new TH1D("EMT_InvMass_all_Outside_mbias2",
             "EMT_InvMass_all_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_all_Outside_mbias2.push_back(EMT_InvMass_all_Outside_mbias2);
  Pi0_pt_vs_rap_all_Outside_mbias2 =
    new TH2D("Pi0_pt_vs_rap_all_Outside_mbias2",
             "Pi0_pt_vs_rap_all_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_all_Outside_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_all_Outside_mbias2",
    "Pi0_pt_vs_rap_est_all_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  // Outside_mbias2 => zero
  GammaInvMassReco_zero_Outside_mbias2 = new TH1D(
    "GammaInvMassReco_zero_Outside_mbias2",
    "GammaInvMassReco_zero_Outside_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_zero_Outside_mbias2.push_back(
    GammaInvMassReco_zero_Outside_mbias2);
  GammaOpeningAngleReco_zero_Outside_mbias2 =
    new TH1D("GammaOpeningAngleReco_zero_Outside_mbias2",
             "GammaOpeningAngleReco_zero_Outside_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_zero_Outside_mbias2.push_back(
    GammaOpeningAngleReco_zero_Outside_mbias2);
  Pdg_zero_Outside_mbias2 = new TH1D(
    "Pdg_zero_Outside_mbias2", "Pdg_zero_Outside_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_zero_Outside_mbias2.push_back(Pdg_zero_Outside_mbias2);
  P_reco_zero_Outside_mbias2 =
    new TH1D("P_reco_zero_Outside_mbias2",
             "P_reco_zero_Outside_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_zero_Outside_mbias2.push_back(P_reco_zero_Outside_mbias2);
  Pt_reco_zero_Outside_mbias2 =
    new TH1D("Pt_reco_zero_Outside_mbias2",
             "Pt_reco_zero_Outside_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_zero_Outside_mbias2.push_back(Pt_reco_zero_Outside_mbias2);
  Pi0InvMassReco_zero_Outside_mbias2 = new TH1D(
    "Pi0InvMassReco_zero_Outside_mbias2",
    "Pi0InvMassReco_zero_Outside_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_man_zero_Outside_mbias2.push_back(
    Pi0InvMassReco_zero_Outside_mbias2);
  EMT_InvMass_zero_Outside_mbias2 =
    new TH1D("EMT_InvMass_zero_Outside_mbias2",
             "EMT_InvMass_zero_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_zero_Outside_mbias2.push_back(EMT_InvMass_zero_Outside_mbias2);
  Pi0_pt_vs_rap_zero_Outside_mbias2 =
    new TH2D("Pi0_pt_vs_rap_zero_Outside_mbias2",
             "Pi0_pt_vs_rap_zero_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  fHistoList_man_zero_Outside_mbias2.push_back(
    Pi0_pt_vs_rap_zero_Outside_mbias2);
  Pi0_pt_vs_rap_est_zero_Outside_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_zero_Outside_mbias2",
    "Pi0_pt_vs_rap_est_zero_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  // Outside_mbias2 => one
  GammaInvMassReco_one_Outside_mbias2 = new TH1D(
    "GammaInvMassReco_one_Outside_mbias2",
    "GammaInvMassReco_one_Outside_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_one_Outside_mbias2.push_back(
    GammaInvMassReco_one_Outside_mbias2);
  GammaOpeningAngleReco_one_Outside_mbias2 =
    new TH1D("GammaOpeningAngleReco_one_Outside_mbias2",
             "GammaOpeningAngleReco_one_Outside_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_one_Outside_mbias2.push_back(
    GammaOpeningAngleReco_one_Outside_mbias2);
  Pdg_one_Outside_mbias2 = new TH1D(
    "Pdg_one_Outside_mbias2", "Pdg_one_Outside_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_one_Outside_mbias2.push_back(Pdg_one_Outside_mbias2);
  P_reco_one_Outside_mbias2 =
    new TH1D("P_reco_one_Outside_mbias2",
             "P_reco_one_Outside_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_one_Outside_mbias2.push_back(P_reco_one_Outside_mbias2);
  Pt_reco_one_Outside_mbias2 =
    new TH1D("Pt_reco_one_Outside_mbias2",
             "Pt_reco_one_Outside_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_one_Outside_mbias2.push_back(Pt_reco_one_Outside_mbias2);
  Pi0InvMassReco_one_Outside_mbias2 =
    new TH1D("Pi0InvMassReco_one_Outside_mbias2",
             "Pi0InvMassReco_one_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_one_Outside_mbias2.push_back(
    Pi0InvMassReco_one_Outside_mbias2);
  EMT_InvMass_one_Outside_mbias2 =
    new TH1D("EMT_InvMass_one_Outside_mbias2",
             "EMT_InvMass_one_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_one_Outside_mbias2.push_back(EMT_InvMass_one_Outside_mbias2);
  Pi0_pt_vs_rap_one_Outside_mbias2 =
    new TH2D("Pi0_pt_vs_rap_one_Outside_mbias2",
             "Pi0_pt_vs_rap_one_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_one_Outside_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_one_Outside_mbias2",
    "Pi0_pt_vs_rap_est_one_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  // Outside_mbias2 => two
  GammaInvMassReco_two_Outside_mbias2 = new TH1D(
    "GammaInvMassReco_two_Outside_mbias2",
    "GammaInvMassReco_two_Outside_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_two_Outside_mbias2.push_back(
    GammaInvMassReco_two_Outside_mbias2);
  GammaOpeningAngleReco_two_Outside_mbias2 =
    new TH1D("GammaOpeningAngleReco_two_Outside_mbias2",
             "GammaOpeningAngleReco_two_Outside_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_two_Outside_mbias2.push_back(
    GammaOpeningAngleReco_two_Outside_mbias2);
  Pdg_two_Outside_mbias2 = new TH1D(
    "Pdg_two_Outside_mbias2", "Pdg_two_Outside_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_two_Outside_mbias2.push_back(Pdg_two_Outside_mbias2);
  P_reco_two_Outside_mbias2 =
    new TH1D("P_reco_two_Outside_mbias2",
             "P_reco_two_Outside_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_two_Outside_mbias2.push_back(P_reco_two_Outside_mbias2);
  Pt_reco_two_Outside_mbias2 =
    new TH1D("Pt_reco_two_Outside_mbias2",
             "Pt_reco_two_Outside_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_two_Outside_mbias2.push_back(Pt_reco_two_Outside_mbias2);
  Pi0InvMassReco_two_Outside_mbias2 =
    new TH1D("Pi0InvMassReco_two_Outside_mbias2",
             "Pi0InvMassReco_two_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_two_Outside_mbias2.push_back(
    Pi0InvMassReco_two_Outside_mbias2);
  EMT_InvMass_two_Outside_mbias2 =
    new TH1D("EMT_InvMass_two_Outside_mbias2",
             "EMT_InvMass_two_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_two_Outside_mbias2.push_back(EMT_InvMass_two_Outside_mbias2);
  Pi0_pt_vs_rap_two_Outside_mbias2 =
    new TH2D("Pi0_pt_vs_rap_two_Outside_mbias2",
             "Pi0_pt_vs_rap_two_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_two_Outside_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_two_Outside_mbias2",
    "Pi0_pt_vs_rap_est_two_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  GammaInvMassReco_onetwo_Outside_mbias2 = new TH1D(
    "GammaInvMassReco_onetwo_Outside_mbias2",
    "GammaInvMassReco_onetwo_Outside_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_onetwo_Outside_mbias2.push_back(
    GammaInvMassReco_onetwo_Outside_mbias2);
  GammaOpeningAngleReco_onetwo_Outside_mbias2 =
    new TH1D("GammaOpeningAngleReco_onetwo_Outside_mbias2",
             "GammaOpeningAngleReco_onetwo_Outside_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_onetwo_Outside_mbias2.push_back(
    GammaOpeningAngleReco_onetwo_Outside_mbias2);
  Pdg_onetwo_Outside_mbias2 = new TH1D("Pdg_onetwo_Outside_mbias2",
                                       "Pdg_onetwo_Outside_mbias2; Id;#",
                                       800,
                                       0,
                                       400);
  fHistoList_man_onetwo_Outside_mbias2.push_back(Pdg_onetwo_Outside_mbias2);
  P_reco_onetwo_Outside_mbias2 =
    new TH1D("P_reco_onetwo_Outside_mbias2",
             "P_reco_onetwo_Outside_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_onetwo_Outside_mbias2.push_back(P_reco_onetwo_Outside_mbias2);
  Pt_reco_onetwo_Outside_mbias2 =
    new TH1D("Pt_reco_onetwo_Outside_mbias2",
             "Pt_reco_onetwo_Outside_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_onetwo_Outside_mbias2.push_back(Pt_reco_onetwo_Outside_mbias2);
  Pi0InvMassReco_onetwo_Outside_mbias2 = new TH1D(
    "Pi0InvMassReco_onetwo_Outside_mbias2",
    "Pi0InvMassReco_onetwo_Outside_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_man_onetwo_Outside_mbias2.push_back(
  ...
  EMT_InvMass_onetwo_Outside_mbias2 =
    new TH1D("EMT_InvMass_onetwo_Outside_mbias2",
             "EMT_InvMass_onetwo_Outside_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_onetwo_Outside_mbias2.push_back(
    EMT_InvMass_onetwo_Outside_mbias2);
  Pi0_pt_vs_rap_onetwo_Outside_mbias2 =
    new TH2D("Pi0_pt_vs_rap_onetwo_Outside_mbias2",
             "Pi0_pt_vs_rap_onetwo_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  fHistoList_man_onetwo_Outside_mbias2.push_back(
    Pi0_pt_vs_rap_onetwo_Outside_mbias2);
  Pi0_pt_vs_rap_est_onetwo_Outside_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_onetwo_Outside_mbias2",
    "Pi0_pt_vs_rap_est_onetwo_Outside_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  GammaInvMassReco_all_Both_mbias2 =
    new TH1D("GammaInvMassReco_all_Both_mbias2",
             "GammaInvMassReco_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             110,
             -0.01,
             0.1);
  fHistoList_man_all_Both_mbias2.push_back(GammaInvMassReco_all_Both_mbias2);
  GammaOpeningAngleReco_all_Both_mbias2 =
    new TH1D("GammaOpeningAngleReco_all_Both_mbias2",
             "GammaOpeningAngleReco_all_Both_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_all_Both_mbias2.push_back(
    GammaOpeningAngleReco_all_Both_mbias2);
  Pdg_all_Both_mbias2 =
    new TH1D("Pdg_all_Both_mbias2", "Pdg_all_Both_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_all_Both_mbias2.push_back(Pdg_all_Both_mbias2);
  P_reco_all_Both_mbias2 = new TH1D("P_reco_all_Both_mbias2",
                                    "P_reco_all_Both_mbias2; P in GeV/c^{2};#",
                                    600,
                                    0,
                                    6);
  fHistoList_man_all_Both_mbias2.push_back(P_reco_all_Both_mbias2);
  Pt_reco_all_Both_mbias2 =
    new TH1D("Pt_reco_all_Both_mbias2",
             "Pt_reco_all_Both_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_all_Both_mbias2.push_back(Pt_reco_all_Both_mbias2);
  Pi0InvMassReco_all_Both_mbias2 =
    new TH1D("Pi0InvMassReco_all_Both_mbias2",
             "Pi0InvMassReco_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_all_Both_mbias2.push_back(Pi0InvMassReco_all_Both_mbias2);
  EMT_InvMass_all_Both_mbias2 =
    new TH1D("EMT_InvMass_all_Both_mbias2",
             "EMT_InvMass_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_all_Both_mbias2.push_back(EMT_InvMass_all_Both_mbias2);
  Pi0_pt_vs_rap_all_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_all_Both_mbias2",
             "Pi0_pt_vs_rap_all_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_all_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_all_Both_mbias2",
             "Pi0_pt_vs_rap_est_all_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  GammaInvMassReco_zero_Both_mbias2 =
    new TH1D("GammaInvMassReco_zero_Both_mbias2",
             "GammaInvMassReco_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             110,
             -0.01,
             0.1);
  fHistoList_man_zero_Both_mbias2.push_back(GammaInvMassReco_zero_Both_mbias2);
  GammaOpeningAngleReco_zero_Both_mbias2 =
    new TH1D("GammaOpeningAngleReco_zero_Both_mbias2",
             "GammaOpeningAngleReco_zero_Both_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_zero_Both_mbias2.push_back(
    GammaOpeningAngleReco_zero_Both_mbias2);
  Pdg_zero_Both_mbias2 =
    new TH1D("Pdg_zero_Both_mbias2", "Pdg_zero_Both_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_zero_Both_mbias2.push_back(Pdg_zero_Both_mbias2);
  P_reco_zero_Both_mbias2 =
    new TH1D("P_reco_zero_Both_mbias2",
             "P_reco_zero_Both_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_zero_Both_mbias2.push_back(P_reco_zero_Both_mbias2);
  Pt_reco_zero_Both_mbias2 =
    new TH1D("Pt_reco_zero_Both_mbias2",
             "Pt_reco_zero_Both_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_zero_Both_mbias2.push_back(Pt_reco_zero_Both_mbias2);
  Pi0InvMassReco_zero_Both_mbias2 =
    new TH1D("Pi0InvMassReco_zero_Both_mbias2",
             "Pi0InvMassReco_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_zero_Both_mbias2.push_back(Pi0InvMassReco_zero_Both_mbias2);
  EMT_InvMass_zero_Both_mbias2 =
    new TH1D("EMT_InvMass_zero_Both_mbias2",
             "EMT_InvMass_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_zero_Both_mbias2.push_back(EMT_InvMass_zero_Both_mbias2);
  Pi0_pt_vs_rap_zero_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_zero_Both_mbias2",
             "Pi0_pt_vs_rap_zero_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_zero_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_zero_Both_mbias2",
             "Pi0_pt_vs_rap_est_zero_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  GammaInvMassReco_one_Both_mbias2 =
    new TH1D("GammaInvMassReco_one_Both_mbias2",
             "GammaInvMassReco_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             110,
             -0.01,
             0.1);
  fHistoList_man_one_Both_mbias2.push_back(GammaInvMassReco_one_Both_mbias2);
  GammaOpeningAngleReco_one_Both_mbias2 =
    new TH1D("GammaOpeningAngleReco_one_Both_mbias2",
             "GammaOpeningAngleReco_one_Both_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_one_Both_mbias2.push_back(
    GammaOpeningAngleReco_one_Both_mbias2);
  Pdg_one_Both_mbias2 =
    new TH1D("Pdg_one_Both_mbias2", "Pdg_one_Both_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_one_Both_mbias2.push_back(Pdg_one_Both_mbias2);
  P_reco_one_Both_mbias2 = new TH1D("P_reco_one_Both_mbias2",
                                    "P_reco_one_Both_mbias2; P in GeV/c^{2};#",
                                    600,
                                    0,
                                    6);
  fHistoList_man_one_Both_mbias2.push_back(P_reco_one_Both_mbias2);
  Pt_reco_one_Both_mbias2 =
    new TH1D("Pt_reco_one_Both_mbias2",
             "Pt_reco_one_Both_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_one_Both_mbias2.push_back(Pt_reco_one_Both_mbias2);
  Pi0InvMassReco_one_Both_mbias2 =
    new TH1D("Pi0InvMassReco_one_Both_mbias2",
             "Pi0InvMassReco_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_one_Both_mbias2.push_back(Pi0InvMassReco_one_Both_mbias2);
  EMT_InvMass_one_Both_mbias2 =
    new TH1D("EMT_InvMass_one_Both_mbias2",
             "EMT_InvMass_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_one_Both_mbias2.push_back(EMT_InvMass_one_Both_mbias2);
  Pi0_pt_vs_rap_one_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_one_Both_mbias2",
             "Pi0_pt_vs_rap_one_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_one_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_one_Both_mbias2",
             "Pi0_pt_vs_rap_est_one_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  GammaInvMassReco_two_Both_mbias2 =
    new TH1D("GammaInvMassReco_two_Both_mbias2",
             "GammaInvMassReco_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             110,
             -0.01,
             0.1);
  fHistoList_man_two_Both_mbias2.push_back(GammaInvMassReco_two_Both_mbias2);
  GammaOpeningAngleReco_two_Both_mbias2 =
    new TH1D("GammaOpeningAngleReco_two_Both_mbias2",
             "GammaOpeningAngleReco_two_Both_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_two_Both_mbias2.push_back(
    GammaOpeningAngleReco_two_Both_mbias2);
  Pdg_two_Both_mbias2 =
    new TH1D("Pdg_two_Both_mbias2", "Pdg_two_Both_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_two_Both_mbias2.push_back(Pdg_two_Both_mbias2);
  P_reco_two_Both_mbias2 = new TH1D("P_reco_two_Both_mbias2",
                                    "P_reco_two_Both_mbias2; P in GeV/c^{2};#",
                                    600,
                                    0,
                                    6);
  fHistoList_man_two_Both_mbias2.push_back(P_reco_two_Both_mbias2);
  Pt_reco_two_Both_mbias2 =
    new TH1D("Pt_reco_two_Both_mbias2",
             "Pt_reco_two_Both_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_two_Both_mbias2.push_back(Pt_reco_two_Both_mbias2);
  Pi0InvMassReco_two_Both_mbias2 =
    new TH1D("Pi0InvMassReco_two_Both_mbias2",
             "Pi0InvMassReco_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_two_Both_mbias2.push_back(Pi0InvMassReco_two_Both_mbias2);
  EMT_InvMass_two_Both_mbias2 =
    new TH1D("EMT_InvMass_two_Both_mbias2",
             "EMT_InvMass_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_two_Both_mbias2.push_back(EMT_InvMass_two_Both_mbias2);
  Pi0_pt_vs_rap_two_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_two_Both_mbias2",
             "Pi0_pt_vs_rap_two_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_two_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_est_two_Both_mbias2",
             "Pi0_pt_vs_rap_est_two_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             10,
             0.,
             4.,
             10,
  ...
  // Both_mbias2 => onetwo
  GammaInvMassReco_onetwo_Both_mbias2 = new TH1D(
    "GammaInvMassReco_onetwo_Both_mbias2",
    "GammaInvMassReco_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    110,
    -0.01,
    0.1);
  fHistoList_man_onetwo_Both_mbias2.push_back(
    GammaInvMassReco_onetwo_Both_mbias2);
  GammaOpeningAngleReco_onetwo_Both_mbias2 =
    new TH1D("GammaOpeningAngleReco_onetwo_Both_mbias2",
             "GammaOpeningAngleReco_onetwo_Both_mbias2; angle [deg];#",
             200,
             -0.1,
             19.9);
  fHistoList_man_onetwo_Both_mbias2.push_back(
    GammaOpeningAngleReco_onetwo_Both_mbias2);
  Pdg_onetwo_Both_mbias2 = new TH1D(
    "Pdg_onetwo_Both_mbias2", "Pdg_onetwo_Both_mbias2; Id;#", 800, 0, 400);
  fHistoList_man_onetwo_Both_mbias2.push_back(Pdg_onetwo_Both_mbias2);
  P_reco_onetwo_Both_mbias2 =
    new TH1D("P_reco_onetwo_Both_mbias2",
             "P_reco_onetwo_Both_mbias2; P in GeV/c^{2};#",
             600,
             0,
             6);
  fHistoList_man_onetwo_Both_mbias2.push_back(P_reco_onetwo_Both_mbias2);
  Pt_reco_onetwo_Both_mbias2 =
    new TH1D("Pt_reco_onetwo_Both_mbias2",
             "Pt_reco_onetwo_Both_mbias2; P_{t} in GeV/c^{2};#",
             300,
             0,
             3);
  fHistoList_man_onetwo_Both_mbias2.push_back(Pt_reco_onetwo_Both_mbias2);
  Pi0InvMassReco_onetwo_Both_mbias2 =
    new TH1D("Pi0InvMassReco_onetwo_Both_mbias2",
             "Pi0InvMassReco_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_onetwo_Both_mbias2.push_back(
    Pi0InvMassReco_onetwo_Both_mbias2);
  EMT_InvMass_onetwo_Both_mbias2 =
    new TH1D("EMT_InvMass_onetwo_Both_mbias2",
             "EMT_InvMass_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_man_onetwo_Both_mbias2.push_back(EMT_InvMass_onetwo_Both_mbias2);
  Pi0_pt_vs_rap_onetwo_Both_mbias2 =
    new TH2D("Pi0_pt_vs_rap_onetwo_Both_mbias2",
             "Pi0_pt_vs_rap_onetwo_Both_mbias2; rapidity y; p_{t} in GeV/c ",
             90,
             -2.,
             7.,
             60,
  ...
  Pi0_pt_vs_rap_est_onetwo_Both_mbias2 = new TH2D(
    "Pi0_pt_vs_rap_est_onetwo_Both_mbias2",
    "Pi0_pt_vs_rap_est_onetwo_Both_mbias2; rapidity y; p_{t} in GeV/c ",
    10,
    0.,
    4.,
    10,
  ...
  Pdg_vs_Distance_mbias2 =
    new TH2D("Pdg_vs_Distance_mbias2",
             "Pdg_vs_Distance_mbias2; pdg; distance in cm",
             2500,
             0,
             2499,
             500,
  ...
  P_vs_Distance_mbias2 =
    new TH2D("P_vs_Distance_mbias2",
  ...
  MultiplicityGamma_all_Target_mbias2 =
    new TH2D("MultiplicityGamma_all_Target_mbias2",
             ...
             0,
             2.0);
  fHistoList_multiplicity_man_Target_mbias2.push_back(
    MultiplicityGamma_all_Target_mbias2);
  MultiplicityGamma_zero_Target_mbias2 =
    new TH2D("MultiplicityGamma_zero_Target_mbias2",
  ...
  fHistoList_multiplicity_man_Target_mbias2.push_back(
    MultiplicityGamma_zero_Target_mbias2);
  MultiplicityGamma_one_Target_mbias2 =
    new TH2D("MultiplicityGamma_one_Target_mbias2",
  ...
  fHistoList_multiplicity_man_Target_mbias2.push_back(
    MultiplicityGamma_one_Target_mbias2);
  MultiplicityGamma_two_Target_mbias2 =
    new TH2D("MultiplicityGamma_two_Target_mbias2",
  ...
  fHistoList_multiplicity_man_Target_mbias2.push_back(
    MultiplicityGamma_two_Target_mbias2);
  MultiplicityGamma_onetwo_Target_mbias2 =
    new TH2D("MultiplicityGamma_onetwo_Target_mbias2",
  ...
  MultiplicityGamma_all_Outside_mbias2 =
    new TH2D("MultiplicityGamma_all_Outside_mbias2",
             ...
             0,
             2.0);
  fHistoList_multiplicity_man_Outside_mbias2.push_back(
    MultiplicityGamma_all_Outside_mbias2);
  MultiplicityGamma_zero_Outside_mbias2 =
    new TH2D("MultiplicityGamma_zero_Outside_mbias2",
  ...
  fHistoList_multiplicity_man_Outside_mbias2.push_back(
    MultiplicityGamma_zero_Outside_mbias2);
  MultiplicityGamma_one_Outside_mbias2 =
    new TH2D("MultiplicityGamma_one_Outside_mbias2",
  ...
  fHistoList_multiplicity_man_Outside_mbias2.push_back(
    MultiplicityGamma_one_Outside_mbias2);
  MultiplicityGamma_two_Outside_mbias2 =
    new TH2D("MultiplicityGamma_two_Outside_mbias2",
  ...
  fHistoList_multiplicity_man_Outside_mbias2.push_back(
    MultiplicityGamma_two_Outside_mbias2);
  MultiplicityGamma_onetwo_Outside_mbias2 =
    new TH2D("MultiplicityGamma_onetwo_Outside_mbias2",
  ...
  MultiplicityGamma_all_Both_mbias2 =
    new TH2D("MultiplicityGamma_all_Both_mbias2",
             ...
             0,
             2.0);
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityGamma_all_Both_mbias2);
  MultiplicityGamma_zero_Both_mbias2 =
    new TH2D("MultiplicityGamma_zero_Both_mbias2",
  ...
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityGamma_zero_Both_mbias2);
  MultiplicityGamma_one_Both_mbias2 =
    new TH2D("MultiplicityGamma_one_Both_mbias2",
  ...
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityGamma_one_Both_mbias2);
  MultiplicityGamma_two_Both_mbias2 =
    new TH2D("MultiplicityGamma_two_Both_mbias2",
  ...
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityGamma_two_Both_mbias2);
  MultiplicityGamma_onetwo_Both_mbias2 =
    new TH2D("MultiplicityGamma_onetwo_Both_mbias2",
  ...
  MultiplicityChargedParticles_all_Both_mbias2 =
    new TH2D("MultiplicityChargedParticles_all_Both_mbias2",
  ...
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityChargedParticles_all_Both_mbias2);
  MultiplicityChargedParticles_zero_Both_mbias2 =
    new TH2D("MultiplicityChargedParticles_zero_Both_mbias2",
  ...
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityChargedParticles_zero_Both_mbias2);
  MultiplicityChargedParticles_one_Both_mbias2 =
    new TH2D("MultiplicityChargedParticles_one_Both_mbias2",
  ...
  fHistoList_multiplicity_man_Both_mbias2.push_back(
    MultiplicityChargedParticles_one_Both_mbias2);
  MultiplicityChargedParticles_two_Both_mbias2 =
    new TH2D("MultiplicityChargedParticles_two_Both_mbias2",
  ...
  fHistoList_rap_vs_pt_InM_mbias2.push_back(
    Pi0_pt_vs_rap_est_onetwo_Both_mbias2);
  rap_vs_Pt_InM_1_mbias2 =
    new TH1D("rap_vs_Pt_InM_1_mbias2",
  ...
  rap_vs_Pt_InM_2_mbias2 =
    new TH1D("rap_vs_Pt_InM_2_mbias2",
  ...
  rap_vs_Pt_InM_3_mbias2 =
    new TH1D("rap_vs_Pt_InM_3_mbias2",
  ...
  rap_vs_Pt_InM_4_mbias2 =
    new TH1D("rap_vs_Pt_InM_4_mbias2",
  ...
  rap_vs_Pt_InM_5_mbias2 =
    new TH1D("rap_vs_Pt_InM_5_mbias2",
  ...
  rap_vs_Pt_InM_6_mbias2 =
    new TH1D("rap_vs_Pt_InM_6_mbias2",
  ...
  rap_vs_Pt_InM_7_mbias2 =
    new TH1D("rap_vs_Pt_InM_7_mbias2",
  ...
  rap_vs_Pt_InM_8_mbias2 =
    new TH1D("rap_vs_Pt_InM_8_mbias2",
  ...
  rap_vs_Pt_InM_9_mbias2 =
    new TH1D("rap_vs_Pt_InM_9_mbias2",
  ...
  rap_vs_Pt_InM_10_mbias2 =
    new TH1D("rap_vs_Pt_InM_10_mbias2",
  ...
  rap_vs_Pt_InM_11_mbias2 =
    new TH1D("rap_vs_Pt_InM_11_mbias2",
  ...
  rap_vs_Pt_InM_12_mbias2 =
    new TH1D("rap_vs_Pt_InM_12_mbias2",
  ...
  rap_vs_Pt_InM_13_mbias2 =
    new TH1D("rap_vs_Pt_InM_13_mbias2",
  ...
  rap_vs_Pt_InM_14_mbias2 =
    new TH1D("rap_vs_Pt_InM_14_mbias2",
  ...
  rap_vs_Pt_InM_15_mbias2 =
    new TH1D("rap_vs_Pt_InM_15_mbias2",
  ...
  rap_vs_Pt_InM_16_mbias2 =
    new TH1D("rap_vs_Pt_InM_16_mbias2",
  ...
  rap_vs_Pt_InM_17_mbias2 =
    new TH1D("rap_vs_Pt_InM_17_mbias2",
  ...
  rap_vs_Pt_InM_18_mbias2 =
    new TH1D("rap_vs_Pt_InM_18_mbias2",
  ...
  rap_vs_Pt_InM_19_mbias2 =
    new TH1D("rap_vs_Pt_InM_19_mbias2",
  ...
  rap_vs_Pt_InM_20_mbias2 =
    new TH1D("rap_vs_Pt_InM_20_mbias2",
  ...
  rap_vs_Pt_InM_21_mbias2 =
    new TH1D("rap_vs_Pt_InM_21_mbias2",
  ...
  rap_vs_Pt_InM_22_mbias2 =
    new TH1D("rap_vs_Pt_InM_22_mbias2",
  ...
  rap_vs_Pt_InM_23_mbias2 =
    new TH1D("rap_vs_Pt_InM_23_mbias2",
  ...
  rap_vs_Pt_InM_24_mbias2 =
    new TH1D("rap_vs_Pt_InM_24_mbias2",
  ...
  rap_vs_Pt_InM_25_mbias2 =
    new TH1D("rap_vs_Pt_InM_25_mbias2",
  ...
  rap_vs_Pt_InM_26_mbias2 =
    new TH1D("rap_vs_Pt_InM_26_mbias2",
  ...
  rap_vs_Pt_InM_27_mbias2 =
    new TH1D("rap_vs_Pt_InM_27_mbias2",
  ...
  rap_vs_Pt_InM_28_mbias2 =
    new TH1D("rap_vs_Pt_InM_28_mbias2",
  ...
  rap_vs_Pt_InM_29_mbias2 =
    new TH1D("rap_vs_Pt_InM_29_mbias2",
  ...
  rap_vs_Pt_InM_30_mbias2 =
    new TH1D("rap_vs_Pt_InM_30_mbias2",
  ...
  rap_vs_Pt_InM_mixing_1_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_1_mbias2",
             "rapidity = (1.2-1.6)      P_{t} = (0.0-0.4 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_2_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_2_mbias2",
             "rapidity = (1.2-1.6)      P_{t} = (0.4-0.8 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_3_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_3_mbias2",
             "rapidity = (1.2-1.6)      P_{t} = (0.8-1.2 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_4_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_4_mbias2",
             "rapidity = (1.2-1.6)      P_{t} = (1.2-1.6 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_5_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_5_mbias2",
             "rapidity = (1.2-1.6)      P_{t} = (1.6-2.0 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_6_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_6_mbias2",
             "rapidity = (1.6-2.0)      P_{t} = (0.0-0.4 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_7_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_7_mbias2",
             "rapidity = (1.6-2.0)      P_{t} = (0.4-0.8 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_8_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_8_mbias2",
             "rapidity = (1.6-2.0)      P_{t} = (0.8-1.2 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_9_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_9_mbias2",
             "rapidity = (1.6-2.0)      P_{t} = (1.2-1.6 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_10_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_10_mbias2",
             "rapidity = (1.6-2.0)      P_{t} = (1.6-2.0 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_11_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_11_mbias2",
             "rapidity = (2.0-2.4)      P_{t} = (0.0-0.4 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_12_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_12_mbias2",
             "rapidity = (2.0-2.4)      P_{t} = (0.4-0.8 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_13_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_13_mbias2",
             "rapidity = (2.0-2.4)      P_{t} = (0.8-1.2 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_14_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_14_mbias2",
             "rapidity = (2.0-2.4)      P_{t} = (1.2-1.6 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_15_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_15_mbias2",
             "rapidity = (2.0-2.4)      P_{t} = (1.6-2.0 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_16_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_16_mbias2",
             "rapidity = (2.4-2.8)      P_{t} = (0.0-0.4 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_17_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_17_mbias2",
             "rapidity = (2.4-2.8)      P_{t} = (0.4-0.8 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_18_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_18_mbias2",
             "rapidity = (2.4-2.8)      P_{t} = (0.8-1.2 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_19_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_19_mbias2",
             "rapidity = (2.4-2.8)      P_{t} = (1.2-1.6 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_20_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_20_mbias2",
             "rapidity = (2.4-2.8)      P_{t} = (1.6-2.0 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_21_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_21_mbias2",
             "rapidity = (2.8-3.2)      P_{t} = (0.0-0.4 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_22_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_22_mbias2",
             "rapidity = (2.8-3.2)      P_{t} = (0.4-0.8 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_23_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_23_mbias2",
             "rapidity = (2.8-3.2)      P_{t} = (0.8-1.2 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_24_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_24_mbias2",
             "rapidity = (2.8-3.2)      P_{t} = (1.2-1.6 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_25_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_25_mbias2",
             "rapidity = (2.8-3.2)      P_{t} = (1.6-2.0 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_26_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_26_mbias2",
             "rapidity = (3.2-3.6)      P_{t} = (0.0-0.4 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_27_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_27_mbias2",
             "rapidity = (3.2-3.6)      P_{t} = (0.4-0.8 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_28_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_28_mbias2",
             "rapidity = (3.2-3.6)      P_{t} = (0.8-1.2 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_29_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_29_mbias2",
             "rapidity = (3.2-3.6)      P_{t} = (1.2-1.6 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  rap_vs_Pt_InM_mixing_30_mbias2 =
    new TH1D("rap_vs_Pt_InM_mixing_30_mbias2",
             "rapidity = (3.2-3.6)      P_{t} = (1.6-2.0 GeV/c^{2}) ;invariant "
             "mass in GeV/c^{2};#",
             1000,
             0,
  ...
  BG1_InM_all_Both_mbias2 =
    new TH1D("BG1_InM_all_Both_mbias2",
             "BG1_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG1_InM_all_Both_mbias2);
  BG2_InM_all_Both_mbias2 =
    new TH1D("BG2_InM_all_Both_mbias2",
             "BG2_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG2_InM_all_Both_mbias2);
  BG3_InM_all_Both_mbias2 =
    new TH1D("BG3_InM_all_Both_mbias2",
             "BG3_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG3_InM_all_Both_mbias2);
  BG4_InM_all_Both_mbias2 =
    new TH1D("BG4_InM_all_Both_mbias2",
             "BG4_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG4_InM_all_Both_mbias2);
  BG5_InM_all_Both_mbias2 =
    new TH1D("BG5_InM_all_Both_mbias2",
             "BG5_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG5_InM_all_Both_mbias2);
  BG6_InM_all_Both_mbias2 =
    new TH1D("BG6_InM_all_Both_mbias2",
             "BG6_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG6_InM_all_Both_mbias2);
  BG7_InM_all_Both_mbias2 =
    new TH1D("BG7_InM_all_Both_mbias2",
             "BG7_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG7_InM_all_Both_mbias2);
  BG8_InM_all_Both_mbias2 =
    new TH1D("BG8_InM_all_Both_mbias2",
             "BG8_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG8_InM_all_Both_mbias2);
  BG9_InM_all_Both_mbias2 =
    new TH1D("BG9_InM_all_Both_mbias2",
             "BG9_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG9_InM_all_Both_mbias2);
  BG10_InM_all_Both_mbias2 =
    new TH1D("BG10_InM_all_Both_mbias2",
             "BG10_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(BG10_InM_all_Both_mbias2);
  PdgCase8_InM_all_Both_mbias2 = new TH1D("PdgCase8_InM_all_Both_mbias2",
                                          "PdgCase8_InM_all_Both_mbias2; Id ;#",
                                          5000,
                                          -2500,
                                          2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(PdgCase8_InM_all_Both_mbias2);
  PdgCase8mothers_InM_all_Both_mbias2 =
    new TH1D("PdgCase8mothers_InM_all_Both_mbias2",
             "PdgCase8mothers_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    PdgCase8mothers_InM_all_Both_mbias2);
  sameMIDcase8_InM_all_Both_mbias2 =
    new TH1D("sameMIDcase8_InM_all_Both_mbias2",
             "sameMIDcase8_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(sameMIDcase8_InM_all_Both_mbias2);
  sameGRIDcase8_InM_all_Both_mbias2 =
    new TH1D("sameGRIDcase8_InM_all_Both_mbias2",
             "sameGRIDcase8_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    sameGRIDcase8_InM_all_Both_mbias2);
  Case1ZYPos_InM_all_Both_mbias2 =
    new TH2D("Case1ZYPos_InM_all_Both_mbias2",
             "Case1ZYPos_InM_all_Both_mbias2; z[cm]; y[cm]",
             400,
             -1,
             200,
             200,
  ...
  sameMIDcase8_mothedPDG_InM_all_Both_mbias2 =
    new TH1D("sameMIDcase8_mothedPDG_InM_all_Both_mbias2",
             "sameMIDcase8_mothedPDG_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
  ...
  PdgCase8NonEComeFromTarget_mbias2_InM_all_Both_mbias2 =
    new TH1D("PdgCase8NonEComeFromTarget_mbias2_InM_all_Both_mbias2",
             "PdgCase8NonEComeFromTarget_mbias2_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
  ...
  PdgCase8NonE_NOT_FromTarget_mbias2_InM_all_Both_mbias2 =
    new TH1D("PdgCase8NonE_NOT_FromTarget_mbias2_InM_all_Both_mbias2",
             "PdgCase8NonE_NOT_FromTarget_mbias2_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    PdgCase8NonE_NOT_FromTarget_mbias2_InM_all_Both_mbias2);
  PdgCase8motherNonE_InM_all_Both_mbias2 =
    new TH1D("PdgCase8motherNonE_InM_all_Both_mbias2",
             "PdgCase8motherNonE_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    PdgCase8motherNonE_InM_all_Both_mbias2);
  Case8ElFromDalitz_InM_all_Both_mbias2 = new TH1D(
    "Case8ElFromDalitz_InM_all_Both_mbias2",
    "Case8ElFromDalitz_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    Case8ElFromDalitz_InM_all_Both_mbias2);
  Case8NonElFrom_pn_InM_all_Both_mbias2 = new TH1D(
    "Case8NonElFrom_pn_InM_all_Both_mbias2",
    "Case8NonElFrom_pn_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    Case8NonElFrom_pn_InM_all_Both_mbias2);
  Case8NonElFrom_eta_InM_all_Both_mbias2 = new TH1D(
    "Case8NonElFrom_eta_InM_all_Both_mbias2",
    "Case8NonElFrom_eta_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    Case8NonElFrom_eta_InM_all_Both_mbias2);
  Case8NonElFrom_kaon_InM_all_Both_mbias2 = new TH1D(
    "Case8NonElFrom_kaon_InM_all_Both_mbias2",
    "Case8NonElFrom_kaon_InM_all_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
    Case8NonElFrom_kaon_InM_all_Both_mbias2);
  sameMIDcase8NonEPdg_InM_all_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdg_InM_all_Both_mbias2",
             "sameMIDcase8NonEPdg_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEMotherPdg_InM_all_Both_mbias2 =
    new TH1D("sameMIDcase8NonEMotherPdg_InM_all_Both_mbias2",
             "sameMIDcase8NonEMotherPdg_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEPdgFromTarget_mbias2_InM_all_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdgFromTarget_mbias2_InM_all_Both_mbias2",
             "sameMIDcase8NonEPdgFromTarget_mbias2_InM_all_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_all_Both_mbias2.push_back(
  ...
  BG1_InM_zero_Both_mbias2 =
    new TH1D("BG1_InM_zero_Both_mbias2",
             "BG1_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG1_InM_zero_Both_mbias2);
  BG2_InM_zero_Both_mbias2 =
    new TH1D("BG2_InM_zero_Both_mbias2",
             "BG2_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG2_InM_zero_Both_mbias2);
  BG3_InM_zero_Both_mbias2 =
    new TH1D("BG3_InM_zero_Both_mbias2",
             "BG3_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG3_InM_zero_Both_mbias2);
  BG4_InM_zero_Both_mbias2 =
    new TH1D("BG4_InM_zero_Both_mbias2",
             "BG4_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG4_InM_zero_Both_mbias2);
  BG5_InM_zero_Both_mbias2 =
    new TH1D("BG5_InM_zero_Both_mbias2",
             "BG5_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG5_InM_zero_Both_mbias2);
  BG6_InM_zero_Both_mbias2 =
    new TH1D("BG6_InM_zero_Both_mbias2",
             "BG6_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG6_InM_zero_Both_mbias2);
  BG7_InM_zero_Both_mbias2 =
    new TH1D("BG7_InM_zero_Both_mbias2",
             "BG7_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG7_InM_zero_Both_mbias2);
  BG8_InM_zero_Both_mbias2 =
    new TH1D("BG8_InM_zero_Both_mbias2",
             "BG8_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG8_InM_zero_Both_mbias2);
  BG9_InM_zero_Both_mbias2 =
    new TH1D("BG9_InM_zero_Both_mbias2",
             "BG9_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG9_InM_zero_Both_mbias2);
  BG10_InM_zero_Both_mbias2 =
    new TH1D("BG10_InM_zero_Both_mbias2",
             "BG10_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(BG10_InM_zero_Both_mbias2);
  PdgCase8_InM_zero_Both_mbias2 =
    new TH1D("PdgCase8_InM_zero_Both_mbias2",
             "PdgCase8_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(PdgCase8_InM_zero_Both_mbias2);
  PdgCase8mothers_InM_zero_Both_mbias2 =
    new TH1D("PdgCase8mothers_InM_zero_Both_mbias2",
             "PdgCase8mothers_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    PdgCase8mothers_InM_zero_Both_mbias2);
  sameMIDcase8_InM_zero_Both_mbias2 =
    new TH1D("sameMIDcase8_InM_zero_Both_mbias2",
             "sameMIDcase8_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    sameMIDcase8_InM_zero_Both_mbias2);
  sameGRIDcase8_InM_zero_Both_mbias2 = new TH1D(
    "sameGRIDcase8_InM_zero_Both_mbias2",
    "sameGRIDcase8_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    sameGRIDcase8_InM_zero_Both_mbias2);
  Case1ZYPos_InM_zero_Both_mbias2 =
    new TH2D("Case1ZYPos_InM_zero_Both_mbias2",
             "Case1ZYPos_InM_zero_Both_mbias2; z[cm]; y[cm]",
             400,
             -1,
             200,
             200,
  ...
  sameMIDcase8_mothedPDG_InM_zero_Both_mbias2 =
    new TH1D("sameMIDcase8_mothedPDG_InM_zero_Both_mbias2",
             "sameMIDcase8_mothedPDG_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
  ...
  PdgCase8NonEComeFromTarget_mbias2_InM_zero_Both_mbias2 =
    new TH1D("PdgCase8NonEComeFromTarget_mbias2_InM_zero_Both_mbias2",
             "PdgCase8NonEComeFromTarget_mbias2_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
  ...
  PdgCase8NonE_NOT_FromTarget_mbias2_InM_zero_Both_mbias2 =
    new TH1D("PdgCase8NonE_NOT_FromTarget_mbias2_InM_zero_Both_mbias2",
             "PdgCase8NonE_NOT_FromTarget_mbias2_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    PdgCase8NonE_NOT_FromTarget_mbias2_InM_zero_Both_mbias2);
  PdgCase8motherNonE_InM_zero_Both_mbias2 =
    new TH1D("PdgCase8motherNonE_InM_zero_Both_mbias2",
             "PdgCase8motherNonE_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    PdgCase8motherNonE_InM_zero_Both_mbias2);
  Case8ElFromDalitz_InM_zero_Both_mbias2 = new TH1D(
    "Case8ElFromDalitz_InM_zero_Both_mbias2",
    "Case8ElFromDalitz_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    Case8ElFromDalitz_InM_zero_Both_mbias2);
  Case8NonElFrom_pn_InM_zero_Both_mbias2 = new TH1D(
    "Case8NonElFrom_pn_InM_zero_Both_mbias2",
    "Case8NonElFrom_pn_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    Case8NonElFrom_pn_InM_zero_Both_mbias2);
  Case8NonElFrom_eta_InM_zero_Both_mbias2 = new TH1D(
    "Case8NonElFrom_eta_InM_zero_Both_mbias2",
    "Case8NonElFrom_eta_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    Case8NonElFrom_eta_InM_zero_Both_mbias2);
  Case8NonElFrom_kaon_InM_zero_Both_mbias2 = new TH1D(
    "Case8NonElFrom_kaon_InM_zero_Both_mbias2",
    "Case8NonElFrom_kaon_InM_zero_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
    Case8NonElFrom_kaon_InM_zero_Both_mbias2);
  sameMIDcase8NonEPdg_InM_zero_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdg_InM_zero_Both_mbias2",
             "sameMIDcase8NonEPdg_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEMotherPdg_InM_zero_Both_mbias2 =
    new TH1D("sameMIDcase8NonEMotherPdg_InM_zero_Both_mbias2",
             "sameMIDcase8NonEMotherPdg_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEPdgFromTarget_mbias2_InM_zero_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdgFromTarget_mbias2_InM_zero_Both_mbias2",
             "sameMIDcase8NonEPdgFromTarget_mbias2_InM_zero_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_zero_Both_mbias2.push_back(
  ...
  BG1_InM_one_Both_mbias2 =
    new TH1D("BG1_InM_one_Both_mbias2",
             "BG1_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG1_InM_one_Both_mbias2);
  BG2_InM_one_Both_mbias2 =
    new TH1D("BG2_InM_one_Both_mbias2",
             "BG2_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG2_InM_one_Both_mbias2);
  BG3_InM_one_Both_mbias2 =
    new TH1D("BG3_InM_one_Both_mbias2",
             "BG3_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG3_InM_one_Both_mbias2);
  BG4_InM_one_Both_mbias2 =
    new TH1D("BG4_InM_one_Both_mbias2",
             "BG4_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG4_InM_one_Both_mbias2);
  BG5_InM_one_Both_mbias2 =
    new TH1D("BG5_InM_one_Both_mbias2",
             "BG5_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG5_InM_one_Both_mbias2);
  BG6_InM_one_Both_mbias2 =
    new TH1D("BG6_InM_one_Both_mbias2",
             "BG6_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG6_InM_one_Both_mbias2);
  BG7_InM_one_Both_mbias2 =
    new TH1D("BG7_InM_one_Both_mbias2",
             "BG7_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG7_InM_one_Both_mbias2);
  BG8_InM_one_Both_mbias2 =
    new TH1D("BG8_InM_one_Both_mbias2",
             "BG8_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG8_InM_one_Both_mbias2);
  BG9_InM_one_Both_mbias2 =
    new TH1D("BG9_InM_one_Both_mbias2",
             "BG9_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG9_InM_one_Both_mbias2);
  BG10_InM_one_Both_mbias2 =
    new TH1D("BG10_InM_one_Both_mbias2",
             "BG10_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(BG10_InM_one_Both_mbias2);
  PdgCase8_InM_one_Both_mbias2 = new TH1D("PdgCase8_InM_one_Both_mbias2",
                                          "PdgCase8_InM_one_Both_mbias2; Id ;#",
                                          5000,
                                          -2500,
                                          2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(PdgCase8_InM_one_Both_mbias2);
  PdgCase8mothers_InM_one_Both_mbias2 =
    new TH1D("PdgCase8mothers_InM_one_Both_mbias2",
             "PdgCase8mothers_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    PdgCase8mothers_InM_one_Both_mbias2);
  sameMIDcase8_InM_one_Both_mbias2 =
    new TH1D("sameMIDcase8_InM_one_Both_mbias2",
             "sameMIDcase8_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(sameMIDcase8_InM_one_Both_mbias2);
  sameGRIDcase8_InM_one_Both_mbias2 =
    new TH1D("sameGRIDcase8_InM_one_Both_mbias2",
             "sameGRIDcase8_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    sameGRIDcase8_InM_one_Both_mbias2);
  Case1ZYPos_InM_one_Both_mbias2 =
    new TH2D("Case1ZYPos_InM_one_Both_mbias2",
             "Case1ZYPos_InM_one_Both_mbias2; z[cm]; y[cm]",
             400,
             -1,
             200,
             200,
  ...
  sameMIDcase8_mothedPDG_InM_one_Both_mbias2 =
    new TH1D("sameMIDcase8_mothedPDG_InM_one_Both_mbias2",
             "sameMIDcase8_mothedPDG_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
  ...
  PdgCase8NonEComeFromTarget_mbias2_InM_one_Both_mbias2 =
    new TH1D("PdgCase8NonEComeFromTarget_mbias2_InM_one_Both_mbias2",
             "PdgCase8NonEComeFromTarget_mbias2_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
  ...
  PdgCase8NonE_NOT_FromTarget_mbias2_InM_one_Both_mbias2 =
    new TH1D("PdgCase8NonE_NOT_FromTarget_mbias2_InM_one_Both_mbias2",
             "PdgCase8NonE_NOT_FromTarget_mbias2_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    PdgCase8NonE_NOT_FromTarget_mbias2_InM_one_Both_mbias2);
  PdgCase8motherNonE_InM_one_Both_mbias2 =
    new TH1D("PdgCase8motherNonE_InM_one_Both_mbias2",
             "PdgCase8motherNonE_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    PdgCase8motherNonE_InM_one_Both_mbias2);
  Case8ElFromDalitz_InM_one_Both_mbias2 = new TH1D(
    "Case8ElFromDalitz_InM_one_Both_mbias2",
    "Case8ElFromDalitz_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    Case8ElFromDalitz_InM_one_Both_mbias2);
  Case8NonElFrom_pn_InM_one_Both_mbias2 = new TH1D(
    "Case8NonElFrom_pn_InM_one_Both_mbias2",
    "Case8NonElFrom_pn_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    Case8NonElFrom_pn_InM_one_Both_mbias2);
  Case8NonElFrom_eta_InM_one_Both_mbias2 = new TH1D(
    "Case8NonElFrom_eta_InM_one_Both_mbias2",
    "Case8NonElFrom_eta_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    Case8NonElFrom_eta_InM_one_Both_mbias2);
  Case8NonElFrom_kaon_InM_one_Both_mbias2 = new TH1D(
    "Case8NonElFrom_kaon_InM_one_Both_mbias2",
    "Case8NonElFrom_kaon_InM_one_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
    Case8NonElFrom_kaon_InM_one_Both_mbias2);
  sameMIDcase8NonEPdg_InM_one_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdg_InM_one_Both_mbias2",
             "sameMIDcase8NonEPdg_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEMotherPdg_InM_one_Both_mbias2 =
    new TH1D("sameMIDcase8NonEMotherPdg_InM_one_Both_mbias2",
             "sameMIDcase8NonEMotherPdg_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEPdgFromTarget_mbias2_InM_one_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdgFromTarget_mbias2_InM_one_Both_mbias2",
             "sameMIDcase8NonEPdgFromTarget_mbias2_InM_one_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_one_Both_mbias2.push_back(
  ...
  BG1_InM_two_Both_mbias2 =
    new TH1D("BG1_InM_two_Both_mbias2",
             "BG1_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG1_InM_two_Both_mbias2);
  BG2_InM_two_Both_mbias2 =
    new TH1D("BG2_InM_two_Both_mbias2",
             "BG2_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG2_InM_two_Both_mbias2);
  BG3_InM_two_Both_mbias2 =
    new TH1D("BG3_InM_two_Both_mbias2",
             "BG3_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG3_InM_two_Both_mbias2);
  BG4_InM_two_Both_mbias2 =
    new TH1D("BG4_InM_two_Both_mbias2",
             "BG4_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG4_InM_two_Both_mbias2);
  BG5_InM_two_Both_mbias2 =
    new TH1D("BG5_InM_two_Both_mbias2",
             "BG5_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG5_InM_two_Both_mbias2);
  BG6_InM_two_Both_mbias2 =
    new TH1D("BG6_InM_two_Both_mbias2",
             "BG6_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG6_InM_two_Both_mbias2);
  BG7_InM_two_Both_mbias2 =
    new TH1D("BG7_InM_two_Both_mbias2",
             "BG7_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG7_InM_two_Both_mbias2);
  BG8_InM_two_Both_mbias2 =
    new TH1D("BG8_InM_two_Both_mbias2",
             "BG8_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG8_InM_two_Both_mbias2);
  BG9_InM_two_Both_mbias2 =
    new TH1D("BG9_InM_two_Both_mbias2",
             "BG9_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG9_InM_two_Both_mbias2);
  BG10_InM_two_Both_mbias2 =
    new TH1D("BG10_InM_two_Both_mbias2",
             "BG10_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(BG10_InM_two_Both_mbias2);
  PdgCase8_InM_two_Both_mbias2 = new TH1D("PdgCase8_InM_two_Both_mbias2",
                                          "PdgCase8_InM_two_Both_mbias2; Id ;#",
                                          5000,
                                          -2500,
                                          2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(PdgCase8_InM_two_Both_mbias2);
  PdgCase8mothers_InM_two_Both_mbias2 =
    new TH1D("PdgCase8mothers_InM_two_Both_mbias2",
             "PdgCase8mothers_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    PdgCase8mothers_InM_two_Both_mbias2);
  sameMIDcase8_InM_two_Both_mbias2 =
    new TH1D("sameMIDcase8_InM_two_Both_mbias2",
             "sameMIDcase8_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(sameMIDcase8_InM_two_Both_mbias2);
  sameGRIDcase8_InM_two_Both_mbias2 =
    new TH1D("sameGRIDcase8_InM_two_Both_mbias2",
             "sameGRIDcase8_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    sameGRIDcase8_InM_two_Both_mbias2);
  Case1ZYPos_InM_two_Both_mbias2 =
    new TH2D("Case1ZYPos_InM_two_Both_mbias2",
             "Case1ZYPos_InM_two_Both_mbias2; z[cm]; y[cm]",
             400,
             -1,
             200,
             200,
  ...
  sameMIDcase8_mothedPDG_InM_two_Both_mbias2 =
    new TH1D("sameMIDcase8_mothedPDG_InM_two_Both_mbias2",
             "sameMIDcase8_mothedPDG_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
  ...
  PdgCase8NonEComeFromTarget_mbias2_InM_two_Both_mbias2 =
    new TH1D("PdgCase8NonEComeFromTarget_mbias2_InM_two_Both_mbias2",
             "PdgCase8NonEComeFromTarget_mbias2_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
  ...
  PdgCase8NonE_NOT_FromTarget_mbias2_InM_two_Both_mbias2 =
    new TH1D("PdgCase8NonE_NOT_FromTarget_mbias2_InM_two_Both_mbias2",
             "PdgCase8NonE_NOT_FromTarget_mbias2_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    PdgCase8NonE_NOT_FromTarget_mbias2_InM_two_Both_mbias2);
  PdgCase8motherNonE_InM_two_Both_mbias2 =
    new TH1D("PdgCase8motherNonE_InM_two_Both_mbias2",
             "PdgCase8motherNonE_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    PdgCase8motherNonE_InM_two_Both_mbias2);
  Case8ElFromDalitz_InM_two_Both_mbias2 = new TH1D(
    "Case8ElFromDalitz_InM_two_Both_mbias2",
    "Case8ElFromDalitz_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    Case8ElFromDalitz_InM_two_Both_mbias2);
  Case8NonElFrom_pn_InM_two_Both_mbias2 = new TH1D(
    "Case8NonElFrom_pn_InM_two_Both_mbias2",
    "Case8NonElFrom_pn_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    Case8NonElFrom_pn_InM_two_Both_mbias2);
  Case8NonElFrom_eta_InM_two_Both_mbias2 = new TH1D(
    "Case8NonElFrom_eta_InM_two_Both_mbias2",
    "Case8NonElFrom_eta_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    Case8NonElFrom_eta_InM_two_Both_mbias2);
  Case8NonElFrom_kaon_InM_two_Both_mbias2 = new TH1D(
    "Case8NonElFrom_kaon_InM_two_Both_mbias2",
    "Case8NonElFrom_kaon_InM_two_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
    Case8NonElFrom_kaon_InM_two_Both_mbias2);
  sameMIDcase8NonEPdg_InM_two_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdg_InM_two_Both_mbias2",
             "sameMIDcase8NonEPdg_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEMotherPdg_InM_two_Both_mbias2 =
    new TH1D("sameMIDcase8NonEMotherPdg_InM_two_Both_mbias2",
             "sameMIDcase8NonEMotherPdg_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEPdgFromTarget_mbias2_InM_two_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdgFromTarget_mbias2_InM_two_Both_mbias2",
             "sameMIDcase8NonEPdgFromTarget_mbias2_InM_two_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_two_Both_mbias2.push_back(
  ...
  BG1_InM_onetwo_Both_mbias2 =
    new TH1D("BG1_InM_onetwo_Both_mbias2",
             "BG1_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG1_InM_onetwo_Both_mbias2);
  BG2_InM_onetwo_Both_mbias2 =
    new TH1D("BG2_InM_onetwo_Both_mbias2",
             "BG2_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG2_InM_onetwo_Both_mbias2);
  BG3_InM_onetwo_Both_mbias2 =
    new TH1D("BG3_InM_onetwo_Both_mbias2",
             "BG3_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG3_InM_onetwo_Both_mbias2);
  BG4_InM_onetwo_Both_mbias2 =
    new TH1D("BG4_InM_onetwo_Both_mbias2",
             "BG4_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG4_InM_onetwo_Both_mbias2);
  BG5_InM_onetwo_Both_mbias2 =
    new TH1D("BG5_InM_onetwo_Both_mbias2",
             "BG5_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG5_InM_onetwo_Both_mbias2);
  BG6_InM_onetwo_Both_mbias2 =
    new TH1D("BG6_InM_onetwo_Both_mbias2",
             "BG6_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG6_InM_onetwo_Both_mbias2);
  BG7_InM_onetwo_Both_mbias2 =
    new TH1D("BG7_InM_onetwo_Both_mbias2",
             "BG7_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG7_InM_onetwo_Both_mbias2);
  BG8_InM_onetwo_Both_mbias2 =
    new TH1D("BG8_InM_onetwo_Both_mbias2",
             "BG8_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG8_InM_onetwo_Both_mbias2);
  BG9_InM_onetwo_Both_mbias2 =
    new TH1D("BG9_InM_onetwo_Both_mbias2",
             "BG9_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG9_InM_onetwo_Both_mbias2);
  BG10_InM_onetwo_Both_mbias2 =
    new TH1D("BG10_InM_onetwo_Both_mbias2",
             "BG10_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
             1000,
             0,
             2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(BG10_InM_onetwo_Both_mbias2);
  PdgCase8_InM_onetwo_Both_mbias2 =
    new TH1D("PdgCase8_InM_onetwo_Both_mbias2",
             "PdgCase8_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    PdgCase8_InM_onetwo_Both_mbias2);
  PdgCase8mothers_InM_onetwo_Both_mbias2 =
    new TH1D("PdgCase8mothers_InM_onetwo_Both_mbias2",
             "PdgCase8mothers_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    PdgCase8mothers_InM_onetwo_Both_mbias2);
  sameMIDcase8_InM_onetwo_Both_mbias2 = new TH1D(
    "sameMIDcase8_InM_onetwo_Both_mbias2",
    "sameMIDcase8_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    sameMIDcase8_InM_onetwo_Both_mbias2);
  sameGRIDcase8_InM_onetwo_Both_mbias2 = new TH1D(
    "sameGRIDcase8_InM_onetwo_Both_mbias2",
    "sameGRIDcase8_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    sameGRIDcase8_InM_onetwo_Both_mbias2);
  Case1ZYPos_InM_onetwo_Both_mbias2 =
    new TH2D("Case1ZYPos_InM_onetwo_Both_mbias2",
             "Case1ZYPos_InM_onetwo_Both_mbias2; z[cm]; y[cm]",
             400,
             -1,
             200,
             200,
  ...
  sameMIDcase8_mothedPDG_InM_onetwo_Both_mbias2 =
    new TH1D("sameMIDcase8_mothedPDG_InM_onetwo_Both_mbias2",
             "sameMIDcase8_mothedPDG_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
  ...
  PdgCase8NonEComeFromTarget_mbias2_InM_onetwo_Both_mbias2 =
    new TH1D("PdgCase8NonEComeFromTarget_mbias2_InM_onetwo_Both_mbias2",
             "PdgCase8NonEComeFromTarget_mbias2_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
  ...
  PdgCase8NonE_NOT_FromTarget_mbias2_InM_onetwo_Both_mbias2 =
    new TH1D("PdgCase8NonE_NOT_FromTarget_mbias2_InM_onetwo_Both_mbias2",
             "PdgCase8NonE_NOT_FromTarget_mbias2_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    PdgCase8NonE_NOT_FromTarget_mbias2_InM_onetwo_Both_mbias2);
  PdgCase8motherNonE_InM_onetwo_Both_mbias2 =
    new TH1D("PdgCase8motherNonE_InM_onetwo_Both_mbias2",
             "PdgCase8motherNonE_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    PdgCase8motherNonE_InM_onetwo_Both_mbias2);
  Case8ElFromDalitz_InM_onetwo_Both_mbias2 = new TH1D(
    "Case8ElFromDalitz_InM_onetwo_Both_mbias2",
    "Case8ElFromDalitz_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    Case8ElFromDalitz_InM_onetwo_Both_mbias2);
  Case8NonElFrom_pn_InM_onetwo_Both_mbias2 = new TH1D(
    "Case8NonElFrom_pn_InM_onetwo_Both_mbias2",
    "Case8NonElFrom_pn_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    Case8NonElFrom_pn_InM_onetwo_Both_mbias2);
  Case8NonElFrom_eta_InM_onetwo_Both_mbias2 = new TH1D(
    "Case8NonElFrom_eta_InM_onetwo_Both_mbias2",
    "Case8NonElFrom_eta_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    Case8NonElFrom_eta_InM_onetwo_Both_mbias2);
  Case8NonElFrom_kaon_InM_onetwo_Both_mbias2 = new TH1D(
    "Case8NonElFrom_kaon_InM_onetwo_Both_mbias2",
    "Case8NonElFrom_kaon_InM_onetwo_Both_mbias2; invariant mass in GeV/c^{2};#",
    1000,
    0,
    2.0);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEPdg_InM_onetwo_Both_mbias2 =
    new TH1D("sameMIDcase8NonEPdg_InM_onetwo_Both_mbias2",
             "sameMIDcase8NonEPdg_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
  ...
  sameMIDcase8NonEMotherPdg_InM_onetwo_Both_mbias2 =
    new TH1D("sameMIDcase8NonEMotherPdg_InM_onetwo_Both_mbias2",
             "sameMIDcase8NonEMotherPdg_InM_onetwo_Both_mbias2; Id ;#",
             5000,
             -2500,
             2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
  ...
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
    sameMIDcase8NonEMotherIM_InM_onetwo_Both_mbias2);
  sameMIDcase8NonEPdgFromTarget_mbias2_InM_onetwo_Both_mbias2 = new TH1D(
    "sameMIDcase8NonEPdgFromTarget_mbias2_InM_onetwo_Both_mbias2",
    "sameMIDcase8NonEPdgFromTarget_mbias2_InM_onetwo_Both_mbias2; Id ;#",
    5000,
    -2500,
    2500);
  fHistoList_bg_InM_onetwo_Both_mbias2.push_back(
