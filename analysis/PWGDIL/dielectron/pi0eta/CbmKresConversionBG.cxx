...
void CbmKresConversionBG::Exec(CbmMCTrack* mctrack1, CbmMCTrack* mctrack2, CbmMCTrack* mctrack3, CbmMCTrack* mctrack4, Double_t invmassRecoPi0, vector<TH1*> BGCases)
{
	/*
	...
	if(NumOfOthers == 2){ 
		...
		if (testGR.size() == 2){
			if (testGR[0] == testGR[1]){ 
				BGCases[13]->Fill(invmassRecoPi0);
			}
		}
...
//				int mcMotherPdg4 = mother4->GetPdgCode();
				...
				if(motherId1 == motherId2 && motherId3 == motherId4 && grandmotherId1 != grandmotherId3) BGCases[2]->Fill(invmassRecoPi0);
