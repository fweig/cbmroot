...
class CbmKresConversionManualmbias3
{
...
private:
  ...
  // charged tracks from the Target_mbias3  
  ...
  // EMT Target_mbias3 Target_mbias3
  ...
  // EMT Target_mbias3 Outside_mbias3
  ...
  // combined gammas from the Target_mbias3
  ...
  // combined gammas from Outside_mbias3
  ...
  // combined gammas from the Target_mbias3 and Outside_mbias3 together
  ...
  // histograms
  ///////   histograms to check Cuts => Both_mbias3
  ...
  ///////   histograms to check Cuts => Target_mbias3
  ...
  ///////   histograms to check Cuts => Outside_mbias3
  ...
  // Both_mbias3 additional histograms
  ...
  ClassDef(CbmKresConversionManualmbias3,2)
};
