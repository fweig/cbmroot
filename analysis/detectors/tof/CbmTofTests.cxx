...
Bool_t   CbmTofTests::InitParameters()
{
   ...
   switch(iGeoVersion){
      ...
      case k14a:
         ...
         break;
      default:
         LOG(error)<<"CbmTofDigitizerBDF::InitParameters: Invalid Detector ID "<<iGeoVersion;
   }
   return kTRUE;
}
...
*/
   ...
   {
      LOG(error)<<"CbmTofTests::RegisterInputs => Could not get the TofPoint TClonesArray!!!";
      return kFALSE;
   } // if( NULL == fTofPointsColl)
   ...
   {
      LOG(error)<<"CbmTofTests::RegisterInputs => Could not get the MCTrack TClonesArray!!!";
      return kFALSE;
   } // if( NULL == fMcTracksColl)
   ...
   {
      LOG(error)<<"CbmTofTests::RegisterInputs => Could not get the TofDigi TClonesArray!!!";
      return kFALSE;
   } // if( NULL == fTofDigisColl)
   ...
   {
      LOG(error)<<"CbmTofTests::RegisterInputs => Could not get the TofHit TClonesArray!!!";
      return kFALSE;
   } // if( NULL == fTofHitsColl)
