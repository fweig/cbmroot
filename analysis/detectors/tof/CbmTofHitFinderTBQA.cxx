...
//      evHits[i] = { hit->GetX(), hit->GetDx(), hit->GetY(), hit->GetDy(), hit->GetTime(), hit->GetTimeError(), {}, {}, CbmTofAddress::GetModFullId(hit->GetAddress()) } ;
      evHits[i] = QAHit{hit->GetX(), hit->GetDx(), hit->GetY(), hit->GetDy(), hit->GetTime(), hit->GetTimeError(), set<const QAMCPoint*>{}, set<const QAMCTrack*>{} , CbmTofAddress::GetModFullId(hit->GetAddress()) };
