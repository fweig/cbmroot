...
void CbmMvd::ConstructGeometry()
{
  ...
  {
      LOG(fatal) << "Don't use old .geo style geometrys for the MVD. Please use a .root geometry";
...
if (fStationMap.size() == 0 )
    LOG(fatal) << "Tried to load MVD Geometry, but didn't succeed to load Sensors";
