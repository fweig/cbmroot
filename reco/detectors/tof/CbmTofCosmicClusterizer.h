/* Copyright (C) 2018-2020 PI-UHd/GSI, Heidelberg/Darmstadt
 ...
 ** @version 1.0
 **/
#ifndef CBMTOFCOSMICCLUSTERIZER_H
#define CBMTOFCOSMICCLUSTERIZER_H 1
...
class CbmTofCosmicClusterizer : public FairTask {
...
#endif  // CBMTOFCOSMICCLUSTERIZER_H
