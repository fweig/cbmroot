...
bool InvSym15(std::vector<litfloat>& a) {
  ...
  const litfloat mDet3_123_012 =
    pM[SM10] * mDet2_23_12 - pM[SM11] * mDet2_23_02 + pM[SM12] * mDet2_23_01;
  const litfloat mDet3_123_013 =
    pM[SM10] * mDet2_23_13 - pM[SM11] * mDet2_23_03 + pM[SM13] * mDet2_23_01;
  const litfloat mDet3_123_023 =
    pM[SM10] * mDet2_23_23 - pM[SM12] * mDet2_23_03 + pM[SM13] * mDet2_23_02;
  const litfloat mDet3_123_123 =
    pM[SM11] * mDet2_23_23 - pM[SM12] * mDet2_23_13 + pM[SM13] * mDet2_23_12;
  const litfloat mDet3_124_012 =
    pM[SM10] * mDet2_24_12 - pM[SM11] * mDet2_24_02 + pM[SM12] * mDet2_24_01;
  const litfloat mDet3_124_013 =
    pM[SM10] * mDet2_24_13 - pM[SM11] * mDet2_24_03 + pM[SM13] * mDet2_24_01;
  const litfloat mDet3_124_014 =
    pM[SM10] * mDet2_24_14 - pM[SM11] * mDet2_24_04 + pM[SM14] * mDet2_24_01;
  const litfloat mDet3_124_023 =
    pM[SM10] * mDet2_24_23 - pM[SM12] * mDet2_24_03 + pM[SM13] * mDet2_24_02;
  const litfloat mDet3_124_024 =
    pM[SM10] * mDet2_24_24 - pM[SM12] * mDet2_24_04 + pM[SM14] * mDet2_24_02;
  const litfloat mDet3_124_123 =
    pM[SM11] * mDet2_24_23 - pM[SM12] * mDet2_24_13 + pM[SM13] * mDet2_24_12;
  const litfloat mDet3_124_124 =
    pM[SM11] * mDet2_24_24 - pM[SM12] * mDet2_24_14 + pM[SM14] * mDet2_24_12;
  const litfloat mDet3_134_012 =
    pM[SM10] * mDet2_34_12 - pM[SM11] * mDet2_34_02 + pM[SM12] * mDet2_34_01;
  const litfloat mDet3_134_013 =
    pM[SM10] * mDet2_34_13 - pM[SM11] * mDet2_34_03 + pM[SM13] * mDet2_34_01;
  const litfloat mDet3_134_014 =
    pM[SM10] * mDet2_34_14 - pM[SM11] * mDet2_34_04 + pM[SM14] * mDet2_34_01;
  const litfloat mDet3_134_023 =
    pM[SM10] * mDet2_34_23 - pM[SM12] * mDet2_34_03 + pM[SM13] * mDet2_34_02;
  const litfloat mDet3_134_024 =
    pM[SM10] * mDet2_34_24 - pM[SM12] * mDet2_34_04 + pM[SM14] * mDet2_34_02;
  const litfloat mDet3_134_034 =
    pM[SM10] * mDet2_34_34 - pM[SM13] * mDet2_34_04 + pM[SM14] * mDet2_34_03;
  const litfloat mDet3_134_123 =
    pM[SM11] * mDet2_34_23 - pM[SM12] * mDet2_34_13 + pM[SM13] * mDet2_34_12;
  const litfloat mDet3_134_124 =
    pM[SM11] * mDet2_34_24 - pM[SM12] * mDet2_34_14 + pM[SM14] * mDet2_34_12;
  const litfloat mDet3_134_134 =
    pM[SM11] * mDet2_34_34 - pM[SM13] * mDet2_34_14 + pM[SM14] * mDet2_34_13;
  const litfloat mDet3_234_012 =
    pM[SM20] * mDet2_34_12 - pM[SM21] * mDet2_34_02 + pM[SM22] * mDet2_34_01;
  const litfloat mDet3_234_013 =
    pM[SM20] * mDet2_34_13 - pM[SM21] * mDet2_34_03 + pM[SM23] * mDet2_34_01;
  const litfloat mDet3_234_014 =
    pM[SM20] * mDet2_34_14 - pM[SM21] * mDet2_34_04 + pM[SM24] * mDet2_34_01;
  const litfloat mDet3_234_023 =
    pM[SM20] * mDet2_34_23 - pM[SM22] * mDet2_34_03 + pM[SM23] * mDet2_34_02;
  const litfloat mDet3_234_024 =
    pM[SM20] * mDet2_34_24 - pM[SM22] * mDet2_34_04 + pM[SM24] * mDet2_34_02;
  const litfloat mDet3_234_034 =
    pM[SM20] * mDet2_34_34 - pM[SM23] * mDet2_34_04 + pM[SM24] * mDet2_34_03;
  const litfloat mDet3_234_123 =
    pM[SM21] * mDet2_34_23 - pM[SM22] * mDet2_34_13 + pM[SM23] * mDet2_34_12;
  const litfloat mDet3_234_124 =
    pM[SM21] * mDet2_34_24 - pM[SM22] * mDet2_34_14 + pM[SM24] * mDet2_34_12;
  const litfloat mDet3_234_134 =
    pM[SM21] * mDet2_34_34 - pM[SM23] * mDet2_34_14 + pM[SM24] * mDet2_34_13;
  const litfloat mDet3_234_234 =
    pM[SM22] * mDet2_34_34 - pM[SM23] * mDet2_34_24 + pM[SM24] * mDet2_34_23;

  // Find all NECESSARY 4x4 dets:   (15 of them)

  const litfloat mDet4_0123_0123 =
    pM[SM00] * mDet3_123_123 - pM[SM01] * mDet3_123_023
    + pM[SM02] * mDet3_123_013 - pM[SM03] * mDet3_123_012;
  const litfloat mDet4_0124_0123 =
    pM[SM00] * mDet3_124_123 - pM[SM01] * mDet3_124_023
    + pM[SM02] * mDet3_124_013 - pM[SM03] * mDet3_124_012;
  const litfloat mDet4_0124_0124 =
    pM[SM00] * mDet3_124_124 - pM[SM01] * mDet3_124_024
    + pM[SM02] * mDet3_124_014 - pM[SM04] * mDet3_124_012;
  const litfloat mDet4_0134_0123 =
    pM[SM00] * mDet3_134_123 - pM[SM01] * mDet3_134_023
    + pM[SM02] * mDet3_134_013 - pM[SM03] * mDet3_134_012;
  const litfloat mDet4_0134_0124 =
    pM[SM00] * mDet3_134_124 - pM[SM01] * mDet3_134_024
    + pM[SM02] * mDet3_134_014 - pM[SM04] * mDet3_134_012;
  const litfloat mDet4_0134_0134 =
    pM[SM00] * mDet3_134_134 - pM[SM01] * mDet3_134_034
    + pM[SM03] * mDet3_134_014 - pM[SM04] * mDet3_134_013;
  const litfloat mDet4_0234_0123 =
    pM[SM00] * mDet3_234_123 - pM[SM01] * mDet3_234_023
    + pM[SM02] * mDet3_234_013 - pM[SM03] * mDet3_234_012;
  const litfloat mDet4_0234_0124 =
    pM[SM00] * mDet3_234_124 - pM[SM01] * mDet3_234_024
    + pM[SM02] * mDet3_234_014 - pM[SM04] * mDet3_234_012;
  const litfloat mDet4_0234_0134 =
    pM[SM00] * mDet3_234_134 - pM[SM01] * mDet3_234_034
    + pM[SM03] * mDet3_234_014 - pM[SM04] * mDet3_234_013;
  const litfloat mDet4_0234_0234 =
    pM[SM00] * mDet3_234_234 - pM[SM02] * mDet3_234_034
    + pM[SM03] * mDet3_234_024 - pM[SM04] * mDet3_234_023;
  const litfloat mDet4_1234_0123 =
    pM[SM10] * mDet3_234_123 - pM[SM11] * mDet3_234_023
    + pM[SM12] * mDet3_234_013 - pM[SM13] * mDet3_234_012;
  const litfloat mDet4_1234_0124 =
    pM[SM10] * mDet3_234_124 - pM[SM11] * mDet3_234_024
    + pM[SM12] * mDet3_234_014 - pM[SM14] * mDet3_234_012;
  const litfloat mDet4_1234_0134 =
    pM[SM10] * mDet3_234_134 - pM[SM11] * mDet3_234_034
    + pM[SM13] * mDet3_234_014 - pM[SM14] * mDet3_234_013;
  const litfloat mDet4_1234_0234 =
    pM[SM10] * mDet3_234_234 - pM[SM12] * mDet3_234_034
    + pM[SM13] * mDet3_234_024 - pM[SM14] * mDet3_234_023;
  const litfloat mDet4_1234_1234 =
    pM[SM11] * mDet3_234_234 - pM[SM12] * mDet3_234_134
    + pM[SM13] * mDet3_234_124 - pM[SM14] * mDet3_234_123;

  // Find the 5x5 det:

  const litfloat det = pM[SM00] * mDet4_1234_1234 - pM[SM01] * mDet4_1234_0234
                       + pM[SM02] * mDet4_1234_0134 - pM[SM03] * mDet4_1234_0124
                       + pM[SM04] * mDet4_1234_0123;
...
bool Similarity(const std::vector<litfloat>& a,
  ...
  litfloat B =
    a[0] * b[1] + a[1] * b[5] + a[2] * b[6] + a[3] * b[7] + a[4] * b[8];
  litfloat C =
    a[0] * b[2] + a[1] * b[6] + a[2] * b[9] + a[3] * b[10] + a[4] * b[11];
  litfloat D =
    a[0] * b[3] + a[1] * b[7] + a[2] * b[10] + a[3] * b[12] + a[4] * b[13];
  litfloat E =
    a[0] * b[4] + a[1] * b[8] + a[2] * b[11] + a[3] * b[13] + a[4] * b[14];

  litfloat F =
    a[5] * b[0] + a[6] * b[1] + a[7] * b[2] + a[8] * b[3] + a[9] * b[4];
  litfloat G =
    a[5] * b[1] + a[6] * b[5] + a[7] * b[6] + a[8] * b[7] + a[9] * b[8];
  litfloat H =
    a[5] * b[2] + a[6] * b[6] + a[7] * b[9] + a[8] * b[10] + a[9] * b[11];
  litfloat I =
    a[5] * b[3] + a[6] * b[7] + a[7] * b[10] + a[8] * b[12] + a[9] * b[13];
  litfloat J =
    a[5] * b[4] + a[6] * b[8] + a[7] * b[11] + a[8] * b[13] + a[9] * b[14];

  litfloat K =
    a[10] * b[0] + a[11] * b[1] + a[12] * b[2] + a[13] * b[3] + a[14] * b[4];
  litfloat L =
    a[10] * b[1] + a[11] * b[5] + a[12] * b[6] + a[13] * b[7] + a[14] * b[8];
  litfloat M =
    a[10] * b[2] + a[11] * b[6] + a[12] * b[9] + a[13] * b[10] + a[14] * b[11];
  litfloat N =
    a[10] * b[3] + a[11] * b[7] + a[12] * b[10] + a[13] * b[12] + a[14] * b[13];
  litfloat O =
    a[10] * b[4] + a[11] * b[8] + a[12] * b[11] + a[13] * b[13] + a[14] * b[14];

  litfloat P =
    a[15] * b[0] + a[16] * b[1] + a[17] * b[2] + a[18] * b[3] + a[19] * b[4];
  litfloat Q =
    a[15] * b[1] + a[16] * b[5] + a[17] * b[6] + a[18] * b[7] + a[19] * b[8];
  litfloat R =
    a[15] * b[2] + a[16] * b[6] + a[17] * b[9] + a[18] * b[10] + a[19] * b[11];
  litfloat S =
    a[15] * b[3] + a[16] * b[7] + a[17] * b[10] + a[18] * b[12] + a[19] * b[13];
  litfloat T =
    a[15] * b[4] + a[16] * b[8] + a[17] * b[11] + a[18] * b[13] + a[19] * b[14];
  ...
  c[14] =
    (a[20] * b[0] + a[21] * b[1] + a[22] * b[2] + a[23] * b[3] + a[24] * b[4])
      * a[20]
    + (a[20] * b[1] + a[21] * b[5] + a[22] * b[6] + a[23] * b[7] + a[24] * b[8])
        * a[21]
    + (a[20] * b[2] + a[21] * b[6] + a[22] * b[9] + a[23] * b[10]
       + a[24] * b[11])
        * a[22]
    + (a[20] * b[3] + a[21] * b[7] + a[22] * b[10] + a[23] * b[12]
       + a[24] * b[13])
        * a[23]
    + (a[20] * b[4] + a[21] * b[8] + a[22] * b[11] + a[23] * b[13]
       + a[24] * b[14])
        * a[24];
  return true;
}
...
bool Mult15On25(const std::vector<litfloat>& a,
  ...
  c[10] =
    a[2] * b[0] + a[6] * b[5] + a[9] * b[10] + a[10] * b[15] + a[11] * b[20];
  c[11] =
    a[2] * b[1] + a[6] * b[6] + a[9] * b[11] + a[10] * b[16] + a[11] * b[21];
  c[12] =
    a[2] * b[2] + a[6] * b[7] + a[9] * b[12] + a[10] * b[17] + a[11] * b[22];
  c[13] =
    a[2] * b[3] + a[6] * b[8] + a[9] * b[13] + a[10] * b[18] + a[11] * b[23];
  c[14] =
    a[2] * b[4] + a[6] * b[9] + a[9] * b[14] + a[10] * b[19] + a[11] * b[24];
  c[15] =
    a[3] * b[0] + a[7] * b[5] + a[10] * b[10] + a[12] * b[15] + a[13] * b[20];
  c[16] =
    a[3] * b[1] + a[7] * b[6] + a[10] * b[11] + a[12] * b[16] + a[13] * b[21];
  c[17] =
    a[3] * b[2] + a[7] * b[7] + a[10] * b[12] + a[12] * b[17] + a[13] * b[22];
  c[18] =
    a[3] * b[3] + a[7] * b[8] + a[10] * b[13] + a[12] * b[18] + a[13] * b[23];
  c[19] =
    a[3] * b[4] + a[7] * b[9] + a[10] * b[14] + a[12] * b[19] + a[13] * b[24];
  c[20] =
    a[4] * b[0] + a[8] * b[5] + a[11] * b[10] + a[13] * b[15] + a[14] * b[20];
  c[21] =
    a[4] * b[1] + a[8] * b[6] + a[11] * b[11] + a[13] * b[16] + a[14] * b[21];
  c[22] =
    a[4] * b[2] + a[8] * b[7] + a[11] * b[12] + a[13] * b[17] + a[14] * b[22];
  c[23] =
    a[4] * b[3] + a[8] * b[8] + a[11] * b[13] + a[13] * b[18] + a[14] * b[23];
  c[24] =
    a[4] * b[4] + a[8] * b[9] + a[11] * b[14] + a[13] * b[19] + a[14] * b[24];
...
bool Mult25On15(const std::vector<litfloat>& a,
  ...
  c[21] =
    a[20] * b[1] + a[21] * b[5] + a[22] * b[6] + a[23] * b[7] + a[24] * b[8];
  c[22] =
    a[20] * b[2] + a[21] * b[6] + a[22] * b[9] + a[23] * b[10] + a[24] * b[11];
  c[23] =
    a[20] * b[3] + a[21] * b[7] + a[22] * b[10] + a[23] * b[12] + a[24] * b[13];
  c[24] =
    a[20] * b[4] + a[21] * b[8] + a[22] * b[11] + a[23] * b[13] + a[24] * b[14];
