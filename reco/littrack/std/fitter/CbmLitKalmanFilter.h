...
public:
  ...
  virtual LitStatus Update(const CbmLitTrackParam* parIn,
  ...
  /* Inherited from CbmLitTrackUpdate */
  virtual LitStatus
  Update(CbmLitTrackParam* par, const CbmLitHit* hit, litfloat& chiSq);
...
private:
  /* Implements KF update step for pixel hits using gain matrix formalism
    ...
    *@return Status code */
  LitStatus
  Update(CbmLitTrackParam* par, const CbmLitPixelHit* hit, litfloat& chiSq);
  ...
  /* Implements KF update step for pixel hits using weighted means formalism
    ...
    *@return Status code */
  LitStatus
  UpdateWMF(CbmLitTrackParam* par, const CbmLitPixelHit* hit, litfloat& chiSq);
  ...
  /* Implements KF update step for strip hits using gain matrix formalism
    ...
    *@return Status code */
  LitStatus
  Update(CbmLitTrackParam* par, const CbmLitStripHit* hit, litfloat& chiSq);
  ...
  /* Implements KF update step for strip hits using weighted means formalism
    ...
    *@return Status code */
  LitStatus
  UpdateWMF(CbmLitTrackParam* par, const CbmLitStripHit* hit, litfloat& chiSq);
};
