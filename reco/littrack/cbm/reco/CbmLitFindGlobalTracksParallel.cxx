...
void CbmLitFindGlobalTracksParallel::ReadAndCreateDataBranches()
{
   ...
   if (fDet.GetDet(ECbmModuleId::kTrd)) {
      ...
      if (NULL == fTrdHits) if (NULL == fTrdHits) LOG(fatal) << "CbmLitFindGlobalTracksParallel: No TRDHit array!";
   }

   // MUCH
   if (fDet.GetDet(ECbmModuleId::kMuch)) {
      fMuchPixelHits = (TClonesArray*) ioman->GetObject("MuchPixelHit");
      if (NULL == fMuchPixelHits) if (NULL == fMuchPixelHits) LOG(fatal) << "CbmLitFindGlobalTracksParallel: No MuchPixelHit array!";
   }
