   ...
   Option_t* opt)
{
   if (fStsTracks != NULL && fMvdHits != NULL) {
      ...
      LOG(warn) << "CbmLitFindMvdTracks::Exec: MVD tracking is not executed NO StsTrack or MvdHit arrays.";
   }
...
void CbmLitFindMvdTracks::ReadAndCreateDataBranches()
{
   ...
   if (NULL == ioman) {
      LOG(fatal) << "CbmLitFindMvdTracks::ReadAndCreateDataBranches FairRootManager is not instantiated";
   }
