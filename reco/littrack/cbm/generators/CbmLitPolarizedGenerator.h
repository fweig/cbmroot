/* Copyright (C) 2011-2015 GSI/JINR-LIT, Darmstadt/Dubna
 ...
 **
 ** CbmLitPolarizedGenerator generates polarized vector mesons with a given
...
#ifndef CBMLITPOLARIZEDGENERATOR_H
