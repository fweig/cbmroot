...
public:
  ...
  /**
    ...
    */
  static void
  FairTrackParamToLitTrackParamScal(const FairTrackParam* par,
  ...
  /**
    ...
    */
  static void
  CbmPixelHitToLitScalPixelHit(const CbmPixelHit* hit,
  ...
  /**
    ...
    */
  static void
  CbmTrackToLitScalTrack(const CbmTrack* track,
  ...
  /**
    ...
    */
  static void LitScalTrackToCbmTrack(const lit::parallel::LitScalTrack* ltrack,
                                     CbmTrack* track);
