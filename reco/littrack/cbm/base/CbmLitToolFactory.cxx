...
CbmLitToolFactory::CreateTrackExtrapolator(const std::string& name) {
...
TrackPropagatorPtr
CbmLitToolFactory::CreateTrackPropagator(const std::string& name) {
  assert(name == "lit" || name == "rk4" || name == "line");
  if (name == "lit") {
    return TrackPropagatorPtr(
      new CbmLitTGeoTrackPropagator(CreateTrackExtrapolator("lit")));
  } else if (name == "rk4") {
    return TrackPropagatorPtr(
      new CbmLitTGeoTrackPropagator(CreateTrackExtrapolator("rk4")));
  } else if (name == "line") {
    return TrackPropagatorPtr(
      new CbmLitTGeoTrackPropagator(CreateTrackExtrapolator("line")));
  }
  return TrackPropagatorPtr();
}
...
TrackFitterPtr CbmLitToolFactory::CreateTrackFitter(const std::string& name) {
  assert(name == "lit_kalman" || name == "kalman_smoother");
  if (name == "lit_kalman") {
    return TrackFitterPtr(new CbmLitTrackFitterImp(
      CreateTrackPropagator("lit"), CreateTrackUpdate("kalman")));
...
TrackSelectionPtr
CbmLitToolFactory::CreateTrackSelection(const std::string& name) {
  assert(name == "empty" || name == "momentum" || name == "momentum_seed"
         || name == "chi_square" || name == "much_final"
         || name == "trd_final");
  if (name == "empty") {
...
TrackFinderPtr CbmLitToolFactory::CreateTrackFinder(const std::string& name) {
  assert(name == "e_nn" || name == "e_branch" || name == "mu_nn"
         || name == "mu_branch" || name == "mvd_nn");
  if (name == "e_nn") {
    ...
    trdFinderBranch->SetNofStations(
      CbmLitTrackingGeometryConstructor::Instance()->GetNofMuchTrdStations());
    ...
    muchFinderBranch->SetNofStations(
      CbmLitTrackingGeometryConstructor::Instance()->GetNofMuchTrdStations());
...
HitToTrackMergerPtr
CbmLitToolFactory::CreateHitToTrackMerger(const std::string& name) {
