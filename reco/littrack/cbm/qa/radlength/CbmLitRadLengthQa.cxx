...
void CbmLitRadLengthQa::CreateHistograms()
{
   ...
   for (Int_t iDet = 0; iDet < nofDetNames; iDet++) {
      ...
      Bool_t createHistograms = detName == "Total" || (detName == "Mvd" && fDet.GetDet(ECbmModuleId::kMvd)) || (detName == "Sts" && fDet.GetDet(ECbmModuleId::kSts))
             || (detName == "Rich" && fDet.GetDet(ECbmModuleId::kRich)) || (detName == "Trd" && fDet.GetDet(ECbmModuleId::kTrd))
             || (detName == "Much" && fDet.GetDet(ECbmModuleId::kMuch)) || (detName == "Tof" && fDet.GetDet(ECbmModuleId::kTof));
...
{
    if (!(detName == "Total" || (detName == "Mvd" && fDet.GetDet(ECbmModuleId::kMvd)) || (detName == "Sts" && fDet.GetDet(ECbmModuleId::kSts))
                || (detName == "Rich" && fDet.GetDet(ECbmModuleId::kRich)) || (detName == "Trd" && fDet.GetDet(ECbmModuleId::kTrd))
                || (detName == "Much" && fDet.GetDet(ECbmModuleId::kMuch)) || (detName == "Tof" && fDet.GetDet(ECbmModuleId::kTof)))) return;
      ...
      Int_t (*getStationId)(const TString&))
{
   if (!((detName == "Mvd" && fDet.GetDet(ECbmModuleId::kMvd)) || (detName == "Sts" && fDet.GetDet(ECbmModuleId::kSts))
           || (detName == "Trd" && fDet.GetDet(ECbmModuleId::kTrd)) || (detName == "Much" && fDet.GetDet(ECbmModuleId::kMuch))
           || (detName == "MuchAbsorber" && fDet.GetDet(ECbmModuleId::kMuch)))) return;
