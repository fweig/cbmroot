...
CbmLitRadLengthQaReport::CbmLitRadLengthQaReport() : CbmSimulationReport() {
...
void CbmLitRadLengthQaReport::DrawDetector(const string& detName) {
  if (HM()->Exists("hrl_Thickness_" + detName + "_H1")) {
    TCanvas* canvas1 =
      CreateCanvas(string("hrl_Thickness_" + detName + "_H1").c_str(),
                   string("hrl_Thickness_" + detName + "_H1").c_str(),
                   1200,
                   1000);
  ...
  if (HM()->Exists("hrl_Thickness_" + detName + "_P2")) {
    TCanvas* canvas2 =
      CreateCanvas(string("hrl_Thickness_" + detName + "_P2").c_str(),
                   string("hrl_Thickness_" + detName + "_P2").c_str(),
                   1200,
                   1000);
  ...
  if (HM()->Exists("hrl_RadThickness_" + detName + "_H1")) {
    TCanvas* canvas3 =
      CreateCanvas(string("hrl_RadThickness_" + detName + "_H1").c_str(),
                   string("hrl_RadThickness_" + detName + "_H1").c_str(),
                   1200,
                   1000);
  ...
  if (HM()->Exists("hrl_RadThickness_" + detName + "_P2")) {
    TCanvas* canvas4 =
      CreateCanvas(string("hrl_RadThickness_" + detName + "_P2").c_str(),
                   string("hrl_RadThickness_" + detName + "_P2").c_str(),
                   1200,
                   1000);
  ...
  if (HM()->Exists("hrl_ThicknessSilicon_" + detName + "_H1")) {
    TCanvas* canvas5 =
      CreateCanvas(string("hrl_ThicknessSilicon_" + detName + "_H1").c_str(),
                   string("hrl_ThicknessSilicon_" + detName + "_H1").c_str(),
                   1200,
                   1000);
  ...
  if (HM()->Exists("hrl_ThicknessSilicon_" + detName + "_P2")) {
    TCanvas* canvas6 =
      CreateCanvas(string("hrl_ThicknessSilicon_" + detName + "_P2").c_str(),
                   string("hrl_ThicknessSilicon_" + detName + "_P2").c_str(),
                   1200,
                   1000);
