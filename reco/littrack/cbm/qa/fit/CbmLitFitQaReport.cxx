...
CbmLitFitQaReport::CbmLitFitQaReport() : CbmSimulationReport() {
...
void CbmLitFitQaReport::Create() {
  ...
  Out() << PrintResAndPullRow(
    "STS first", "htf_Sts_FirstParam_(Res|Pull)_.+", "sigma");
  Out() << PrintResAndPullRow(
    "STS last", "htf_Sts_LastParam_(Res|Pull)_.+", "sigma");
  Out() << PrintResAndPullRow(
    "TRD first", "htf_Trd_FirstParam_(Res|Pull)_.+", "sigma");
  Out() << PrintResAndPullRow(
    "TRD last", "htf_Trd_LastParam_(Res|Pull)_.+", "sigma");
  Out() << PrintResAndPullRow(
    "MUCH first", "htf_Much_FirstParam_(Res|Pull)_.+", "sigma");
  Out() << PrintResAndPullRow(
    "MUCH last", "htf_Much_LastParam_(Res|Pull)_.+", "sigma");
  Out() << R()->TableEnd();

  Out() << R()->TableBegin(
    "Residuals and pulls (RMS)",
    list_of("")("x")("y")("tx")("ty")("q/p")("x")("y")("tx")("ty")("q/p"));
  Out() << PrintResAndPullRow(
    "STS first", "htf_Sts_FirstParam_(Res|Pull)_.+", "rms");
  Out() << PrintResAndPullRow(
    "STS last", "htf_Sts_LastParam_(Res|Pull)_.+", "rms");
  Out() << PrintResAndPullRow(
    "TRD first", "htf_Trd_FirstParam_(Res|Pull)_.+", "rms");
  Out() << PrintResAndPullRow(
    "TRD last", "htf_Trd_LastParam_(Res|Pull)_.+", "rms");
  Out() << PrintResAndPullRow(
    "MUCH first", "htf_Much_FirstParam_(Res|Pull)_.+", "rms");
  Out() << PrintResAndPullRow(
    "MUCH last", "htf_Much_LastParam_(Res|Pull)_.+", "rms");
  Out() << R()->TableEnd();

  Out() << R()->TableBegin(
    "Residuals and pulls (mean)",
    list_of("")("x")("y")("tx")("ty")("q/p")("x")("y")("tx")("ty")("q/p"));
  Out() << PrintResAndPullRow(
    "STS first", "htf_Sts_FirstParam_(Res|Pull)_.+", "mean");
  Out() << PrintResAndPullRow(
    "STS last", "htf_Sts_LastParam_(Res|Pull)_.+", "mean");
  Out() << PrintResAndPullRow(
    "TRD first", "htf_Trd_FirstParam_(Res|Pull)_.+", "mean");
  Out() << PrintResAndPullRow(
    "TRD last", "htf_Trd_LastParam_(Res|Pull)_.+", "mean");
  Out() << PrintResAndPullRow(
    "MUCH first", "htf_Much_FirstParam_(Res|Pull)_.+", "mean");
  Out() << PrintResAndPullRow(
    "MUCH last", "htf_Much_LastParam_(Res|Pull)_.+", "mean");
  Out() << R()->TableEnd();
...
string CbmLitFitQaReport::PrintResAndPullRow(const string& rowName,
  ...
  for (UInt_t iHist = 0; iHist < histos.size(); iHist++) {
    ...
    Int_t parIndex =
      (split[3] == "Res") ? (ctc[split[4]]) : (ctc[split[4]] + 5);
    if (propertyName == "mean") {
      ...
      parameters[parIndex] =
        NumberToString<Float_t>((NULL != fit) ? fit->GetParameter(2) : 0., 2);
    }
  }
...
void CbmLitFitQaReport::DrawHistSigmaRMS(Double_t sigma, Double_t rms) {
  string txt1 = Cbm::NumberToString<Double_t>(sigma, 2) + " / "
                + Cbm::NumberToString<Double_t>(rms, 2);
  TLatex text;
...
void CbmLitFitQaReport::DrawResidualAndPullHistograms(const string& detName,
                                                      Bool_t draw2D) {
...
void CbmLitFitQaReport::DrawTrackParams(const string& detName) {
  ...
  for (Int_t i = 0; i < 2; i++) {
    string trackParamName = (i == 0) ? "FirstParam" : "LastParam";
    string canvasName =
      string("fit_qa_track_params_" + detName + trackParamName);
    TCanvas* canvas =
...
void CbmLitFitQaReport::DrawTrackParamsAtVertex() {
  TCanvas* canvas1 = CreateCanvas(
    "fit_qa_momentum_momres_mom_2D", "fit_qa_momentum_momres_mom_2D", 600, 600);
  canvas1->cd(1);
  DrawH2(HM()->H2("htf_MomRes_Mom"));
  gPad->SetGridx(true);
  gPad->SetGridy(true);

  TCanvas* canvas2 = CreateCanvas(
    "fit_qa_momentum_projection", "fit_qa_momentum_projection", 600, 600);
  canvas2->cd(1);
  TH1* projY =
    HM()->H2("htf_MomRes_Mom")->ProjectionY("htf_MomRes_Mom_ProjectionY");
  ...
  TCanvas* canvas3 = CreateCanvas("fit_qa_momentum_momres_mom_sigma",
  ...
  TCanvas* canvas4 = CreateCanvas("fit_qa_momentum_momres_mom_rms",
  ...
  TCanvas* canvas5 =
    CreateCanvas("fit_qa_chi_primary", "fit_qa_chi_primary", 600, 600);
  canvas5->cd(1);
...
void CbmLitFitQaReport::DrawTrackMomentumAtVertex() {
  const char* histNames[] = {"htp_PrimaryVertexResidualPx",
  ...
  TCanvas* canvas =
    CreateCanvas("Momentum at primary vertex residuals and pulls",
  ...
  const char* histNames2[] = {"htp_PrimaryVertexResidualTx",
  ...
  TCanvas* canvas2 =
    CreateCanvas("Tangents and Qp at primary vertex residuals and pulls",
