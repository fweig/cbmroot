...
Int_t CbmLitClusteringQa::GetStationId(
      ...
      ECbmModuleId detId)
{
   assert(detId == ECbmModuleId::kSts || 
   ...
   else if (detId == ECbmModuleId::kTrd) return CbmTrdAddress::GetLayerId(address);
   else if (detId == ECbmModuleId::kMuch) return (CbmMuchGeoScheme::Instance()->GetLayerSideNr(address) - 1) / 2;
   return 0;
}
...
void CbmLitClusteringQa::FillEventCounterHistograms(Int_t iEvent)
{
    ...
    if (fDigiMan->IsPresent(ECbmModuleId::kMvd) && fHM->Exists("hno_NofObjects_MvdDigis_Event")) fHM->H1("hno_NofObjects_MvdDigis_Event")->Fill(fDigiMan->GetNofDigis(ECbmModuleId::kMvd));
    ...
    if (fDigiMan->IsPresent(ECbmModuleId::kSts) && fHM->Exists("hno_NofObjects_StsDigis_Event")) fHM->H1("hno_NofObjects_StsDigis_Event")->Fill(fDigiMan->GetNofDigis(ECbmModuleId::kSts));
    ...
    if (fDigiMan->IsPresent(ECbmModuleId::kTrd) && fHM->Exists("hno_NofObjects_TrdDigis_Event")) fHM->H1("hno_NofObjects_TrdDigis_Event")->Fill(fDigiMan->GetNofDigis(ECbmModuleId::kTrd));
    ...
    if (fDigiMan->IsPresent(ECbmModuleId::kMuch) && fHM->Exists("hno_NofObjects_MuchDigis_Event")) fHM->H1("hno_NofObjects_MuchDigis_Event")->Fill(fDigiMan->GetNofDigis(ECbmModuleId::kMuch));
      ...
      const string& detName)
{
   ...
   assert(detId == ECbmModuleId::kMvd || detId == ECbmModuleId::kSts || detId == ECbmModuleId::kRich || detId == ECbmModuleId::kMuch || detId == ECbmModuleId::kTrd || detId == ECbmModuleId::kTof);
