...
private:
    ...
    template <class Digi> void ProcessDigis(const string& detName);
    ...
    CbmMCDataArray* fStsPoints       = nullptr;; //! CbmStsPoint
    TClonesArray* fStsClusters       = nullptr;; //! CbmStsCluster
