 ...
 **/
    ...
    * \brief Constructor.
    */
      LitStationGroupMuon() : fFieldGridFront(), fFieldGridMiddle(), fFieldGridBack(), fStations(), fAbsorber() {}
    ...
    */
      ...
      {
        std::string str =
          "LitStationGroupMuon: nofStations=" + lit::parallel::ToString<int>((int) GetNofStations()) + "\n";
