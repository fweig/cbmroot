 ...
 **/
    ...
    * \brief Constructor.
    */
      LitAbsorber() : fZ(0.), fMaterial(), fFieldGridFront(), fFieldGridMiddle(), fFieldGridBack() {}
    ...
    */
      ...
      {
        return "LitAbsorber: Z=" + lit::parallel::ToString<T>(GetZ()) + ", material=" + GetMaterial().ToString();
      }
