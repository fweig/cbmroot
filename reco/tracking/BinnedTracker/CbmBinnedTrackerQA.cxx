...
CbmBinnedTrackerQA::CbmBinnedTrackerQA() : fPrimaryParticleIds(), fIsOnlyPrimary(false), fSettings(0), fGlobalTracks(0), fStsTracks(0), fMuchTracks(0),
   ...
   fStsDigis(0), fStsDigiMatches(0), fMuchDigis(0), fTrdDigis(0), fTofDigis(0), fMCTracks(0), fStsPoints(0), fMuchPoints(0), fTrdPoints(0), fTofPoints(0)
{
...
InitStatus CbmBinnedTrackerQA::Init()
{
   ...
   if (TrackDesc::nofTrdStations > 0)
   {
      ...
      if (0 == fTrdDigis)
         LOG(fatal) <<  "No trd digis in the input file";
#else//TRD_IDEAL
...
void CbmBinnedTrackerQA::Exec(Option_t*)
{
   ...
   for (Int_t i = 0; i < nofGlobalTracks; ++i)
   {
      ...
      if (maxIter->second.size() < size_t(0.7 * nofStations))
         continue;
