...
void CbmBinned3DStation::SearchHits(const CbmTrackParam2& stateVec, Double_t, std::function<void(CbmTBin::HitHolder&)> handleHit)
{
...
void CbmBinned3DStation::SearchHits(Double_t, Double_t, Double_t minY, Double_t maxY, Double_t minX, Double_t maxX, Double_t minT, Double_t maxT,
