...
public:
  ...
  friend F32vec4 rcp(const F32vec4& a) {
    ...
    return _mm_sub_ps(_mm_add_ps(Ra0, Ra0),
                      _mm_mul_ps(_mm_mul_ps(Ra0, a), Ra0));
  }
  ...
  friend F32vec4 sgn(const F32vec4& a) {
    return _mm_or_ps(_mm_and_ps(a, _f32vec4_sgn_mask), _f32vec4_one);
  }
...
#undef _f1
  ...
  friend F32vec4 atan2(const F32vec4& y, const F32vec4& x) {
    ...
    const F32vec4& gt_tan_pi_8 =
      F32vec4(a > F32vec4(0.4142135623730950)) & F32vec4(!gt_tan_3pi_8);
