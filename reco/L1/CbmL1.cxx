...
//  fTrdDigiPar = (CbmTrdDigiPar*)(FairRunAna::Instance()->GetRuntimeDb()->getContainer("CbmTrdDigiPar"));
  ...
  fStsParSetModule = dynamic_cast<CbmStsParSetModule*>
    (rtdb->getContainer("CbmStsParSetModule"));
  fStsParSetSensor = dynamic_cast<CbmStsParSetSensor*>
...
InitStatus CbmL1::Init()
{
  ...
  if (fPerformance){
    ...
    if ( NULL == fStsPoints )
      LOG(fatal) << GetName() << ": No StsPoint data!";
    if ( NULL == fMCTracks )
...
//              algo->fRadThick[iSta].table[iB][iB2] = algo->vStations[iSta].materialInfo.RadThick[0];
     ...
     LOG(warn) << "No MVD material budget file is found. Homogenious budget will be used";
  ...
  if (fStsMatBudgetFileName != "") {
    ...
    LOG(warn) << "No STS material budget file is found. Homogenious budget will be used";
...
//              algo->fRadThick[iSta].table[iB][iB2] = algo->vStations[iSta].materialInfo.RadThick[0];
    ...
    LOG(warn) << "No Much material budget file is found. Homogenious budget will be used";
...
//              algo->fRadThick[iSta].table[iB][iB2] = algo->vStations[iSta].materialInfo.RadThick[0];
    ...
    LOG(warn) << "No TRD material budget file is found. Homogenious budget will be used";
...
//              algo->fRadThick[iSta].table[iB][iB2] = algo->vStations[iSta].materialInfo.RadThick[0];
    ...
    LOG(warn) << "No TOF material budget file is found. Homogenious budget will be used";
