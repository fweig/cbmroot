...
#ifndef _CbmInverseSlope_h_
#define _CbmInverseSlope_h_
...
class CbmInverseSlope: public CbmModelBase
{
 public:
 //static const int p_sz = 8;
  TString name;
  CbmInverseSlope(Int_t recoLevel = -1,	// -1 - MC Tracks, 0 - Reconstructible MC Tracks, 1 - Reco Tracks with MC Data, 2 - Reco Tracks with Reco Momentum and MC Primary, 3 - Reco Tracks with Reco Momentum and Reco Primary
