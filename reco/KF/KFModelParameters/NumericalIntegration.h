...
double Integrate2DLaguerre32Legendre32(double (*func)(double, double),
                                       double ay,
                                       double by) {
...
void GetCoefsIntegrateLegendre32(double a,
                                 double b,
                                 std::vector<double>& x,
                                 std::vector<double>& w) {
...
void GetCoefsIntegrateLaguerre32(std::vector<double>& x,
                                 std::vector<double>& w) {
