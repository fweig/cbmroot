...
#pragma link C++ class CbmKFTrack + ;
#pragma link C++ class CbmKFVertex + ;
#pragma link C++ class CbmKFMaterial + ;
#pragma link C++ class CbmKFTube + ;
#pragma link C++ class CbmKFBox + ;
