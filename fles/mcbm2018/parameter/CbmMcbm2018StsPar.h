...
//   static constexpr UInt_t  kuCrobMapElinkFebA[ kuNbElinksPerCrob ] = {
   const UInt_t  kuCrobMapElinkFebA[ kuNbElinksPerCrob ] = {
            0x0021, 0x0023, 0x0025, 0x0020, 0x0022, 0x0018,
            0x001A, 0x001C, 0x0024, 0x0027, 0xFFFF, 0xFFFF,
            0x0026, 0x001E, 0x0010, 0x0012, 0x0019, 0x001B,
            0x001F, 0x000E, 0x0011, 0x0013, 0x000C, 0x0015,
            0x0017, 0x0016, 0x001D, 0x0014, 0x0009, 0x000D,
            0x000F, 0x0008, 0x000A, 0x0002, 0x0004, 0x0006,
