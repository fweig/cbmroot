...
class CbmMcbm2018UnpackerAlgoTof : public CbmStar2019Algo<CbmTofDigi>
{
   public:
      CbmMcbm2018UnpackerAlgoTof();
      ~CbmMcbm2018UnpackerAlgoTof();
   ...
   private:
      ...
      /// Buffers
      std::vector< std::vector< gdpbv100::Message > >    fvvmEpSupprBuffer;         //! [DPB], FIXME: dimension to be removed as not needed with real MS
