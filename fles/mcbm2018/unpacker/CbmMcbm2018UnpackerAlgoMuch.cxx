...
*/
         ...
         LOG(warning) << "Could not find the sDPB index for AFCK id 0x"
                   ...
                   << "\n"
                   << "If valid this index has to be added in the MUCH parameter file in the DbpIdArray field";
...
// -------------------------------------------------------------------------
void CbmMcbm2018UnpackerAlgoMuch::ProcessHitInfo( const stsxyter::Message & mess, const UShort_t & usElinkIdx, const UInt_t & uAsicIdx, const UInt_t & /*uMsIdx*/ )
{
...
*/
   ...
   if( mess.IsHitMissedEvts() )
      fErrVect.push_back( CbmErrorMessage( ECbmModuleId::kMuch, dHitTimeNs, uAsicIdx, 1 << stsxyter::kusLenStatStatus, usChan ) );
...
Bool_t CbmMcbm2018UnpackerAlgoMuch::CreateHistograms()
{
   ...
   fhDigisTimeInRun = new TH1I( "hMuchDigisTimeInRun",
