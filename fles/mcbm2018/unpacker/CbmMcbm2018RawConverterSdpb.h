...
public:
  ...
  CbmMcbm2018RawConverterSdpb
  operator=(const CbmMcbm2018RawConverterSdpb&) = delete;
...
private:
  ...
  size_t fuNbMsLoop;                       //!
  Bool_t
    fbIgnoreOverlapMs;  //! /** Ignore Overlap Ms: all fuNbOverMsPerTs MS at the end of timeslice **/
  ...
  /// Output vector
  std::vector<std::vector<stsxyter::Message>*>
    fvSdpbMessages;  //! Output arrays, 1 per DPB
