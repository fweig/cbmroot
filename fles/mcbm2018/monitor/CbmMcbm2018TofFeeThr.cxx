...
/// TODO: move these constants somewhere shared, e.g the parameter file
   ...
   Double_t kdThrMeasVal[ kuNbThrMeasPoints ] = {
       -652.6, -631.2, -611.4, -590.6, -570.9, -550.0, -529.9, -509.4,
       -490.6, -469.5, -449.3, -428.5, -408.5, -388.2, -367.8, -347.2,
       -329.2, -308.2, -287.5, -266.8, -246.9, -226.0, -205.6, -185.0,
       -165.7, -144.9, -124.4, -103.8,  -83.4,  -62.9,  -42.4,  -21.2,
         -5.3,   15.5,   36.2,   56.8,   77.3,   97.8,  118.4,  139.1,
        158.7,  179.2,  199.7,  220.2,  240.8,  261.1,  281.7,  302.2,
        321.3,  341.4,  362.0,  382.2,  402.9,  422.8,  443.4,  463.7,
        483.7,  503.7,  524.1,  544.3,  565.0,  585.0,  605.5,  626.0,
        646.1 };
...
void CbmMcbm2018TofFeeThr::CreateHistograms()
{
   ...
   fhGdpbAsicSpiCounts = new TH2I( "hGdpbAsicSpiCounts",
