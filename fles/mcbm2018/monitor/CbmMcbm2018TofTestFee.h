...
class CbmMcbm2018TofTestFee: public CbmMcbmUnpack {
   public:
      ...
      inline void SelectTestFees( UInt_t uGdpbA, UInt_t uGbtxA, UInt_t uFeeA,
                           UInt_t uGdpbB, UInt_t uGbtxB, UInt_t uFeeB )
         {
          fuGdpbA = uGdpbA; fuGbtxA = uGbtxA; fuFeeA  = uFeeA;
          fuGdpbB = uGdpbB; fuGbtxB = uGbtxB; fuFeeB  = uFeeB;
         }
