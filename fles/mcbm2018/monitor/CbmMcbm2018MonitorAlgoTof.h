...
public:
  ...
  inline void UseAbsoluteTime(Bool_t bFlagIn = kTRUE) {
    fbUseAbsoluteTime = bFlagIn;
  }
...
private:
  ...
  Bool_t fbUseAbsoluteTime =
    kFALSE;  //! Switch ON the usage of abolute time scale for the evo histo (no start time)
