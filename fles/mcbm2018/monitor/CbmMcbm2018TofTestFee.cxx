...
void CbmMcbm2018TofTestFee::CreateHistograms()
{
   ...
   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
   {
      ...
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
      {
         if( uChanA < uChanB )
         {
            fvhTimeDiffPulserFeeA[ uChanA ][ uChanB ] = new TH1I(
               Form("hTimeDiffPulser_g%02u_gbt%1u_f%1u_ch%02u_ch%02u", fuGdpbA, fuGbtxA, fuFeeA, uChanA, uChanB ),
               Form("Time difference for pulser on gDPB %02u GBTx %02u FEE %1u channels %02u and %02u; DeltaT [ps]; Counts",
                     fuGdpbA, fuGbtxA, fuFeeA, uChanA, uChanB ),
               uNbBinsDt, dMinDt, dMaxDt);

            fvhTimeDiffPulserFeeB[ uChanA ][ uChanB ] = new TH1I(
               Form("hTimeDiffPulser_g%02u_gbt%1u_f%1u_ch%02u_ch%02u", fuGdpbB, fuGbtxB, fuFeeB, uChanA, uChanB ),
               Form("Time difference for pulser on gDPB %02u GBTx %02u FEE %1u channels %02u and %02u; DeltaT [ps]; Counts",
         ...
         fvhTimeDiffPulserFeeFee[ uChanA ][ uChanB ] = new TH1I(
            Form("hTimeDiffPulser_g%02u_gbt%1u_f%1u_ch%02u_g%02u_gbt%1u_f%1u_ch%02u",
                  fuGdpbA, fuGbtxA, fuFeeA, uChanA, fuGdpbB, fuGbtxB, fuFeeB, uChanB ),
            Form("Time difference for pulser on gDPB %02u GBTx %02u FEE %1u channel %02u and gDPB %02u GBTx %02u FEE %1u channel %02u; DeltaT [ps]; Counts",
                  fuGdpbA, fuGbtxA, fuFeeA, uChanA,
                  fuGdpbB, fuGbtxB, fuFeeB, uChanB ),
            uNbBinsDt, dMinDt, dMaxDt);
      } // for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
   } // for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
   ...
   fhTimeMeanPulserFeeA = new TH2D( name.Data(),
         "Time difference Mean for each channel pairs in FEE A; Chan A; Chan B ; Mean [ps]",
   ...
   fhTimeRmsPulserFeeA = new TH2D( name.Data(),
         "Time difference RMS for each channel pairs in FEE A; Chan A; Chan B; RMS [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeRmsZoomFitPulsFeeA";
   fhTimeRmsZoomFitPulsFeeA = new TH2D( name.Data(),
         "Time difference RMS after zoom for each channel pairs in FEE A; Chan A; Chan B; RMS [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeResFitPulsFeeA";
   fhTimeResFitPulsFeeA = new TH2D( name.Data(),
         "Time difference Res from fit for each channel pairs in FEE A; Chan A; Chan B; Sigma [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );
   ...
   fhTimeMeanPulserFeeB = new TH2D( name.Data(),
         "Time difference Mean for each channel pairs in FEE B; Chan A; Chan B ; Mean [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeRmsPulserFeeB";
   fhTimeRmsPulserFeeB = new TH2D( name.Data(),
         "Time difference RMS for each channel pairs in FEE B; Chan A; Chan B; RMS [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeRmsZoomFitPulsFeeB";
   fhTimeRmsZoomFitPulsFeeB = new TH2D( name.Data(),
         "Time difference RMS after zoom for each channel pairs in FEE B; Chan A; Chan B; RMS [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeResFitPulsFeeB";
   fhTimeResFitPulsFeeB = new TH2D( name.Data(),
         "Time difference Res from fit for each channel pairs in FEE B; Chan A; Chan B; Sigma [ps]",
         fuNrOfChannelsPerFee - 1, -0.5, fuNrOfChannelsPerFee - 1.5,
         fuNrOfChannelsPerFee - 1,  0.5, fuNrOfChannelsPerFee - 0.5 );
   ...
   fhTimeMeanPulserFeeFee = new TH2D( name.Data(),
         "Time difference Mean for each channel pairs in FEE A & B; Chan FEE A; Chan FEE B ; Mean [ps]",
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5,
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeRmsPulserFeeFee";
   fhTimeRmsPulserFeeFee = new TH2D( name.Data(),
         "Time difference RMS for each channel pairs in FEE A & B; Chan FEE A; Chan FEE B; RMS [ps]",
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5,
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeRmsZoomFitPulsFeeFee";
   fhTimeRmsZoomFitPulsFeeFee = new TH2D( name.Data(),
         "Time difference RMS after zoom for each channel pairs in FEE A & B; Chan FEE A; Chan FEE B; RMS [ps]",
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5,
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5 );

   name = "hTimeResFitPulsFeeFee";
   fhTimeResFitPulsFeeFee = new TH2D( name.Data(),
         "Time difference Res from fit for each channel pairs in FEE A & B; Chan FEE A; Chan FEE B; Sigma [ps]",
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5,
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5 );

   /// TOT plots
   name = "hChanTotFeeA";
   fhChanTotFeeA = new TH2D( name.Data(),
         "TOT distribution per channel in FEE A; Chan FEE A; TOT [bin]; Counts []",
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5,
         gdpbv100::kuTotCounterSize, -0.5, gdpbv100::kuTotCounterSize - 0.5 );
   name = "hChanTotFeeB";
   fhChanTotFeeB = new TH2D( name.Data(),
...
//   double * dBinsLog = GenerateLogBinArray( 9, 9, 10, iNbBinsLog );
   ...
   fhChanPulseIntervalFeeA = new TH2D( name.Data(),
         "Pulses time interval per channel in FEE A; Time interval [ns]; Chan FEE A; Counts []",
         iNbBinsLog, dBinsLog,
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5 );
   name = "hChanPulseIntervalFeeB";
   fhChanPulseIntervalFeeB = new TH2D( name.Data(),
         "Pulses time interval per channel in FEE B; Time interval [ns]; Chan FEE B; Counts []",
         iNbBinsLog, dBinsLog,
         fuNrOfChannelsPerFee, -0.5, fuNrOfChannelsPerFee - 0.5 );
   ...
   for( UInt_t uGdpb = 0; uGdpb < fuNrOfGdpbs; ++uGdpb )
   {
      ...
      fvhPulserCountEvoPerFeeGdpb.push_back( new TH2D( name.Data(),
            Form( "Pulser count per FEE in gDPB %02u; time in run [s]; FEE []", uGdpb ),
      ...
      for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      {
         ...
         for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         {
            if( bChanOkFeeA )
            {
               ...
               {
                  Double_t dTimeDiff = 1e3 * ( fvdFeeChanMsLastPulserHit[ fuGlobalIdxFeeA ][ uChanB ]
                                             - fvdFeeChanMsLastPulserHit[ fuGlobalIdxFeeA ][ uChanA ] );
                  if( TMath::Abs( dTimeDiff ) < kdMaxDtPulserPs )
                     fvhTimeDiffPulserFeeA[ uChanA ][ uChanB ]->Fill( dTimeDiff );
               } // if( uChanA < uChanB && 1 == fvuFeeChanNbHitsLastMs[ fuGlobalIdxFeeA ][ uChanB ] )

               /// Fill FEE A VS FEE B plots
               if( 1 == fvuFeeChanNbHitsLastMs[ fuGlobalIdxFeeB ][ uChanB ] )
               {
                  Double_t dTimeDiff = 1e3 * ( fvdFeeChanMsLastPulserHit[ fuGlobalIdxFeeB ][ uChanB ]
                                             - fvdFeeChanMsLastPulserHit[ fuGlobalIdxFeeA ][ uChanA ] );
                  if( TMath::Abs( dTimeDiff ) < kdMaxDtPulserPs )
                     fvhTimeDiffPulserFeeFee[ uChanA ][ uChanB ]->Fill( dTimeDiff );
               } // if( 1 == fvuFeeChanNbHitsLastMs[ fuGlobalIdxFeeB ][ uChanB ] )
            } // if( bChanOkFeeA )
            ...
            if( bChanOkFeeB )
            {
               ...
               if( uChanA < uChanB && 1 == fvuFeeChanNbHitsLastMs[ fuGlobalIdxFeeB ][ uChanB ] )
               {
                  ...
                  if( TMath::Abs( dTimeDiff ) < kdMaxDtPulserPs )
                     fvhTimeDiffPulserFeeB[ uChanA ][ uChanB ]->Fill( dTimeDiff );
               } // if( uChanA < uChanB && 1 == fvuFeeChanNbHitsLastMs[ fuGlobalIdxFeeB ][ uChanB ] )
            } // if( bChanOkFeeB )
         } // for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
      } // for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
...
//                           fulCurrentTsIndex, fuCurrentMs, ulCycleData, ulEpochCycleVal );
                << " TS " << FormatDecPrintout( fulCurrentTsIndex, 5 )
                << " MS " << FormatDecPrintout( fuCurrentMs, 3 )
                << " In data 0x" << FormatHexPrintout( ulCycleData, 16, '0', true )
                << " Cycle 0x" << FormatHexPrintout( ulEpochCycleVal, 16, '0', true );
      fuRawDataPrintMsgIdx ++;
   } // if( fuRawDataPrintMsgIdx < fuRawDataPrintMsgNb || gLogger->IsLogNeeded( fair::Severity::debug2 ) )
...
//   UInt_t uGbtxNrInSys = fuGdpbNr * kuNbGbtxPerGdpb + uGbtxNr;
   ...
   if (0 <= fdStartTime)
      fvhPulserCountEvoPerFeeGdpb[ fuGdpbNr ]->Fill( 1e-9 * (dHitTime - fdStartTime), uFeeNr );
...
void CbmMcbm2018TofTestFee::SaveAllHistos( TString sFileName )
{
   ...
   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         if( NULL != fvhTimeDiffPulserFeeA[ uChanA ][ uChanB ] )
            fvhTimeDiffPulserFeeA[ uChanA ][ uChanB ]->Write();
   gDirectory->cd("..");
   ...
   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         if( NULL != fvhTimeDiffPulserFeeB[ uChanA ][ uChanB ] )
            fvhTimeDiffPulserFeeB[ uChanA ][ uChanB ]->Write();
   gDirectory->cd("..");
   ...
   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         if( NULL != fvhTimeDiffPulserFeeFee[ uChanA ][ uChanB ] )
            fvhTimeDiffPulserFeeFee[ uChanA ][ uChanB ]->Write();
   gDirectory->cd("..");
...
void CbmMcbm2018TofTestFee::ResetAllHistos()
{
   ...
   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         if( NULL != fvhTimeDiffPulserFeeA[ uChanA ][ uChanB ] )
            fvhTimeDiffPulserFeeA[ uChanA ][ uChanB ]->Reset();

   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         if( NULL != fvhTimeDiffPulserFeeB[ uChanA ][ uChanB ] )
            fvhTimeDiffPulserFeeB[ uChanA ][ uChanB ]->Reset();

   for( UInt_t uChanA = 0; uChanA < fuNrOfChannelsPerFee; uChanA++)
      for( UInt_t uChanB = 0; uChanB < fuNrOfChannelsPerFee; uChanB++)
         if( NULL != fvhTimeDiffPulserFeeFee[ uChanA ][ uChanB ] )
            fvhTimeDiffPulserFeeFee[ uChanA ][ uChanB ]->Reset();
...
void CbmMcbm2018TofTestFee::UpdateZoomedFit( std::vector< std::vector< TH1* > > phTimeDiff, TH2* phTimeRmsZoom, TH2* phTimeResFit )
{
