...
#ifndef CbmMcbm2018MonitorAlgoTofPulser_H
#define CbmMcbm2018MonitorAlgoTofPulser_H
...
class CbmMcbm2018MonitorAlgoTofPulser : public CbmStar2019Algo<CbmTofDigi>
{
   public:
      CbmMcbm2018MonitorAlgoTofPulser();
      ~CbmMcbm2018MonitorAlgoTofPulser();
      ...
      inline void SetPulserTotLimits( UInt_t uMin, UInt_t uMax ) { fuPulserMinTot = uMin; fuPulserMaxTot = uMax; }
   ...
   private:
      ...
      std::vector< std::vector< Bool_t > >   fvvbFeeHitFound;           //! [ gDPB ][ FEE ]
      std::vector< std::vector< Double_t > > fvvdFeeHits;               //! [ gDPB ][ FEE ]
...
#endif // CbmMcbm2018MonitorAlgoTofPulser_H
