...
class CbmCheckTiming : public FairTask
{
  public:
    ...
    inline void SetTofPulserTotLimits( UInt_t uMin, UInt_t uMax ) { fuMinTotPulserTof = uMin; fuMaxTotPulserTof = uMax; }
  ...
  private:
    ...
    void CheckTimeOrder();
    template <class Digi> Int_t CheckIfSorted(TH1*, Double_t&, TString);
    ...
    */
    template <class Digi> Int_t FillSystemOffsetHistos(
                                 TH1* histo, TH2* histoCharge,
                                 TH2* histoEvo, TH2* histoEvoLong, TH2* histoAFCK,
                                 const Double_t T0Time, const Int_t offsetRange, Int_t iStartDigi,
                                 Bool_t bSts = kFALSE, Bool_t bMuch = kFALSE, Bool_t bTof = kFALSE, Bool_t bPsd = kFALSE );

    template <class Digi> Int_t FillHistosSelT0(
                                 TH1* histo,
                                 const Double_t T0Time, const Int_t offsetRange, Int_t iStartDigi,
                                 Bool_t bSts = kFALSE, Bool_t bMuch = kFALSE, Bool_t bTof = kFALSE, Bool_t bPsd = kFALSE );
