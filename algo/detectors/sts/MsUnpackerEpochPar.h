...
namespace cbm::algo::sts
{
  ...
  struct Unpack : xpu::kernel<GPUReco> {
    using scan_t = xpu::block_scan<int, kBlockSize>;
    struct shared_memory {
      scan_t::storage_t scan;
      u64 bcastBlockDigiOffset;
      u64 bcastNCycles;
      u64 bcastBaselineEpoch;
      stsxyter::Message tsMsbMsg [kBlockSize]; // note: potentially increase to 1024
    };
  ...
  private:  // methods
     ...
     **/
    XPU_D void ProcessHitMessage(const stsxyter::Message& message, CbmStsDigi* digi,
