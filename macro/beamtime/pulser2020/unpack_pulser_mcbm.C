...
*/
  ...
  if( 999 == uRunId )
    inFile = "/home/loizeau/EDC/flesnet/build/r0004_20200306_0858/r0004_20200306_0858_*.tsa";
...
//  pulserChecker->SetMuchPulseradcLimits(     2,    10 );  /// EDC Setup
...
//  pulserChecker->SetMuchOffsetSearchRange( 5000 );
  pulserChecker->SetMuchOffsetSearchRange( 50000 );
  ...
  if( 0 < uRunId )
    ...
    else pulserChecker->SetOutFilename(  "data/HistosPulserCheck_online.root" );
...
*/
  /// EDC Setup
//  pulserChecker->SetMuchAsic( 0 );
  pulserChecker->SetMuchChanRange( 32, 32 );
