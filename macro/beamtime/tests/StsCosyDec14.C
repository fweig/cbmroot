...
void StsCosyDec14(Int_t nEvents = -1, Int_t runID = 106, Int_t fileID = 0)
{
  ...
  TString inDir = "/lustre/cbm/prod/beamtime/2014/12/cosy/";
  ...
  if (runID > 0 && runID < 12) setup = "_hodo_only";
    ...
    setup = "_sts3exttrig_polswap";
  else if (runID > 63 && runID < 67)
    setup = "_0mm";
  else if ((runID > 67 && runID < 72) || runID == 74)
    setup = "_0mm";
  else if (runID == 72)
    setup = "_3mm";
  else if (runID == 73 || runID == 87)
    setup = "_2mm";
  else if (runID == 75)
    setup = "_sts3exttrig_0mm";
  else if (runID == 76)
    setup = "_sts3exttrig_0mm_nobeam";
  else if (runID == 77 || runID == 80)
    setup = "_0mm_selftriggered";
  else if (runID == 82 || runID == 84)
    setup = "_-1mm";
  else if (runID == 83)
    setup = "_-3mm";
  else if (runID == 85)
    ...
    setup = "_1.5mm";
  else if (runID == 89 || runID == 105 || runID == 123)
    setup = "_production_selftrigg";
  else if (runID == 90 || runID == 89)
    setup = "_production_sts3exttrig";
  else if (runID == 92)
    setup = "_-450V_selftrigg";
  else if (runID == 93)
    setup = "_-450V_sts3exttrig";
  else if (runID == 94)
    setup = "_-400V_sts3exttrig";
  else if (runID == 95)
    setup = "_-400V_selftrigg";
  else if (runID == 96)
    setup = "_-350V_selftrigg";
  else if (runID == 97)
    setup = "_-350V_sts3exttrig";
  else if (runID == 98)
    setup = "_-300V_sts3exttrig";
  else if (runID == 99)
    setup = "_-300V_selftrigg";
  else if (runID == 100)
    setup = "_-250V_selftrigg";
  else if (runID == 101)
    setup = "_-250V_sts3exttrig";
  else if (runID == 102 || runID == 104 || runID == 119 || runID == 120)
    setup = "_selftrigg";
  else if (runID == 103 || runID == 121)
    setup = "_-0.5mm_selftrigg";
  else if (runID == 106 || runID == 124 || runID == 127)
    setup = "_production_sts3exttrig";
  else if (runID == 107)
    setup = "_voltagescan470_selftrigg";
  else if (runID == 108)
    setup = "_voltagescan470_sts3exttrig";
  else if (runID == 109)
    setup = "_voltagescan450_sts3exttrig";
  else if (runID == 110)
    setup = "_voltagescan450_selftrigg";
  else if (runID == 111)
    setup = "_voltagescan400_selftrigg";
  else if (runID == 112)
    setup = "_voltagescan400_sts3exttrig";
  else if (runID == 113)
    setup = "_voltagescan350_sts3exttrig";
  else if (runID == 114)
    setup = "_voltagescan350_selftrigg";
  else if (runID == 115)
    setup = "_voltagescan300_selftrigg";
  else if (runID == 116)
    setup = "_voltagescan300_sts3exttrig";
  else if (runID == 117)
    setup = "_voltagescan251_sts3exttrig";
  else if (runID == 118)
    setup = "_voltagescan251_selftrigg";
  else if (runID == 122)
    setup = "_0.25mm_selftrigg";
  else if (runID == 125)
    setup = "_nobeam_selftrigg_150V";
  else if (runID == 126)
    setup = "_production_selftrigg_150V";
  else if (runID == 128)
  ...
  if (runID < 10) inFile = inDir + "run00" + runN + setup + "_00" + fileN + "?.lmd";
    ...
    inFile = inDir + "run" + runN + setup + "_0000" + ".lmd";
  else if (runID > 99)
    inFile = inDir + "run" + runN + setup + "_00" + fileN + "?.lmd";
...
*/
  ...
  run->Run(0, 1000);  // run for 100 events
  timer.Stop();
