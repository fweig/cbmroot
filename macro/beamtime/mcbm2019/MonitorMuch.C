...
void MonitorMuch(TString inFile = "", TString sHostname = "en02", Int_t nEvents = -1, Int_t iServerRefreshRate = 100,
                 Int_t iServerHttpPort = 8080, TString sHistoFile = "data/MuchHistos.root")
{
  ...
  TString outFile = "data/moni_much.root";
