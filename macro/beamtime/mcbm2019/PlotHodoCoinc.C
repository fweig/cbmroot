...
void PlotHodoCoinc( TString sFilename, Int_t iNbTs = -1, Double_t dOffsetX = 0.0, Double_t dOffsetY = 0.0 )
{
   /// Data access
...
///---------------------------------------------------------------------///
   ...
   TH2 * phNbHitsComparison  = new TH2I( "phNbHitsComparison", "Number of hits per TS in Hodo A vs Hodo B; Nb Hits A[]; Nb Hits B []; TS []",
                                          100, 0.0, 100.0,
                                          100, 0.0, 100.0 );
///---------------------------------------------------------------------///
