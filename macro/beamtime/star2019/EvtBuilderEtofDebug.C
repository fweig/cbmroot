...
void EvtBuilderEtofDebug(TString inFile = "", TString sHostname = "localhost", Int_t iServerRefreshRate = 100,
                         Int_t iServerHttpPort = 8082, Bool_t bAddStatusToEvent = kTRUE, UInt_t nrEvents = 0)
{
  ...
  etofEventBuilder->SetMonitorMode();
  etofEventBuilder->SetDebugMonitorMode();
