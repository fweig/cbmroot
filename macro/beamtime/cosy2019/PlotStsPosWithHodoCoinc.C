...
Bool_t PlotStsPosWithHodoCoinc( Long64_t liNbEntryToRead = -1, UInt_t uRunId = 12,
                                Double_t dHodoWinStart = -600, Double_t dHodoWinStop = 600,
                                Double_t dStsWinStart = -1000, Double_t dStsWinStop = 1000 )
{
   /// Data Input
   TClonesArray * pHitsArraySts  = new TClonesArray("CbmStsHit",5000);\
//   TClonesArray * pHitsArrayT0   = new TClonesArray("CbmTofHit",5000);
   ...
   TH1 * hHodoTimeDiff = new TH1D( "hHodoTimeDiff", "Time difference between hits on the front and back hodoscopes; T_B - T_A [ns]; Counts [Hits]",
                                   static_cast< Int_t >(dHodoWinStop - dHodoWinStart), dHodoWinStart, dHodoWinStop );
   TH2 * hHodoTimeDiffEvo = new TH2D( "hHodoTimeDiffEvo", "Evolution of Time difference between hits on the front and back hodoscopes; Time in Run [s]; T_B - T_A [ns]; Counts [Hits]",
                                   120, 0, 1200,
                                   static_cast< Int_t >(dHodoWinStop - dHodoWinStart), dHodoWinStart, dHodoWinStop );

      /// Hodo-STS time difference
   TH1 * hStsTimeDiff = new TH1D( "hStsTimeDiff", "Time difference between hits on the STS and hodoscopes; T_Sts - T_Hodo [ns]; Counts [Hits]",
                                   static_cast< Int_t >(dStsWinStop - dStsWinStart), dStsWinStart, dStsWinStop );
   TH2 * hStsTimeDiffEvo = new TH2D( "hStsTimeDiffEvo", "Evolution of Time difference between hits on the STS and hodoscopes; Time in Run [s]; T_Sts - T_Hodo [ns]; Counts [Hits]",
                                   120, 0, 1200,
                                   static_cast< Int_t >(dStsWinStop - dStsWinStart), dStsWinStart, dStsWinStop );
