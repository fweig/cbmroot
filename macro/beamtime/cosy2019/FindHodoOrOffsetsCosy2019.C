...
Bool_t FindHodoOrOffsetsCosy2019( Long64_t liNbEntryToRead = -1, UInt_t uRunId = 25,
                        ...
                        TString sInputFileName = "data/unp_cosy")
{
   ...
   TH1 * hTimeDiffHodoA = new TH1D( "hTimeDiffHodoA", "Time difference between Digis in the front hodoscopes and OR coincidences; T_A - T_Or [ns]; Counts [Digis]",
                                   ( 2 * uHodoWinLimClk + 1 ), dHodoWinStart, dHodoWinStop );
   TH1 * hTimeDiffHodoB = new TH1D( "hTimeDiffHodoB", "Time difference between Digis in the back hodoscopes and OR coincidences; T_B - T_Or [ns]; Counts [Digis]",
                                   ( 2 * uHodoWinLimClk + 1 ), dHodoWinStart, dHodoWinStop );
   TH2 * hTimeDiffEvoHodoA = new TH2D( "hTimeDiffEvoHodoA", "Evolution of Time difference between Digis in the front hodoscopes and OR coinc; Time in Run [s]; T_A - T_Or [ns]; Counts [Digis]",
                                   120, 0, 1200,
                                   ( 2 * uHodoWinLimClk + 1 ), dHodoWinStart, dHodoWinStop );
   TH2 * hTimeDiffEvoHodoB = new TH2D( "hTimeDiffEvoHodoB", "Evolution of Time difference between Digis in the back hodoscopes and OR coinc; Time in Run [s]; T_B - T_Or [ns]; Counts [Digis]",
                                   120, 0, 1200,
                                   ( 2 * uHodoWinLimClk + 1 ), dHodoWinStart, dHodoWinStop );

      /// STS time difference
   TH2 * hTimeDiffSts = new TH2D( "hTimeDiffSts", "Time difference between Digis on the STS and hodoscopes OR; T_Sts - T_Hodo [ns]; ASIC; Counts [Digis]",
                                   ( 2 * uStsWinLimClk + 1 ), dStsWinStart, dStsWinStop,
                                   kuNbAsics, -0.5, kuNbAsics - 0.5 );
