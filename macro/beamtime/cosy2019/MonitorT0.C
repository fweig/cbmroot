...
void MonitorT0( TString inFile = "", TString sHostname = "localhost",
                Int_t iServerHttpPort = 8082, Int_t iServerRefreshRate = 100,
                UInt_t uRunId = 0, UInt_t nrEvents=0)
{
  ...
  if( uRunId < 87 )
    monitor_t0->SetPulserTotLimits( 90, 100 ); // for runs <= 86
    else monitor_t0->SetPulserTotLimits( 180, 210 ); // for runs  >  86
