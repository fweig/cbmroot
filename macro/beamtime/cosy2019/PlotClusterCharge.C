...
Bool_t PlotClusterCharge(Long64_t liNbEntryToRead = -1, UInt_t uRunId = 12) {
  ...
  TH2* hClustChargeHodoA =
    new TH2D("hClustChargeHodoA",
  ...
  TH2* hClustChargeSts =
    new TH2D("hClustChargeSts",
             ...
             0.,
             400000.);
  TH2* hClustChargeHodoB =
    new TH2D("hClustChargeHodoB",
             "Cluster charge vs cluster position in Hodo B; Cluster position "
             "(strip) []; Cluster Charge []; Counts [Clusters]",
             128,
             -0.5,
  ...
  TH2* hClustChargeSizeHodoA =
    new TH2D("hClustChargeSizeHodoA",
             ...
             0.,
             400000.);
  TH2* hClustChargeSizeSts =
    new TH2D("hClustChargeSizeSts",
             ...
             0.,
             400000.);
  TH2* hClustChargeSizeHodoB =
    new TH2D("hClustChargeSizeHodoB",
  ...
  TH2* hClustSizePosHodoA =
    new TH2D("hClustSizePosHodoA",
             ...
             -0.5,
             127.5);
  TH2* hClustSizePosSts =
    new TH2D("hClustSizePosSts",
             ...
             -0.5,
             254.5);
  TH2* hClustSizePosHodoB =
    new TH2D("hClustSizePosHodoB",
             "Cluster size vs cluster position in Hodo B; Cluster position "
  ...
  for (Long64_t liEntry = 3; liEntry < liNbEntryToRead; liEntry++) {
    ...
    if (0 == liEntry % 1000)
      std::cout << "Event " << std::setw(6) << liEntry << " Nb Sts clusters is "
                << std::setw(6) << uNbClustersSts << std::endl;

    for (UInt_t uStsClust = 0; uStsClust < uNbClustersSts; ++uStsClust) {
      CbmStsCluster* pClust =
        static_cast<CbmStsCluster*>(pClustersArraySts->At(uStsClust));
  ...
  /// Displaying
  TCanvas* cClustCharge =
    new TCanvas("cClustCharge", "Cluster charge VS position for each detector");
  ...
  TCanvas* cClustChargeSize =
    new TCanvas("cClustChargeSize", "Cluster charge VS size for each detector");
  ...
  TCanvas* cClustSizePos =
    new TCanvas("cClustSizePos", "Cluster size VS position for each detector");
  ...
  TFile* outFile =
    new TFile(Form("data/PlotClusterCharge_%04u.root", uRunId), "recreate");
  outFile->cd();
