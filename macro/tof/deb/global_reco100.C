...
void global_reco100(Int_t nEvents = 100,  // number of events
                    Int_t seed    = 555)
{
  ...
  TString mcFile         = dir + "auaumbias.mc.root";           // MC transport file
  TString parFile        = dir + "auaumbias.params.root";       // Parameters file
  TString globalRecoFile = dir + "auaumbias.global.reco.root";  // Output file with reconstructed tracks and hits
  ...
  TString resultDir = "./data/auaumbias100/";
