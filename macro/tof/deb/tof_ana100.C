tof_ana100(Int_t nEvents = 1000, Int_t iout = 1) {
  ...
  TH2F* ptm_rap_gen_p = new TH2F(
    "ptm_rap_gen_p", "MCTrack-gen proton; y; p_{T}/m", 30, -1, 5, 30, 0, 2.5);

  TH1F* drp_gen =
    new TH1F("drp_gen", "#Delta#phi-reaction plane;", 100, -180., 180.);
  TH2F* cdrp_b_gen = new TH2F(
    "cdrp_b_gen",
    "reaction plane resolution;impact parameter b; cos#Delta#phi_{rp};",
    15,
    0.,
    15.,
    20,
    0.,
    1.);
  TH2F* drp_b_gen = new TH2F("drp_b_gen",
                             "#Delta#phi-reaction plane;impact parameter b;",
                             15,
                             0.,
                             15.,
                             36,
  ...
  TH2F* ptm_rap_poi_p = new TH2F(
    "ptm_rap_poi_p", "MCTrack-poi proton; y; p_{T}/m", 30, -1, 5, 30, 0, 2.5);

  TH1F* drp_poi =
    new TH1F("drp_poi", "#Delta#phi-reaction plane (Poi);", 100, -180., 180.);
  TH2F* cdrp_b_poi = new TH2F(
    "cdrp_b_poi",
    "Poi reaction plane resolution;impact parameter b; cos#Delta#phi_{rp};",
    15,
    0.,
    15.,
    20,
  ...
  TH2F* drp_b_poi =
    new TH2F("drp_b_poi",
             "Poi-reaction plane;impact parameter b; #Delta#phi;",
             15,
             0.,
             15.,
             36,
  ...
  TH2F* ptm_rap_hit_p = new TH2F(
    "ptm_rap_hit_p", "MCTrack-hit proton; y; p_{T}/m", 30, -1, 5, 30, 0, 2.5);

  TH1F* drp_hit = new TH1F(
    "drp_hit", "#Delta#phi-reaction plane (TofHit);", 100, -180., 180.);
  TH2F* cdrp_b_hit = new TH2F(
    "cdrp_b_hit",
    "TofHit reaction plane resolution;impact parameter b; cos#Delta#phi_{rp};",
    15,
    0.,
    15.,
    20,
  ...
  TH2F* drp_b_hit =
    new TH2F("drp_b_hit",
             "TofHit-reaction plane;impact parameter b; #Delta#phi;",
             15,
             0.,
             15.,
             36,
  ...
  TH2F* pv_poi =
    new TH2F("pv_poi", "momentum; velocity;", 100, 0., 32., 100., 0., 4.);
  TH2F* tm_poi = new TH2F(
    "tm_poi", "Tofpoi(all); momentum; Tofmass;", 100, 0., 10., 100., 0., 2.5);
  TH2F* tm_poiprim = new TH2F("tm_poiprim",
                              "Tofpoi(primary points); momentum; Tofmass",
                              100,
                              0.,
                              10.,
                              100.,
                              ...
                              2.5);
  TH1F* len_poiprim =
    new TH1F("len_poiprim", "TofPoi; tof (ns); Counts", 100, 0., 800.);
  ...
  TH2F* dzx =
    new TH2F("dzx", "TofHit; z; Delta x;", 100, -xrange, xrange, 50, -20., 20.);
  TH2F* dzy =
    new TH2F("dzy", "TofHit; z; Delta y;", 100, -yrange, yrange, 50, -20., 20.);
  TH2F* dzz =
    new TH2F("dzz", "TofHit; z; Delta z;", 100, 400., 650., 50, -20., 20.);

  TH2F* pv_hit = new TH2F(
    "pv_hit", "TofHit; velocity; momentum; ", 100, 0., 32., 100., 0., 4.);
  TH1F* tof_hit  = new TH1F("tof_hit", "TofHit; tof (ns)", 100, 0., 200.);
  TH1F* dt_hit   = new TH1F("dt_hit", "TofHit; delta-tof (ns)", 100, -2., 2.);
  TH2F* dt_p_hit = new TH2F("dt_p_hit",
                            "TofHit; momentum; delta-tof (ns)",
                            100,
                            0.,
                            10.,
                            50,
                            ...
                            1.5);
  TH2F* tm_hit =
    new TH2F("tm_hit", "TofHit; momentum; mass;", 100, 0., 10., 100., 0., 2.5);
  TH2F* tm_hit1 = new TH2F(
    "tm_hit1", "TofHit(flg=1); momentum; mass;", 100, 0., 10., 100., 0., 2.5);
  TH2F* tm_hit2 = new TH2F(
    "tm_hit2", "TofHit(flg=2); momentum; mass;", 100, 0., 10., 100., 0., 2.5);
  TH2F* tm_hitp = new TH2F(
    "tm_hitp", "TofHit(protons); momentum; mass;", 100, 0., 10., 100., 0., 2.5);
  TH2F* tm_hitprim   = new TH2F("tm_hitprim",
                              "TofHit(primaries); momentum; mass;",
                              100,
                              0.,
                              10.,
                              100.,
                              0.,
                              2.5);
  TH2F* tm_hitp_prim = new TH2F("tm_hitp_prim",
                                "TofHit(prim. protons); momentum; mass;",
                                100,
                                0.,
                                10.,
                                100.,
  ...
  //global tracks
  TH2F* pv_glo = new TH2F(
    "pv_glo", "Global tracks; velocity; momentum;", 100, 0., 32., 100., 0., 4.);
  TH2F* tm_glo = new TH2F(
    "tm_glo", "Global tracks; momentum; mass;", 100, 0., 10., 100., 0., 2.5);

  TH2F* pv_gloprim =
    new TH2F("pv_gloprim",
             "Global primary tracks; velocity(cm/ns); momentum(GeV/c);",
             100,
             0.,
             32.,
             100.,
             0.,
             4.);
  TH2F* tm_gloprim = new TH2F("tm_gloprim",
                              "Global primary tracks; momentum (GeV/c); mass;",
                              100,
                              0.,
                              10.,
                              100.,
                              ...
                              2.5);
  TH2F* tm_glop_prim =
    new TH2F("tm_glop_prim",
             "Global primary proton tracks; momentum (GeV/c); mass;",
             100,
             0.,
             10.,
             100.,
  ...
  TH2F* ptm_rap_glo_kp = new TH2F(
    "ptm_rap_glo_kp", "MCTrack-glo k-plus; y; p_{T}/m", 30, -1, 5, 30, 0, 2.5);
  TH2F* ptm_rap_glo_km = new TH2F(
    "ptm_rap_glo_km", "MCTrack-glo k-minus; y; p_{T}/m", 30, -1, 5, 30, 0, 2.5);
  TH2F* ptm_rap_glo_p = new TH2F(
    "ptm_rap_glo_p", "MCTrack-glo proton; y; p_{T}/m", 30, -1, 5, 30, 0, 2.5);

  TH1F* drp_glo = new TH1F(
    "drp_glo", "#Delta#phi-reaction plane (GloHit);", 100, -180., 180.);
  TH2F* cdrp_b_glo = new TH2F(
    "cdrp_b_glo",
    "GloHit reaction plane resolution;impact parameter b; cos #Delta#phi_{rp};",
    15,
    0.,
    15.,
    20,
  ...
  TH2F* drp_b_glo =
    new TH2F("drp_b_glo",
             "Glo-reaction plane;impact parameter b; #Delta#phi; ",
             15,
             0.,
             15.,
             36,
  ...
  cout << "total number of events to process: " << nevent << ", wxy2=" << wxy2
       << ", rxy2=" << rxy2 << endl;
  ...
  for (Int_t iev = 0; iev < nevent; iev++) {
    ...
    for (Int_t k = 0; k < nMCTracks; k++) {  // inspect tracks
      ...
      //	{                       // all particles
      if (pid == 2212) {  // protons
        ptm_rap_gen_p->Fill(MCTrack->GetRapidity(),
                            MCTrack->GetPt() / MCTrack->GetMass());
    ...
    for (Int_t l = 0; l < nTofPoints; l++) {
      ...
      if (TrackP[k] == 0) {  // for efficiency
        ...
        //	{                       // all particles
        if (pid == 2212) {  // protons
          ptm_rap_poi_p->Fill(MCTrack->GetRapidity(),
                              MCTrack->GetPt() / MCTrack->GetMass());
          if (MCTrack->GetRapidity()
              > yrp_mid) {  // set weights for reaction plane
            rp_weight = 1.;
        ...
        if (MCTrack->GetMotherId() == -1) {
          ...
          if (tofmass > 0.98) {
            ...
            Float_t p_poi = sqrt(vmom.X() * vmom.X() + vmom.Y() * vmom.Y()
                                 + vmom.Z() * vmom.Z());
            cout << "Bad primary TofPoint from MCtrack " << k << " pid " << pid
                 << ", M " << tofmass << ", DetID " << TofPoint->GetDetectorID()
                 << ", SM " << SMtype_poi << "," << mod_poi << "," << cel_poi
                 << "," << gap_poi << ",p: " << p_MC << "-" << p_poi << endl;
            //TofPoint->Print();
          }
        }
        //x_poi1->Fill(x_poi);
    ...
    for (Int_t j = 0; j < nTofHits; j++) {
      ...
      if (TrackP[k] == 0) {  // for efficiency
        ...
        if (pid == 2212) {  //protons
          ptm_rap_hit_p->Fill(MCTrack->GetRapidity(),
                              MCTrack->GetPt() / MCTrack->GetMass());
      ...
      if (flg_hit == 1) { tm_hit1->Fill(p_MC, tofmass); }
      elseif(flg_hit == 2) { tm_hit2->Fill(p_MC, tofmass); }

      if (MCTrack->GetMotherId() == -1) { tm_hitprim->Fill(p_MC, tofmass); }
    ...
    for (Int_t i = 0; i < nGlobTracks; i++) {  // inspect global tracks
      ...
      if (j > 0) {
        ...
        if (tpar->GetQp() == 0.) {
          cout << "Invalid momentum for global track " << i << " Hit " << j
               << endl;
          continue;
        }
        ...
        if (MCTrack->GetMotherId() == -1) {  // select primaries
          ...
          if (pid == 321) {
            ptm_rap_glo_kp->Fill(MCTrack->GetRapidity(),
                                 MCTrack->GetPt() / MCTrack->GetMass());
          }
          if (pid == -321) {
            ptm_rap_glo_km->Fill(MCTrack->GetRapidity(),
                                 MCTrack->GetPt() / MCTrack->GetMass());
          }
          if (pid == 2212) {  //protons
            tm_glop_prim->Fill(mom, tofmass);
            ptm_rap_glo_p->Fill(MCTrack->GetRapidity(),
                                MCTrack->GetPt() / MCTrack->GetMass());
