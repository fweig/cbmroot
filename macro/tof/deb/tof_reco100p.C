...
void tof_reco100p(Int_t nEvents = 1000)
{
  ...
  TString inFile = "data/prot.mc.root";

  // Parameter file
  TString parFile = "data/prot.params.root";

  // Output file
  TString outFile = "data/prot.eds.root";
  ...
  TString TofGeoPar = "/parameters/tof/par_tof_V12a.txt";  // 6 m version
