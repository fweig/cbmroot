tof_deb100(Int_t nEvents = 1000, Int_t iout = 1)
{
  ...
  TH2F* cdrp_b_gen =
    new TH2F("cdrp_b_gen", "reaction plane resolution;impact parameter b; cos[D]_{rp};", 15, 0., 15., 20, 0., 1.);
  ...
  TH2F* cdrp_b_poi =
    new TH2F("cdrp_b_poi", "Poi reaction plane resolution;impact parameter b; cos[D]_{rp};", 15, 0., 15., 20, 0., 1.);
  ...
  TH2F* cdrp_b_hit = new TH2F("cdrp_b_hit", "TofHit reaction plane resolution;impact parameter b; cos[D]_{rp};", 15, 0.,
                              15., 20, 0., 1.);
  TH2F* drp_b_hit =
    new TH2F("drp_b_hit", "TofHit-reaction plane;impact parameter b; [Df]", 15, 0., 15., 36, -180., 180.);
  ...
  TH2F* cdrp_b_glo = new TH2F("cdrp_b_glo", "GloHit reaction plane resolution;impact parameter b; cos[D]_{rp};", 15, 0.,
                              15., 20, 0., 1.);
