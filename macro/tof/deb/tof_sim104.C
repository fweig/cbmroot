...
void tof_sim104(Int_t nEvents = 10)
{
  ...
  TString inFile  = inDir + "/input/urqmd.auau.4agev.mbias.0000.ftn14";
  TString outDir  = "data";
  TString outFile = outDir + "/auaumbias4.mc.root";
  TString parFile = outDir + "/auaumbias4.params.root";
  ...
  Double_t fieldScale = 0.4;           // field scaling factor
