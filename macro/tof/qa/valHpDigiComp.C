...
Bool_t valHpDigiComp(
  TString sFilenameA =
    "data/tofqaHP.cbm100_pbar_auau.25gev.centr._qa.hst.all.root",
  TString sFilenameB =
    "data/tofqa.cbm100_pbar_auau.25gev.centr._qa.hst.all.root",
  TString sFilenameC =
    "data/tofqaHP.cbm100_pbar_auau.25gev.centr.noTRD_qa.hst.all.root",
  TString sFilenameD =
    "data/tofqa.cbm100_pbar_auau.25gev.centr.noTRD_qa.hst.all.root",
  TString sTagFilesA  = "HitProd",
  TString sTagFilesB  = "DigiClust",
  TString sTagFilesC  = "HitProd_noTrd",
  TString sTagFilesD  = "DigiClust_noTrd",
