...
Bool_t hitProdComp(
  ...
  TString sFilenameB =
    "data/tofqa.sis300_electron_auau.25gev.centr.noTRD_HitProd.hst.all.root",
  TString sFilenameC =
    "data/tofqa.cbm100_pbar_auau.25gev.centr._HitProd.hst.all.root",
  TString sFilenameD =
    "data/tofqa.cbm100_pbar_auau.25gev.centr.noTRD_HitProd.hst.all.root",
  ...
  for (UInt_t uFile = 0; uFile < kuNbFiles; uFile++)
    for (UInt_t uDim = 0; uDim < kuNbDim; uDim++) {
      ...
      if (NULL != tempOneDimHist)
        hDiffPointHitLeftDelta[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffPointHitLeftDelta%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hDiffPointHitRightDelta[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffPointHitRightDelta%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hSingleTrackHitLeftDelta[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_SingleTrackHitLeftDelta%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hSingleTrackHitRightDelta[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_SingleTrackHitRightDelta%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hDiffTrackHitLeftDelta[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffTrackHitLeftDelta%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hDiffTrackHitRightDelta[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffTrackHitRightDelta%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      hAllPntHitHpLeftDelta[uFile][uDim] =
        (TH1*) (hDiffPointHitLeftDelta[uFile][uDim]->Clone(
          Form("%s_AllPntHitHpLeftDelta%s",
               sTagFiles[uFile].Data(),
               ksDimName[uDim].Data())));
      hAllPntHitHpRightDelta[uFile][uDim] =
        (TH1*) (hDiffPointHitRightDelta[uFile][uDim]->Clone(
          Form("%s_AllPntHitHpRightDelta%s",
               sTagFiles[uFile].Data(),
               ksDimName[uDim].Data())));

      hAllPntHitHpLeftDelta[uFile][uDim]->Add(
        hSinglePointHitDelta[uFile][uDim]);
      hAllPntHitHpRightDelta[uFile][uDim]->Add(
        hSinglePointHitDelta[uFile][uDim]);
  ...
  for (UInt_t uDim = 0; uDim < kuNbDim; uDim++) {
    ...
    for (UInt_t uFile = 0; uFile < kuNbFiles; uFile++) {
      ...
      legSingPnt[uDim]->AddEntry(
        hSinglePointHitDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiPntL[uDim]->AddEntry(
        hDiffPointHitLeftDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiPntR[uDim]->AddEntry(
        hDiffPointHitRightDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legSingTrkL[uDim]->AddEntry(
        hSingleTrackHitLeftDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legSingTrkR[uDim]->AddEntry(
        hSingleTrackHitRightDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiTrkL[uDim]->AddEntry(
        hDiffTrackHitLeftDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiTrkR[uDim]->AddEntry(
        hDiffTrackHitRightDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legAllPntL[uDim]->AddEntry(
        hAllPntHitHpLeftDelta[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legAllPntR[uDim]->AddEntry(
        hAllPntHitHpRightDelta[uFile][uDim], sTagFiles[uFile], "l");
    }  // for( UInt_t uFile = 0; uFile < kuNbFiles; uFile++)
