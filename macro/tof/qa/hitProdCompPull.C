...
Bool_t hitProdCompPull(
  ...
  for (UInt_t uFile = 0; uFile < kuNbFiles; uFile++)
    for (UInt_t uDim = 0; uDim < kuNbDim; uDim++) {
      ...
      if (NULL != tempOneDimHist)
        hDiffPointHitLeftPull[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffPointHitLeftPull%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hDiffPointHitRightPull[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffPointHitRightPull%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hSingleTrackHitLeftPull[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_SingleTrackHitLeftPull%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hSingleTrackHitRightPull[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_SingleTrackHitRightPull%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hDiffTrackHitLeftPull[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffTrackHitLeftPull%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      if (NULL != tempOneDimHist)
        hDiffTrackHitRightPull[uFile][uDim] =
          (TH1*) (tempOneDimHist->Clone(Form("%s_DiffTrackHitRightPull%s",
                                             sTagFiles[uFile].Data(),
                                             ksDimName[uDim].Data())));
      else
        return kFALSE;
      ...
      hAllPntHitHpLeftPull[uFile][uDim] =
        (TH1*) (hDiffPointHitLeftPull[uFile][uDim]->Clone(
          Form("%s_AllPntHitHpLeftPull%s",
               sTagFiles[uFile].Data(),
               ksDimName[uDim].Data())));
      hAllPntHitHpRightPull[uFile][uDim] =
        (TH1*) (hDiffPointHitRightPull[uFile][uDim]->Clone(
          Form("%s_AllPntHitHpRightPull%s",
               sTagFiles[uFile].Data(),
               ksDimName[uDim].Data())));
  ...
  TCanvas* canvSingPnt = new TCanvas(
    "canvSingPnt", "Pull between Hit and Point, single point", 1920, 986);
  ...
  for (UInt_t uDim = 0; uDim < kuNbDim; uDim++) {
    ...
    for (UInt_t uFile = 0; uFile < kuNbFiles; uFile++) {
      ...
      legSingPnt[uDim]->AddEntry(
        hSinglePointHitPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiPntL[uDim]->AddEntry(
        hDiffPointHitLeftPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiPntR[uDim]->AddEntry(
        hDiffPointHitRightPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legSingTrkL[uDim]->AddEntry(
        hSingleTrackHitLeftPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legSingTrkR[uDim]->AddEntry(
        hSingleTrackHitRightPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiTrkL[uDim]->AddEntry(
        hDiffTrackHitLeftPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legMultiTrkR[uDim]->AddEntry(
        hDiffTrackHitRightPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legAllPntL[uDim]->AddEntry(
        hAllPntHitHpLeftPull[uFile][uDim], sTagFiles[uFile], "l");
      ...
      legAllPntR[uDim]->AddEntry(
        hAllPntHitHpRightPull[uFile][uDim], sTagFiles[uFile], "l");
    }  // for( UInt_t uFile = 0; uFile < kuNbFiles; uFile++)
