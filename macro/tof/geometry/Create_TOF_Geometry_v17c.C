...
const TString geoVersion = "tof_v17c_1h";  // SIS 100 hadron, 4.5 m
//const TString geoVersion = "tof_v17c_1e";     // SIS 100 electron, 6 m
//const TString geoVersion = "tof_v17c_1m";     // SIS 100 muon, 6.8 m
//const TString geoVersion = "tof_v17c_3e";     // SIS 300 electron, 8.8 m
//const TString geoVersion = "tof_v17c_3m";     // SIS 300 muon, 10 m
...
const Float_t TOF_Z_Front =
  ("tof_v17c_1h" == geoVersion ? 450 :               // SIS 100 hadron
     ("tof_v17c_1e" == geoVersion ? 600 :            // SIS 100 electron
        ("tof_v17c_1m" == geoVersion ? 680 :         // SIS 100 muon
           ("tof_v17c_3e" == geoVersion ? 880 :      // SIS 300 electron
              ("tof_v17c_3m" == geoVersion ? 1020 :  // SIS 300 muon
                 600  // Set default to SIS 100 electron
               )))));
// Shift of the TOF inner wall relative to default position [cm];
const Float_t InnerWall_Z_PositionShift =
  TOF_Z_Front - 475;  // in cm, Inner wall Offset 0 for wall at 6m
// Shift of the TOF outer wall relative to default position [cm];
const Float_t Wall_Z_PositionShift =
  InnerWall_Z_PositionShift
  - 405;  // in cm, Outer wall Offset -5cm for wall at 10m
// for 0 m
/*
const Float_t  = -600.;  // inner wall placed at 600
const Float_t       = -998.;  // outer wall placed at 1000
*/
// for 6m
/*
...
const Float_t xPosCounter2[27] = {87.,  58.,  29.,  0.,   -29., 87.,  58.,
                                  29.,  0.,   -29., 87.,  58.,  29.,  0.,
                                  -29., -58., -87., -58., -87., -58., -87.,
                                  -58., -87., -58., -87., -58., -87.};
const Float_t yPosCounter2[27] = {-19., -19., -19., -19.,  -19.,  0.,   0.,
                                  0.,   0.,   0.,   19.,   19.,   19.,  19.,
                                  19.,  -24., -24., -14.4, -14.4, -4.8, -4.8,
                                  4.8,  4.8,  14.4, 14.4,  24.,   24.};
const Float_t zPosCounter2[27] = {
...
const Float_t CounterDyoff2[NMTm][2] = {{-4.54, 4.54}, {-4.54, 4.54}, {0., 0.}};
const Float_t CounterDzoff2[NMTm][2] = {{4.54, -4.54}, {4.54, -4.54}, {0., 0.}};
...
const Float_t Module_Size_X[NofModuleTypes] =
  {180.2, 180.2, 180.2, 127.0, 214.0, 185.0};
const Float_t Module_Size_Y[NofModuleTypes] =
  {49., 49., 74., 141.7, 70.5, 141.7};
...
const Float_t CounterXStartPosition[NofModuleTypes] =
  {-60.0, -67.02, -67.02, -60.0, -60.0, -16.0};
const Float_t CounterXDistance[NofModuleTypes] =
  {30.0, 30.351, 30.351, 30.0, 30.0, 30.0};
...
void read_module_positions() {
  ...
  while (std::getline(inFile, strdummy)) {
    ...
    switch (cMod) {
      case 'b': iModType = 2; break;
      case 's': iModType = 1; break;
