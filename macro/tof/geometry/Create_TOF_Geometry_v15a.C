...
const Float_t Inner_Module_Number[Inner_Module_NTypes] = {1., 2., 0.};  //debugging, V15a
...
const Float_t HDbig_Number[HDbig_NTypes] = {1.};  //debugging, V15a

const Float_t HDsmall_Z_Position             = 325.7;
const Float_t HDsmall_First_Y_Position       = 50.2;  // HD - P2
const Float_t HDsmall_X_Offset               = 0.0;
...
const Float_t BucRef_Z_Position            = 405.1;
const Float_t BucRef_First_Y_Position      = 0.;
const Float_t BucRef_X_Offset              = -46.;
...
const Float_t HDRef_Z_Position           = 425.3;
const Float_t HDRef_First_Y_Position     = 67.0;
const Float_t HDRef_X_Offset             = 0.;
...
const Float_t Buc2013_Z_Position             = 340.7;
const Float_t Buc2013_First_Y_Position       = 0.;
const Float_t Buc2013_X_Offset               = -38.4;
...
const Float_t USTC_Z_Position          = 390.1;
...
const Float_t THU_Z_Position         = 370;
const Float_t THU_First_Y_Position   = 0.0;
const Float_t THU_X_Offset           = -43.;
...
const Float_t THUstrip_Z_Position              = 355.0;
const Float_t THUstrip_First_Y_Position        = 56.5;  //
const Float_t THUstrip_X_Offset                = 1.6;
