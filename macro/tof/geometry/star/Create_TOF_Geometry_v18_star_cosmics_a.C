...
const Float_t Glass_X[NumberOfDifferentCounterTypes] =
  {32., 32., 15.04, 18., 2., 0.2, 28.8, 28.8, 17.4, 25.};
const Float_t Glass_Y[NumberOfDifferentCounterTypes] =
  {26.9, 26.9, 4., 4.6, 8., 0.2, 9.6, 9.6, 2.0, 26.7};
const Float_t Glass_Z[NumberOfDifferentCounterTypes] =
  {0.07, 0.028, 0.1, 0.1, 0.01, 0.1, 0.05, 0.05, 0.07, 0.1};
...
const Float_t Electronics_X[NumberOfDifferentCounterTypes] =
  {34.0, 34.0, 15.5, 18.5, 2., 0.3, 30.5, 30.5, 0.2, 26.};
const Float_t Electronics_Y[NumberOfDifferentCounterTypes] =
  {5.0, 5.0, 1.0, 1., 2., 0.1, 0.5, 0.5, 0.2, 5.};
...
const Float_t CounterXStartPosition[NofModuleTypes] =
  {-10.0, -27.74, 2.0, 0.0, 0.0, 0., 0., -15., 0., 0.};
const Float_t CounterXDistance[NofModuleTypes] =
  {30.0, 30.5, 0.0, 30.0, 0.0, 0., 0., 30., 0., 0.};
...
const Float_t Pla_Z_Position[Pla_NTypes] = {(float) ZDist2Target,
                                            (float) (ZDist2Target + 179.5)};
const Float_t Pla_X_Position[Pla_NTypes] = {1.0, -1.};
const Float_t Pla_Y_Position[Pla_NTypes] = {
  (Float_t)(ZDist2Target * TanTheta),
...
const Float_t Cer_Z_Position[Cer_NTypes] = {
  static_cast<Float_t>(ZDist2Target + 164.),
...
const Float_t Cer_Y_Position[Cer_NTypes] = {
  static_cast<Float_t>((ZDist2Target + 164.) * TanTheta),
...
TGeoVolume* create_new_counter(Int_t modType) {
  ...
  if (NULL == DiamondVolMed)
    cout << "<E> DiamondMedium " << DiamondMedium << " not found " << endl;
...
void position_Star2(Int_t modNType) {
  ...
  TGeoRotation* module_rot =
    new TGeoRotation("Star2", Star2_rotate_Z, -MeanTheta, 0.);
...
void position_Star(Int_t modNType) {
  TGeoTranslation* module_trans = NULL;
  TGeoRotation* module_rot =
    new TGeoRotation("Star", Star_rotate_Z, -MeanTheta, 0.);
  // module_rot->RotateZ(Star2_rotate_Z);
  TGeoCombiTrans* module_combi_trans = NULL;
...
void position_HDRef(Int_t modNType) {
  TGeoTranslation* module_trans = NULL;
  TGeoRotation* module_rot =
    new TGeoRotation("HDRef", HDRef_rotate_Z, MeanTheta, 0.);
...
void position_Buc2015(Int_t modNType) {
  TGeoTranslation* module_trans = NULL;
  TGeoRotation* module_rot =
    new TGeoRotation("Buc2015", Buc2015_rotate_Z, -MeanTheta, 0.);
...
void position_pla_modules(Int_t modNType) {
  ...
  for (Int_t j = 0; j < modNType; j++) {
    ...
    TGeoCombiTrans* module_combi_trans = NULL;
    TGeoRotation* module_rot           = new TGeoRotation(
      Form("Pla%d", j), 90. + MeanTheta, 90., 90., 0., -MeanTheta, -90.);
