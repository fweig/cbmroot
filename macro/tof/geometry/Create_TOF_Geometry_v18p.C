...
const Float_t Star_First_Z_Position      = ZDist2Target + 19.5;
const Float_t Star_Delta_Z_Position      = 0.;
...
const Float_t Star_Types[Star_NTypes]    = {1.};
const Float_t Star_Number[Star_NTypes]   = {1.};  //debugging, V16b
const Float_t Star_X_Offset[Star_NTypes] = {
  0.,
};
