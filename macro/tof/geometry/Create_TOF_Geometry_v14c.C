...
const Float_t HDsmall_Z_Position             = 300.7;
...
const Float_t BucRef_Z_Position            = 360.;
const Float_t BucRef_First_Y_Position      = 0.;
const Float_t BucRef_X_Offset              = -20.;
...
const Float_t HDRef_Z_Position           = 397.4;
const Float_t HDRef_First_Y_Position     = 64.0;
...
const Float_t Buc2013_Z_Position             = 300.;
const Float_t Buc2013_First_Y_Position       = 0.;
const Float_t Buc2013_X_Offset               = -20.;
...
const Float_t USTC_Z_Position          = 362.4;
const Float_t USTC_First_Y_Position    = 58.2;
...
const Float_t THU_Z_Position         = 333.5;
const Float_t THU_First_Y_Position   = 0.0;
const Float_t THU_X_Offset           = -20.;
...
const Float_t THUstrip_Z_Position              = 327.6;
const Float_t THUstrip_First_Y_Position        = 55.5;  //
