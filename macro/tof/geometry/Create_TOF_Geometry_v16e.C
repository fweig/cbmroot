...
const Double_t TOF_Z_Corr = ("tof_v16e_1h" == geoVersion ? 546.485 :           // SIS 100 hadron
...
const Double_t TOF_Z_Front = ("tof_v16e_1h" == geoVersion ? (450 - TOF_Z_Corr) :               // SIS 100 hadron
