...
const Float_t Glass_Z[NumberOfDifferentCounterTypes] = {0.1, 0.1, 0.1, 0.1, 0.01, 0.1, 0.07, 0.07, 0.07, 0.1};
...
const Float_t GasGap_Z[NumberOfDifferentCounterTypes] = {0.022, 0.022, 0.022, 0.014, 0.02,
...
const Float_t Electronics_Y[NumberOfDifferentCounterTypes] = {5.0, 5.0, 1.0, 1., 0.5, 0.1, 0.5, 0.5, 0.2, 5.};
...
const Float_t Module_Size_X[NofModuleTypes] = {120., 35., 9., 50., 30., 8., 50., 70., 29., 100.};
const Float_t Module_Size_Y[NofModuleTypes] = {74., 18., 7., 49., 16., 5., 30., 35., 33., 49.};
  ...
  for (Int_t j = 0; j < modNType; j++) {
    ...
    for (Int_t i = 0; i < Star2_Number[j]; i++) {
      ...
      switch (i) {
        ...
        case 1: zPos = Star2_First_Z_Position + 1. * Star2_Delta_Z_Position; break;
        case 2: zPos = Star2_First_Z_Position + 2. * Star2_Delta_Z_Position; break;
      }
