...
const Double_t TOF_Z_Corr =
  ("tof_v16d_1h" == geoVersion ? 546.485 :           // SIS 100 hadron
...
const Double_t TOF_Z_Front =
  ("tof_v16d_1h" == geoVersion ? (450 - TOF_Z_Corr) :        // SIS 100 hadron
     ("tof_v16d_1e" == geoVersion ? (600 - TOF_Z_Corr) :     // SIS 100 electron
        ("tof_v16d_1m" == geoVersion ? (680 - TOF_Z_Corr) :  // SIS 100 muon
           ("tof_v16d_3e" == geoVersion ? (880 - TOF_Z_Corr)
                                        :  // SIS 300 electron
              ("tof_v16d_3m" == geoVersion ? (1020 - TOF_Z_Corr)
                                           :  // SIS 300 muon
                 600                          // Set default to SIS 100 electron
               )))));
