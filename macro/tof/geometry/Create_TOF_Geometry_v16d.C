...
//const TString geoVersion = "tof_v16d_1h";     // SIS 100 hadron, 4.5 m
//const TString geoVersion = "tof_v16d_1e";     // SIS 100 electron, 6 m
//const TString geoVersion = "tof_v16d_1m";     // SIS 100 muon, 6.8 m
const TString geoVersion = "tof_v16d_3e";     // SIS 300 electron, 8.8 m
//const TString geoVersion = "tof_v16d_3m";     // SIS 300 muon, 10 m
const TString FileNameSim  = geoVersion + ".geo.root";
const TString FileNameGeo  = geoVersion + "_geo.root";
const TString FileNameInfo = geoVersion + ".geo.info";

const Double_t TOF_Z_Corr = (      "tof_v16d_1h" == geoVersion  ?  546.485 : // SIS 100 hadron
                              (    "tof_v16d_1e" == geoVersion  ?  696.485 : // SIS 100 electron
                               (   "tof_v16d_1m" == geoVersion  ?  776.485 : // SIS 100 muon
                                (  "tof_v16d_3e" == geoVersion  ?  976.485 : // SIS 300 electron
                                 ( "tof_v16d_3m" == geoVersion  ?  0 : // SIS 300 muon
...
const Double_t TOF_Z_Front = (     "tof_v16d_1h" == geoVersion  ?  (450-TOF_Z_Corr) : // SIS 100 hadron
                              (    "tof_v16d_1e" == geoVersion  ?  (600-TOF_Z_Corr) : // SIS 100 electron
                               (   "tof_v16d_1m" == geoVersion  ?  (680-TOF_Z_Corr) : // SIS 100 muon
                                (  "tof_v16d_3e" == geoVersion  ?  (880-TOF_Z_Corr) : // SIS 300 electron
                                 ( "tof_v16d_3m" == geoVersion  ? (1020-TOF_Z_Corr) : // SIS 300 muon
                                   600 // Set default to SIS 100 electron
                                 )
                                )
                               )
...
//*************************************************************
const Double_t xPosCounter1[32] = {43.5,14.5,-14.5,-43.5,43.5,14.5,-14.5,-43.5,43.5,14.5,-14.5,-43.5,43.5,14.5,-14.5,-43.5,
				  43.5,14.5,-14.5,-43.5,43.5,14.5,-14.5,-43.5,43.5,14.5,-14.5,-43.5,43.5,14.5,-14.5,-43.5};
const Double_t yPosCounter1[32] = {-54.6,-54.6,-54.6,-54.6,-36.4,-36.4,-36.4,-36.4,-18.2,-18.2,-18.2,-18.2,0.,0.,0.,0.,18.2,18.2,18.2,18.2,
				  36.4,36.4,36.4,36.4,50.5,50.5,50.5,50.5,59.6,59.6,59.6,59.6};
const Double_t zPosCounter1[32] = {-3.01,-7.55,-3.01,-7.55,6.07,1.53,6.07,1.53,-3.01,-7.55,-3.01,-7.55,6.07,1.53,6.07,1.53,
...
const Double_t xPosCounter2[27] = {87.,58.,29.,0.,-29.,87.,58.,29.,0.,-29.,87.,58.,29.,0.,-29.,
-58.,-87.,-58.,-87.,-58.,-87.,-58.,-87.,-58.,-87.,-58.,-87.};
const Double_t yPosCounter2[27] = {-19.,-19.,-19.,-19.,-19.,0.,0.,0.,0.,0.,19.,19.,19.,19.,19.,
-24.,-24.,-14.4,-14.4,-4.8,-4.8,4.8,4.8,14.4,14.4,24.,24.};
const Double_t zPosCounter2[27] = {-7.55,-3.01,-7.55,-3.01,-7.55,1.53,6.07,1.53,6.07,1.53,-7.55,-3.01,-7.55,-3.01,-7.55,
-3.01,-7.55,6.07,1.53,-3.01,-7.55,6.07,1.53,-3.01,-7.55,6.07,1.53};

const Double_t xPosCounter3[42] = {72.5,43.5,14.5,-14.5,-43.5,-72.5,72.5,43.5,14.5,-14.5,-43.5,-72.5,72.5,43.5,14.5,-14.5,-43.5,-72.5,
72.5,43.5,14.5,-14.5,-43.5,-72.5,72.5,43.5,14.5,-14.5,-43.5,-72.5,72.5,43.5,14.5,-14.5,-43.5,-72.5,72.5,43.5,14.5,-14.5,-43.5,-72.5};
const Double_t yPosCounter3[42] = {-54.6,-54.6,-54.6,-54.6,-54.6,-54.6,-34.6,-34.6,-34.6,-34.6,-34.6,-34.6,-18.2,-18.2,-18.2,-18.2,-18.2,-18.2,
0.,0.,0.,0.,0.,0.,18.2,18.2,18.2,18.2,18.2,18.2,34.6,34.6,34.6,34.6,34.6,34.6,54.6,54.6,54.6,54.6,54.6,54.6};
const Double_t zPosCounter3[42] = {-7.55,-3.01,-7.55,-3.01,-7.55,-3.01,1.53,6.07,1.53,6.07,1.53,6.07,-7.55,-3.01,-7.55,-3.01,-7.55,-3.01,
...
const Double_t CounterXstart1[NMTm] = {-43.5,87.,72.5};  // position of left most counter in x - direction (for un-rotated modules)
const Double_t CounterYstart1[NMTm] = {-54.6,-19.,-54.6};  // position of lowest counter in y direction (for un-rotated modules)
...
//m,s,b,m1,m2,m3
const Double_t Module_Size_X[NofModuleTypes] = {180.2,180.2,180.2,127.0,214.0,185.0};
const Double_t Module_Size_Y[NofModuleTypes] = {49.,49.,74.,141.7,70.5,141.7};
const Double_t Module_Over_Y[NofModuleTypes] = {11.5,11.5,11.,4.5,4.5,5.1};
const Double_t Module_Size_Z[NofModuleTypes] = {10.,10.,10.,23.9,23.9,23.9};
...
const Double_t CounterXStartPosition[NofModuleTypes] = {-60.0, -67.02, -67.02,-60.0,-60.0,-16.0};
const Double_t CounterXDistance[NofModuleTypes]      = {30.0,   30.351, 30.351, 30.0, 30.0, 30.0};
const Double_t CounterZDistance[NofModuleTypes]      = {2.5,     0.0,   0.0,  2.5,  2.5,  2.5};
const Double_t CounterRotationAngle[NofModuleTypes]  = {0.,      8.7,   8.7,  0.,   0.,   0.};
...
//  gSystem->Load("libBase");
   ...
   std::cout << "Generating geometry "<< geoVersion
             ...
             << std::endl
             << "Inner wall need to be shifted by "
             << InnerWall_Z_PositionShift << std::endl
             << "Outer wall need to be shifted by "
             << Wall_Z_PositionShift << std::endl
             ;
...
void position_outer_tof_modules(Int_t nCol) //modType, Int_t col1, Int_t col2)
{
  ...
  for(Int_t j=0; j<nCol; j++){
   ...
   cout << Form( "Placed Outer module bar %03d at X= %7.2f and Z = %7.2f ", NumberOfBars, Bar_XPos[NumberOfBars], Bar_ZPos[NumberOfBars])
        << endl;
   }
