void ana_hits(Int_t nEvents        = 10,
  ...
  cout << "dispatch iSel = " << iSel << ", iSel2 = " << iSel2 << ", " << iSel2Sm
       << ", " << iSel2Rpc << endl;
  ...
  switch (iSel) {
    ...
    case 921920:
      ...
      switch (iRSel) {
        case 5:
          tofAnaTestbeam->SetMulDMax(1);  // Max Multiplicity in Diamond
          tofAnaTestbeam->SetChi2Lim(
            5.);  // initialization of Chi2 selection limit
          ...
          switch (iSel2) {
            ...
            case 4:
              ...
              tofAnaTestbeam->SetSel2TOff(
                -50.);  // Shift Sel2 time peak to 0	   break
              break;
            ...
            case 9:
              tofAnaTestbeam->SetChi2Lim2(
                4.);  // initialization of Chi2 selection limit
              tofAnaTestbeam->SetSel2TOff(
                140.);  // Shift Sel2 time peak to 0	   break  //921
              break;
          ...
          switch (iSel2) {
            ...
            case 9:
              ...
              switch (iSel2Sm) {
                case 2:
                  tofAnaTestbeam->SetSel2TOff(
                    -170.);  // Shift Sel2 time peak to 0   //920
                  break;
                default:
          ...
          switch (iSel2) {
            ...
            case 9:
              ...
              switch (iSel2Sm) {
                case 0:
                  tofAnaTestbeam->SetSel2TOff(
                    20.);  // Shift Sel2 time peak to 0   //900
                  break;
                default:
                  cout << "Counter " << iSel2 << ", " << iSel2Sm << ", "
                       << iSel2Rpc << " not configured yet as iSel2" << endl;
    ...
    case 901900:
      ...
      tofAnaTestbeam->SetDCh4Sel(
        15. * dScalFac);  // Width  of channel selection window
      cout << "Run with iRSel = " << iRSel << ", iRSelin = " << iRSelin
      ...
      switch (iRSel) {
          ...
          switch (iSel2) {
            ...
            case 9:
              ...
              switch (iSel2Sm) {
                case 0:
                  tofAnaTestbeam->SetSel2TOff(
                    20.);  // Shift Sel2 time peak to 0   //901
                  break;
                case 1:
                  tofAnaTestbeam->SetSel2TOff(
                    380.);  // Shift Sel2 time peak to 0
                  break;
        ...
        case 6:
          tofAnaTestbeam->SetChS2Sel(
            15.);  // Center of channel selection window
          ...
          switch (iRSelin) {
            case 921:
              ...
              switch (iSel2in) {
                case 901:
                  tofAnaTestbeam->SetSel2TOff(
                    350.);  // Shift Sel2 time peak to 0
                  break;

                case 910:
                  tofAnaTestbeam->SetSel2TOff(
                    1458.);  // Shift Sel2 time peak to 0
                  break;
      ...
      tofAnaTestbeam->SetChi2Lim(
        3. * dChi2Lim2);  // initialization of Chi2 selection limit
      tofAnaTestbeam->SetChi2Lim2(
              ...
              switch (iSel2Sm) {
                case 2:
                  switch (iSel2Rpc) {
                    case 0:
                      tofAnaTestbeam->SetSel2TOff(
                        30.);  // Shift Sel2 time peak to 0
                      break;
                    case 1:
                      tofAnaTestbeam->SetSel2TOff(
                        124.);  // Shift Sel2 time peak to 0
                      break;
                    default:
                      cout << "Counter " << iSel2 << ", " << iSel2Sm << ", "
                ...
                case 0:
                  switch (iSel2Rpc) {
                    case 0:
                      tofAnaTestbeam->SetSel2TOff(
                        -40.);  // Shift Sel2 time peak to 0
                      break;
                    case 1:
                      tofAnaTestbeam->SetSel2TOff(
                        -45.);  // Shift Sel2 time peak to 0
                      break;
                    default:
                      cout << "Counter " << iSel2 << ", " << iSel2Sm << ", "
                           << iSel2Rpc << " not configured yet as iSel2"
    ...
    case 601100:
      ...
      switch (iRSel) {
          ...
          switch (iSel2) {
            ...
            case 6:
              ...
              switch (iSel2Rpc) {
                case 0:
                  tofAnaTestbeam->SetSel2TOff(
                    2000.);  // Shift Sel2 time peak to 0 // 600
                  break;
                case 1:
                  tofAnaTestbeam->SetSel2TOff(
        ...
        case 6:
          ...
          tofAnaTestbeam->SetTOffD4(17000.);  // Shift DTD4 to physical value
          tofAnaTestbeam->SetSel2TOff(
            -2900.);  // Shift Sel2 time peak to 0 for 601
          break;
        default: cout << "Define setup! " << endl; return;
      }
