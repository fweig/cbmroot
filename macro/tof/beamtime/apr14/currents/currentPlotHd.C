...
Bool_t currentPlotHd(Int_t iDetectorIndex = -1,
                     Int_t iDate          = 0,
                     Int_t iTime          = -1,
                     Int_t iSecOffset     = 0) {
  ...
  if (kFALSE == bDetType) {
    ...
    hTimeBinCor =
      new TH1D("hTimeBinCor",
               "Time bin correlation; CAEN readout time intervals; Time [s]",
               iNumHours * 3600,
               0,
               iNumHours * 3600);
