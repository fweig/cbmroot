...
Bool_t ratePlot() {
  ...
  TProfile* hRateEvoScalMbs0 = new TProfile(
    "hRateEvoScalMbs0",
  ...
  TProfile* hRateEvoScalMbs7 = new TProfile(
    ...
    0,
    iTimeIntervalsec);
  TProfile* hRateEvoScalMbs8 = new TProfile(
    "hRateEvoScalMbs8",
    "Triglog input scaler 9 (Buc. RPC2012); MBS Time [s]; Rate [kHz/cm2]",
    10 * iTimeIntervalsec,
    0,
    iTimeIntervalsec);
  TProfile* hRateEvoScalMbs9 = new TProfile(
    "hRateEvoScalMbs9",
  ...
  TProfile* hRateEvoScalMbs10 = new TProfile(
    ...
    0,
    iTimeIntervalsec);
  TProfile* hRateEvoScalMbs11 = new TProfile(
    "hRateEvoScalMbs11",
    "Triglog input scaler 12 (PAD RPC); MBS Time [s]; Rate [kHz/cm2]",
    10 * iTimeIntervalsec,
    0,
    iTimeIntervalsec);
  TProfile* hRateEvoScalMbs12 =
    new TProfile("hRateEvoScalMbs12",
                 "Triglog input scaler 13 (USTC + Ts. Strip RPC); MBS Time "
                 "[s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec,
                 0,
                 iTimeIntervalsec);
  TProfile* hRateEvoScalMbs13 = new TProfile(
    "hRateEvoScalMbs13",
    "Triglog input scaler 14 (empty); MBS Time [s]; Rate [kHz/cm2]",
    10 * iTimeIntervalsec,
    0,
    iTimeIntervalsec);
  TProfile* hRateEvoScalMbs14 = new TProfile(
    "hRateEvoScalMbs14",
    "Triglog input scaler 15 (empty); MBS Time [s]; Rate [kHz/cm2]",
    10 * iTimeIntervalsec,
    0,
    iTimeIntervalsec);
  TProfile* hRateEvoScalMbs15 = new TProfile(
    "hRateEvoScalMbs15",
  ...
  for (uMbsEvtIndex = iFirstGoodMbsEvent; uMbsEvtIndex < uNTreeEntriesScal;
    ...
    dRateKhzCm0 =
      fCalTrloBoard->GetScalerValue(0) / 1000.0 / 16;  // front HD PMT (2cmx8cm)
    dRateKhzCm1 =
      fCalTrloBoard->GetScalerValue(1) / 1000.0 / 44;  // back HD PMT (4cmx11cm)
    dRateKhzCm2 = fCalTrloBoard->GetScalerValue(2) / 1000.0
                  / 15;  // front Buc PMT (1.5cmx10cm)
    dRateKhzCm3 = fCalTrloBoard->GetScalerValue(3) / 1000.0
                  / 15;  // back Buc PMT (1.5cmx10cm)
    dRateKhzCm4 = fCalTrloBoard->GetScalerValue(4) / 1000.0
                  / 1;  // TRD Buc PMT area unknown ??????
    dRateKhzCm5 = fCalTrloBoard->GetScalerValue(5) / 1000.0 / 1;  // Diamant
    dRateKhzCm6 = fCalTrloBoard->GetScalerValue(6) / 1000.0
                  / 731.5;  // Ref Buc RPC (72*0.254cm x 4cm)
    dRateKhzCm7 = fCalTrloBoard->GetScalerValue(7) / 1000.0
                  / 59.5;  // Ref HD RPC (16*0.93 x 4cm)
    dRateKhzCm8 =
      fCalTrloBoard->GetScalerValue(8) / 1000.0 / 1;  //Buc RPC2012 (??????)
    dRateKhzCm9 =
      fCalTrloBoard->GetScalerValue(9) / 1000.0 / 1;  //Buc RPC2013 (??????)
    dRateKhzCm10 =
      fCalTrloBoard->GetScalerValue(10) / 1000.0 / 2756;  //Big HD (53cm x 52cm)
    dRateKhzCm11 =
      fCalTrloBoard->GetScalerValue(11) / 1000.0 / 1;  // Pad RPC (??????)
    dRateKhzCm12 =
      fCalTrloBoard->GetScalerValue(12) / 1000.0 / 1;  // Strip  (??????)
    ...
    //      if( 5e-5 < fCalTrloBoard->GetTimeToLast() ) // avoid too low reference clock counts
    {
      ...
      hRateEvoScalMbs0->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm0,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs1->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm1,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs2->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm2,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs3->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm3,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs4->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm4,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs5->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm5,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs6->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm6,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs7->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm7,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs8->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm8,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs9->Fill(dCurrMbsTime - dFirstMbsTime,
                             dRateKhzCm9,
                             fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs10->Fill(dCurrMbsTime - dFirstMbsTime,
                              dRateKhzCm10,
                              fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs11->Fill(dCurrMbsTime - dFirstMbsTime,
                              dRateKhzCm11,
                              fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs12->Fill(dCurrMbsTime - dFirstMbsTime,
                              dRateKhzCm12,
                              fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs13->Fill(dCurrMbsTime - dFirstMbsTime,
                              dRateKhzCm13,
                              fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs14->Fill(dCurrMbsTime - dFirstMbsTime,
                              dRateKhzCm14,
                              fCalTrloBoard->GetTimeToLast());
      hRateEvoScalMbs15->Fill(dCurrMbsTime - dFirstMbsTime,
                              dRateKhzCm15,
                              fCalTrloBoard->GetTimeToLast());
    }
