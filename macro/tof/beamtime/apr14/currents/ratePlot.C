...
Bool_t ratePlot()
{
  ...
  TProfile* hRateEvoScalMbs0 =
    new TProfile("hRateEvoScalMbs0", "Triglog input scaler 1 (Front HD PMT); MBS Time [s]; Rate [kHz/cm2]",
  ...
  TProfile* hRateEvoScalMbs1 =
    new TProfile("hRateEvoScalMbs1", "Triglog input scaler 2 (Back HD PMT); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs2 =
    new TProfile("hRateEvoScalMbs2", "Triglog input scaler 3 (Front Buc. PMT); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs3 =
    new TProfile("hRateEvoScalMbs3", "Triglog input scaler 4 (Back Buc. PMT); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs4 =
    new TProfile("hRateEvoScalMbs4", "Triglog input scaler 5 (TRD Buc. PMT); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs5 =
    new TProfile("hRateEvoScalMbs5", "Triglog input scaler 6 (Diamond); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs6 =
    new TProfile("hRateEvoScalMbs6", "Triglog input scaler 7 (Buc. Ref. RPC); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs7 =
    new TProfile("hRateEvoScalMbs7", "Triglog input scaler 8 (HD. Ref. RPC); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs8 =
    new TProfile("hRateEvoScalMbs8", "Triglog input scaler 9 (Buc. RPC2012); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs9 =
    new TProfile("hRateEvoScalMbs9", "Triglog input scaler 10 (Buc. RPC2013); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs10 =
    new TProfile("hRateEvoScalMbs10", "Triglog input scaler 11 (HD Big RPC); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs11 =
    new TProfile("hRateEvoScalMbs11", "Triglog input scaler 12 (PAD RPC); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs12 = new TProfile("hRateEvoScalMbs12",
                                             "Triglog input scaler 13 (USTC + Ts. Strip RPC); MBS Time "
                                             "[s]; Rate [kHz/cm2]",
                                             10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs13 =
    new TProfile("hRateEvoScalMbs13", "Triglog input scaler 14 (empty); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs14 =
    new TProfile("hRateEvoScalMbs14", "Triglog input scaler 15 (empty); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
  TProfile* hRateEvoScalMbs15 =
    new TProfile("hRateEvoScalMbs15", "Triglog input scaler 16 (scaler); MBS Time [s]; Rate [kHz/cm2]",
                 10 * iTimeIntervalsec, 0, iTimeIntervalsec);
