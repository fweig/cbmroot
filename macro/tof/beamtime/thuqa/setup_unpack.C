...
void setup_unpack(Int_t nEvents = 10, Int_t start_run = 0, Int_t end_run = 11, Int_t calMode = 1,
                  char* cFileId = "Trb23Feb0930", Int_t iSet = 0)
{
  ...
  TString paramDir = workDir + "/macro/tof/beamtime/thuqa";
  ...
  switch (iSet) {
    case 0:
      ...
      mapParFile = paramDir + "/parMapCosmicsThuMay2015.txt";  //change PW
      break;
