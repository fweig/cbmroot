...
void create_bpipe_geometry_v14hp1() {
  ...
  Double_t z04[nSects04]  = {
    3700., 6000., 8738.93, 8739.13, 8743.03, 8755.49, 8776.88, 8799.8};  // mm
  Double_t rin04[nSects04]  = {0., 0., 0., 3.42, 70., 140., 210., 263.3};
  Double_t rout04[nSects04] = {
    166.27, 263.3, 263.3, 263.3, 263.3, 263.3, 263.3, 263.3};
  TString pipe6name =
    "pipe6 - second window @ 6000mm, h=0.2mm, R=600mm";  // iron !!!
  const Int_t nSects6  = 7;
  Double_t z6[nSects6] = {
    8738.93, 8739.13, 8743.03, 8755.49, 8776.88, 8799.8, 8800.};  // mm
  ...
  infoFile << " PCON shape (including windows). There are two windows: first "
              "one @ 220mm"
           << endl;
  infoFile << " with R600mm and 0.7mm thickness, second one of iron @ 8800mm "
              "with R600mm"
           << endl;
