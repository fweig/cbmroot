...
TString macrosname = "create_bpipe_geometry_v14j.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe_v14j.root";
// ---> Geometry name
TString pipeName = "PIPE_v14j";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v14j() {
  ...
  Double_t z01[nSects01]  = {
    -50., 25., 35., 220., 220., 220.5, 221.25, 223.51, 227.29, 230.17};  // mm
  Double_t rin01[nSects01] = {
    0., 0., 0., 0., 11., 23.66, 36.66, 63.97, 92.96, 110.};
