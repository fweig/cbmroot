...
TString macrosname = "create_bpipe_geometry_v14k.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe_v14k.root";
// ---> Geometry name
TString pipeName = "pipe_v14k";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v14k() {
  ...
  Double_t rout04[nSects04] = {
    156.2, 250.84, 250.85, 251.01, 251.54, 252.44, 253.23};
  ...
  infoFile << "SIS-100. Beam pipe geometry created with " + macrosname << endl
           << endl;
  infoFile << "	  pipe_v14k = pipe_v14e + fixed sizes of vacuum chamber for "
              "mvd_v14a"
           << endl
           << endl;
