...
void create_bpipe_geometry_v16a_1m(Bool_t bMuch = kTRUE, Bool_t bTrd = kTRUE, Bool_t bTof = kTRUE, Bool_t bEnd = kTRUE,
                                   Bool_t bWin = kTRUE)
{
...
*/
  ...
  Double_t dRoutTrd[nSectsTrd] = {193.9, 230.0, 288.0};  // mm, 3.0 deg inner opening in, detector fit out
  ...
  Double_t dRoutEnd[nSectsEnd] = {dRoutTof[nSectsTof - 1],
