...
TString macrosname = "create_bpipe_geometry_v16b_1m.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe_v16b_1m.geo.root";
// ---> Geometry name
TString pipeName = "pipe_v16b_1m";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v16b_1m() {
