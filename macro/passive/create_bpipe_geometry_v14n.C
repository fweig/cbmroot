 ...
 **
 ** SIS-300
 ** pipe_v14n = pipe_v14h + fixed sizes of vacuum chamber for mvd_v14a
 **
...
TString macrosname = "create_bpipe_geometry_v14n.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe_v14n.root";
// ---> Geometry name
TString pipeName = "pipe_v14n";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v14n() {
  ...
  infoFile << "SIS-300. Beam pipe geometry created with " + macrosname << endl
           << endl;
  infoFile << "	  pipe_v14n = pipe_v14h + fixed sizes of vacuum chamber for "
              "mvd_v14a"
           << endl
           << endl;
