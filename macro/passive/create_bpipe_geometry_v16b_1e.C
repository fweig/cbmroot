...
TString macrosname = "create_bpipe_geometry_v16b_1e.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe_v16b_1e.geo.root";
// ---> Geometry name
TString pipeName = "pipe_v16b_1e";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v16b_1e() {
