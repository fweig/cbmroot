...
void create_bpipe_geometry_v14r()
{
  ...
  Double_t z04[nSects04]   = {3700., 7923.24, 7923.44, 7927.34, 7939.8, 7961.19, 7979.8};  // mm
  ...
  Double_t rout04[nSects04] = {156.2, 190.84, 190.85, 191.01, 191.54, 192.44, 193.23};

  TString pipe6name       = "pipe6 - second window @ 6000mm, h=0.2mm, R=600mm";  // iron !!!
  const Int_t nSects6     = 7;
  Double_t z6[nSects6]    = {7923.24, 7923.44, 7927.34, 7939.8, 7961.19, 7979.8, 7980.};  // mm
