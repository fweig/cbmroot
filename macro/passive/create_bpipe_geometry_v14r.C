 ...
 **
 ** SIS-100
 ** extend pipe v14l to downstream of TOF, stop at z=798 cm, 2 cm in front of PSD
 **
...
TString macrosname = "create_bpipe_geometry_v14r.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe_v14r.root";
// ---> Geometry name
...
void create_bpipe_geometry_v14r() {
  ...
  Double_t z5[nSects5]    = {3700., 7979.8, 7980.};  // mm
  Double_t rout5[nSects5] = {161.6, 201.96, 202.};
  Double_t rin5[nSects5]  = {156.2, 193.23, 193.27};
  ...
  Double_t z04[nSects04] = {
    3700., 7923.24, 7923.44, 7927.34, 7939.8, 7961.19, 7979.8};  // mm
  Double_t rin04[nSects04] = {0., 0., 3.42, 40., 100., 150., 193.23};
  //Double_t rout04[nSects04] = {  156.2,   250.87,  250.88,  251.05,  251.57,  252.48,  253.23 };
  Double_t rout04[nSects04] = {
    156.2, 190.84, 190.85, 191.01, 191.54, 192.44, 193.23};

  TString pipe6name =
    "pipe6 - second window @ 6000mm, h=0.2mm, R=600mm";  // iron !!!
  const Int_t nSects6  = 7;
  Double_t z6[nSects6] = {
    7923.24, 7923.44, 7927.34, 7939.8, 7961.19, 7979.8, 7980.};  // mm
  ...
  infoFile << "SIS-100. Beam pipe geometry created with " + macrosname << endl
           << endl;
  infoFile << "	  pipe_v14r = pipe_v14f + fixed sizes of vacuum chamber for "
              "mvd_v14a"
           << endl
           << endl;
