 ...
 ** @date 04.06.2014
 **
 ** pipe v16d_1e is based on v16b_1e and adapted to the streched 105 mm pitch STS v19i
...
TString macrosname = "create_bpipe_geometry_v16d_1e.C";
// ---> Geometry file name (output)
TString rootFileName    = "pipe_v16d_1e.geo.root";
TString rootFileNameExp = "pipe_v16d_1e-geo.root";
// ---> Geometry name
TString pipeName = "pipe_v16d_1e";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v16d_1e() {
