...
int checkFieldMap()
{
  ...
  const char* mapFile;
  if (type >= 1 && type <= 3) mapFile = field->GetFileName();
  // ----------------------------------------------------------------------
  ...
  TH2F hB2("hB2", "B at RICH entrance", fmx, fxmin, fxmax, fmy, fymin, fymax);
  TH2F hB3("hB3", "B at RICH PM", fmx, fxmin, fxmax, fmy, fymin, fymax);
  // ----------------------------------------------------------------------
