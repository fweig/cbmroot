#include <fstream>
#include <iostream>
void CreateGDMLfile_April2015_ModOct2015(float pmt_pos_y_addend   = 0,
                                         float pmt_pos_z_addend   = 0,
                                         int RotMir               = -10,
                                         float PMTrotX            = 5,
                                         float PMTrotY            = 5,
                                         float EnlargedPMTWidth   = 40.,
                                         float EnlargedPMTHight   = 20.,
                                         int DefaultDims          = 0,
  ...
  sprintf(GeoFileName,
          "/geometry/rich/GeoOpt/rich_geo_%s_RotPMT_%s_%s_TransPMT_%s_%s_%s%s",
          RotMirText,
          ShiftXTxt,
          ShiftYTxt,
          YTransText,
