...
*/
  ...
  TString magnetGeom =
    "/data/cbm/cbmroot_new/geometry/magnet/magnet_v15a.geo.root";
  ...
  if (Flag == 0) {
    TString richGeom = "/lustre/nyx/cbm/users/jbendar/CBMINSTALL/share/cbmroot/"
                       "geometry/rich/Rich_jan2016_aligned.root";
  } else if (Flag == 1) {
    TString richGeom = "/data/cbm/cbmroot_new/geometry/rich/"
                       "Rich_jan2016_misalign_5mrad_Tiles_1_5_0_1.root";
  }
  //	else if (Flag == 1) { TString richGeom = "/lustre/nyx/cbm/users/jbendar/CBMINSTALL/share/cbmroot/geometry/rich/Rich_jan2016_misalign_5mradXY_Tile0_1.root"; }
    ...
    TString richGeom = "/lustre/nyx/cbm/users/jbendar/CBMINSTALL/share/cbmroot/"
                       "geometry/rich/Rich_jan2016_corrected.root";
  }
  ...
  TString macroName = "/lustre/nyx/cbm/users/jbendar/CBMINSTALL/share/cbmroot/"
                      "macro/run/modules/registerSetup.C";
