...
void run_sim_position2(Int_t nEvents = 100, Int_t Flag = 0)
{
  ...
  TString parDir = "/u/jbendar/CBMSRC/parameters";
...
*/
  ...
  TString magnetGeom = "/lustre/nyx/cbm/users/jbendar/CBMINSTALL/share/cbmroot/"
                       "geometry/magnet/magnet_v15a.geo.root";
  TString fieldMap = "field_v12b";
  //	TString stsGeom = "sts/sts_v15c.geo.root";
  TString stsGeom = "/lustre/nyx/cbm/users/jbendar/CBMINSTALL/share/cbmroot/"
                    "geometry/sts/sts_v17a.geo.root";
