void run_sim_position(Int_t nEvents = 200000,
                      TString numb  = "00001",
                      Int_t Flag    = 0) {
...
*/
  ...
  if (Flag == 0) {
    TString richGeom = "rich/Rich_jan2016_aligned.root";
  } else if (Flag == 1) {
    TString richGeom = "rich/Rich_jan2016_misalign_5mradXY_Tile1_3.root";
  }
