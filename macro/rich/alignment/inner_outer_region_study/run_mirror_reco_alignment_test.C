void run_mirror_reco_alignment_test(Int_t nEvents = 5000,
                                    TString tile  = "",
                                    TString axis  = "",
                                    TString numb  = "") {
  ...
  //	TString outDir = "/data/misalignment_correction/Sim_Outputs/Mirror_Sorting/28th_CBM_Week/1mradXY/";
  ...
  TString recoFile =
    outDir + "reco." + numb + "_" + axis + "_" + tile + "_alignment" + ".root";
