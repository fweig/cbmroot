void run_mirror_sim_test(Int_t nEvents = 5000,
                         TString tile  = "",
                         TString axis  = "",
                         TString numb  = "")
// !!! DEFINE NEW ROTATION ANGLE IN THE GEO FILE AND RUN IMPORT_EXPORT_GEO MACRO BEFORE RUNNING RUN_SIM !!!
{
  ...
  TString outDir = "/data/misalignment_correction/Sim_Outputs/Mirror_Sorting/"
                   "Study_Track_Ring/Tile_"
                   + tile + "/" + axis + "_" + numb + "mrad" + "/";
  //    TString outDir = "/home/aghoehne/Desktop/";
  //	TString numb = "0.1mrad_";
  //	TString axis = "Y_";
  //	TString tile = "TILE";
  //	TString tile = "1_4";
  //	TString tile = "2_1";
...
*/
  ...
  //	TString richPath = "/data/misalignment_correction/Sim_Outputs/RICH_Geometries/Tile_" + tile + "/Rich_jan2016_misalign_" + numb + "mrad_" + axis + ".root";
  TString richPath = "/data/cbm/cbmroot_new/geometry/rich/geoGen/GeoFiles1/"
                     "Rich_jan2016_misalign_tile_"
                     + tile + "_axis_" + axis + "_mis_" + numb + "mrad.root";
  TString richGeom = richPath;
  ...
  if (electrons == "yes") {
    if (tile == "1_4") {
      cout << endl << "Box tile 1_4" << endl << endl;
    ...
    elseif(tile == "2_8") {
      cout << endl << "Box tile 2_8" << endl << endl;
