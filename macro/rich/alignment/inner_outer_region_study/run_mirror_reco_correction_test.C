void run_mirror_reco_correction_test(Int_t nEvents = 5000,
                                     TString tile  = "",
                                     TString axis  = "",
                                     TString numb  = "") {
  ...
  //	TString outDir = "/data/misalignment_correction/Sim_Outputs/Mirror_Sorting/28th_CBM_Week/1mradY/";
  TString outDir = "/data/misalignment_correction/Sim_Outputs/Mirror_Sorting/"
                   "Study_Track_Ring/Tile_"
                   + tile + "/" + axis + "_" + numb + "mrad" + "/";
  //	TString outDir = "/data/misalignment_correction/Sim_Outputs/Mirror_Sorting/Test/";
  //	TString runTitle = "Mirror_Sorting";
  //	TString outDir = "/home/aghoehne/Desktop/";
  TString runTitle = "Track_Ring";
  //	TString numb = "1_";
  //	TString axis = "Y_";
  //	TString tile = "1_4";
  //	numb = "", axis = "", tile = "test";
  ...
  TString recoFile =
    outDir + "reco." + numb + "_" + axis + "_" + tile + "_correction" + ".root";
...
*/
  ...
  TString studyName = numb + "_" + axis + "_" + tile;
  TString studyName = runTitle + "_" + numb + "_" + axis + "_" + tile;
