...
// !!! DEFINE NEW ROTATION ANGLE IN THE GEO FILE AND RUN IMPORT_EXPORT_GEO MACRO BEFORE RUNNING RUN_SIM !!!
{
  ...
  TString outDir =
    "/data/misalignment_correction/Sim_Outputs/Mirror_Sorting/First/";
  TString numb = "3mrad_";
  TString axis = "X_";
  //	TString tile = "TILE";
  //	TString tile = "1_4";
  ...
  TString outDir =
    "/data/misalignment_correction/event_display/test/";  // For eventDisplay and run_rich_event_display macros
  TString numb    = ".00001";
