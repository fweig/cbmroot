void run_sim(
        const string& urqmdFile = "/Users/slebedev/Development/cbm/data/urqmd/auau/8gev/centr/urqmd.auau.8gev.centr.00001.root", // if "", no urqmd
        ...
        const string& geoFile = "/Users/slebedev/Development/cbm/data/sim/rich/reco/geosim.00000.root",
        int nofElectrons = 5, // number of e- to be generated, if <=0 no electrons are embedded into event
        int nofPositrons = 5, // number of e- to be generated, if <=0 no positrons are embedded into event
