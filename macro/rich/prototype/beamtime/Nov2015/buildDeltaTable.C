                     ...
                     TString picturesFolder = "pictures")
{
  ...
  TH1F* hAlpha[MATRIXSIZE][MATRIXSIZE];
  Bool_t alphaOriginalFilled[MATRIXSIZE][MATRIXSIZE];
  TString histoName;
  ...
  do {
    ...
    alphaOriginal[refId][mesId]       = hmax;  // hmax or hmean
