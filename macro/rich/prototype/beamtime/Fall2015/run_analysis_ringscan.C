...
void run_analysis_ringscan(Bool_t generateCalib = kTRUE, TString inputFile, TString outputFile, TString calibFile,
                           TString histoFile, TString histo2File, TString fileBasename, Int_t inNevents = -1)
{
  ...
  fgCalibrator->SetCorrInputFilename("/store/cbm_rich_data_2014/Corrections_WLS_off_noBadChannels.txt");
  ...
  CbmRichTrbEventBuilder* unpack_qa =
    new CbmRichTrbEventBuilder();  // either CbmRichTrbEventBuilder or CbmRichProtoAnalysis
  //   CbmRichProtoAnalysis* unpack_qa = new CbmRichProtoAnalysis(); // either CbmRichTrbEventBuilder or CbmRichProtoAnalysis
