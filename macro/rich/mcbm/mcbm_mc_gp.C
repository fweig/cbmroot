...
void mcbm_mc_gp(Int_t nEvents = 100,
                ...
                const char* setupName = "sis18_mcbm_20deg_long", const char* inputFile = "")
{
  ...
  TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00000.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00001.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00002.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00003.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00004.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00005.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00006.root";
  //  TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00007.root";
  //  TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00008.root";
  // TString defaultInputFile = "/input/urqmd.auau.1.24gev.centr.00009.root";
  ...
  TString outFile = outDir + setupName + "_test10.mc.root";
  TString parFile = outDir + setupName + "_params10.root";
  TString geoFile = outDir + setupName + "_geofile_full.root";
  //  TString geoFile = outDir + setupName + "_rich_v18d_mcbm.geo.root";
