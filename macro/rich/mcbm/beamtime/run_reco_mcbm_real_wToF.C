void run_reco_mcbm_real_wToF(
  ...
  const string& parFile =
    "/lustre/nyx/cbm/users/adrian/data/159_corr/10kTS/unp_mcbm_params_159.root",
  ...
  const string& digiFile =
    "/lustre/nyx/cbm/users/adrian/data/159_corr/all/unp_mcbm_159.root",
