void draw_histo(TString input="sis100_muon_lmvm/8gev/centr_010_sup_histo.root")
{
  ...
  else if(input.Contains("eff"))type=1;
  else if(input.Contains("YPt"))type=2;
 ...
 TH1D *h1 = ( TH1D *)f->Get("BgSup_Vtx");             h1->SetLineWidth(6);
 TH1D *h2 = ( TH1D *)f->Get("BgSup_VtxSts");          h2->SetLineWidth(6);   
 TH1D *h3 = ( TH1D *)f->Get("BgSup_VtxStsMuch");      h3->SetLineWidth(6);    
 TH1D *h4 = ( TH1D *)f->Get("BgSup_VtxStsMuchTrd");   h4->SetLineWidth(6); 
 TH1D *h5 = ( TH1D *)f->Get("BgSup_VtxStsMuchTrdTof");h5->SetLineWidth(6);
