...
//#########################################################################################################################################
// The first absorber is 30 cm low density carbon (density 1.7 g/cm^3) + 30 cm concrete.
// The shield inside the first absorber is composed of 30 cm of Al + 30 cm of lead. Rest are made of Iron.                                         
...
const TString C= "MUCHcarbon"; //High Density Carbon for shielding
...
Double_t fAbsorberZ1[6]={0, 16, 30, 90, 140, 190}; 
// Absorber thickness [cm]
Double_t fAbsorberLz[6]= {16, 14, 30, 20, 20, 30}; 
...
Double_t fShieldZin[5]={125,155.0, 215.0, 265.0, 315.0};
Double_t fShieldLz[5]={30, 30, 20, 20, 30};
...
fstream infoFile;
void create_MUCH_geometry_v19c_lmvm() {
 ...
 // -------   Open info file   -----------------------------------------------
  ...
  infoFile << "MUCH geometry created with create_MUCH_geometry_v19c_lmvm.C" << endl << endl;
