...
void create_field(TString fileName = "CwPolus6_Cs_2", const char* fileType = "A", TString symmetry = "sym3",
                  TString outputFile = "field_v12b.root", TString mapName = "field_v12b")
{
  ...
  if (symmetry == "sym2") { CbmFieldMapSym2* fieldMap = new CbmFieldMapSym2(fileName, fileType); }
