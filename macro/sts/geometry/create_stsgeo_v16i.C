 ...
 **
 ** @file create_stsgeo_v16gi.C
 ** @author Volker Friese <v.friese@gsi.de>
 ** @since 15 June 2012
 ** @date 09.05.2014
 ** @author Tomas Balog <T.Balog@gsi.de>
 **
 ** v16i: first carbon ladder structure in Unit00 is on -x side of the beam
...
TGeoVolume* ConstructLadder(Int_t LadderIndex,
                            ...
                            Double_t shiftZ);
TGeoVolume*
ConstructUnit(Int_t iSide, Int_t iUnit, Int_t nLadders, Int_t* ladderTypes);
...
void create_stsgeo_v16i(const char* geoTag = "v16i") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16i.C" << endl << endl;
  ...
  */
  ...
  /*
// the first carbon ladder is on the left side of the beam axis
...
*/
  ...
  // the first carbon ladder is on the right side of the beam axis
  Int_t allUnitTypes[16][16] = {
    {-1, -1, -1, -1, 0, 9, 0, 1, 0, 9, 0, 10, -1, -1, -1, -1},  // unit00D
    {-1,
     -1,
     -1,
     -1,
     ...
     -1,
     -1},                                                     // unit01U
    {-1, -1, 11, 0, 10, 0, 9, 0, 2, 0, 9, 0, 10, 0, -1, -1},  // unit01D
    {-1,
     -1,
     0,
     110,
     ...
     -1,
     -1},                                                       // unit02U
    {-1, -1, 0, 13, 0, 12, 0, 3, 0, 12, 0, 12, 0, 14, -1, -1},  // unit02D
    {-1,
     -1,
     114,
     0,
     ...
     -1,
     -1},                                                      // unit03U
    {-1, 0, 14, 0, 12, 0, 12, 0, 4, 0, 12, 0, 13, 0, 15, -1},  // unit03D
    {-1,
     115,
     0,
     113,
     ...
     0,
     -1},                                                      // unit04U
    {-1, 19, 0, 17, 0, 16, 0, 5, 0, 16, 0, 17, 0, 18, 0, -1},  // unit04D
    {-1,
     0,
     118,
     0,
     ...
     119,
     -1},                                                      // unit05U
    {-1, 0, 18, 0, 17, 0, 16, 0, 6, 0, 16, 0, 17, 0, 19, -1},  // unit05D
    {-1,
     119,
     0,
     117,
     ...
     0,
     -1},                                                     // unit06U
    {0, 19, 0, 20, 0, 20, 0, 7, 0, 20, 0, 20, 0, 18, 0, 21},  // unit06D
    {121,
     0,
     118,
     0,
     ...
     119,
     0},                                                      // unit07U
    {19, 0, 23, 0, 22, 0, 22, 0, 8, 0, 22, 0, 22, 0, 17, 0},  // unit07D
    {0,
     117,
     0,
     122,
  ...
  for (Int_t iUnit = 0; iUnit < 16; iUnit++) {
    ...
    myunit[iUnit * 2 + 0] =
      ConstructUnit(0, iUnit * 2 + 0, nLadders, ladderTypes);
    myunit[iUnit * 2 + 1] =
      ConstructUnit(1, iUnit * 2 + 1, nLadders, ladderTypes);
