...
TGeoVolume* ConstructLadder(Int_t LadderIndex, TGeoVolume* halfLadderU, TGeoVolume* halfLadderD, Double_t gapY,
                            Double_t shiftZ);
TGeoVolume* ConstructUnit(Int_t iSide, Int_t iUnit, Int_t nLadders, Int_t* ladderTypes);
...
*/
  ...
  Int_t allUnitTypes[16][16] = {{-1, -1, -1, -1, 0, 9, 0, 1, 0, 9, 0, 10, -1, -1, -1, -1},          // unit00D
                                {-1, -1, -1, -1, 110, 0, 109, 0, 101, 0, 109, 0, -1, -1, -1, -1},   // unit01U
                                {-1, -1, 11, 0, 10, 0, 9, 0, 2, 0, 9, 0, 10, 0, -1, -1},            // unit01D
                                {-1, -1, 0, 110, 0, 109, 0, 102, 0, 109, 0, 110, 0, 111, -1, -1},   // unit02U
                                {-1, -1, 0, 13, 0, 12, 0, 3, 0, 12, 0, 12, 0, 14, -1, -1},          // unit02D
                                {-1, -1, 114, 0, 112, 0, 112, 0, 103, 0, 112, 0, 113, 0, -1, -1},   // unit03U
                                {-1, 0, 14, 0, 12, 0, 12, 0, 4, 0, 12, 0, 13, 0, 15, -1},           // unit03D
                                {-1, 115, 0, 113, 0, 112, 0, 104, 0, 112, 0, 112, 0, 114, 0, -1},   // unit04U
                                {-1, 19, 0, 17, 0, 16, 0, 5, 0, 16, 0, 17, 0, 18, 0, -1},           // unit04D
                                {-1, 0, 118, 0, 117, 0, 116, 0, 105, 0, 116, 0, 117, 0, 119, -1},   // unit05U
                                {-1, 0, 18, 0, 17, 0, 16, 0, 6, 0, 16, 0, 17, 0, 19, -1},           // unit05D
                                {-1, 119, 0, 117, 0, 116, 0, 106, 0, 116, 0, 117, 0, 118, 0, -1},   // unit06U
                                {0, 19, 0, 20, 0, 20, 0, 7, 0, 20, 0, 20, 0, 18, 0, 21},            // unit06D
                                {121, 0, 118, 0, 120, 0, 120, 0, 107, 0, 120, 0, 120, 0, 119, 0},   // unit07U
                                {19, 0, 23, 0, 22, 0, 22, 0, 8, 0, 22, 0, 22, 0, 17, 0},            // unit07D
                                {0, 117, 0, 122, 0, 122, 0, 108, 0, 122, 0, 122, 0, 123, 0, 119}};  // unit08U
