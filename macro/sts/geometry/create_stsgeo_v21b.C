 ...
 **
 ** @file create_stsgeo_v21b.C
 ** @author Volker Friese <v.friese@gsi.de>
 ** @since 15 June 2012
 ** @date 09.05.2014
 ** @author Tomas Balog <T.Balog@gsi.de>
 ** 
 ** v21b: Airex foam in the front and  back side wall (Solid).
 * 		  New beam pipe R = 2.0 cm with thickness 1 mm. 
...
void create_stsgeo_v21b(const char* geoTag = "v21b")
{
  ...
  infoFile << "STS geometry created with create_stsgeo_v21b.C" << endl;
