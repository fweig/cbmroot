 ...
 **
 ** v16w: v16a with ladders rotated around y to point towards the vertex
...
void create_stsgeo_v16w(const char* geoTag = "v16w") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16w.C" << endl << endl;
  ...
  */
  ...
  for (Int_t iStation = 0; iStation < 8; iStation++) {
    ...
    mystation[iStation] = ConstructStation(
      iStation, nLadders, ladderTypes, rHole[iStation], statPos[iStation]);
...
Int_t CreateLadders() {
  ...
  Int_t allSectorTypes[23][6] = {
    ...
    {7,
     ...
     4,
     4,
     -1},  // ladder 05 - last column defines alignment of small sensors
    {7,
     2,
     3,
     4,
     4,
     0},  // ladder 06 - last column defines alignment of small sensors
    {2,
     2,
     3,
     4,
...
TGeoVolume* ConstructStation(Int_t iStation,
  ...
  for (Int_t iLadder = 0; iLadder < nLadders; iLadder++) {
    ...
    {
      rot->RotateY(180.);
      rot->RotateY(atan(xPos / zStation) / acos(-1) * 180);
      //      rot->RotateY(60.);
      //      rot->RotateY(60.);
      //      rot->RotateY(60.);
    } else {
    ...
    //         << endl;
    //    cout << "DEE4 "
    //         << "atan: " << atan(xPos/zStation) / acos(-1)*180
    //         << endl;
