...
void create_stsgeo_v17a(const char* geoTag = "v17a") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v17a.C" << endl << endl;
  ...
  */
  ...
  TGeoTranslation* sts_placement =
    new TGeoTranslation("sts_trans", 0., 0., stsPosZ);
  sts_placement->Write();
