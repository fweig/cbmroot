 ...
 **
 ** v16k: derived from v16g with sensor overlap version 3 by Johann
 ** v16j: derived from v16g with sensor overlap version 2 by Johann
...
const Double_t gkSectorOverlapY = 0.4600;  // 0.27; // DEJH -> 0.3345 / 0.4600

// ---> Gap in z between neighbouring sectors in a ladder [cm]
const Double_t gkSectorGapZ = 0.07;  // 0.02; // DEJH -> 0.07 / 0.07

// ---> Horizontal overlap of neighbouring ladders [cm]
const Double_t gkLadderOverlapX = 0.25;  // 0.30; // DEJH -> 0.25 / 0.25

// ---> Gap in z between neighbouring ladders [cm]
const Double_t gkLadderGapZ = 0.50;  // 1.00; // DEJH -> 0.90 / 0.50
...
void create_stsgeo_v16k(const char* geoTag = "v16k") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16k.C" << endl << endl;
