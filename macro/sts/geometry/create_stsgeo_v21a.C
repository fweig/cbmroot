 ...
 **
 ** @file create_stsgeo_v21a.C
 ** @author Volker Friese <v.friese@gsi.de>
 ** @since 15 June 2012
 ** @date 09.05.2014
 ** @author Tomas Balog <T.Balog@gsi.de>
 ** 
 * v21a:  Airex foam in the front and  back side wall (Solid).
 * 		  Old beam pipe with 1mm thickness.
 * 		  FEBs, POBs and C-frames are adjusted. 
...
void create_stsgeo_v21a(const char* geoTag = "v21a")
{
  ...
  infoFile << "STS geometry created with create_stsgeo_v21a.C" << endl;
  ...
  */
  ...
  //                          68.0, 68.0, 78.5, 78.5, 89.0, 89.0, 99.5, 99.5};
...
void PostProcessGdml(TGeoVolume* gdmlVolume)
{
  ...
  std::map<std::string, std::tuple<UInt_t, UInt_t>> props {
    ...
    {"passive_Box_Wall_Vertical_Foam", std::tuple<UInt_t, UInt_t> {kCfColor - 8, kCfTransparency}},
    {"passive_Box_Wall_Vertical_Foam2", std::tuple<UInt_t, UInt_t> {kCfColor - 8, kCfTransparency}},
