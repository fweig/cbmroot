...
TGeoVolume* ConstructLadder(Int_t LadderIndex, TGeoVolume* halfLadderU, TGeoVolume* halfLadderD, Double_t gapY,
                            Double_t shiftZ);
TGeoVolume* ConstructStation(Int_t iStation, Int_t nLadders, Int_t* ladderTypes);
...
void create_stsgeo_v16d(const char* geoTag = "v16d")
{
  ...
  */
  ...
  Int_t allLadderTypes[8][16] = {{-1, -1, -1, -1, 10, 109, 9, 101, 1, 109, 9, 110, -1, -1, -1, -1},         // station 1
