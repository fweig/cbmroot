...
TGeoVolume* ConstructLadder(Int_t LadderIndex,
                            ...
                            Double_t shiftZ);
TGeoVolume*
ConstructStation(Int_t iStation, Int_t nLadders, Int_t* ladderTypes);
...
void create_stsgeo_v16d(const char* geoTag = "v16d") {
  ...
  */
  ...
  //  Int_t allLadderTypes[8][16]= { {  -1,  -1,  -1,  -1,  10,   0,   9,   0,   1,   0,   9,   0,  -1,  -1,  -1,  -1 },    // station 1
  //                                 {  -1,  -1,   0,  10,   0,   9,   0,   2,   0,   9,   0,  10,   0,  11,  -1,  -1 },    // station 2

  Int_t allLadderTypes[8][16] = {{-1,
                                  -1,
                                  -1,
                                  -1,
                                  10,
