 ...
 * 
 * 
 ** v21c: Airex foam in the front and  back side wall (Solid).
 * 		  New beam pipe R = 2.75 cm with thickness 1mm.
...
void create_stsgeo_v21c(const char* geoTag = "v21c")
{
  ...
  infoFile << "STS geometry created with create_stsgeo_v21c.C" << endl;
