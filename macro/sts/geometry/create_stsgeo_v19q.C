...
TGeoVolume* ConstructLadder(Int_t LadderIndex, TGeoVolume* halfLadderU, TGeoVolume* halfLadderD, Double_t gapY,
                            Double_t shiftZ, Double_t offsetZ);
...
Int_t CreateLadders()
{
  ...
  for (Int_t iLadder = 0; iLadder < 27; iLadder++) {
    ...
    ConstructLadder(1000 + iLadder + 1, halfLadderU, halfLadderD, gapXYZ[iLadder][1], gapXYZ[iLadder][2],
                    offsetZcarbon);  // v19k
    ConstructLadder(1100 + iLadder + 1, halfLadderU, halfLadderD, gapXYZ[iLadder][1], gapXYZ[iLadder][2],
                    offsetZcarbon);  // v19k
                            ...
                            Double_t shiftZ, Double_t offsetZ)
{
  ...
  cout << "DERR iladder " << LadderIndex << " zu " << zu << " zd " << zd << " zd+shi " << zd + shiftZ << " ladderZ "
       << ladderZ << endl;
