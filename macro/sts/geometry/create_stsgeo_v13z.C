...
Int_t CreateLadders() {
  ...
  halfLadderU = ConstructHalfLadder(
    "HalfLadder18u", nSectors, sectorTypes, 'r');  // mirrored
  halfLadderD = ConstructHalfLadder(
  ...
  halfLadderU = ConstructHalfLadder(
    "HalfLadder19u", nSectors, sectorTypes, 'r');  // mirrored
  halfLadderD = ConstructHalfLadder(
  ...
  halfLadderU = ConstructHalfLadder(
    "HalfLadder20u", nSectors, sectorTypes, 'r');  // mirrored
  halfLadderD = ConstructHalfLadder(
 ...
 **            ladderZ          thickness of ladder along y
 **/
void AddCarbonLadder(Int_t LadderIndex,
  ...
  Int_t YnumOfFrameBoxes =
    (Int_t)(ladderY / gkFrameStep) + 1;  // calculate number of elements
  if (LadderIndex == 5
      || LadderIndex
           == 19)  // set even number of ladder elements for these ladders
    YnumOfFrameBoxes++;
  ...
  for (i = 1; i <= inum; i++) {
    ...
    if (LadderIndex == 1 || LadderIndex == 5 || LadderIndex == 10
        || LadderIndex == 15 || LadderIndex == 18 || LadderIndex == 19
        || LadderIndex == 20)     // central ladders in stations 1 to 8
...
TGeoVolume* ConstructStation(Int_t iStation,
  ...
  for (Int_t iLadder = 0; iLadder < nLadders; iLadder++) {
    ...
    if (iStation % 2
        == 0)  // flip ladders for even stations to reproduce CAD layout
