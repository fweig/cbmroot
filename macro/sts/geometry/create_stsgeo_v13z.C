...
void AddCarbonLadder(Int_t LadderIndex, TGeoVolume* ladder, Double_t xu, Double_t ladderY, Double_t ladderZ)
{
  ...
  if (LadderIndex == 5 || LadderIndex == 19)                    // set even number of ladder elements for these ladders
    YnumOfFrameBoxes++;
  ...
  for (i = 1; i <= inum; i++) {
    ...
    if (LadderIndex == 1 || LadderIndex == 5 || LadderIndex == 10 || LadderIndex == 15 || LadderIndex == 18
        || LadderIndex == 19 || LadderIndex == 20)  // central ladders in stations 1 to 8
