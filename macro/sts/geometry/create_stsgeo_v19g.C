...
void create_stsgeo_v19g(const char* geoTag = "v19g") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v19g.C" << endl;
  ...
  */
  ...
  Double_t statPos[16]   = {30,
                          ...
                          96,
                          107,
                          107};  // z positions of units
  Double_t statPos18[18] = {30,
...
void ImportPassive(TGeoVolume* stsVolume, TString geoTag, fstream& infoFile) {
  ...
  TGeoTranslation* passiveTrans = new TGeoTranslation(0., 0., 4.68 - 4.);
