...
//                          70, 70, 80, 80, 90, 90, 100, 100 };  // z positions of units
  // v19e
  Double_t statPos[16]   = { 30, 30, 41, 41, 52, 52,  63,  63,
                             74, 74, 85, 85, 96, 96, 107, 107 };  // z positions of units
  Double_t statPos18[18] = { 30, 30,                              // expanded for placement of Unit00
                             30, 30, 41, 41, 52, 52,  63,  63,
                             74, 74, 85, 85, 96, 96, 107, 107 };  // z positions of units
