...
const Double_t gkSectorOverlapY = 0.3345;  // 0.27; // DEJH -> 0.3345 / 0.4600
...
const Double_t gkLadderGapZ = 0.90;  // 1.00; // DEJH -> 0.90 / 0.50
...
void create_stsgeo_v16j(const char* geoTag = "v16j") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16j.C" << endl << endl;
