...
void create_stsgeo_v13w(const char* geoTag = "v13w") {
  ...
  */
  ...
  ladderTypes[6] = 2;
  ladderTypes[7] = 3;
  TGeoVolume* station01 =
    ConstructStation("Station01", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[10] = 3;
  ladderTypes[11] = 4;
  TGeoVolume* station02 =
    ConstructStation("Station02", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[10] = 7;
  ladderTypes[11] = 8;
  TGeoVolume* station03 =
    ConstructStation("Station03", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[12] = 8;
  ladderTypes[13] = 9;
  TGeoVolume* station04 =
    ConstructStation("Station04", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[12] = 13;
  ladderTypes[13] = 14;
  TGeoVolume* station05 =
    ConstructStation("Station05", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[12] = 13;
  ladderTypes[13] = 14;
  TGeoVolume* station06 =
    ConstructStation("Station06", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[14] = 13;
  ladderTypes[15] = 14;
  TGeoVolume* station07 =
    ConstructStation("Station07", nLadders, ladderTypes, rHole);
  ...
  ladderTypes[14] = 13;
  ladderTypes[15] = 14;
  TGeoVolume* station08 =
    ConstructStation("Station08", nLadders, ladderTypes, rHole);
...
ConstructModule(const char* name, TGeoVolume* sector, Double_t cableLength) {
  ...
  // --- Get size of cable
  //  Double_t cableX   = sectorX /2.;  // split cables
  //  Double_t cableX   = sectorX /4.;  // split cables
  //  Double_t cableX   = sectorX /6.;  // split cables
  Double_t cableX = sectorX / 8.;  // split cables
  ...
  if (gkConstructCables && cableLength > 0.0001) {
    ...
    TGeoTranslation* cableTrans1 = new TGeoTranslation(
      "cableTrans1", cableXpos - 1 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 1, cableTrans1);

    TGeoTranslation* cableTrans2 = new TGeoTranslation(
      "cableTrans2", cableXpos + 1 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 2, cableTrans2);

    TGeoTranslation* cableTrans3 = new TGeoTranslation(
      "cableTrans3", cableXpos - 3 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 3, cableTrans3);

    TGeoTranslation* cableTrans4 = new TGeoTranslation(
      "cableTrans4", cableXpos + 3 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 4, cableTrans4);

    TGeoTranslation* cableTrans5 = new TGeoTranslation(
      "cableTrans5", cableXpos - 5 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 5, cableTrans5);

    TGeoTranslation* cableTrans6 = new TGeoTranslation(
      "cableTrans6", cableXpos + 5 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 6, cableTrans6);

    TGeoTranslation* cableTrans7 = new TGeoTranslation(
      "cableTrans7", cableXpos - 7 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 7, cableTrans7);

    TGeoTranslation* cableTrans8 = new TGeoTranslation(
      "cableTrans8", cableXpos + 7 * cableX / 2., cableYpos, cableZpos);
    module->AddNode(cable, 8, cableTrans8);
  }
...
TGeoVolume* ConstructStation(const char* name,
  ...
  TGeoBBox* statTub =
    new TGeoBBox(tubName, rHole, rHole, statZ / 2. + .1);  // .1 opens the hole
