...
void create_stsgeo_v19d(const char* geoTag = "v19d") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v19d.C" << endl;
  ...
  */
  ...
  Double_t statPos[16]   = {30.0,
                          ...
                          93.0,
                          103.5,
                          103.5};  // z positions of units
  Double_t statPos18[18] = {30.0,
                            30.0,  // expanded for placement of Unit00
                            30.0,
                            30.0,
                            40.5,
                            40.5,
