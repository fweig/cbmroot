...
const Bool_t gkConstructCones =
  kFALSE;  // kTRUE;   // switch this false by default for v15c and v16v
const Bool_t gkConstructFrames =
  kTRUE;  // kFALSE;  // switch this true  by default for v15c and v16v
...
void create_stsgeo_v16v(const char* geoTag = "v16v") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16v.C" << endl << endl;
