 ...
 **
 ** v16u: sensor thickness 400 mu
 ** v16v: increase thickness of sensors from 300 mu to 500 mu
...
const Double_t gkSensorThickness = 0.04;  // v16u
// const Double_t gkSensorThickness = 0.05;  // v16v
// const Double_t gkSensorThickness = 0.03;  // v16x
...
const Bool_t gkConstructCones =
  kFALSE;  // kTRUE;   // switch this false by default for v15c and v16u
const Bool_t gkConstructFrames =
  kTRUE;  // kFALSE;  // switch this true  by default for v15c and v16u
...
void create_stsgeo_v16u(const char* geoTag = "v16u") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16u.C" << endl << endl;
...
Int_t CreateLadders() {
  ...
  Double_t gapXYZ[23][3] = {
    {0., -gkSectorOverlapY, 0.},               // ladder 01
