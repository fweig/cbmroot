...
void create_stsgeo_v16d(const char* geoTag = "v16d")
{
  ...
  */
  ...
  Double_t rHole[8] = {2.0,  2.0,  2.0,  2.43,
                       3.04, 3.35, 3.96, 4.2};  // size of cutouts in stations, derived from gapXYZ[x][1]/2
  ...
  for (Int_t iStation = 0; iStation < 8; iStation++) {
    ...
    if (gkConstructCones) {
      ...
      TGeoCombiTrans* conePosRot11 = new TGeoCombiTrans(
        name + "conePosRot2", 0., 0., -coneDz - cone_offset[cone_size[iStation]] - gkLadderGapZ / 2., coneRot11);
      ...
      TGeoCombiTrans* conePosRot12 = new TGeoCombiTrans(
        name + "conePosRot1", 0., 0., coneDz + cone_offset[cone_size[iStation]] + gkLadderGapZ / 2., coneRot12);
