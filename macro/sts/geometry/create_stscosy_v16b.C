...
void create_stscosy_v16b(const char* geoTag = "v16b") {
  ...
  */
  ...
  for (Int_t iSensor = 1; iSensor <= nSensors; iSensor++) {
    ...
    if (iSensor == 2) sensor->SetLineColor(kYellow);  // kRed);
  ...
  //  Int_t statPos[8] = {40., 80., 120., 160., 200., 240., 280., 320.};
  //  Int_t statPos[8] = {40., 75., 85., 120., 160., 195., 205., 240.};
  Int_t statPos[8] = {20., 37.5., 42.5., 60., 80., 97.5, 102.5, 120.};
  cout << endl << endl;
  ...
  nLadders       = 1;
  ladderTypes[0] = 1;
  //  ladderTypes[1]  = 9;  // 13;  // 33;  // 7;
  //  ladderTypes[2]  = 9;  // 12;  // 32;  // 6;
  ...
  rHole          = 2.9;
  nLadders       = 1;
  ladderTypes[0] = 9;  // 15;  // 42;  // 9;
                       //  ladderTypes[1]  = 9;  // 14;  // 34;  // 8;
                       //  ladderTypes[2]  = 9;  // 13;  // 33;  // 7;
                       //  ladderTypes[3]  = 9;  // 12;  // 32;  // 6;
                       //  ladderTypes[4]  = 12;  // 32;  // 6;
  ...
  rHole          = 3.7;
  nLadders       = 1;
  ladderTypes[0] = 9;  // 19;  //  55;  // 14;
                       //  ladderTypes[1]  = 9;  // 18;  //  54;  // 13;
                       //  ladderTypes[2]  = 9;  // 17;  //  53;  // 12;
                       //  ladderTypes[3]  = 9;  // 17;  //  53;  // 12;
                       //  ladderTypes[4]  = 9;  // 16;  //  52;  // 11;
...
Int_t CreateSensors() {
  ...
  // ---  Sensor type 03: Baby sensor (1.62 cm x 1.62 cm)
  xSize = 1.62;
  ySize = 1.62;
  ...
  // ---  Sensor type 05: Baby sensor (1.62 cm x 1.62 cm)
  xSize = 1.62;
  ySize = 1.62;
...
Int_t CreateLadders() {
  ...
  halfLadderD =
    ConstructHalfLadder("HalfLadder01d", 0, sectorTypes, 'l');  // mirrored
