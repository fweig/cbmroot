  ...
  */
  ...
  if (gkConstructCones) {
    ...
    TGeoCombiTrans* conePosRot31 =
      new TGeoCombiTrans(name + "conePosRot2", 0., 0., -coneDz - 0.285 - gkLadderGapZ / 2., coneRot31);
    ...
    TGeoCombiTrans* conePosRot32 =
      new TGeoCombiTrans(name + "conePosRot1", 0., 0., coneDz + 0.285 + gkLadderGapZ / 2., coneRot32);
  ...
  if (gkConstructCones) {
    ...
    TGeoCombiTrans* conePosRot41 =
      new TGeoCombiTrans(name + "conePosRot2", 0., 0., -coneDz - 0.285 - gkLadderGapZ / 2., coneRot41);
    ...
    TGeoCombiTrans* conePosRot42 =
      new TGeoCombiTrans(name + "conePosRot1", 0., 0., coneDz + 0.285 + gkLadderGapZ / 2., coneRot42);
  ...
  if (gkConstructCones) {
    ...
    TGeoCombiTrans* conePosRot51 =
      new TGeoCombiTrans(name + "conePosRot2", 0., 0., -coneDz - 0.285 - gkLadderGapZ / 2., coneRot51);
    ...
    TGeoCombiTrans* conePosRot52 =
      new TGeoCombiTrans(name + "conePosRot1", 0., 0., coneDz + 0.285 + gkLadderGapZ / 2., coneRot52);
  ...
  if (gkConstructCones) {
    ...
    TGeoCombiTrans* conePosRot61 =
      new TGeoCombiTrans(name + "conePosRot2", 0., 0., -coneDz - 0.285 - gkLadderGapZ / 2., coneRot61);
    ...
    TGeoCombiTrans* conePosRot62 =
      new TGeoCombiTrans(name + "conePosRot1", 0., 0., coneDz + 0.285 + gkLadderGapZ / 2., coneRot62);
  ...
  if (gkConstructCones) {
    ...
    TGeoCombiTrans* conePosRot71 =
      new TGeoCombiTrans(name + "conePosRot2", 0., 0., -coneDz - 0.285 - gkLadderGapZ / 2., coneRot71);
    ...
    TGeoCombiTrans* conePosRot72 =
      new TGeoCombiTrans(name + "conePosRot1", 0., 0., coneDz + 0.285 + gkLadderGapZ / 2., coneRot72);
  ...
  if (gkConstructCones) {
    ...
    TGeoCombiTrans* conePosRot81 =
      new TGeoCombiTrans(name + "conePosRot2", 0., 0., -coneDz - 0.285 - gkLadderGapZ / 2., coneRot81);
    ...
    TGeoCombiTrans* conePosRot82 =
      new TGeoCombiTrans(name + "conePosRot1", 0., 0., coneDz + 0.285 + gkLadderGapZ / 2., coneRot82);
...
Int_t CreateLadders()
{
  ...
  halfLadderD = ConstructHalfLadder("HalfLadder01d", 0, sectorTypes, 'l');  // mirrored
...
TGeoVolume* ConstructHalfLadder(const TString& name, Int_t nSectors, Int_t* sectorTypes, char align)
{
  ...
  for (Int_t iSector = 0; iSector < nSectors; iSector++) {
    ...
    if (!sector) Fatal("ConstructHalfLadder", Form("Volume %s not found", sectorName));
...
TGeoVolume* ConstructFrameElement(const TString& name, TGeoVolume* frameBoxVol, Double_t x)
{
  ...
  if (gkCylindricalFrames)
    ...
    TGeoBBox* frameVertPillarShp =
      new TGeoTube(name + "_vertpillar_shape", gkCylinderDiaInner / 2., gkCylinderDiaOuter / 2.,
                   gkFrameStep / 2.);  // circle crossection, along z
  else
    TGeoBBox* frameVertPillarShp = new TGeoBBox(name + "_vertpillar_shape", t, t,
