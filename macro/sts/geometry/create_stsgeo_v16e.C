...
TGeoVolume* ConstructLadder(Int_t LadderIndex,
                            ...
                            Double_t gapY,
                            Double_t shiftZ);
TGeoVolume* ConstructUnit(Int_t iUnit, Int_t nLadders, Int_t* ladderTypes);
...
void create_stsgeo_v16e(const char* geoTag = "v16e") {
  ...
  infoFile << "STS geometry created with create_stsgeo_v16e.C" << endl << endl;
