...
//
// v17l - 96 cm
const Int_t RobsPerModule[NofModuleTypes] = {4, 2, 1, 1, 6, 4, 3, 1};                  // number of GBTx ROBs on module
...
const Int_t GbtxPerModule[NofModuleTypes]   = {12, 6,  3, 0,
                                             0,  12, 9, 3};  // for .geo.info - TODO: merge with above GbtxPerRob
const Int_t RobTypeOnModule[NofModuleTypes] = {3333, 33,  3, 0, 0,
                                               3333, 333, 3};  // for .geo.info - TODO: merge with above GbtxPerRob
...
//void Create_TRD_Geometry_v17l(const Int_t setupid = 1) {
void Create_TRD_Geometry_v17l()
{
