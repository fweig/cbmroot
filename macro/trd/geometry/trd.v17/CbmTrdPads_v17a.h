...
//
// automatically generated by Create_TRD_Geometry_v17a_1e.C
// created 20170316
//
...
Float_t fst1_pad_type[8][3][4] =
  ...
  {{{54.0, 18.00, 54.0 / 80, 1.50},
   ...
   {{92.0, 30.00, 92.0 / 128, 3.75},
    {92.0, 32.00, 92.0 / 128, 4.00},
    {92.0, 30.00, 92.0 / 128, 3.75}},
   ...
   {{92.0, 23.00, 92.0 / 128, 5.75},
    {92.0, 46.00, 92.0 / 128, 5.75},
    {92.0, 23.00, 92.0 / 128, 5.75}},
   ...
   {{92.0, 23.00, 92.0 / 128, 11.50},
    {92.0, 46.00, 92.0 / 128, 11.50},
    {92.0, 23.00, 92.0 / 128, 11.50}},

   // module type 8
   // number of pads: 128 x  4 =  512
   // pad size sector 1:  0.72 cm x 23.00 cm = 16.53 cm2
   // pad size sector 0:  0.72 cm x 23.00 cm = 16.53 cm2
   {{92.0, 23.00, 92.0 / 128, 23.00},
    {92.0, 46.00, 92.0 / 128, 23.00},
    {92.0, 23.00, 92.0 / 128, 23.00}}};
