...
const Int_t RobsPerModule[NofModuleTypes] =
  {5, 3, 2, 1, 2, 3, 2, 1};  // number of GBTx ROBs on module
...
const Int_t FebsPerModule[NofModuleTypes] =
  {10, 6, 4, 4, 12, 9, 6, 3};  // number of FEBs on backside
...
//void Create_TRD_Geometry_v17b(const Int_t setupid = 1) {
void Create_TRD_Geometry_v17b() {
...
void dump_digi_file() {
  ...
  const Double_t PadHeightInSector[NofModuleTypes][NofSectors] =  // pad height
    {{1.25, 1.50, 1.25},  // module type 1 -  1.01 cm2
     {2.25, 2.25, 2.25},  // module type 2 -  1.52 cm2
