...
// 2017-06-13 - DE - v17o    - create a geometry with FEB-8x1 on the large modules, module size 87/90 cm
...
//
// v17o - 90 cm
const Int_t RobsPerModule[NofModuleTypes] = {4, 2, 1, 1, 3, 3, 1, 1};                  // number of GBTx ROBs on module
...
const Int_t GbtxPerModule[NofModuleTypes]   = {12, 6, 3, 0,
                                             9,  9, 3, 3};  // for .geo.info - TODO: merge with above GbtxPerRob
const Int_t RobTypeOnModule[NofModuleTypes] = {3333, 33,  3, 0,
                                               333,  333, 3, 3};  // for .geo.info - TODO: merge with above GbtxPerRob
...
// v17o
const Int_t FebsPerModule[NofModuleTypes] = {8, 4, 2, 4, 6, 6, 2, 2};  // number of FEBs on backside
...
// mini - production
const Double_t DetectorSizeX[2] = {57., 90.};  // => 54 x 54 cm2 & 96 x 96 cm2 active area
const Double_t DetectorSizeY[2] = {57., 90.};  // quadratic modules
...
//void Create_TRD_Geometry_v17o(const Int_t setupid = 1) {
void Create_TRD_Geometry_v17o()
{
...
void dump_digi_file()
{
  ...
  // v17n          { 12.00, 12.00, 12.00 },   // module type 7 -  8.00 cm2
  // v17n          { 24.00, 24.00, 24.00 } }; // module type 8 - 16.00 cm2
