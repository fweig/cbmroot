...
// 2017-05-01 - DE - v17d    - use same layout for module types 2 and 3
...
const Int_t RobsPerModule[NofModuleTypes] =
  {4, 2, 2, 1, 2, 3, 2, 1};  // number of GBTx ROBs on module
const Int_t GbtxPerRob[NofModuleTypes] =
  {103, 103, 103, 103, 107, 103, 103, 103};  // number of GBTx ASICs on ROB
...
//const Int_t GbtxPerRob[NofModuleTypes]    = {103,103,103,103,107,103,103,103 }; // number of GBTx ASICs on ROB
//
//xconst Int_t GbtxPerModule[NofModuleTypes] = {   15,  9,  6,  0,  0,  9,  6,  3 }; // for .geo.info - TODO: merge with above GbtxPerRob
...
const Int_t FebsPerModule[NofModuleTypes] =
  {8, 4, 4, 4, 12, 9, 6, 3};  // number of FEBs on backside
const Int_t AsicsPerFeb[NofModuleTypes] = {
  ...
  107,
  107,
  107};  // %100 gives number of ASICs on FEB, /100 gives grouping
...
//void Create_TRD_Geometry_v17d(const Int_t setupid = 1) {
void Create_TRD_Geometry_v17d() {
...
void dump_digi_file() {
  ...
  // v17b
  const Int_t NofPadsInRow[2] = {80, 112};  // number of pads in rows
  ...
  const Double_t PadHeightInSector[NofModuleTypes][NofSectors] =  // pad height
    {//v17b {  1.25,  1.50,  1.25 },   // module type 1 -  1.01 cm2
     ...
     {3.25, 3.50, 3.25},  // module type 3 -  2.36 cm2
     //v17c          {  6.75,  6.75,  6.75 },   // module type 3 -  4.56 cm2
