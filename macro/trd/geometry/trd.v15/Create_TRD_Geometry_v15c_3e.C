...
// 2015-12-14 - DE - v15c_1m - move TRD in muon_jpsi_setup to z = 490 cm
...
const Bool_t IncludeRobs =
  false;  // false;  // true, if ROBs are included in geometry
...
//Double_t LayerPosition[MaxLayers] = { 490. }; // start position - 2015-12-14 - DE - v14_1m - SIS 100 muon           ( 4 layers, z = 4900 )
...
void Create_TRD_Geometry_v15c_3e() {
