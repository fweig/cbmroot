...
void trd_elid_draw_study() {
  ...
  detectors.push_back("Spectra_Be_run2410003_Rad_H++_Sus02.root");
  leg.push_back("H++/02");

  detectors.push_back("Spectra_Be_run2310013_Rad_G30_Sus06.root");
  leg.push_back("G30/06");
  ...
  detectors.push_back("Spectra_Be_run2310004_Rad_F_Sus18.root");
  leg.push_back("F/18");
  // detectors.push_back("Spectra_Be_run2210010_Rad_G10_Sus18.root"); leg.push_back("18/G10");
  detectors.push_back("Spectra_Be_run2310014_Rad_B_Sus18.root");
  leg.push_back("B/18");
  // detectors.push_back("Spectra_Be_run2310010_Rad_G20_Sus18.root"); leg.push_back("18/G20");

  detectors.push_back("4mm_foam");
  leg.push_back("4mm_foam");
  detectors.push_back("5mm_fibre");
  leg.push_back("5mm_fibre");
  detectors.push_back("4mm_f350");
  leg.push_back("4mm_f350");
