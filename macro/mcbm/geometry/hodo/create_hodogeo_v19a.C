...
*/
  ...
  */
  ...
  nLadders              = 1;
  ladderTypes[0]        = 1;
  TGeoVolume* station01 = ConstructStation(0 + gkStationIdxOffset, nLadders, ladderTypes, rHole);
  ...
  nLadders              = 1;
  ladderTypes[0]        = 1;
  TGeoVolume* station02 = ConstructStation(1 + gkStationIdxOffset, nLadders, ladderTypes, rHole);
  ...
  for (Int_t iStation = 1; iStation <= 2; iStation++) {
    ...
    cout << "Station " << iStation + gkStationIdxOffset << ":  Y " << stsY << endl;
  }
...
Int_t CreateSensors()
{
  ...
  xSize                    = 6.5;
  ySize                    = 6.5;
  TGeoBBox* shape_sensor01 = new TGeoBBox("sensor04", xSize / 2., ySize / 2., zSize / 2.);
