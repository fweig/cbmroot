...
void create_stsgeo_v18a(const char* geoTag = "v18a") {
  ...
  infoFile << "Sensor thickness                   = " << gkSensorThickness
           << " cm" << endl;
  infoFile << "Vertical gap in sensor chain       = " << gkChainGapY << " cm"
           << endl;
  infoFile << "Vertical overlap of sensors        = " << gkSectorOverlapY
           << " cm" << endl;
  infoFile << "Gap in z between neighbour sensors = " << gkSectorGapZ << " cm"
           << endl;
  infoFile << "Horizontal overlap of sensors      = " << gkLadderOverlapX
           << " cm" << endl;
  infoFile << "Gap in z between neighbour ladders = " << gkLadderGapZ << " cm"
           << endl;
  if (gkConstructCables)
    infoFile << "Cable thickness                    = " << gkCableThickness
             << " cm" << endl;
  else
  ...
  */
  ...
  TGeoVolume* station01 =
    ConstructStation("Station01", 0, nLadders, ladderTypes, rHole);
  ...
  TGeoVolume* station02 =
    ConstructStation("Station02", 1, nLadders, ladderTypes, rHole);
...
Int_t CreateLadders() {
  ...
  halfLadderU    = ConstructHalfLadder(
    "HalfLadder21u", nSectors, sectorTypes, 'r');  // mirrored
  ...
  shiftZ         = 2. * shape->GetDZ() + gkSectorGapZ;
  halfLadderU    = ConstructHalfLadder(
    "HalfLadder22u", nSectors, sectorTypes, 'r');  // mirrored
  halfLadderD = ConstructHalfLadder(
  ...
  ladderY        = 2. * shape->GetDY();
  halfLadderU    = ConstructHalfLadder(
    "HalfLadder23u", nSectors, sectorTypes, 'r');  // mirrored
  halfLadderD = ConstructHalfLadder(
    "HalfLadder23d", nSectors, sectorTypes, 'l');  // mirrored
  shape = (TGeoBBox*) halfLadderU->GetShape();
