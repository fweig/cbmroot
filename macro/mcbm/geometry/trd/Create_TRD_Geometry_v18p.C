...
Double_t LayerPosition[MaxLayers] = {
  -19.};  // start position = 0 - 2016-07-12 - DE
...
const Int_t RobsPerModule[NofModuleTypes] =
  {1, 2, 1, 6, 2, 2, 1, 1};  // number of GBTx ROBs on module
const Int_t GbtxPerRob[NofModuleTypes] =
  {103, 105, 105, 103, 107, 105, 105, 103};  // number of GBTx ASICs on ROB
...
const Int_t FebsPerModule[NofModuleTypes] =
  {7, 5, 6, 18, 12, 8, 4, 3};  // number of FEBs on backside
...
const Double_t FrameWidth[3] = {1.0,
                                1.0,
...
const Double_t lattice_o_width[2] = {
  1.0,
  1.0};  // Width of outer lattice frame in cm
