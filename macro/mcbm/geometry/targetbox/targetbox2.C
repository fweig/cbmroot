...
//   // Offset       29.9 cm
   ...
   TGeoVolume *vpipe20 = gGeoManager->MakeCtub("pipe20", med, rmin20, rmax20, length20/2., angle1, angle2, nlow[0], nlow[1], nlow[2], nhi[0], nhi[1], nhi[2]);
   ...
   TGeoVolume *vwall21 = gGeoManager->MakeCtub("wall21", med, rmin21, rmax21, length21/2., angle1, angle2, 0, 0,-1, 0, 0, 1);
...
//   dcov->SetName("O");                 // shapes need names too
   ...
   TGeoCombiTrans*  tfra = new TGeoCombiTrans("tfra",
...
//=======================================================================================
   ...
   TGeoVolume *vpipe10 = gGeoManager->MakeCtub("pipe10", med, rmin10, rmax10, length10/2., angle1, angle2, 0, 0,-1, 0, 0, 1);
   ...
   TGeoVolume *vfla11 = gGeoManager->MakeCtub("flange11", med, rmin11, rmax11, length11/2., angle1, angle2, 0, 0,-1, 0, 0, 1);
...
//=======================================================================================
   ...
   TGeoVolume *vpipe30 = gGeoManager->MakeCtub("pipe30", med, rmin30, rmax30, length30/2., angle1, angle2,
   ...
   // downstream flange
   TGeoVolume *vfla31 = gGeoManager->MakeCtub("flange31", med, rmin40, rmax40, length40/2., angle1, angle2,
					    0, 0,-1, 0, 0, 1);
