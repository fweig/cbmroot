...
void ideal_much_test(Int_t nEvents = 1)
{
  ...
  TString clFile   = dir + "clustering.test.0000.root";
  ...
  CbmMuchClusteringQa* testTask = new CbmMuchClusteringQa();
