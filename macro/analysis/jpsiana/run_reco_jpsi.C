...
void run_reco_jpsi(Int_t nEvents = 50)
{
  ...
  TString parFile = "/hera/cbm/users/slebedev/data/jpsi/jun15_25gev/urqmd_jpsi/"
                    "params.auau.25gev.centr.00697.root";
  TString recoFile = "/hera/cbm/users/slebedev/data/jpsi/jun15_25gev/"
                     "urqmd_jpsi/temp.reco.auau.25gev.centr.00697.root";
  TString mcFile = "/hera/cbm/users/slebedev/data/jpsi/jun15_25gev/urqmd_jpsi/"
