...
graph_RP_cos_vsCentrality()
{
  ...
  for (int i = 0; i < n; i++)
    esigma1[i] = esigma[0][i];
  for (int i = 0; i < n; i++)
    esigma2[i] = esigma[1][i];
  for (int i = 0; i < n; i++)
    esigma3[i] = esigma[2][i];
  for (int i = 0; i < n; i++)
    esigma4[i] = esigma[3][i];
  for (int i = 0; i < n; i++)
    esigma5[i] = esigma[4][i];
  for (int i = 0; i < n; i++)
    esigma6[i] = esigma[5][i];
  for (int i = 0; i < n; i++)
    esigma7[i] = esigma[6][i];
  ...
  for (int i = 0; i < n; i++)
    esmear1[i] = esmear[0][i];
  for (int i = 0; i < n; i++)
    esmear2[i] = esmear[1][i];
  for (int i = 0; i < n; i++)
    esmear3[i] = esmear[2][i];
  for (int i = 0; i < n; i++)
    esmear4[i] = esmear[3][i];
  for (int i = 0; i < n; i++)
    esmear5[i] = esmear[4][i];
  for (int i = 0; i < n; i++)
    esmear6[i] = esmear[5][i];
  for (int i = 0; i < n; i++)
    esmear7[i] = esmear[6][i];
  ...
  c1->SaveAs("plot/EP/"
             "cosRP_vsPercMostCentr_STSmult_afterflatdetinfo_FixStep_2_4_6_10_"
             "15_25_35AGeV_PSD.C");
  c1->SaveAs("plot/EP/"
             "cosRP_vsPercMostCentr_STSmult_afterflatdetinfo_FixStep_2_4_6_10_"
             "15_25_35AGeV_PSD.eps");
  c1->SaveAs("plot/EP/"
             "cosRP_vsPercMostCentr_STSmult_afterflatdetinfo_FixStep_2_4_6_10_"
             "15_25_35AGeV_PSD.gif");
