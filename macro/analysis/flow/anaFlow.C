...
void anaFlow(Int_t mode = 7, Double_t En = 10., Int_t nEvents = 200, Int_t fileNum = 10, int iharmo = 2,
             int genreco = 1, Double_t bMIN = 20., Double_t bMAX = 30.)
{
  Int_t gen     = 0;
  TString harmo = "";
  if (iharmo == 1) harmo = "1";
  ...
  if (mode == 0) {
    ...
    TString infilename_gen = "/hera/cbm/prod/gen/" + sGen + "/auau/" + sEn + "gev/mbias/urqmd.auau." + sEn
                             + "gev.mbias." + sfileNumL + ".root";
  ...
  if (mode == 1) {
    ...
    TString EPfilename_Qcorr =
      dir + "ana/ana_" + numEvt + "evt_" + sfileNum + "_RECOtracks_STScutY_lt0.8_Qcorr_FlatBin_FixStep.root";
    cout << "EPfilename_Qcorr: " << EPfilename_Qcorr << endl;

    // Output file
    if (mcreco == 0)
      TString outfilename = dir + "ana/anaFlow_reco_assMC_" + numEvt + "evt_" + Bcut + sfileNum + ".root";
    if (mcreco == 1)
      TString outfilename = dir + "ana/anaFlow_reco_track_" + numEvt + "evt_" + Bcut + sfileNum + ".root";
  ...
  if (mode == 3 || mode == 4) {
    if (mcreco == 0)
      TString file_tree =
        dir + "ana/anaFlow_reco_assMC_1000evt_" + sfileNum + ".root";  // reco. or KFParticle finder output
    if (mcreco == 1)
      TString file_tree =
        dir + "ana/anaFlow_reco_track_1000evt_" + sfileNum + ".root";  // reco. or KFParticle finder output
    TString file_tree_gen      = dir + "ana/anaFlow_gen_1000evt_" + sfileNum + ".root";  // particles at gen. level
    TString EPcorrFactor_Qcorr = dir
                                 + "ana/"
    ...
    TString outfilename =
      dir + "ana/pion/v" + harmo + "_pion_" + sGenReco + "_N_eff_vspty_" + Bcut + "_mode4_EP_PSD2_effCorr.root";
    ...
    TString result_y = "result/au" + sEn + "au/pion/result_pion_mode4_cut6_" + sGenReco + "_v" + harmo + "_y_" + Bcut
                       + sEP + "_30bins.txt";
    TString result_pt = "result/au" + sEn + "au/pion/result_pion_mode4_cut6_" + sGenReco + "_v" + harmo + "_pt_" + Bcut
                        + sEP + "_30bins.txt";
  ...
  if (mode == 5) {
    ...
    if (genreco == 0)
      TString outfilename = dir + "ana/pion/anaFlow_pion_v" + harmo + "_gen_" + numEvt + "evt_" + Bcut + "_" + sfileNum;
    if (genreco == 1)
      TString outfilename =
        dir + "ana/pion/anaFlow_pion_v" + harmo + "_reco_track_" + numEvt + "evt_" + Bcut + "_" + sfileNum;
  ...
  if (mode == 6) {
    ...
    if (genreco == 0)
      TString outfilename =
        dir + "ana/pion/anaFlow_pion_v" + harmo + "_gen_1Mevt_" + Bcut + "_2Dhistos_mode567_bin300-400.root";
    if (genreco == 1)
      TString outfilename = dir + "ana/pion/anaFlow_pion_v" + harmo + "_reco_track_1Mevt_" + Bcut
  ...
  if (mode == 7) {
    ...
    TString file_2Dmap = dir + "ana/pion/anaFlow_pion_v" + harmo + "_reco_track_1Mevt_" + Bcut
                         + "_2Dhistos_mode567_bin300-400_EP_PSD2.root";
    TString file_2Dmap_gen =
      dir + "ana/pion/anaFlow_pion_v" + harmo + "_gen_1Mevt_" + Bcut + "_2Dhistos_mode567_bin300-400.root";
    TString EPcorrFactor_Qcorr = dir + "ana/ana_1Mevt_RECOtracks_STScutY_lt0.8_Qcorr_FlatBin_FixStep.root";
    TString outfilename =
      dir + "ana/pion/eff_pion_v" + harmo + "_pion_" + sGenReco + "_vspty_1Mevt_" + Bcut + "_mode567_bin300-400.root";
    ...
    TString result_y = "result/au" + sEn + "au/pion/result_pion_mode567_bin300-400_cut9_" + sGenReco + "_v" + harmo
                       + "_y_1Mevt_" + Bcut + sEP + "_30bins.txt";
    TString result_pt = "result/au" + sEn + "au/pion/result_pion_mode567_bin300-400_cut9_" + sGenReco + "_v" + harmo
                        + "_pt_1Mevt_" + Bcut + sEP + "_30bins.txt";
