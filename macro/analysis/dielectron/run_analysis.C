void run_analysis(
        ...
        const string& digiFile = "/lustre/nyx/cbm/users/slebedev/cbm/data/digi.00000.root",
        const string& recoFile = "/lustre/nyx/cbm/users/slebedev/cbm/data/reco.00000.root",
        const string& analysisFile = "/lustre/nyx/cbm/users/slebedev/cbm/data/analysis.00000.root",
