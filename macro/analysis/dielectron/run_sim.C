void run_sim(
    const string& urqmdFile = "/lustre/nyx/cbm/prod/gen/urqmd/auau/8gev/centr/urqmd.auau.8gev.centr.00000.root", // if "", no urqmd
    const string& plutoFile = "/lustre/nyx/cbm/prod/gen/pluto/auau/cktA/8gev/omega/epem/pluto.auau.8gev.omega.epem.0000.root", // if "", no pluto particles are embedded into event
    const string& mcFile = "/lustre/nyx/cbm/users/slebedev/cbm/data/mc.00000.root",
    const string& parFile = "/lustre/nyx/cbm/users/slebedev/cbm/data/param.00000.root",
    const string& geoFile = "/lustre/nyx/cbm/users/slebedev/cbm/data/geosim.00000.root",
