void ana_histo_la()
{
  ...
  hyperon_style();
  TString resultFileName = "la.histo.res.root";
  TString title;
  ...
  TFile* f      = TFile::Open("la.histo.root");
  ...
  Double_t b = hBgdChi1Chi2->Integral(0, nBins + 1, 0, nBins + 1);
  Double_t s = hSigChi1Chi2->Integral(0, nBins + 1, 0, nBins + 1);
  ...
  hSigM->Draw("same e");
  c1->cd(2);
  hAllChi1Chi2M->Draw("e");
  hSigChi1Chi2M->Draw("same e");
  c1->cd(3);
  hAllChiDcaM->Draw("e");
